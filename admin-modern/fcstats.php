...
$HTML_text.="<div class='header' ><h3 class=\"pull-left\">"._QXZ("$report_name")." $NWB#fcstats$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./admin.php?ADD=3111&group_id=$group\">"._QXZ("MODIFY")."</a></div></div>\n";
$HTML_text.="<div class=\"col-md-12\"><div class=\"content\">";
$HTML_text.="<TABLE CELLPADDING=3 CELLSPACING=0 BGCOLOR=\"#e3e3ff\"><TR><TD class='col-md-4' valign='TOP'>";
$HTML_text.="<div id='cl-wrapper' class='sb-collapsed' style='position:relative;margin-bottom:10px;'>";

$HTML_text.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$HTML_text.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>Dates</label></div></div>";
...
$HTML_text.=" <div class='col-lg-10 no-padding''><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=shift>\n";
...
$HTML_text.="</SELECT><label>Shift</label></div></div>\n";

$HTML_text.=" <div class='col-lg-10 no-padding'> ";
...
$HTML_text.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>Display as</label></div></div>\n";
...
$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=group>\n";
	$o=0;
...
if ($archives_available=="Y") 
	{
	$HTML_text.="<input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label>\n";
	}
$HTML_text.="</TD>";


$HTML_text.="</TR><TR><TD colspan='3'><div class='col-md-12 text-center'>";
$HTML_text.="<INPUT TYPE=submit NAME=SUBMIT  class='btn btn-success' VALUE='"._QxZ("SUBMIT")."'>";
$HTML_text.=" <a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?query_date=$query_date&group=$group&shift=$shift&file_download=1&search_archived_data=$search_archived_data\">"._QXZ("DOWNLOAD")."</a>  <BR/>\n";
$HTML_text.="</div></FORM>\n\n";
