...
$MAIN.="<TABLE BORDER=0 CELLSPACING=6 ><TR><TD valign='top' class='col-md-6'>";

$MAIN.="";
$MAIN.="<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date Range").":</label></div></div><div class='col-md-2 text-center p-18'>";
...
$MAIN.="<BR><div class='col-md-12' style='text-align:center;'><label>"._QXZ("to")."</label> </div> <div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT  class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div></div><div class='col-md-2 text-center p-18'>";
...
$MAIN.="</div></div></TD><TD class='col-md-6' valign=top>\n";
...
$MAIN.="<INPUT TYPE=submit NAME=SUBMIT class='btn btn-success' VALUE='"._QXZ("SUBMIT")."'>";
