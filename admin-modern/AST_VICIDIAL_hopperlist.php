...
echo "<TABLE class='col_table table1' CELLPADDING=4 CELLSPACING=0><TR><TD>";
echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET>\n";
echo "<div class='col-md-3'><div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=1 NAME=group>\n";
$o=0;
...
echo "</SELECT><label>"._QXZ("Campaign")."</label></div></div></div>\n";
if ($SShopper_hold_inserts > 0)
	{
	echo "<div class='col-md-3'><div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><SELECT SIZE=1 class='form-control' NAME=status>\n";
	...
	echo "</SELECT> <label>"._QXZ("Status")."</label></div></div></div> \n";
	}

echo "<div class='col-md-6' style='margin-top:10px;'><INPUT TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'>\n";
echo " <a class='btn btn-bdr-sucess' href=\"./admin.php?ADD=34&campaign_id=$group\">"._QXZ("MODIFY")."</a></div>\n";
echo "</FORM><br><br><br>\n\n";

echo "<PRE style='width:85% !important;'><FONT SIZE=2>\n\n";
