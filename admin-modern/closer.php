...
<TITLE><?php echo _QXZ("CLOSER: Main"); ?></TITLE>
<?php $short_header=0;
...
if (!$dialplan_number)
{
	...
	$ext_found=$row[0];
		...
		if (!$group_selected)
			...
			echo "<br><font size='2'><b>"._QXZ("Please select the groups you want to pick calls up from")."</b></font>: <form action=$PHP_SELF method=GET>\n";
			...
			echo "<b>"._QXZ("Inbound Call Groups").":</b> <br>\n";
				$o=0;
			...
			echo "</td></tr></table>\n";
			echo "<input type=SUBMIT name=SUBMIT value='"._QXZ("SUBMIT")."'  class='btn btn-bdr-sucess'>\n";
			echo "<BR><BR><BR>\n";
			}
		else
			{
		...
		{
		echo "<font=red><font size='2' style='color:red;'>"._QXZ("The extension you entered does not exist, please try again")."</b></font>\n";
		echo "<br><b style='float:center'><font size='2'>"._QXZ("Please enter your phone_ID").":</font></b> <form action=$PHP_SELF method=POST>\n";
		echo "<input type=hidden name=PHONE_LOGIN value=1>\n";
		echo "<div class='col-md-12'><div class='col-md-4'><center><b><font size='2'>"._QXZ("phone station ID").":</font></b></center></div><div class='col-md-4'><input type=text name=extension size=10 maxlength=10 value=\"$extension\" class='form-control'></div></div> &nbsp; <br>\n";
		echo "<input type=submit name=SUBMIT value='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'>\n";
		echo "<BR><BR><BR>\n";
		}
	...
	echo "<br><b style='float:center'><font size='2'>"._QXZ("Please enter your phone_ID").":</font></b><form action=$PHP_SELF method=POST>\n";
	echo "<input type=hidden name=PHONE_LOGIN value=1>\n";
	echo "<div class='col-lg-12'><div class='col-md-4'><center><b><font size='2'>"._QXZ("phone station ID").": </font></b></center></div><div class='col-md-4'><input type=text name=extension size=10 maxlength=10 class='form-control'></div></div> &nbsp;<br> \n";
	echo "<input type=submit name=SUBMIT value='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'>\n";
	echo "<BR><BR><BR>\n";
	}
...
echo "<font size='2'><b>$NOW_TIME &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; $PHP_AUTH_USER - $fullname -  "._QXZ("CALLS SENT TO").": $dialplan_number</b><BR><BR>\n";

echo "<font size='2'><b>"._QXZ("Click on the channel below that you would like to have directed to your phone")."</b></font><BR>\n";
