...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")." $NWB#DIDstats$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./admin.php?ADD=3311&did_id=$group[0]\">"._QXZ("MODIFY")."</a></div></div>
...
$MAIN.="<TABLE BORDER=0 CELLPADDING=3 CELLSPACING=0 ><TR><TD class=\"col-md-4\" valign=top>\n";
$MAIN.="<div class='col-md-12'>";

$MAIN.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>Dates</label>";
$MAIN.="</div></div>";
...
$MAIN.="</script>\n";
$MAIN.="</div>";
$MAIN.="<BR><div class=\"col-md-10\" ><div class='form-group custom-input mb-10'><INPUT class='form-control'  TYPE=TEXT NAME=time_BEGIN SIZE=10 MAXLENGTH=8 VALUE=\"$time_BEGIN\"></div>";
$MAIN.="</div></div>";

$MAIN.="<BR><div class=\"col-md-12 text-center\"><label> "._QXZ("to")."</label> </div>";
$MAIN.="<div class='col-md-12'>";
$MAIN.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\">";
...
$MAIN.="</script>\n";
$MAIN.="</div>";
$MAIN.="<BR><div class=\"col-md-10\"><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=time_END SIZE=10 MAXLENGTH=8 VALUE=\"$time_END\"></div>";
$MAIN.="</div></div>";
...
$MAIN.="</TD>";
$MAIN.="<TD class=\"col-md-4\" align=left valign=top>\n";
...
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>"._QXZ("Display as:")."</label></div></div><BR><BR><BR>\n";
...
$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> <a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&DB=$DB&SUBMIT=$SUBMIT&file_download=1\">"._QXZ("DOWNLOAD")."</a>  </FONT>\n";
...
if (!$group)
	...
	if (strlen($extension[0]) > 0)
		...
		$HTML_text.="<BR><table class='table_list hover centerline' border='0' cellpadding='3' cellspacing='1'>";
		$HTML_text.="<tr>";
