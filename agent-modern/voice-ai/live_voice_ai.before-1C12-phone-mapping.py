...
def get_customer_context(lead_id):
    """
    ...
    try:
        ...
        print(
            "DATABASE: lead_id=%s | name=%s | balance=%s RM"
            % (
                lead_id,
                name,
                balance
...
def ask_ollama(transcript):
    ...
    # Phase 1C.10 test customer context.
    # lead_id 15 is the controlled demo lead.
    customer = get_customer_context(15)
...
def process_segment(
    ...
    try:
        ...
        # Do this before Ollama/TTS so no AI response is generated.
        normalized = " ".join(
