...
else
{
	...
	if ($lead_count > 0)
	{
		...
		echo "<tr><td colspan=2 class='col-sm-3'>"._QXZ("Vendor ID").": $vendor_id &nbsp; &nbsp; "._QXZ("Campaign ID").": $campaign_id</td></tr>\n";
		echo "<tr><td colspan=2 class='col-sm-3'>"._QXZ("Fronter").": $tsr &nbsp; &nbsp; "._QXZ("List ID").": $list_id</td></tr>\n";
		echo "<tr><td align=right class='col-sm-3'>"._QXZ("First Name").": </td><td align=left><div class='col-sm-2' style='padding-left:10px;'><input type=text name=first_name size=15 maxlength=30 value=\"$first_name\" class='form-control'></div> &nbsp; \n";
		echo "<div class='col-sm-2'>"._QXZ("Last Name").":</div><div class='col-sm-2' style='padding-left:10px;'><input type=text name=last_name size=15 maxlength=30 value=\"$last_name\" class='form-control'> </div></td></tr>\n";
		echo "<tr><td align=right class='col-sm-2'>"._QXZ("Address 1")." : </td><td align=left><div class='col-sm-4' style='padding-left:10px;'><input type=text name=address1 size=30 maxlength=30 value=\"$address1\" class='form-control' ></div></td></tr>\n";
		echo "<tr><td align=right class='col-sm-2'>"._QXZ("Address 2")." : </td><td align=left><div class='col-sm-4' style='padding-left:10px;'><input type=text name=address2 size=30 maxlength=30 value=\"$address2\" class='form-control'></div></td></tr>\n";
		echo "<tr><td align=right class='col-sm-2'>"._QXZ("Address 3")." : </td><td align=left><div class='col-sm-4' style='padding-left:10px;'><input type=text name=address3 size=30 maxlength=30 value=\"$address3\" class='form-control'></div></td></tr>\n";
		echo "<tr><td align=right class='col-sm-2'>"._QXZ("City")." : </td><td align=left><div class='col-sm-4' style='padding-left:10px;'><input type=text name=city size=30 maxlength=30 value=\"$city\" class='form-control'></div></td></tr>\n";
		echo "<tr><td align=right class='col-sm-2'>"._QXZ("State").": </td><td align=left><div class='col-sm-2' style='padding-left:10px;'><input type=text name=state size=2 maxlength=2 value=\"$state\" class='form-control'></div> &nbsp; \n";
		echo "<div class='col-sm-2'> "._QXZ("Postal Code").": </div><div class='col-sm-2' style='padding-left:10px;'><input type=text name=postal_code size=10 maxlength=10 value=\"$postal_code\" class='form-control'> </div></td></tr>\n";

		echo "<tr><td align=right class='col-sm-2'>"._QXZ("Province")." : </td><td align=left><div class='col-sm-4' style='padding-left:10px;'><input type=text name=province size=30 maxlength=30 value=\"$province\" class='form-control'></div></td></tr>\n";
		echo "<tr><td align=right class='col-sm-2'>"._QXZ("Country")." : </td><td align=left><div class='col-sm-4' style='padding-left:10px;'><input type=text name=country_code size=3 maxlength=3 value=\"$country_code\" class='form-control'></div></td></tr>\n";
		echo "<tr><td align=right class='col-sm-2'>"._QXZ("Alt Phone")." : </td><td align=left><div class='col-sm-4' style='padding-left:10px;'><input type=text name=alt_phone size=10 maxlength=10 value=\"$alt_phone\" class='form-control'></div></td></tr>\n";
		echo "<tr><td align=right class='col-sm-2'>"._QXZ("Email")." : </td><td align=left><div class='col-sm-4' style='padding-left:10px;'><input type=text name=email size=30 maxlength=50 value=\"$email\" class='form-control'></div></td></tr>\n";
		echo "<tr><td align=right class='col-sm-2'>"._QXZ("Security")." : </td><td align=left><div class='col-sm-4' style='padding-left:10px;'><input type=text name=security size=30 maxlength=100 value=\"$security\" class='form-control'></div></td></tr>\n";
		echo "<tr><td align=right class='col-sm-2'>"._QXZ("Comments")." : </td><td align=left><div class='col-sm-4' style='padding-left:10px;'><input type=text name=comments size=30 maxlength=255 value=\"$comments\" class='form-control'></div></td></tr>\n";
			echo "<tr ><td align=right>"._QXZ("Disposition").": </td><td align=left><div class='col-sm-4' style='padding-left:10px;'><select size=1 name=status class='form-control'>\n";
		...
		echo "<tr><td colspan=2><center><input type=submit name=submit value=\""._QXZ("END CALL")."\" class='btn btn-bdr-sucess'></center></td></tr>\n";
		echo "</table></form>\n";
		echo "<BR><BR><BR>\n";
