...
$HEADER.="<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 861px; top: 359px; opacity: 1; z-index: 2;'></div>";
...
$MAIN.="<div class='header'><h3 class=\"pull-left\">"._QXZ("$report_name")." $NWB#LISTS_pass_report$NWE</h3><div class='pull-right'><a class='btn btn-info' href=\"$PHP_SELF?use_lists=1&DB=$DB\">"._QXZ("SWITCH TO LISTS")."</a></div><div class='pull-right'><a class='btn btn-info' href=\"$PHP_SELF?use_lists=0&DB=$DB\">"._QXZ("SWITCH TO CAMPAIGNS")."</a></div><div class='pull-right'>";
if ($use_lists > 0)
	{
	if (strlen($group[0]) > 1)
		{
		$MAIN.=" <a class=\"btn btn-info\" href=\"./admin.php?ADD=311&list_id=$group[0]\">"._QXZ("MODIFY")."</a>  \n";
		$MAIN.=" <a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a> </FONT>\n";
		}
	else
		{
		$MAIN.=" <a class=\"btn btn-info\" href=\"./admin.php?ADD=100\">"._QXZ("LISTS")."</a>  \n";
		$MAIN.=" <a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a> </FONT>\n";
		}
	}
else
...
if ($use_lists > 0)
	{
	$MAIN.="<TD class='col-md-6' VALIGN=TOP> ";
	$MAIN.="<div class='form-group custom-input mb-10'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
	if  (preg_match('/\-\-ALL\-\-/',$group_string))
	...
	$MAIN.="</SELECT><label>"._QXZ("Lists")."</label></div></div>\n\n";
	
	}
else
	{
	$MAIN.="</TD><TD class=\"col-md-6\" VALIGN=TOP> ";
	$MAIN.="<div class='form-group custom-input mb-10'><div class='form-group custom-input mb-10'><SELECT class='form-control'  NAME=group[] multiple>\n";
	if  (preg_match('/\-\-ALL\-\-/',$group_string))
