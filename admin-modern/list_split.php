...
echo "<div class='header'><h3>"._QXZ("List Split Tool")."</h3></div>\n";
echo "<br><br><br>";
echo "<table width=$page_width cellpadding=2 cellspacing=0>\n";
echo "<tr><td class=text-left colspan=2><font face='ARIAL,HELVETICA' color=black size=3> &nbsp; \n";
...
if ($submit == _QXZ("submit") )
	...
	echo "<input class='btn btn-success' type=submit name=confirm value=confirm>\n";
	echo "</form></center>\n";
	echo "<p><a class='btn btn-info' href='$PHP_SELF'>"._QXZ("Click here to start over.")."</a></p>\n";
	echo "</body>\n</html>\n";
...
if (($submit != _QXZ("submit") ) && ($confirm != "confirm"))
	...
	if ($SSallow_manage_active_lists > 0)
		{echo "<p class=text-left>"._QXZ("This is the list split tool. It will split an existing list into several new lists with the same options as the original list. This includes copying the customer fields from the original.")."</p>";}
	else
		{echo "<p class=text-left>"._QXZ("This is the list split tool.  It will only work on inactive lists. It will split an existing list into several new lists with the same options as the original list. This includes copying the customer fields from the original.")."</p>";}
	
	echo "<form action=$PHP_SELF method=POST>\n";
	echo "<center><table width=$section_width cellspacing=3>\n";
	echo "<tr><td colspan=2 class=text-left><font><b>"._QXZ("List Split")."</b></font></td></tr>\n";

	# Orginal Lists
	echo "<tr><td align=right>"._QXZ("Original List")."</td><td align=left><div class='col-lg-5'>\n";
	echo "<select class='form-control' size=1 name=orig_list>\n";
	...
	echo "<tr><td align=right>"._QXZ("Start Destination List")."</td><td align=left><div class='col-lg-5'>\n";
	echo "<input class='form-control' type='text' name='start_dest_list_id' value='$max_list_id'> </div>("._QXZ("must be")." >= $max_list_id)</td></tr>\n";

	# Number of leads per list
	echo "<tr><td align=right>"._QXZ("Number of Leads Per List")."</td><td align=left><div class='col-lg-5'>\n";
	echo "<select class='form-control' size=1 name=num_leads>\n";
