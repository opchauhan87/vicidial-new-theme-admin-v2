...
$HTML_text.="<TABLE CELLSPACING=3 BGCOLOR=\"#".$SSframe_background."\"><TR><TD class=\"col-md-4\" VALIGN=TOP>";
$HTML_text.="<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
$HTML_text.="<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Dates")."</label></div></div>";
$HTML_text.="<div class='col-md-2 p-18'>";
...
$HTML_text.="<BR><div style='padding-top: 24px !important;width: 84%;'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_time SIZE=10 MAXLENGTH=10 VALUE=\"$query_time\"></div></div></div>";

$HTML_text.="<BR><div class='col-md-12' style=\"text-align:center;\"> <label>"._QXZ("to")."</label> </div>";

$HTML_text.="<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div></div>";

$HTML_text.="<div class='col-md-2 p-18'><script language=\"JavaScript\">\n";
$HTML_text.="var o_cal = new tcal ({\n";
$HTML_text.="	// form name\n";
$HTML_text.="	'formname': 'vicidial_report',\n";
$HTML_text.="	// input name\n";
...
$HTML_text.="<BR><div style='padding-top: 29px !important;width: 84%;'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_time SIZE=10 MAXLENGTH=10 VALUE=\"$end_time\"></div></div></div>";


$HTML_text.="</TD><TD class=\"col-md-4\" VALIGN=TOP><BR>";
$HTML_text.="<div class='col-lg-12'><div class='form-group custom-input mb-10'><SELECT class='form-control'  NAME=group[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
$HTML_text.="<div class='col-lg-12'><div class='form-group custom-input mb-10'><SELECT  class='form-control'  NAME=user_group[] multiple>\n";
...
$HTML_text.=" <BR>";
$HTML_text.="<div class='col-lg-12'><div class='form-group custom-input mb-10'><SELECT  class='form-control' NAME=users[] multiple>\n";
...
$HTML_text.="<BR>";
$HTML_text.="<div class='form-group custom-input mb-10'><select class='form-control' name='report_display_type'>";
...
$HTML_text.="<BR>";
$HTML_text.="<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=shift>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Shift").":</label></div>	</div><BR><BR>\n";

$HTML_text.="<input type='checkbox' name='live_agents' value='checked' $live_agents><label>"._QXZ("&nbsp;Only live agents")."</label><BR>\n";
$HTML_text.="<input type='checkbox' name='show_percentages' value='checked' $show_percentages><label>"._QXZ("&nbsp;Show %s")."</label><BR>\n";
$HTML_text.="<input type='checkbox' name='time_in_sec' value='checked' $time_in_sec><label>"._QXZ("&nbsp;Time in seconds")."</label><BR>\n";
$HTML_text.="<input type='checkbox' name='breakdown_by_date' value='checked' $breakdown_by_date><label>"._QXZ("&nbsp;Show date breakdown")."</label><BR>\n";
$HTML_text.="<input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label><BR>\n";
$HTML_text.="<input type='checkbox' name='show_defunct_users' value='checked' $show_defunct_users><label>"._QXZ("&nbsp;Show defunct users")."</label><BR>\n";
...
$HTML_text.="</TABLE>";
$HTML_text.="<div align='center' class='col-md-12'><INPUT class='btn btn-success' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></div>\n";
$HTML_text.="</FORM>\n\n";


$HTML_text.="<PRE class='m-0'><FONT SIZE=2>";
