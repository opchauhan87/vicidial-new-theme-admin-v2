...
$show_disposition_statuses = preg_replace('/[^-_0-9a-zA-Z]/', '', $show_disposition_statuses);
$ignore_afterhours = preg_replace('/[^-_0-9a-zA-Z]/', '', $ignore_afterhours);
$exclude_afterhours = preg_replace('/[^-_0-9a-zA-Z]/', '', $exclude_afterhours);
...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")." $NWB#inbound_daily_report$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./admin.php?ADD=3111&group_id=$group[0]\">"._QXZ("MODIFY")."</a></div> </div>
		<div class='col-md-12'><div class='content'>";
$MAIN.="<TR>";

$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE CELLPADDING=3 CELLSPACING=0 ><TR valign='top'><TD class=\"col-md-4\" valign='TOP'>";

$MAIN.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>Dates</label></div></div>";
...
$MAIN.="<div class=\"col-md-12\" style=\"text-align:center;\"><label> "._QXZ("to")."</label></div><div class='col-lg-10 no-padding'> <div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div></div>";
$MAIN.="<div class='col-md-2 text-center p-18'>";
$MAIN.="<script language=\"JavaScript\">\n";
$MAIN.="var o_cal = new tcal ({\n";
$MAIN.="	// form name\n";
...
$MAIN.="</script>\n";
$MAIN.="</div>";
$MAIN.="<TD class=\"col-md-4\" >\n";

$MAIN.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=list_ids[] multiple>\n";
...
$MAIN.="</SELECT><label>Lists</label></div></div>\n";
...
$MAIN.="</SELECT><label>ALL INGROUPS</label></div></div>\n";
$MAIN.=" &nbsp;";
...
$MAIN.="<INPUT TYPE=checkbox NAME=hourly_breakdown VALUE='checked' $hourly_breakdown><label>"._QXZ("&nbsp;Show hourly results")."</label><BR><INPUT TYPE=checkbox NAME=show_disposition_statuses VALUE='checked' $show_disposition_statuses><label>"._QXZ("&nbsp;Show disposition statuses")."</label><BR><INPUT TYPE=checkbox NAME=ignore_afterhours VALUE='checked' $ignore_afterhours><label>"._QXZ("&nbsp;Ignore after-hours calls")."</label><BR><INPUT TYPE=checkbox NAME=exclude_afterhours VALUE='checked' $exclude_afterhours><label>"._QXZ("&nbsp;Exclude after-hours from abandons")."</label>";
...
$MAIN.= "<a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date$selected_group_URLstr&shift=$shift&hourly_breakdown=$hourly_breakdown&show_disposition_statuses=$show_disposition_statuses&SUBMIT=$SUBMIT&file_download=1&search_archived_data=$search_archived_data\">"._QXZ("DOWNLOAD")."</a>";
$MAIN.="</div>";
$MAIN.="</TD></TR></TABLE>";
$MAIN.="<PRE class='col-md-12 m-0'>\n\n";
