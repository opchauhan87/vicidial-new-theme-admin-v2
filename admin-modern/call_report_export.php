...
if ($run_export > 0)
    ...
    {
    $Excelfilename = "EXPORT_LEAD_REPORT_$FILE_TIME.xls";

    // We'll be outputting a CSV file for Excel
...
echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("$report_name").$NWB.$NWE.'</h3> </div>
	...
	echo "<TABLE BORDER=0 CELLSPACING=8><TR><TD  VALIGN=TOP class='col-md-4'>\n";

	
	echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class=form-control TYPE=TEXT NAME=query_date SIZE=8 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date Range").":</label></div></div>";

	?>
	<div class='col-md-2 p-18'>
	...
	<?php
	echo "<BR>\n";
	echo "<div class='col-md-10'><div class='form-group custom-input mb-10'><select class=form-control name='query_hour' id='query_hour'>\n";
	for ($i=0; $i<24; $i++)
		{
		$hr=substr("0$i", -2);
	...
	echo "</select><B>:00:00</B></div>\n";
	
	//~ echo "<div class='col-md-12 text-center'><label>"._QXZ("to")."</label></div>\n";
	//~ echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class=form-control TYPE=TEXT NAME=end_date  MAXLENGTH=10 SIZE=8 VALUE=\"$end_date\"></div></div>";
	
	echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class=form-control TYPE=TEXT NAME=end_date SIZE=8 MAXLENGTH=10 VALUE=\"$end_date\"><label>"._QXZ("to").":</label></div></div>";
	...
	echo "<BR>\n";
	echo "<div class='col-md-10'><div class='form-group custom-input mb-10'><select class=form-control name='end_hour' id='end_hour'>\n";
	for ($i=0; $i<24; $i++)
		{
		$hr=substr("0$i", -2);
	...
	echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><input class=form-control type='text' name='user' id='user' size='7' maxlength='20'><label>"._QXZ("User").":</label></div></div>$NWB#call_export_report-user$NWE\n";
//	echo "<BR><BR>\n";
//echo "\n";
	
	//echo "<B>"._QXZ("Header Row").":</B> $NWB#call_export_report-header_row$NWE<BR>\n";
	//~ echo "<div class='col-md-12'><div class='form-group custom-input mb-10'><select class=form-control size=1 name=header_row style='width: 85%;'>";
	//~ echo "<option selected value=\"YES\">"._QXZ("YES")."</option><option value=\"NO\">"._QXZ("NO")."</option>\n";
	//~ echo "</SELECT><label>"._QXZ("Header Row").":</label></div></div>\n";
	//~ echo "<B>"._QXZ("Date Field").":</B><BR>\n";
	echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><select class=form-control size=1 name=date_field><option selected value=\"call_date\">"._QXZ("Call date")."</option><option value=\"entry_date\">"._QXZ("Entry date")."</option></select> <label>"._QXZ("Date Field").":</label></div></div>$NWB#call_export_report-date_field$NWE\n";

	//echo "<BR><BR>\n";
	
	//echo "<B>"._QXZ("Recording Fields").":</B> $NWB#call_export_report-rec_fields$NWE<BR>\n";
	echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><B>"._QXZ("Sort order").":</B>";
	echo "<input type=radio value='asc' name='sort_dir' $asc>"._QXZ("Ascending")."<BR>\n";
	echo "<input type=radio value='desc' name='sort_dir' $desc>"._QXZ("Descending")."<BR></div></div>$NWB#call_export_report-sort_dir$NWE\n";
	
	echo "<BR><BR>\n";

	//~ echo "<B>"._QXZ("Header Row").":</B><BR>\n";
	echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><select class=form-control size=1 name=header_row><option selected value=\"YES\">"._QXZ("YES")."</option><option value=\"NO\">"._QXZ("NO")."</option></select> <label>"._QXZ("Header Row").":</label></div></div>$NWB#call_export_report-header_row$NWE\n";

	echo "<BR><BR>\n";

	//~ echo "<B>"._QXZ("Rec Fields").":</B><BR>\n";
	echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><select class=form-control size=1 name=rec_fields style='width: 85%;'>";
	...
	//echo "<B>"._QXZ("Recording Fields").":</B> $NWB#call_export_report-rec_fields$NWE<BR>\n";
	echo "</SELECT><label>"._QXZ("Recording Fields").":</label></div></div>$NWB#call_export_report-rec_fields$NWE<BR>\n\n";
	...
	if ($custom_fields_enabled > 0)
		...
		echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><select class=form-control size=1 name=custom_fields style='width: 85%;'>";
		echo "<option value=\"YES\">"._QXZ("YES")."</option><option selected value=\"NO\">"._QXZ("NO")."</option>\n";
		echo "</SELECT><label>"._QXZ("Custom Fields").":</label></div></div>$NWB#call_export_report-custom_fields$NWE\n";
		}
	...
	echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><select class=form-control size=1 name=call_notes style='width: 85%;'>";
	echo "<option value=\"YES\">"._QXZ("YES")."</option><option selected value=\"NO\">"._QXZ("NO")."</option>\n";
	echo "</SELECT><label>"._QXZ("Per Call Notes").":</label></div></div>$NWB#call_export_report-call_notes$NWE\n";

	//echo "<BR>\n";

	
	//echo "<div class='size col-lg-6' style='text-align:left; padding:10px 0px 0px 0px;'><select size=1 class=form-control name=export_fields style='width: 85%;'><option selected value=\"STANDARD\">"._QXZ("STANDARD")."</option><option value=\"EXTENDED\">"._QXZ("EXTENDED")."</option><option value=\"EXTENDED_2\">"._QXZ("EXTENDED_2")."</option><option value=\"EXTENDED_3\">"._QXZ("EXTENDED_3")."</option><option value=\"ALTERNATE_1\">ALTERNATE_1</option></select></div></div>\n";
...
echo "</TD><TD VALIGN=TOP class='col-md-4'>\n";
	
	echo "<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT  class=form-control  NAME=campaign[] multiple>\n";
			$o=0;
	...
	echo "</SELECT><label>"._QXZ("Campaigns").":</label></div></div><BR>\n";
	
		echo "<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT  class=form-control NAME=status[] multiple>\n";
	$o=0;
	...
	echo "</SELECT><label>"._QXZ("Statuses").":</label></div></div><BR>\n";
	
		if ($ivr_export != 'YES')
		{
		
		
		echo "<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class=form-control  NAME=user_group[] multiple>\n";
			$o=0;
		...
		echo "</SELECT><label>"._QXZ("User Groups").":</label></div></div>\n";
		}
	...
	if ($ivr_export != 'YES')
		{
		echo "</TD><TD class='col-md-4' VALIGN=TOP>\n";
		
		echo "<div class='form-group custom-input mb-10'><SELECT  class=form-control NAME=group[] multiple>\n";
		$o=0;
		...
		echo "</SELECT><label>"._QXZ("Inbound Groups").":</label></div><BR>\n";
		}
		
	
	echo "<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT  class=form-control NAME=list_id[] multiple>\n";
	$o=0;
	...
	echo "</SELECT><label>"._QXZ("Lists").":</label></div></div><BR>\n";
	
	//echo "<B>"._QXZ("Export Fields").":</B> $NWB#call_export_report-export_fields$NWE<BR>\n";
	echo "<div class='col-md-12'><div class='form-group custom-input mb-10'><select class=form-control size=1 name=export_fields style='width: 85%;'>";
 	echo "<option selected value=\"STANDARD\">"._QXZ("STANDARD")."</option><option value=\"EXTENDED\">"._QXZ("EXTENDED")."</option><option value=\"EXTENDED_2\">"._QXZ("EXTENDED_2")."</option><option value=\"EXTENDED_3\">"._QXZ("EXTENDED_3")."</option><option value=\"EXTENDED_4\">"._QXZ("EXTENDED_4")."</option><option value=\"ALTERNATE_1\">ALTERNATE_1</option><option value=\"ALTERNATE_2\">ALTERNATE_2</option>\n";
 	echo "</SELECT><label>"._QXZ("Export Type").":</label></div></div><BR>\n";
	...
	echo "<INPUT class='btn btn-success' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
