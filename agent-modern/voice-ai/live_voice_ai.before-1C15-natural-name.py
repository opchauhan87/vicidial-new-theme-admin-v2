...
def ask_ollama(transcript, customer=None):
    ...
    system_prompt = (
        ...
        "If the customer's name is supplied, address the customer by name naturally. "
        "For example, use the customer's first name when greeting them. "
...
def process_segment(
    ...
    try:
        ...
        try:
            ...
            # Resolve customer from AudioSocket UUID.
