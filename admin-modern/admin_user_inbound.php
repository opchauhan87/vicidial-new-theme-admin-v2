...
$report_name = 'User Inbound Calls Today ALL USERS';
$NWB = "<IMG SRC=\"help.png\" onClick=\"FillAndShowHelpDiv(event, '";
$NWE = "#user_inbound_calls_today')\" WIDTH=20 HEIGHT=20 BORDER=0 ALT=\"HELP\" ALIGN=TOP>";
...
while ($users_to_print > $i) 
	...
	if ($Rmax_inbound_calls[$i] == 0) {$Rmax_inbound_calls[$i] = "("._QXZ("disabled").")</font>";}
	if ($Rinbound_credits[$i] == -1) {$Rinbound_credits[$i] = "("._QXZ("disabled").")</font>";}
	...
	$rows_output .= "<td >$calls_today</td>";
	$rows_output .= "<td >$calls_today_filtered</td>";
	$rows_output .= "<td >$Rmax_inbound_calls[$i]</td>";
	$rows_output .= "<td >$Rinbound_credits[$i]</td>";
...
$credits_message='';
if ($SSinbound_credits < 1) {$credits_message = "("._QXZ("disabled").")</font>";}
echo "<TABLE class='table_list hover centerline' width=1080 cellspacing=3>\n";
echo "<thead><tr><th>#</th><th><font><b>"._QXZ("USER")."</th><th><font><b>"._QXZ("USER GROUP")."</th><th NOWRAP COLSPAN=2><font size=2><b>"._QXZ("INBOUND CALLS TODAY - filtered")."</th><th><font><b>"._QXZ("MAX INBOUND CALLS")."</th><th><font><b>"._QXZ("INBOUND CREDITS")." $credits_message</th><th><font><b>"._QXZ("NOTES")." ($notes_ct)</th></tr></thead>\n";
