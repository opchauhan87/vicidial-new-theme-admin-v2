...
if ( (!$OK_to_process) or ( ($leadfile) and ($file_layout!="standard" && $file_layout!="template") ) )
	...
	if ($file_layout!="custom") 
		...
		?>
					  <div class="header">
					  <h3><?php echo  _QXZ("ADMINISTRATION: Lead Loader"); ?></h3>
			  		  </div>
			  		  <div class="col-md-12">
			  		  <div class="content">
	<table class="centerline hover" align=center border=0 cellpadding=5 cellspacing=0 >
		  <tr>
			<td><B><font face="arial, helvetica" size=2><?php echo _QXZ("Load leads from this file"); ?>:</font></B></td>
			<td><div class="col-lg-5"><input class="form-control" type=file name="leadfile" value="<?php echo $leadfile ?>"></div> <?php echo "$NWB#list_loader$NWE"; ?></td>
		  </tr>
		  <tr>
				<td><font face="arial, helvetica" size=2><?php echo _QXZ("List ID Override"); ?>: </font></td>
			<td><font face="arial, helvetica" size=1>
			<div class="col-lg-5"><select class="form-control" name='list_id_override' onchange="PopulateStatuses(this.value)">
			...
			?>
				</select></div><div class="col-lg-5"><input class="ace"  type='checkbox' name='master_list_override' value='1'><label class="lbl"></label>(<?php echo _QXZ("override template setting"); ?>)
			</font></td>
		  </tr>
		  <tr>
			<td><font face="arial, helvetica" size=2><?php echo _QXZ("Phone Code Override"); ?>:  </font></td>
				<td><font face="arial, helvetica" size=1>
			<div class="col-lg-5"><select class="form-control" name='phone_code_override'>
                        <option value='in_file' selected='yes'><?php echo _QXZ("Load from Lead File"); ?></option>
			<?php
			...
			$count=0;
				...
				{
				$row = mysqli_fetch_row($rslt);
				$stmt_system_seeting="SELECT distinct  default_phone_code from system_settings;";
			 	$rslt_system_setting=mysql_to_mysqli($stmt_system_seeting, $link);
				$row1 = mysqli_fetch_row($rslt_system_setting);

				echo "<option value='$row[0]'";echo (($row[0]==$row1[0])?'selected':'');echo ">$row[0] - $row[1]</option>\n";
		  ...
		  <tr>
			<td><B><font face="arial, helvetica" size=2><?php echo _QXZ("File layout to use"); ?>:</font></B></td>
		<td align=left><div class='col-lg-6'><font face="arial, helvetica" size=2><input type=radio name="file_layout" value="standard" checked> <?php echo _QXZ("Standard Format"); ?>&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="custom"><?php echo _QXZ("Custom layout"); ?>&nbsp;&nbsp;&nbsp;&nbsp;<input type=radio name="file_layout" value="template"><?php echo _QXZ("Custom Template"); ?><?php echo "<!--$NWB#list_loader-file_layout$NWE-->"; ?></div></td>
		  </tr>
		  <tr>
			<td><B><font face="arial, helvetica" size=2><?php echo _QXZ("Custom Layout to Use"); ?>:</font></B></td>
			<td align=left><div class="col-lg-5"><select class="form-control" name="template_id" id="template_id">
<?php
...
?>
			</select></div> <a href='AST_admin_template_maker.php'><font face="arial, helvetica" size=1><?php echo _QXZ("template builder"); ?></font></a><?php echo "$NWB#list_loader-template_id$NWE"; ?><BR><a href='#' onClick="TemplateSpecs()"><font face="arial, helvetica" size=1><?php echo _QXZ("View template info"); ?></font></a></td>
		  <tr>
			<td><font face="arial, helvetica" size=2><?php echo _QXZ("Lead Duplicate Check"); ?>: </font></td>
		<td align=left width="75%"><font face="arial, helvetica" size=1><div class="col-lg-5"><select class="form-control" size=1 name=dupcheck>
			...
			</select></div> <?php echo "$NWB#list_loader-duplicate_check$NWE"; ?></td>
		  </tr>
		 <?php
...
?>
<tr >
		<td><font class="standard"><?php echo _QXZ("Status Duplicate Check"); ?>:</font></td>
		<td width='75%'>
		<span id='statuses_display'>
		<div class="col-lg-5"><select class="form-control" id='dedupe_statuses' name='dedupe_statuses[]' size=5 multiple>
...
<?php } ?>
		  <tr>
			<td ><font face="arial, helvetica" size=2><?php echo _QXZ("USA-Canada Check"); ?>:</font></td>
			<td align=left width="75%"><font face="arial, helvetica" size=1><div class="col-lg-5"><select class="form-control" size=1 name=usacan_check>
		  ...
		  <tr>
		<td ><font face="arial, helvetica" size=2><?php echo _QXZ("Lead Time Zone Lookup"); ?>:</font></td>
			<td align=left width="75%"><font face="arial, helvetica" size=1><div class="col-lg-5"><select class="form-control" size=1 name=postalgmt>
		  ...
		  <tr>
			...
			<td align=left width="75%"><font face="arial, helvetica" size=1><div class="col-lg-5"><select class="form-control" size=1 name=state_conversion>
		  ...
		  <tr>
			...
			<td align=left width="75%"><font face="arial, helvetica" size=1><div class="col-lg-5"><select class="form-control" size=1 name=web_loader_phone_length>
		...
		<div  align='center'><input class="btn btn-success" type=submit value="<?php echo _QXZ("SUBMIT"); ?>" name='submit_file'><input class="btn btn-bdr-pink" type=button onClick="javascript:document.location='admin_listloader_fourth_gen.php'" value="<?php echo _QXZ("START OVER"); ?>" name='reload_page'>
		</div>
<!--
...
?>
	...
	<tr>
	<td align=center colspan=2><B><center>
	<form action=<?php echo $PHP_SELF ?> method=get onSubmit="ParseFileName()" enctype="multipart/form-data">
	<input type=hidden name='leadfile_name' value="<?php echo $leadfile_name ?>">
	<input type=hidden name='DB' value="<?php echo $DB ?>">
	<a class='btn btn-primary btn-sm' href="admin_listloader_fourth_gen.php"><?php echo _QXZ("Load Another Lead File"); ?></a></center></B> </td>
	</tr></table>
	</div></div></div></div></div></div></div>
	<BR><BR><BR><BR>
	<?php
...
if ($OK_to_process) 
	...
	if (count($field_check)>=2) 
		...
		flush();
		$file=fopen("$lead_file", "r");
		print "<center><font face='arial, helvetica' size=3 color='#009900'><span class='message_block'><B>"._QXZ("Processing file")."...\n";
...
//16-03-21
				...
				if (preg_match("/DUPLIST/i",$dupcheck))
					...
					if ($dup_lead < 1)
						{
						echo $stmt="SELECT count(*) from vicidial_list where phone_number='$phone_number' and list_id='$list_id' $multidaySQL $statuses_clause;";
						$rslt=mysql_to_mysqli($stmt, $link);
						$pc_recs = mysqli_num_rows($rslt);
						if ($pc_recs > 0)
							{
		...
		print "<BR><BR>"._QXZ("Done")."</B> "._QXZ("GOOD").": $good &nbsp; &nbsp; &nbsp; "._QXZ("BAD").": $bad $moved_str &nbsp; &nbsp; &nbsp; "._QXZ("TOTAL").": $total<BR><BR></span></font></center>";
		} 
	else 
		{
		print "<center><span class='message_block' style='margin-bottom: 35px !important;'><B>"._QXZ("ERROR").": "._QXZ("The file does not have the required number of fields to process it").".</B></span></center>";
		}
	}
...
#			$custom_table=$template_row["custom_table"];
		...
		if (count($field_check)>=2) 
			...
			$file=fopen("$lead_file", "r");
			$total=0; $good=0; $bad=0; $dup=0; $inv=0; $post=0; $moved=0; $phone_list='';
			print "<center><font face='arial, helvetica' size=3 color='#009900'><span class='message_block'><B>"._QXZ("Processing")." $delim_name "._QXZ("file using template")." $template_id... ($tab_count|$pipe_count)\n";
			if (strlen($list_id_override)>0) 
				{
				print "<BR>"._QXZ("LIST ID OVERRIDE FOR THIS FILE").": $list_id_override<BR>";
				}
...
/*
			...
			{
			print "<center><font face='arial, helvetica' size=3 color='#990000'><span class='message_block' style='margin-bottom: 35px !important;'><B>"._QXZ("ERROR: The file does not have the required number of fields to process it").".</B></span></font></center>";
			}
	...
	if ($file_layout=="standard") 
		...
		if (count($field_check)>=2) 
			...
			$file=fopen("$lead_file", "r");
			$total=0; $good=0; $bad=0; $dup=0; $inv=0; $post=0; $moved=0; $phone_list='';
			print "<center><font face='arial, helvetica' size=3 color='#009900'><span class='message_block'><B>"._QXZ("Processing")." $delim_name "._QXZ("file")."... ($tab_count|$pipe_count)\n";
			...
			print "<BR><BR>"._QXZ("Done")."</B> "._QXZ("GOOD").": $good &nbsp; &nbsp; &nbsp; "._QXZ("BAD").": $bad &nbsp; &nbsp; &nbsp; "._QXZ("TOTAL").": $total<BR><BR></span></font></center>";
			}
		else 
			{
			print "<center><font face='arial, helvetica' size=3 color='#990000'><B><span class='message_block' style='margin-bottom: 35px !important;'>"._QXZ("ERROR: The file does not have the required number of fields to process it").".</span></B></font></center>";
			}
		}
	...
	##### BEGIN field chooser #####
		...
		print "<script language='JavaScript1.2'>\nif(document.forms[0].leadfile) {document.forms[0].leadfile.disabled=true;}\nif(document.forms[0].submit_file) {document.forms[0].submit_file.disabled=true;}\nif(document.forms[0].reload_page) {document.forms[0].reload_page.disabled=true;}\n</script><HR>";
		flush();
		print "<div class='col-md-12'><div class='content'><table class=\"hover block-flat\" border=0 cellpadding=3 cellspacing=0 width=700 align=center>\r\n";
		print "  <tr>\r\n";
		print "    <th width=30% style=\"text-align:right; padding-top:7px;border-right:1px solid #CDCDCD ; padding-bottom:7px\">"._QXZ("VICIDIAL Column")." &nbsp;</th>\r\n";
		print "    <th style=\"text-align:left;  padding-top:7px ; padding-bottom:7px\"> &nbsp; &nbsp; &nbsp;"._QXZ("File data")."</th>\r\n";
		print "  </tr>\r\n";
		...
		flush();
		$file=fopen("$lead_file", "r");
		print "<center><font face='arial, helvetica' size=3 color='#009900'><span class='message_block'><B>"._QXZ("Processing")." $delim_name "._QXZ("file")."...\n";
		...
		if (strlen($phone_code_override)>0) 
			{
			print "<BR><span class=''>"._QXZ("PHONE CODE OVERRIDE FOR THIS FILE").": $phone_code_override</span><BR>";
			}
		if (strlen($dupcheck)>0) 
			{
			print "<BR><span class=''>"._QXZ("LEAD DUPLICATE CHECK").": $dupcheck<BR></span>\n";
			}
		if (strlen($international_dnc_scrub)>0)
			{
			print "<BR><span class=''>"._QXZ("INTERNATIONAL DNC SCRUB").": $international_dnc_scrub</span><BR>\n";
			}
		if (strlen($status_dedupe_str)>0) 
			{
			print "<BR><span class=''>"._QXZ("OMITTING DUPLICATES AGAINST FOLLOWING STATUSES ONLY").": $status_dedupe_str</span><BR>\n";
			}
		if (strlen($status_mismatch_action)>0) 
			{
			print "<BR><span class=''>"._QXZ("ACTION FOR DUPLICATE NOT ON STATUS LIST").": $status_mismatch_action</span><BR>\n";
			}
		if (strlen($state_conversion)>9)
			{
			print "<BR><span class=''>"._QXZ("CONVERSION OF STATE NAMES TO ABBREVIATIONS ENABLED").": $state_conversion</span><BR>\n";
			}
		if ( (strlen($web_loader_phone_length)>0) and (strlen($web_loader_phone_length)< 3) )
			{
			print "<BR><span class=''>"._QXZ("REQUIRED PHONE NUMBER LENGTH").": $web_loader_phone_length</span><BR>\n";
			}
		if ( (strlen($SSweb_loader_phone_strip)>0) and ($SSweb_loader_phone_strip != 'DISABLED') )
			{
			print "<BR><span class=''>"._QXZ("PHONE NUMBER PREFIX STRIP SYSTEM SETTING ENABLED").": $SSweb_loader_phone_strip</span><BR>\n";
			}
		...
		print "    <th colspan=2><p style='text-align:center'><input class='btn btn-bdr-sucess' type=submit name='OK_to_process' value='"._QXZ("OK TO PROCESS")."'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class='btn btn-bdr-pink' type=button onClick=\"javascript:document.location='admin_listloader_fourth_gen.php'\" value=\""._QXZ("START OVER")."\" name='reload_page'></p></th>\r\n";
		print "  </tr>\r\n";
		print "</table>\r\n";
		print "</div></div>";
