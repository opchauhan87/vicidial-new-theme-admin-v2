...
# 220303-1631 - Added allow_web_debug system setting
# 220812-0949 - Added User Group report permissions checking
#
...
$report_name='Agent Disposition Report';
...
echo "<META HTTP-EQUIV=\"Content-Type\" CONTENT=\"text/html; charset=utf-8\">\n";
	echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("VICIDIAL: Agent Disposition")." </h3> </div>
		<div class='col-md-12'><div class='content'>";
//~ echo "<TITLE>"._QXZ("VICIDIAL: Agent Disposition")."</TITLE></HEAD><BODY BGCOLOR=WHITE>\n";
echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET>\n";
echo "<div class='col-lg-1'>"._QXZ("Date").":</div> <div class='col-lg-2'><input class='form-control' type=text name=begin_date value=\"$begin_date\" size=10 maxsize=10></div> <div class='col-lg-1'>"._QXZ("to")."</div>";
echo " <div class='col-lg-2'><input class='form-control' type=text name=end_date value=\"$end_date\" size=10 maxsize=10> </div>\n";
echo " <div class='col-lg-2'><SELECT class='form-control' SIZE=1 NAME=group>\n";
	$o=0;
