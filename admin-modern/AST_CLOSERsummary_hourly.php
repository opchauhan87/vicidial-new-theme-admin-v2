...
$exclude_rollover = preg_replace('/[^-_0-9a-zA-Z]/', '', $exclude_rollover);
$inbound_rate = preg_replace('/[^-\.\_0-9a-zA-Z]/', '', $inbound_rate);
...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("$report_name")." $NWB#CLOSERsummary_hourly$NWE<div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./admin.php?ADD=3111&group_id=$group[0]\">"._QXZ("MODIFY")."</a></div> </div></h3>
	...
	$MAIN.="</SELECT><label>"._QXZ("Inbound Groups")."</label> </div>\n";
	...
	$MAIN.=" &nbsp; <div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=exclude_rollover>\n";
	...
	$MAIN.="</SELECT><label> "._QXZ("Exclude Outbound Drop Groups").":</label></div>\n";
	$MAIN.="<BR>\n";
	...
	$MAIN.="</SELECT><label>"._QXZ("Call Time").":</label></div>\n";
	...
	$MAIN.="<a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?DB=$DB&inbound_rate=$inbound_rate&outbound_rate=$outbound_rate$groupQS&costformat=$costformat&print_calls=$print_calls&query_date=$query_date&end_date=$end_date&exclude_rollover=$exclude_rollover&SUBMIT=$SUBMIT&shift=$shift&file_download=1&search_archived_data=$search_archived_data\">"._QXZ("DOWNLOAD")."</a>  ";
	$MAIN.="</div>";
	$MAIN.="</TD>";
	$MAIN.="</TR>";
	$MAIN.="</TABLE>\n";
