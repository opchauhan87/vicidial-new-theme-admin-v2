...
<?php
	...
	require("admin_header.php");echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("OUTBOUND recent sales report").'</h3></div><div class="col-md-12"><div class="content">';
...
<tr >
	<td colspan=3>
		<table width=100%>
			...
			<td ><div class='col-lg-3'><select class='form-control' name="dcampaign" onChange="this.form.submit();">
			<?php 
			if ($dcampaign) {
			...
			<tr>
				...
				<td ><div class='col-lg-3'><select class='form-control' name="list_id" multiple size="4">
				<?php
...
<tr>
	<th align=left width=350><font class='standard_bold'><?php echo _QXZ("View sales made within the last"); ?> <select class='' name="sales_time_frame">
	<option value=''>----------</option>
...
<tr ><th colspan=3><font class="small_standard">(<?php echo _QXZ("If you enter values in both fields, the results will be limited by the first criteria met"); ?>)</font></th></tr>
<tr >
...
<tr><th colspan=3><input class='btn btn-bdr-sucess' type=submit name="submit_report" value="<?php echo _QXZ("SUBMIT"); ?>"></th></tr>
