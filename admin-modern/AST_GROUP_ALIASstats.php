...
# 220303-0216 - Added allow_web_debug system setting
# 220812-0939 - Added User Group report permissions checking
#
...
$MAIN.="<TABLE BORDER=0 class='col-lg-12 spacer no-border'><TR><TD VALIGN=TOP class='col-lg-4 no-border'>";
echo "<div class='col-lg-5'><INPUT class='form-control'  TYPE=TEXT NAME=query_date SIZE=20 MAXLENGTH=20 VALUE=\"$query_date\">";
echo "<BR> "._QXZ("to")." <BR><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=20 MAXLENGTH=20 VALUE=\"$end_date\"></div>\n";
