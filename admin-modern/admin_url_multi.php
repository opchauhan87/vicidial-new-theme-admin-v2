...
//~ echo "<link rel='stylesheet' href='//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.min.css'>";
echo "<link href='js/bootstrap/dist/css/bootstrap.css' rel='stylesheet'/>\n";
//~ echo "<link href='fonts/font-awesome-4.2.0/css/font-awesome.css' rel='stylesheet'/>\n";
...
//03-july-2019
//change theme
echo '<div id="pcont4" class="container-fluid" style="overflow:visible !important;">
	<div class="cl-mcont">
		<div class="row">
...
if ($action == "BLANK")
	...
	echo "<br><p style='text-align:center'>"._QXZ("Alternate URL Form");
	...
	while ($types_to_print > $o) 
		...
		echo "<td>$o</td>";
		echo "<td><select size=1 name=active class='form-control'><option value='Y'>"._QXZ("Y")."</option><option value='N'>"._QXZ("N")."</option><option SELECTED>$Ractive</option></select></td>";
		echo "<td><font size=1><input type=text size=3 maxlength=3 name=url_rank value=\"$Rurl_rank\"></td>";
		echo "<td><input type=text size=24 maxlength=1000 class='form-control' name=url_statuses value=\"$Rurl_statuses\"></td>";
		echo "<td><input type=text size=24 maxlength=1000 class='form-control' name=url_lists value=\"$Rurl_lists\"></td>";
		echo "<td><font size=1><input type=text size=5 maxlength=5 name=url_call_length value=\"$Rurl_call_length\"></td>";
		echo "<td><input type=text size=24 maxlength=255 class='form-control' name=url_description value=\"$Rurl_description\"></td>";
		echo "<td><input class='btn btn-bdr-sucess' type=submit name=SUBMIT value='"._QXZ("SUBMIT")."'></td>";
		//echo "<BR><BR>";
		if ($Ractive == 'N')
			{echo "<td><a href=\"$PHP_SELF?DB=$DB&campaign_id=$campaign_id&entry_type=$entry_type&url_type=$url_type&url_id=$Rurl_id&action=URL_MULTI_DELETE\" class='btn btn-bdr-org'>"._QXZ("DELETE")."</a></td>";}
		else
			{echo "<td><DEL>"._QXZ("DELETE")."</DEL></td>";}
		//echo "</td>";
		echo "</tr>";
		echo "<tr>";
	...
	echo "<br><p style='text-align:center'>"._QXZ("Add a new %1s URL",0,'',$url_type_text).":</p>";
	//~ echo "</td></tr>\n";

	//~ echo "<TABLE class='hover centerline' width=500 cellspacing=3>\n";
	//~ echo "<tr>";
	echo "<form action=$PHP_SELF method=POST>\n";
	...
	echo "<div class='col-lg-1 spacer form-group'>"._QXZ("RANK").": </div> <div class='col-lg-1'><input type=text size=4 maxlength=3 class='form-control' name=url_rank value=\"\"></div>";
	echo "<div class='col-lg-1 spacer form-group'>"._QXZ("STATUSES").":</div> <div class='col-lg-1'> <input type=text size=30 class='form-control' maxlength=1000 name=url_statuses value=\"\"></div>";
	echo "<div class='col-lg-2 spacer form-group'>"._QXZ("DESCRIPTION").": </div> <div class='col-lg-2'><input type=text size=30 maxlength=255 name=url_description value=\"\" class='form-control'></div>";
	
	echo "<input type=submit class='btn btn-bdr-sucess' name=SUBMIT value='"._QXZ("SUBMIT")."'>";
