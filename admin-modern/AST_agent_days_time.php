...
echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"vicidial_stylesheet.php\">\n";
	...
	echo "<span style=\"left:0px;top:0px;z-index:20;\"  id=admin_header>";
...
echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name").'</h3> <div class="pull-right">';
		if (strlen($user) > 1)
	{
	echo " <a class='btn btn-info' href=\"./admin.php?ADD=3&user=$user\">"._QXZ("USER")."</a>  ";
	echo " <a class='btn btn-info' href=\"./user_stats.php?user=$user&begin_date=$query_date&end_date=$end_date\">"._QXZ("USER STATS")."</a>  ";
	}
else
	{echo " <a class='btn btn-info' href=\"./admin.php?ADD=0A\">"._QXZ("USERS")."</a>  ";}
echo "<a class='btn btn-info' href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a> </FONT>";
	echo '</div></div><div class="col-md-12"><div class="content">';
	echo "</span>\n";
	}
...
echo "<TABLE CELLSPACING=3 BGCOLOR=\"#e3e3ff\"><TR><TD class='col-md-4' VALIGN=TOP> ";
echo "<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
echo "<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>Dates</label></div></div><div class='col-md-2 text-center p-18'>";
...
<?php
echo "</div><BR><div class='col-md-10' style='text-align:center;'>"._QXZ("to")." </div><div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date MAXLENGTH=10 VALUE=\"$end_date\"></div></div><div class='col-md-2 text-center p-18'>";
...
if ($archives_available=="Y") 
	{
	echo "<input type='checkbox' name='search_archived_data' style='margin-left:14px' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label>\n";
	}
...
echo "<TD class='col-md-4' VALIGN=TOP><div class='col-md-12'><div class='form-group custom-input mb-10'>";
echo "<INPUT class='form-control' TYPE=TEXT  NAME=user value=\"$user\"><label>User</label></div></div>\n";

echo "<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control'  NAME=shift>\n";
...
echo "</SELECT><label>"._QXZ("Shift").":</label></div></div> \n";
echo "</br>";


echo "</TD><TD VALIGN=TOP>  ";
echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK >";

echo "</TD></TR><TR><TD colspan=3>";
echo "<div class='col-md-12 text-center'>";
echo "<INPUT TYPE=SUBMIT class='btn btn-success' NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
echo "</div>";
echo "</TD></TR></TABLE>";
...
if ($report_display_type=="TEXT" || !$report_display_type) 
	{
		echo "<span style=\"left:3px;top:3px;z-index:18;\"  id=agent_status_bars>\n";
