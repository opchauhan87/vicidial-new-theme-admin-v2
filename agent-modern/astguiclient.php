	...
	echo "<meta name='viewport' content='width=device-width'>";
		...
		echo "<div class=\"block-flat\">\n";
	    	...
	    	if ($hide_timeclock_link < 1)
             {echo "<a style='margin-top: 4%;' class='btn pull-right btn-rad btn-primary' title='Timeclock' href=\"./timeclock.php?referrer=agent&amp;pl=$phone_login&amp;pp=$phone_pass&amp;user=$user&amp;pass=$pass\"> <i class='fa fa-clock-o' style='font-size: 20px;'></i></a>\n";}
	 ...
	 echo "<form class=\"clear\" name=\"callcenter_form\" id=\"callcenter_form\" action=\"$agcPAGE\" method=\"post\">\n";
        echo "<input type=\"hidden\" name=\"DB\" value=\"$DB\" />\n";
	echo "<div class=\"content\">\n";
	$placeholder1 = _QXZ('astGUIclient Login');
    $placeholder2 = _QXZ('User Login');
    $placeholder3 = _QXZ('User Password');
    $placeholder4 = _QXZ('Phone Login');
    $placeholder5 = _QXZ('Phone Password');
    $placeholder6 = _QXZ('SUBMIT');
	
	echo "<h4 class=\"title\">$placeholder1</h4>";
	
	echo "<div class=\"form-group clear\">\n";
   			$user_placeholder = _QXZ('User Login');
			echo "<input class=\"form-control\" placeholder=\"$placeholder2\" type=\"text\" name=\"user\" size=\"20\" maxlength=\"20\" value=\"$user\" autocomplete='new-login' />\n";
    echo "</div>\n";
    
    echo "<div class=\"form-group\">\n";
			$pass_placeholder = _QXZ('User Password');
    		echo "<input class=\"form-control\" placeholder=\"$placeholder3\" type=\"password\" name=\"pass\" size=\"20\" maxlength=\"20\" value=\"$pass\" autocomplete='new-password' /></td></tr>\n";
	echo "</div>\n";
    	
    echo "<div class=\"form-group clear\">\n";
   			$Phone_user_placeholder = _QXZ('Phone Login');
			echo "<input class=\"form-control\" placeholder=\"$placeholder4\" type=\"text\" name=\"phone_login\" size=\"20\" maxlength=\"20\" value=\"$phone_login\" autocomplete='new-login' />\n";
    echo "</div>\n";
    
    echo "<div class=\"form-group\">\n";
			$Phone_pass_placeholder = _QXZ('Phone Password');
    		echo "<input class=\"form-control\" placeholder=\"$placeholder5\" type=\"password\" name=\"phone_pass\" size=\"20\" maxlength=\"20\" value=\"$phone_pass\" autocomplete='new-password' /></td></tr>\n";
	echo "</div>\n";
	
	echo "<div class=\"foot col-md-12\">\n";
			$submit_btn = _QXZ('SUBMIT');
    		echo "<input class=\"btn btn-primary btn-rad btn-block\"  type=\"submit\" name=\"SUBMIT\" value=\"$placeholder6\" />\n";
	echo "</div>\n";
...
?>
<div class="col-md-12 border" id="main_header1">
<div class="col-md-1" style="width: 14.5%;">
 <div class="sidebar-logo">
            <div class="logo">
                <IMG SRC="./images/<?php echo _QXZ("agc_live_call_OFF.gif") ?>" NAME=livecall ALT="Live Call" WIDTH=109 HEIGHT=30 BORDER=0></TD>
            </div>
          </div>
</div>
