...
echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Dates").":</label></div></div>";
...
echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'>";
...
echo "</TD><TD class=\"col-md-4\" VALIGN=TOP> <BR>";
...
echo "<input type='checkbox' name='show_parks' value='checked' $show_parks><label>"._QXZ("&nbsp;Show parks-holds")."</label><BR>";
echo "<input type='checkbox' name='time_in_sec' value='checked' $time_in_sec><label>"._QXZ("&nbsp;Time in seconds")."</label><BR>";
