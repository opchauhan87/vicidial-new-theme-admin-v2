...
#### Javascript for auto-generate of user ID Button
	...
	function launch_moh_chooser(fieldname,stage,vposition)
		...
		var Iframe_content = '<IFRAME SRC="' + audiolistURL + '?' + audiolistQuery + '"  style="margin-left:-100px;width:740;height:440;background-color:#e8e8e8;" scrolling="NO" frameborder="0" allowtransparency="true" id="audio_chooser_frame' + epoch + '" name="audio_chooser_frame" width="740" height="460" STYLE="z-index:2"> </IFRAME>';
	...
	function call_menu_option(option,route,value,value_context,chooser_height)
		...
		if (selected_route=='CALLMENU')
			...
			if (route == selected_route)
				...
				{value='';}
			new_content = '<br><div style="margin-top:30px"><span class="col-lg-1" name=option_route_link_' + option + ' id=option_route_link_' + option + "><a href=\"<?php echo $ADMIN ?>?ADD=3511&menu_id=" + value + "\"><?php echo _QXZ("Call Menu"); ?>: </a></span><div class='col-lg-3'><select class='form-control' size=1 name=option_route_value_" + option + " id=option_route_value_" + option + " onChange=\"call_menu_link('" + option + "','CALLMENU');\">" + call_menu_list + "\n" + selected_value + '</select></div></div>';
			}
		if (selected_route=='INGROUP')
			...
			new_content = new_content + '<BR><BR><a href=\"<?php echo $ADMIN ?>?ADD=3111&group_id=' + value + '"><?php echo _QXZ("In-Group"); ?>:</a> </span>';
			...
			new_content = new_content + '' + ingroup_list + "\n" + selected_value + '<option>DYNAMIC_INGROUP_VAR</option></select></div>';
			
			new_content = new_content + '<div class="col-lg-2"><?php echo _QXZ("Handle Method"); ?>:</div> <div class="col-lg-3"><select class="form-control" size=1 name=IGhandle_method_' + option + ' id=IGhandle_method_' + option + '>';
			...
			new_content = new_content + '<BR><BR><div class="col-lg-12" style="text-align:left;"><div class="col-lg-2"><?php echo _QXZ("Search Method"); ?>:</div> <div class="col-lg-3"><select class="form-control" size=1 name=IGsearch_method_' + option + ' id=IGsearch_method_' + option + '>';
			new_content = new_content + '' + IGsearch_method_list + "\n" + '<option SELECTED>' + IGsearch_method + '</select></div>';
			
			new_content = new_content + '<BR><div class="col-lg-2"> <?php echo _QXZ("List ID"); ?>:</div><div class="col-lg-3"><input class="form-control" type=text size=5 maxlength=14 name=IGlist_id_' + option + ' id=IGlist_id_' + option + ' value="' + IGlist_id + '"></div></div>';
			
			new_content = new_content + '<BR><div class="col-lg-12" style="text-align:left;"><div class="col-lg-2"><?php echo _QXZ("Campaign ID"); ?>:</div><div class="col-lg-3"> <select class="form-control" size=1 name=IGcampaign_id_' + option + ' id=IGcampaign_id_' + option + '>';
			new_content = new_content + '' + IGcampaign_id_list + "\n" + '<option SELECTED>' + IGcampaign_id + '</select></div>';
			
			new_content = new_content + '<BR><div class="col-lg-2"><?php echo _QXZ("Phone Code"); ?>:</div><div class="col-lg-3"><input class="form-control" type=text size=5 maxlength=14 name=IGphone_code_' + option + ' id=IGphone_code_' + option + ' value="' + IGphone_code + '"></div></div>';
			
			new_content = new_content + "<BR><BR><div class='col-lg-12' style='text-align:left;'><div class='col-lg-2'><?php echo _QXZ("VID Enter Filename"); ?>:</div><div class='col-lg-3'><input class='form-control' type=text name=IGvid_enter_filename_" + option + " id=IGvid_enter_filename_" + option + " size=40 maxlength=255 value=\"" + IGvid_enter_filename + "\"></div><div class='col-lg-2'><a href=\"javascript:launch_chooser('IGvid_enter_filename_" + option + "','date'," + chooser_height + ");\"><?php echo _QXZ("audio chooser"); ?></a></div></div>";
			
			new_content = new_content + "<BR><BR><div class='col-lg-12' style='text-align:left;'><div class='col-lg-2'> <?php echo _QXZ("VID ID Number Filename"); ?>:</div><div class='col-lg-3'><input class='form-control' type=text name=IGvid_id_number_filename_" + option + " id=IGvid_id_number_filename_" + option + " size=40 maxlength=255 value=\"" + IGvid_id_number_filename + "\"></div><div class='col-lg-2'><a href=\"javascript:launch_chooser('IGvid_id_number_filename_" + option + "','date'," + chooser_height + ");\"><?php echo _QXZ("audio chooser"); ?></a></div></div>";
			
			new_content = new_content + "<BR><BR><div class='col-lg-12' style='text-align:left;'><div class='col-lg-2'><?php echo _QXZ("VID Confirm Filename"); ?>:</div><div class='col-lg-3'><input class='form-control' type=text name=IGvid_confirm_filename_" + option + " id=IGvid_confirm_filename_" + option + " size=40 maxlength=255 value=\"" + IGvid_confirm_filename + "\"></div><div class='col-lg-2'><a href=\"javascript:launch_chooser('IGvid_confirm_filename_" + option + "','date'," + chooser_height + ");\"><?php echo _QXZ("audio chooser"); ?></a></div></div>";
			
			new_content = new_content + '<BR><BR><div class="col-lg-12" style="text-align:left;"><div class="col-lg-2"> <?php echo _QXZ("VID Digits"); ?>:</div><div class="col-lg-3"><input class="form-control" type=text size=3 maxlength=3 name=IGvid_validate_digits_' + option + ' id=IGvid_validate_digits_' + option + ' value="' + IGvid_validate_digits + '"></div></div>';
		...
		if (selected_route=='DID')
			...
			if (route == selected_route)
				...
				{value='';}
			new_content = '<br><div style="margin-top:30px"><span class="col-lg-1" name=option_route_link_' + option + ' id=option_route_link_' + option + '><a href=\"<?php echo $ADMIN ?>?ADD=3311&did_pattern=' + value + '"><?php echo _QXZ("DID"); ?>:</a> </span><div class="col-lg-3"><select class="form-control" size=1 name=option_route_value_' + option + ' id=option_route_value_' + option + " onChange=\"call_menu_link('" + option + "','DID');\">" + did_list + "\n" + selected_value + '</select></div></div>';
			}
		if (selected_route=='HANGUP')
			...
			if (route == selected_route)
				...
				{value='vm-goodbye';}
			new_content = "<br><div style='margin-top:30px'><div class='col-lg-1'><?php echo _QXZ("Audio File"); ?>:</div><div class='col-lg-3'><input class='form-control' type=text name=option_route_value_" + option + " id=option_route_value_" + option + " size=40 maxlength=255 value=\"" + selected_value + "\"></div><div class='col-lg-2'><a href=\"javascript:launch_chooser('option_route_value_" + option + "','date'," + chooser_height + ");\"><?php echo _QXZ("audio chooser"); ?></a></div></div>";
			}
		if (selected_route=='EXTENSION')
			...
			if (route == selected_route)
				...
				{value='8304';}
			new_content = "<br><div style='margin-top:30px'><div class='col-lg-1'><?php echo _QXZ("Extension"); ?>:</div><div class='col-lg-3'><input class='form-control' type=text name=option_route_value_" + option + " id=option_route_value_" + option + " size=20 maxlength=255 value=\"" + selected_value + "\"></div> &nbsp; <div class='col-lg-1'><?php echo _QXZ("Context"); ?>:</div><div class='col-lg-3'><input class='form-control' type=text name=option_route_value_context_" + option + " id=option_route_value_context_" + option + " size=20 maxlength=255 value=\"" + selected_context + "\"></div></div>";
			}
		if (selected_route=='PHONE')
			...
			if (route == selected_route)
				...
				{value='';}
			new_content = '<br><div style="margin-top:30px"><div class="col-lg-1"><?php echo _QXZ("Phone"); ?>:</div><div class="col-lg-4"><select class="form-control" size=1 name=option_route_value_' + option + ' id=option_route_value_' + option + '>' + phone_list + "\n" + selected_value + '</select></div></div>';
			}
		if ( (selected_route=='VOICEMAIL') || (selected_route=='VMAIL_NO_INST') )
			...
			if (route == selected_route)
				...
				{value='';}
			new_content = "<br><div style='margin-top:30px'><div class='col-lg-1'><?php echo _QXZ("Voicemail Box"); ?>: </div><div class='col-lg-3'><input class='form-control' type=text name=option_route_value_" + option + " id=option_route_value_" + option + " size=12 maxlength=10 value=\"" + selected_value + "\"></div><div class='col-lg-2'><a href=\"javascript:launch_vm_chooser('option_route_value_" + option + "','date'," + chooser_height + ");\">voicemail chooser</a></div></div>";
			}
		if (selected_route=='AGI')
			...
			if (route == selected_route)
				...
				{value='';}
			new_content = "<br><div style='margin-top:30px'><div class='col-lg-1'><?php echo _QXZ("AGI"); ?>:</div><div class='col-lg-3'><input class='form-control' type=text name=option_route_value_" + option + " id=option_route_value_" + option + " size=80 maxlength=255 value=\"" + selected_value + "\"></div></div>";
			}
...
if ( ($ADD==2811) or ($ADD==3811) or ($ADD==3111) or ($ADD==2111) or ($ADD==2011) or ($ADD==4111) or ($ADD==5111) )
	...
	function dynamic_call_action(option,route,value,chooser_height)
		...
		//	new_content = new_content + "<BR> &nbsp; <?php echo _QXZ("VID Enter Filename"); ?>: <input type=text name=IGvid_enter_filename_" + option + " id=IGvid_enter_filename_" + option + " size=40 maxlength=255 value=\"" + IGvid_enter_filename + "\"> <a href=\"javascript:launch_chooser('IGvid_enter_filename_" + option + "','date'," + chooser_height + ");\">audio chooser</a>";
		//	new_content = new_content + "<BR> &nbsp; <?php echo _QXZ("VID ID Number Filename"); ?>: <input type=text name=IGvid_id_number_filename_" + option + " id=IGvid_id_number_filename_" + option + " size=40 maxlength=255 value=\"" + IGvid_id_number_filename + "\"> <a href=\"javascript:launch_chooser('IGvid_id_number_filename_" + option + "','date'," + chooser_height + ");\">audio chooser</a>";
		//	new_content = new_content + "<BR> &nbsp; <?php echo _QXZ("VID Confirm Filename"); ?>: <input type=text name=IGvid_confirm_filename_" + option + " id=IGvid_confirm_filename_" + option + " size=40 maxlength=255 value=\"" + IGvid_confirm_filename + "\"> <a href=\"javascript:launch_chooser('IGvid_confirm_filename_" + option + "','date'," + chooser_height + ");\">audio chooser</a>";
...
echo "/* hnc-ai-live-chat */\n";
echo "document.addEventListener('DOMContentLoaded', function () {\n";
echo "    var aiButton = document.querySelector('.ai-tool');\n";
echo "    var aiChat = document.getElementById('hncAiChat');\n";
echo "    var toolPanel = document.querySelector('.modern-right-tools');\n";
echo "    var closeBtn = document.getElementById('hncAiClose');\n";
echo "    var input = document.querySelector('.hnc-ai-chat-input');\n";
echo "    var sendBtn = document.querySelector('.hnc-ai-send');\n";
echo "    var chatBody = document.querySelector('.hnc-ai-chat-body');\n";
echo "    if (!aiButton || !aiChat || !closeBtn || !input || !sendBtn || !chatBody) { return; }\n";
echo "    aiButton.addEventListener('click', function(e) {\n";
echo "        e.preventDefault();\n";
echo "        aiChat.classList.add('open');\n";
echo "        if (toolPanel) { toolPanel.classList.add('ai-chat-open'); }\n";
echo "        setTimeout(function() { input.focus(); }, 100);\n";
echo "    });\n";
echo "    closeBtn.addEventListener('click', function() {\n";
echo "        aiChat.classList.remove('open');\n";
echo "        if (toolPanel) { toolPanel.classList.remove('ai-chat-open'); }\n";
echo "    });\n";
echo "    function addMessage(text, type) {\n";
echo "        var bubble = document.createElement('div');\n";
echo "        bubble.className = 'hnc-ai-message ' + type;\n";
echo "        bubble.textContent = text;\n";
echo "        chatBody.appendChild(bubble);\n";
echo "        chatBody.scrollTop = chatBody.scrollHeight;\n";
echo "        return bubble;\n";
echo "    }\n";
echo "    function setBusy(busy) {\n";
echo "        sendBtn.disabled = busy;\n";
echo "        input.disabled = busy;\n";
echo "        sendBtn.classList.toggle('busy', busy);\n";
echo "    }\n";
echo "    async function sendMessage() {\n";
echo "        var message = input.value.trim();\n";
echo "        if (!message || sendBtn.disabled) { return; }\n";
echo "        addMessage(message, 'user');\n";
echo "        input.value = '';\n";
echo "        setBusy(true);\n";
echo "        var thinking = addMessage('HNC AI is thinking...', 'assistant thinking');\n";
echo "        try {\n";
echo "            var response = await fetch('hnc_ai.php', {\n";
echo "                method: 'POST',\n";
echo "                headers: { 'Content-Type': 'application/json' },\n";
echo "                body: JSON.stringify({ message: message })\n";
echo "            });\n";
echo "            var data = await response.json();\n";
echo "            thinking.remove();\n";
echo "            if (!response.ok || !data.success) {\n";
echo "                throw new Error(data.error || 'AI service error');\n";
echo "            }\n";
echo "            addMessage(data.answer, 'assistant');\n";
echo "        } catch (error) {\n";
echo "            thinking.remove();\n";
echo "            addMessage('Sorry, HNC AI could not process your request. Please try again.', 'assistant error');\n";
echo "            console.error('HNC AI:', error);\n";
echo "        } finally {\n";
echo "            setBusy(false);\n";
echo "            input.focus();\n";
echo "        }\n";
...
$stmt="SELECT admin_home_url,enable_tts_integration,callcard_enabled,custom_fields_enabled,allow_emails,level_8_disable_add,allow_chats,enable_languages,svn_revision from system_settings;";
$rslt=mysql_to_mysqli($stmt, $link);
$row=mysqli_fetch_row($rslt);
$admin_home_url_LU =		$row[0];
$SSenable_tts_integration = $row[1];
...
if ( ($SSadmin_modify_refresh > 1) and (preg_match("/^3|^4/",$ADD)) )
	...
	echo "<BODY class='cbp-spmenu-push' BGCOLOR=white marginheight=0 marginwidth=0 leftmargin=0 topmargin=0 onLoad=\"modify_refresh_display();\">\n";
        echo "<div id='cl-wrapper' class='vicidial-modern-enabled' >";
	}
else
	{
...
<div class="modern-legacy-header col-md-12" style="position: sticky;top: 0;z-index: 13;">
<div class="col-md-2" style="width: 14%;">
 <div class="sidebar-logo modern-brand">
    <a href="<?php echo $ADMIN ?>" class="modern-brand-link">
        <span class="modern-brand-icon">
            <i class="fa fa-phone"></i>
        </span>
        <span class="modern-brand-text">
            <strong>VICIdial</strong>
...
<div id="head-nav" class="navbar navbar-default">
    <button type="button" id="sidebar-collapse" class="vicidial-mobile-toggle" aria-label="Toggle navigation">
    ...
    <div class="container-fluid">
      <div class="navbar-collapse">
		  <div class="pull-right spacer" style="padding-left:15px;">
			<a href="../admin/admin.php?force_logout=1"><i class="fa fa-power-off" style='color:#00c0ef;font-size: 30px;'></i></a>
		  </div>
        <ul class="nav navbar-nav navbar-right user-nav">
          <li class="dropdown profile_menu">
<!--
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img alt="Avatar" src="./images/profile_pic.png" /><span style="color:#14496a !important;"><?php echo $PHP_AUTH_USER ?></span> <b class="caret"></b></a>
-->
            <img alt="Avatar" src="./images/profile_pic.png" /><span style="color:#14496a !important;margin-top:8px;"><?php echo $PHP_AUTH_USER ?></span> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img class="nav_menu" alt="Avatar" src="./images/nav_menu.png" /></a>
            <ul class="dropdown-menu">

			  <li><A HREF="<?php echo "admin.php";?>?ADD=999989 "> <?php echo _QXZ("Change language");?></a></li>
              ...
              <li><a href="<?php echo "../agent/index.php"; ?>" target="blank"><?php echo _QXZ("Agent Login");?></a></li>
        ...
        <span class="col-md-4 pull-right header_time" >
			<span class="time_header" ><?php echo date("l F j, Y G:i:s A") ?></span>
...
<!--
change theme version 1.4.2
-->	    

	   <ul class="dropdown-menu" style="padding-bottom:0px;padding-left: 16px;padding-right: 14px;margin-left: -6px;margin-top:14px;">
		   <p style="font-size:11px;"><strong><?php echo _QXZ("Version"); ?>:</strong> <?php echo $admin_version ?> <br> <strong><?php echo _QXZ("Build"); ?>: </strong><?php echo $build ?> <br> <strong><?php echo _QXZ("Theme Version"); ?>:</strong> 1.5.5<br><strong><?php echo _QXZ("SVN Version"); ?>:</strong> <?php echo $svn_revision;?></p>
	   </ul>
	    </li>
	    </span>
...
<div class='col-md-12 modern-admin-nav-shell'>

        <div class="modern-top-user-mini">
            <div class="modern-top-user-avatar">
                <i class="fa fa-user"></i>
            </div>

            <div class="modern-top-user-info">
                <span class="modern-top-user-name"><?php echo htmlspecialchars($PHP_AUTH_USER, ENT_QUOTES, 'UTF-8'); ?></span>
                <span class="modern-top-user-status">
                    <span class="modern-top-status-dot"></span>
                    ONLINE
                </span>
            </div>

            <a class="modern-top-user-logout"
               href="../admin/admin.php?force_logout=1"
               title="Logout">
	...
	if ( ($reports_only_user < 1) and ($qc_only_user < 1) )
		{
	?>
		<div class="modern-nav-section">Management</div>
		<!-- REPORTS NAVIGATION -->
		<ul class='cl-vnavigation'>
		<li <?php echo $reports_hh;if(strlen($reports_hh)>1){ echo "class='active'";} ?>>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=999999">
	...
	<ul class='cl-vnavigation'>
		<li <?php echo $users_hh;if(strlen($users_hh)>1){ echo "class='active'";} ?>>
	      <a href="<?php echo "../admin/admin.php"; ?>?ADD=0A">
			<div class="col-xs-1"><i class="fa fa-user"></i></div>
               <div class="col-xs-9"><span><?php echo _QXZ("Users");?></span></div>
				</a>
		<ul class="sub-menu">
			<li><a href="<?php echo "../admin/admin.php"; ?>?ADD=0A"><?php echo _QXZ("Show Users");?></a></li>
        <li>
			<?php if ($add_copy_disabled < 1) { ?>
			<a href="<?php echo "../admin/admin.php"; ?>?ADD=1"><?php echo _QXZ("Add A New User");?> </a>
	  </li>
       <li>
			<a href="<?php echo "../admin/admin.php"; ?>?ADD=1A"><?php echo _QXZ("Copy User");?> </a>
	  </li>
       <li>
			<?php } ?>
			<a href="<?php echo "../admin/admin.php"; ?>?ADD=550"><?php echo _QXZ("Search For A User");?> </a>
		</li>
        <li>
			<a href="../admin/user_stats.php?user=<?php echo $user ?>"><?php echo _QXZ("User Stats");?> </a>
		</li>
		<li>
			<a href="../admin/user_status.php?user=<?php echo $user ?>"><?php echo _QXZ("User Status");?> </a>
		</li>
         <li>
			<a href="../admin/AST_agent_time_sheet.php?agent=<?php echo $user ?>"><?php echo _QXZ("Time Sheet");?> </a> </li>
			<?php
			if ( ($SSuser_territories_active > 0) or ($user_territories_active > 0) )
			{ ?>

	<li>
	  <a href="../admin/user_territories.php?agent=<?php echo $user ?>"><?php echo _QXZ("User Territories");?> </a>
</li>
			...
			<li <?php echo $newlimit_sh ?><?php if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='./admin_user_list_new.php?user=---ALL---&list_id=NONE&stage=overall';\"";} ?>>
	 <a href="./admin_user_list_new.php?user=---ALL---&list_id=NONE&stage=overall" STYLE="text-decoration:none;"><?php echo _QXZ("Overall New Lead Limits"); ?> </a> </li>
			
			<?php }    ?>

			</ul></li> 
	
	<div class="modern-nav-section">Campaigns</div>
	<!-- CAMPAIGNS NAVIGATION -->
		<li <?php echo $campaigns_hh; if(strlen($campaigns_hh)>1){ echo "class='active'";} ?>>
                 <a href="<?php echo "../admin/admin.php"; ?>?ADD=10">
	...
	<?php  if ($sh=='basic') {$sh='list';}
			...
			if ($sh=='accid') {$accid_sh="bgcolor=\"$subcamp_color\""; $accid_fc="$subcamp_font";}
		       ...
		       ?>
		     	...
		     	<li  <?php echo $list_sh ?>> 
                     	  	<a href="<?php echo "../admin/admin.php"; ?>?ADD=10"><?php echo _QXZ("Campaigns Main");?></a>
                   	</li>
		
			<li  <?php echo $status_sh ?>> 
                        	<a href="<?php echo "../admin/admin.php"; ?>?ADD=32"><?php echo _QXZ("Statuses");?></a>
                    </li>
	
		    <li <?php echo $hotkey_sh ?>> 
                          <a href="<?php echo "../admin/admin.php"; ?>?ADD=33"><?php echo _QXZ("HotKeys");?></a>
                    </li>
		<?php
		//if ($SSoutbound_autodial_active > 0)
			//{
			...
			<li  <?php echo $recycle_sh ?>> 
                            <a href="<?php echo "../admin/admin.php"; ?>?ADD=35"><?php echo _QXZ("Lead Recycle");?></a>
                        </li>
			
                        
			<li  <?php echo $autoalt_sh ?>> 
                            <a href="<?php echo "../admin/admin.php"; ?>?ADD=36"><?php echo _QXZ("Auto-Alt Dial");?></a>
                        </li>
			
			<li <?php echo $listmix_sh ?>> 
                             <a href="<?php echo "../admin/admin.php"; ?>?ADD=39"><?php echo _QXZ("List Mix");?></a></li>
			<?php
			//}
		?>
		
			<li ALIGN=LEFT <?php echo $pause_sh ?>>  <a href="<?php echo "../admin/admin.php"; ?>?ADD=37"><?php echo _QXZ("Pause Codes");?></a></li>
		
			<li ALIGN=LEFT <?php echo $preset_sh ?>> <a href="<?php echo "../admin/admin.php"; ?>?ADD=301"><?php echo _QXZ("Presets");?></a></li>
		<?php
		//if ($SScampaign_cid_areacodes_enabled > 0)
			//{
			?>
			
			<li  <?php echo $accid_sh ?>> <a href="<?php echo "../admin/admin.php"; ?>?ADD=302"><?php echo _QXZ("AC-CID");?></a></li>
			<?php
			//}
//		 }
...
<div class="modern-nav-section">Contact Center</div>
<!-- LISTS NAVIGATION -->
	<?php
	//if ($SSoutbound_autodial_active > 0)
		//{
		?>
		<li <?php if(strlen($lists_hh)>1){ echo "class='active'";} ?>><a href="<?php echo "../admin/admin.php"; ?>?ADD=100">
...
//		if (strlen($lists_hh) > 1) { 
			...
			?>
			<li><li ALIGN=LEFT> 
			<a href="<?php echo "../admin/admin.php"; ?>?ADD=100"> <?php echo _QXZ("Show Lists");?> </a>
			</li><li><li ALIGN=LEFT> 
			<?php if ($add_copy_disabled < 1) { ?>
			<a href="<?php echo "../admin/admin.php"; ?>?ADD=111"> <?php echo _QXZ("Add A New List");?> </a>
			</li><li><li ALIGN=LEFT> 
			<?php } ?>
			<a href="../admin/admin_search_lead.php"> <?php echo _QXZ("Search For A Lead");?> </a>
			</li>
			<li> 
			<a href="../admin/admin_modify_lead.php"><?php echo _QXZ("Add A New Lead");?> </a>
			</li>
			<li>
		
			<a href="<?php echo "../admin/admin.php"; ?>?ADD=121"><?php echo $DNClink ?> </a>
			</li>
			<li> 
			<a href="../admin/admin_listloader_fourth_gen.php"> <?php echo _QXZ("Load New Leads");?> </a>
			<?php
			if ($SScustom_fields_enabled > 0)
				{
				?>
				</li><li>
				<a href="../admin/admin_lists_custom.php"> <?php echo _QXZ("List Custom Fields");?> </a>
				</li><li> 
				<a href="../admin/admin_lists_custom.php?action=COPY_FIELDS_FORM"> <?php echo _QXZ("Copy Custom Fields");?> </a>
				<?php
				...
				<a href="<?php echo "../admin/admin.php"; ?>?ADD=130"> <?php echo _QXZ("Drop Lists"); ?> </a>
				<?php
				}
			?>
	...
	<?php
             if (($SSqc_features_active=='1') && ($qc_auth=='1')) 
		{ ?>
			<li <?php echo $qc_hh; if(strlen($qc_hh)>1){ echo "class='active'";}?>>
				<a href="<?php echo "../admin/admin.php"; ?>?ADD=100000000000000">
					<div class="col-xs-1"><i class="fa fa-file-o"></i></div>
					<div class="col-xs-9"><span><?php echo _QXZ("Quality Control");?></span></div>
				</a>
			<ul class="sub-menu">  
			<li>
				<a href="<?php echo "../admin/admin.php"; ?>?ADD=100000000000000"><?php echo _QXZ("Show QC Campaigns");?> </a>
			</li>
			<li>
				<a href="<?php echo "../admin/admin.php"; ?>?ADD=100000000000000&qc_display_group_type=LIST"><?php echo _QXZ("QC Calls by List");?> </a>
			</li>
			<li>
				<a href="<?php echo "../admin/admin.php"; ?>?ADD=100000000000000&qc_display_group_type=INGROUP"><?php echo _QXZ("QC Calls by Ingroup");?> </a>
			</li>
			<!--<li>
				<a href="<?php echo "../admin/admin.php"; ?>?ADD=100000000000000"><?php echo _QXZ("Enter QC Queue");?> </a></li>
			<li>-->
			<li>
				<a href="<?php echo "../admin/qc_scorecards.php"; ?>"><?php echo _QXZ("Show QC Scorecards");?> </a></li>
			<li>
				<a href="<?php echo "../admin/admin.php"; ?>?ADD=341111111111111"> <?php echo _QXZ("Modify QC Codes");?> </a>
			</li>
			</ul></li>
			<?php }?>

 <div class="modern-nav-section">Tools</div>
<!-- SCRIPTS NAVIGATION -->
			<li <?php echo $scripts_hh;if(strlen($scripts_hh)>1){ echo "class='active'";} ?>>
					<a href="<?php echo "../admin/admin.php"; ?>?ADD=1000000">
					<div class="col-xs-1"><i class="fa fa-file-o"></i></div>
					<div class="col-xs-9"><span><?php echo _QXZ("Scripts");?></span></div></a>
					<ul class="sub-menu">  
			<?php
//	if (strlen($scripts_hh) > 1) { 
			?>
			<li><a href="<?php echo "../admin/admin.php"; ?>?ADD=1000000"> <?php echo _QXZ("Show Scripts");?> </a></li>
			<li> 
				<?php if ($add_copy_disabled < 1) { ?>
				<a href="<?php echo "../admin/admin.php"; ?>?ADD=1111111"> <?php echo _QXZ("Add A New Script");?> </a>
				<?php } ?>
				</li>
				<?php 
//} 
...
<div class="modern-nav-section">Dialing</div>
<!-- FILTERS NAVIGATION -->
			<?php
				//~ if ($SSoutbound_autodial_active > 0)
				//~ {
			...
			<li <?php echo $filters_hh;if(strlen($filters_hh)>1){ echo "class='active'";}  ?>>
                <a href="<?php echo "../admin/admin.php"; ?>?ADD=10000000">
...
//		if (strlen($filters_hh) > 1) { 
			?>
		<li> 
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=10000000"><?php echo _QXZ("Show Filters");?> </a>
		</li>
		<li>
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=11111111"> <?php echo _QXZ("Add A New Filter");?> </a>
		<?php } ?>
		</li>
		
                 </ul></li>
               
	<div class="modern-nav-section">Inbound</div>
<!-- INGROUPS NAVIGATION -->
	<li <?php echo $ingroups_hh;if(strlen($ingroups_hh)>1){ echo "class='active'";} ?>>
	<a href="<?php echo "../admin/admin.php"; ?>?ADD=1000"> 
	 <div class="col-xs-1"><i class="fa fa-file-o"></i></div>
		...
		<li> 
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1000"> <?php echo _QXZ("In-Groups");?> </a>
	...
	//if (strlen($ingroups_hh) > 1) {
		...
		?>
		<li> 
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1000"> <?php echo _QXZ("Show In-Groups");?> </a>
		</li>
                <li> 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1111"> <?php echo _QXZ("Add A New In-Group");?> </a>
		</li><li> 
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1211"> <?php echo _QXZ("Copy In-Group");?> </a></li>
		<?php } ?>
...
Purpose:remove space above and below unline in submenu -->
		...
		?>
		<li>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1800"> <?php echo _QXZ("Show Email Groups");?> </a>
		</li><li> 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1811"> <?php echo _QXZ("Add New Email Group");?> </a>
		</li><li> 
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1911"> <?php echo _QXZ("Copy Email Group");?> </a>
		<?php } ?>
<!--Name:sangani jagruti
Date:2014-11-26
Purpose:remove space above and below unline in submenu -->
 ...
 <hr style='margin:10px 0px 10px 0px; border-width: 1px; border-style: inset;color: #ffffff; '>
		...
		?>
					...
					<a href="<?php echo "../admin/admin.php"; ?>?ADD=1900"> <?php echo _QXZ("Show Chat Groups");?> </a>
					</li><li> 
					<?php if ($add_copy_disabled < 1) { ?>
					<a href="<?php echo "../admin/admin.php"; ?>?ADD=18111"> <?php echo _QXZ("Add New Chat Group");?> </a>
					</li><li> 
					<a href="<?php echo "../admin/admin.php"; ?>?ADD=19111"> <?php echo _QXZ("Copy Chat Group");?> </a>
		<?php } ?>
...
//} 
        ...
        <li> 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1300"> <?php echo _QXZ("DIDs");?> </a>
		 <ul class="sub-menu submenus">  
	<?php
	//if (strlen($ingroups_hh) > 1) {
		if ($LOGdelete_from_dnc > 0) {$FPGlink = _QXZ("Add-Delete FPG Number");}
		...
		?>
		<li> 
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1300"> <?php echo _QXZ("Show DIDs");?> </a>
		</li><li>  
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1311"> <?php echo _QXZ("Add A New DID");?> </a>
		</li><li>  
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1411"> <?php echo _QXZ("Copy DID");?> </a>
		<?php
			}
		if ($SSdid_ra_extensions_enabled > 0)
			...
			<a href="<?php echo "../admin/admin.php"; ?>?ADD=1320"><?php echo _QXZ("RA Extensions");?></a>
			<?php
			}
		?>
<!--Name:sangani jagruti
...
Purpose:remove space above and below unline in submenu -->
 ...
 <hr style='margin:0px 0px 0px 0px; border-width: 1px; border-style: inset;color: #ffffff; '>
		
		</li><li> 
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1500"> <?php echo _QXZ("Show Call Menus");?> </a>
		</li><li > 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1511"> <?php echo _QXZ("Add A New Call Menu");?> </a>
		</li><li>  
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1611"> <?php echo _QXZ("Copy Call Menu");?> </a>
		<?php } ?>
...
Purpose:remove space above and below unline in submenu -->
 ...
 <hr style='margin:0px 0px 0px 0px; border-width: 1px; border-style: inset;color: #ffffff; 0px 0px; border-width: 1px; border-style: inset;color: #ffffff; '>

		</li><li> 
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1700"> <?php echo _QXZ("Filter Phone Groups");?> </a>
		</li><li> 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=1711"> <?php echo _QXZ("Add Filter Phone Group");?> </a>
		</li><li> 
		<?php } ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=171"><?php echo $FPGlink ?></a>
		</li>
		<?php 
//} 
		?>
...
//} 
	...
	<a href="<?php echo "../admin/admin.php"; ?>?ADD=100000">
...
//	if (strlen($usergroups_hh) > 1)	{ 
		?>
		<li> 
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=100000"> <?php echo _QXZ("Show User Groups");?> </a>
		</li><li> 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=111111"> <?php echo _QXZ("Add A New User Group");?> </a>
		</li><li> 
		<?php } ?>
		<a href="../admin/group_hourly_stats.php"> <?php echo _QXZ("Group Hourly Report");?> </a>
		</li><li> 
		<a href="../admin/user_group_bulk_change.php"> <?php echo _QXZ("Bulk Group Change");?> </a>
		</li>
		<?php 
//} 
	?>
	...
	<a href="<?php echo "../admin/admin.php"; ?>?ADD=10000">
               	 <div class="col-xs-1"><i class="fa fa-user"></i></div>
...
//	if (strlen($remoteagent_hh) > 1) { 
		?>
		<li>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=10000"> <?php echo _QXZ("Show Remote Agents");?> </a>
		</li><li> 
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=11111"> <?php echo _QXZ("Add New Remote Agents");?> </a>
		</li><li> 
		<?php } ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=12000"> <?php echo _QXZ("Show Extension Groups");?> </a>
		</li><li>
		<?php if ($add_copy_disabled < 1) { ?>
		<a href="<?php echo "../admin/admin.php"; ?>?ADD=12111"> <?php echo _QXZ("Add Extension Group");?> </a>
		<?php } ?>
		</li>
	<?php 
//} 
	...
	<a href="<?php echo "../admin/admin.php"; ?>?ADD=999998">
                 <div class="col-xs-1"><i class="fa fa-user"></i></div>
...
//	if (strlen($admin_hh) > 1) { 
		...
		if ($sh=='colors') {$colors_sh="bgcolor=\"$colors_color\""; $colors_fc="$colors_font";}
			else {$colors_sh=''; $colors_fc='BLACK';}
		...
		if ($sh=='soundboard') {$soundboard_sh="bgcolor=\"$soundboard_color\""; $soundboard_fc="$soundboard_font";}
			else {$soundboard_sh=''; $soundboard_fc='BLACK';}
		...
		if ($sh=='qg') {$qg_sh="bgcolor=\"$subcamp_color\""; $qg_fc="$subcamp_font";}
			else {$qg_sh=''; $qg_fc='BLACK';}
		...
		<li ALIGN=LEFT <?php echo $phones_sh ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=10000000000"> <?php echo _QXZ("Phones");?> </a>
		</li>
		<li <?php echo $templates_sh ?>><a href="<?php echo "admin.php"; ?>?ADD=130000000000"> <?php echo _QXZ("Templates");?> </a>
		</li>
		<li BGCOLOR=<?php echo $admin_color ?>><li ALIGN=LEFT <?php echo $carriers_sh ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=140000000000"> <?php echo _QXZ("Carriers");?> </a>
		</li>
		<li ALIGN=LEFT <?php echo $server_sh ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=100000000000"> <?php echo _QXZ("Servers");?> </a>
		</li>
		<li ALIGN=LEFT <?php echo $conference_sh ?>>  
		<a href="<?php echo "admin.php"; ?>?ADD=1000000000000"> <?php echo _QXZ("Conferences");?> </a>
		</li>
		<li ALIGN=LEFT <?php echo $settings_sh ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=311111111111111"> <?php echo _QXZ("System Settings");?> </a>
		</li>
		<li ALIGN=LEFT <?php echo $label_sh ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=180000000000"> <?php echo _QXZ("Screen Labels");?> </a>
		</li>
		<li ALIGN=LEFT <?php echo $colors_sh ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=182000000000"> <?php echo _QXZ("Screen Colors");?> </a>
		</li>
		<li ALIGN=LEFT <?php echo $status_sh ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=321111111111111"> <?php echo _QXZ("System Statuses");?> </a>
		</li>
		<li ALIGN=LEFT <?php echo $cg_sh ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=196000000000"> <?php echo _QXZ("CID Groups ");?> </a>
		</li>
		
		<li ALIGN=LEFT <?php echo $vm_sh ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=193000000000"> <?php echo _QXZ("Status Groups");?> </a>
		</li>
			<li ALIGN=LEFT <?php echo $ar_sh ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=194000000000"> <?php echo _QXZ("Automated Reports");?> </a>
		</li>
		<li ALIGN=LEFT <?php echo $il_sh ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=195000000000"> <?php echo _QXZ("IP Lists");?> </a>
		</li>

		<li ALIGN=LEFT <?php echo $cts_color ?>> 
		<a href="<?php echo "admin.php"; ?>?ADD=190000000000"> <?php echo _QXZ("Contacts");?> </a>
		</li>

		<!-- <li ALIGN=LEFT <?php echo $soundboard_sh ?>> 
		<a href="<?php echo $ADMIN ?>?ADD=162000000000"> <?php echo _QXZ("Audio Soundboards");?> </a>
		</li> -->
...
//			}
		...
		<li ALIGN=LEFT <?php echo $soundboard_sh ?>> 
		<a href="admin_soundboard.php?ADD=162000000000"> <?php echo _QXZ("Audio Soundboards");?> </a>
		</li>	
		<li ALIGN=LEFT <?php echo $vmmg_sh ?>> 
		<a href="<?php echo $ADMIN ?>?ADD=197000000000"> <?php echo _QXZ("VM Message Groups");?> </a>
		</li>	
...
?>
			<!-- REPORTS NAVIGATION -->
			<ul class='cl-vnavigation'>
			<li><li <?php echo $reports_hh ?> class="active">
...
<!--		        <ul class="sub-menu">  -->
		...
		else
			{
				...
				if (($SSqc_features_active=='1') && ($qc_auth=='1')) 
					{
					?>
					<li><li <?php echo $qc_hh ?>>
				<a href="<?php echo $ADMIN ?>?ADD=100000000000000"> 
                         <div class="col-xs-1"><i class="fa fa-user"></i></div>
	                 <div class="col-xs-9"><span><?php echo _QXZ("Quality Control");?></span></div>
         		</a>
...
<!-- VICIDIAL MODERN CONTEXT BAR -->
<div class="vicidial-context-bar">
    <div class="vicidial-context-left">
        <div class="vicidial-context-icon">
            <i class="fa fa-th-large"></i>
        </div>
        <div class="vicidial-context-title">
            <div class="title">Administration</div>
            <div class="subtitle">HNC Management</div>
        </div>
    </div>

    <div class="vicidial-context-right">
        <div class="vicidial-context-status">
            <span class="status-dot"></span>
            <span>System Online</span>
        </div>

        <div class="vicidial-context-user">
            <i class="fa fa-user"></i>
...
<div class="modern-right-tools">

    <a href="#" class="modern-tool whatsapp-tool">
        <span class="modern-tool-icon">
            <svg viewBox="0 0 32 32" aria-hidden="true">
                <path fill="#25D366" d="M16 3C8.82 3 3 8.82 3 16c0 2.29.6 4.52 1.72 6.51L3 29l6.63-1.7A12.94 12.94 0 0 0 16 29c7.18 0 13-5.82 13-13S23.18 3 16 3z"/>
                <path fill="#fff" d="M22.1 18.64c-.34-.17-2.01-1-2.32-1.11-.31-.11-.54-.17-.77.17-.23.34-.88 1.11-1.08 1.34-.2.23-.4.26-.74.09-.34-.17-1.43-.53-2.72-1.69-1.01-.9-1.69-2.01-1.89-2.35-.2-.34-.02-.52.15-.69.15-.15.34-.4.51-.6.17-.2.23-.34.34-.57.11-.23.06-.43-.03-.6-.08-.17-.77-1.86-1.05-2.55-.28-.67-.56-.58-.77-.59h-.65c-.23 0-.6.08-.91.43-.31.34-1.2 1.17-1.2 2.86s1.23 3.32 1.4 3.55c.17.23 2.42 3.7 5.86 5.19.82.35 1.46.56 1.96.72.82.26 1.57.22 2.16.13.66-.1 2.02-.83 2.31-1.63.29-.8.29-1.49.2-1.63-.08-.14-.31-.23-.65-.4z"/>
            </svg>
        </span>
        <span class="modern-tool-text">
            <strong>WhatsApp</strong>
            <small>Chat with us</small>
        </span>
    </a>

    <a href="#" class="modern-tool ai-tool">
        <span class="modern-tool-icon">
            <svg viewBox="0 0 32 32" aria-hidden="true">
                <path fill="currentColor" d="M16 3a9 9 0 0 0-9 9v5a9 9 0 0 0 9 9h1.5l4.5 3v-4.05A9 9 0 0 0 25 17v-5a9 9 0 0 0-9-9zm-4 10h8v2h-8zm0 4h6v2h-6z"/>
                <path fill="currentColor" d="M23.5 4l.7 2.3L26.5 7l-2.3.7-.7 2.3-.7-2.3-2.3-.7 2.3-.7z"/>
            </svg>
        </span>
        <span class="modern-tool-text">
...
<!-- HNC AI CHAT PANEL -->
<div class="hnc-ai-chat" id="hncAiChat">

    <div class="hnc-ai-chat-header">

        <div class="hnc-ai-avatar-small">
            HNC
            <span class="hnc-ai-online-dot"></span>
        </div>

        <div class="hnc-ai-title">
            <strong>HNC AI Assistant</strong>
            <small><span>Online</span> · Ready to help</small>
        </div>

        <button type="button"
                class="hnc-ai-close"
                id="hncAiClose"
                aria-label="Close AI Chat">&times;</button>

    </div>

    <div class="hnc-ai-chat-body">

        <div class="hnc-ai-welcome">

            <div class="hnc-ai-welcome-icon">HNC</div>

            <div class="hnc-ai-welcome-content">
                <strong>Welcome to HNC AI</strong>
                <span>Your AI assistant is ready to help.</span>
            </div>
    ...
    <div class="hnc-ai-chat-footer">

        <div class="hnc-ai-input-wrap">

            <input type="text"
                   class="hnc-ai-chat-input"
...
<div class="container-fluid" id="pcont4">
	...
	<?php
	if ( (strlen($list_sh) > 1) and (strlen($campaigns_hh) > 1) ) { 
		?>
			...
			&nbsp; &nbsp; <a href="<?php echo "admin.php"; ?>?ADD=11"><?php echo _QXZ("Add A New Campaign ");?></a> &nbsp; &nbsp; | &nbsp; &nbsp; <a href="<?php echo "admin.php"; ?>?ADD=12"> <?php echo _QXZ("Copy Campaign");?> </a> &nbsp; &nbsp; |<?php } ?> &nbsp; &nbsp; <a href="./AST_timeonVDADallSUMMARY.php"><?php echo _QXZ("Real-Time Campaigns Summary");?> </a>
			</div>	
			</div>
			</div>
	<?php } 
	if (strlen($times_sh) > 1) { 
		...
		?>
			<div class="">
			<div class="fd-tile detail">
    		<div class="page-head"><a href="<?php echo $ADMIN ?>?ADD=10000000000"> <?php echo _QXZ("Show Phones");?> </a>&nbsp;|<?php if ($add_copy_disabled < 1) { ?>&nbsp;<a href="<?php echo $ADMIN ?>?ADD=11111111111"> <?php echo _QXZ("Add A New Phone");?> </a>&nbsp;|<?php } ?>
    		&nbsp;<a href="<?php echo $ADMIN ?>?ADD=12222222222"> <?php echo _QXZ("Copy an Existing Phone");?> </a>&nbsp;|
    		&nbsp;<a href="<?php echo $ADMIN ?>?ADD=12000000000"> <?php echo _QXZ("Phone Alias List");?> </a>&nbsp;|<?php if ($add_copy_disabled < 1) { ?>&nbsp;<a href="<?php echo $ADMIN ?>?ADD=12111111111"> <?php echo _QXZ("Add A New Phone Alias");?> </a>&nbsp;|<?php } ?>&nbsp;<a href="<?php echo $ADMIN ?>?ADD=13000000000"> <?php echo _QXZ("Group Alias List");?> </a>&nbsp;|<?php if ($add_copy_disabled < 1) { ?>&nbsp;<a href="<?php echo $ADMIN ?>?ADD=13111111111"> <?php echo _QXZ("Add A New Group Alias");?> </a><?php } ?>
    		</div>	
			</div>
			</div>
			<?php }
		...
		?>
			<div class="">
			<div class="fd-tile detail">
    		<div class="page-head"> <a href="<?php echo $ADMIN ?>?ADD=130"> <?php echo _QXZ("Show Drop Lists"); ?> </a> &nbsp; &nbsp; |<?php if ($add_copy_disabled < 1) { ?>
			&nbsp; &nbsp; <a href="<?php echo $ADMIN ?>?ADD=131"><?php echo _QXZ("Add A New Drop List"); ?> </a><?php } ?></div>	
			</div>
			</div>
		<?php }
		...
		?>
			...
			<div class="fd-tile detail">
    		<div class="page-head">	
    		<a href="<?php echo $ADMIN ?>?ADD=1000000000000"><?php echo _QXZ("Show Conferences"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=1111111111111"> <?php echo _QXZ("Add A New Conference"); ?> </a> &nbsp; |<?php } ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=10000000000000"> <?php echo _QXZ("Show VICIDIAL Conferences"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=11111111111111"> <?php echo _QXZ("Add A New VICIDIAL Conference"); ?> </a><?php } ?> | &nbsp; <a href="<?php echo $ADMIN ?>?ADD=12000000000000"> <?php echo _QXZ("Show ConfBridges"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=12111111111111"> <?php echo _QXZ("Add ConfBridge"); ?> </a><?php } ?>
    		</div>	
			</div>
			</div>
		<?php }
	...
	if (strlen($conference_sh) > 25) { 
		?>
		   <div class="">
		   <div class="fd-tile detail">
		   <div class="page-head"><a href="<?php echo $ADMIN ?>?ADD=1000000000000"> <?php echo _QXZ("Show Conferences");?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=1111111111111"> <?php echo _QXZ("Add A New Conference");?> </a> &nbsp; |<?php } ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=10000000000000"> <?php echo _QXZ("Show VICIDIAL Conferences");?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=11111111111111"><?php echo _QXZ("Add A New VICIDIAL Conference");?> </a><?php } ?>| &nbsp; <a href="<?php echo $ADMIN ?>?ADD=12000000000000"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show ConfBridges"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=12111111111111"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add ConfBridge"); ?> </a><?php } ?>
		   </div>	
		   </div>
			</div>
	<?php }
...
if ( (strlen($cc_sh) > 1) and (strlen($admin_hh) > 1) ) { 
	...
	<div class="col-md-12">
    <div class="fd-tile detail">
    		<div class="page-head"><a href="admin_soundboard.php?ADD=162000000000"><?php echo _QXZ("Show Soundboard Entries"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="admin_soundboard.php?ADD=162111111111"><?php echo _QXZ("Add A New Soundboard Entry"); ?></FONT></a> &nbsp; | &nbsp; <a href="admin_soundboard.php?ADD=162211111111"><?php echo _QXZ("Copy A Soundboard Entry"); ?></FONT></a> &nbsp; <?php } ?></div>
    </div>
    </div>
	<?php
		}
...
<div class="col-md-12">
	...
	<div class="col-md-12">
    <div class="fd-tile detail">
    		<div class="page-head"> <a href="<?php echo $ADMIN ?>?ADD=180000000000"> <?php echo _QXZ("Screen Labels"); ?> </a> |<?php if ($add_copy_disabled < 1) { ?>  <a href="<?php echo $ADMIN ?>?ADD=181111111111"> <?php echo _QXZ("Add A Screen Label"); ?> </a><?php } ?>	</div>	
    </div>
    
    </div>
	<?php }
	if (strlen($colors_sh) > 1) { 
		?>
	<div class="col-md-12">
    <div class="fd-tile detail">
    		<div class="page-head"><a href="<?php echo $ADMIN ?>?ADD=182000000000"><?php echo _QXZ("Screen Colors"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=182111111111"><?php echo _QXZ("Add A Screen Colors"); ?> </a><?php } ?> &nbsp; | &nbsp; <a href="<?php echo $ADMIN ?>?ADD=311111111111111#screen_colors"> <?php echo _QXZ("Change Active Screen Colors"); ?> </a> 
	</div>	
    </div>
	<?php }
	if (strlen($cts_sh) > 1) { 
	...
	<div class="col-md-12">
    <div class="fd-tile detail">
    		<div class="page-head"> <a href="<?php echo $ADMIN ?>?ADD=192000000000"><?php echo _QXZ("Settings Containers"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=192111111111"> <?php echo _QXZ("Add A Settings Container"); ?> </a><?php } ?></div>	
    </div>
    </div>
	<?php }
	...
	if (strlen($ar_sh) > 25) { 
	 ...
	 <div class="col-md-12">
    <div class="fd-tile detail">
    		<div class="page-head"><a href="<?php echo $ADMIN ?>?ADD=194000000000"><?php echo _QXZ("Automated Reports"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=194111111111"><?php echo _QXZ("Add An Automated Report"); ?> </a><?php } ?></div>	
    </div>
    </div>
	<?php }
	...
	<div class="col-md-12">
    <div class="fd-tile detail">
    		<div class="page-head"> <a href="<?php echo $ADMIN ?>?ADD=195000000000"><?php echo _QXZ("IP Lists"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=195111111111"> <?php echo _QXZ("Add An IP List"); ?> </a><?php } ?></div>	
    </div>
    </div>
	<?php }
	if (strlen($sg_sh) > 25) { 
		...
		<div class="col-md-12">
    <div class="fd-tile detail">
    		<div class="page-head"><a href="<?php echo $ADMIN ?>?ADD=193000000000"> <?php echo _QXZ("Status Groups"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=193111111111"><?php echo _QXZ("Add A Status Group"); ?> </a><?php } ?>	</div>	
    </div>
    </div>
	<?php }
	...
	<div class="col-md-12">
    <div class="fd-tile detail">
    		<div class="page-head"> <a href="<?php echo $ADMIN ?>?ADD=196000000000"><?php echo _QXZ("CID Groups"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=196111111111"> <?php echo _QXZ("Add A CID Group"); ?> </a><?php } ?>	</div>	
    </div>
    </div>
	<?php }
	...
	<div class="col-md-12">
    <div class="fd-tile detail">
    		<div class="page-head"> <a href="<?php echo $ADMIN ?>?ADD=197000000000"> <?php echo _QXZ("VM Message Groups"); ?> </a> &nbsp; |<?php if ($add_copy_disabled < 1) { ?> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=197111111111"> <?php echo _QXZ("Add A VM Message Group"); ?> </a></div>	
    </div>
    </div><?php } ?>
	<?php }
	...
	<div class="col-md-12">
    <div class="fd-tile detail">
    		<div class="page-head"><a href="<?php echo $ADMIN ?>?ADD=198000000000"> <?php echo _QXZ("Queue Groups");?> </a> &nbsp; | &nbsp; <a href="<?php echo $ADMIN ?>?ADD=198111111111"><?php echo _QXZ("Add A Queue Group");?> </a> </div>	
    </div>
    </div>
	<?php 
	}
	...
	<div class='col-md-12'>
    <div class="fd-tile detail">
		<div class="page-head"><a href="<?php echo $ADMIN ?>?ADD=999988"><?php echo _QXZ("Available Timezones");?> </a> &nbsp; | &nbsp; <a href="<?php echo $ADMIN ?>?ADD=999987"><?php echo _QXZ("Phone Codes");?> </a> &nbsp; | &nbsp; <a href="<?php echo $ADMIN ?>?ADD=999986"><?php echo _QXZ("Postal Codes");?> </a> &nbsp; | &nbsp; <a href="<?php echo $ADMIN ?>?ADD=999985"><?php echo _QXZ("Postal Codes Cities");?> </a>
    	</div>	
    </div>
	</div>
	<?php 
