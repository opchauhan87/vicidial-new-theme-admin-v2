...
$campaigns_or_lists_rpt = preg_replace('/[^-_0-9a-zA-Z]/', '', $campaigns_or_lists_rpt);
...
while($i < $list_ct)
	{
	$list[$i] = preg_replace('/[^-_0-9\p{L}]/u', '', $list[$i]);
	$list_string .= "$list[$i]|";
	$i++;
	}
...
$HEADER.="<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 824px; top: 190px; opacity: 1; z-index: 2;'></div>";
...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")." $NWB#LISTS_stats$NWE</h3><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"AST_LISTS_campaign_stats.php?DB=$DB\">"._QXZ("SWITCH TO CAMPAIGNS")."</a></div><div class='pull-right'>";
		
		if (strlen($list[0]) > 1)
	{
	$MAIN.=" <a class=\"btn btn-info\" href=\"./admin.php?ADD=34&campaign_id=$list[0]\">"._QXZ("MODIFY")."</a>  \n";
	$MAIN.=" <a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a> </FONT>\n";
	}
else
	{
...
//~ $MAIN.="<TABLE CELLPADDING=3 CELLSPACING=0><TR><TD class='no-border'>";

$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE CELLPADDING=3 CELLSPACING=0 class='no-border' BGCOLOR=\"#".$SSframe_background."\"><TR><TD class='no-border' VALIGN=TOP>";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$MAIN.="</TD>";

$MAIN.="<TD VALIGN=TOP>";
$MAIN.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=list[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$list_string))
...
//~ $MAIN.="<BR><a href=\"AST_LISTS_campaign_stats.php?DB=$DB\">"._QXZ("SWITCH TO CAMPAIGNS")."</a>\n";
$MAIN.="</TD>";
...
$MAIN.="<BR><BR><BR>\n";
$MAIN.="<INPUT type=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'>\n";
$MAIN.="</TD><TD VALIGN=TOP> &nbsp; &nbsp; &nbsp; &nbsp; ";
$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";
//~ if (strlen($list[0]) > 1)
	//~ {
	//~ $MAIN.=" <a href=\"./admin.php?ADD=34&campaign_id=$list[0]\">"._QXZ("MODIFY")."</a> | \n";
