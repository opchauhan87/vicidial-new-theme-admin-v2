...
$MAIN.="<TABLE BORDER=0 cellspacing=5 cellpadding=5><TR><TD VALIGN=TOP class='col-md-6 no-pading' align=center>\n";
...
$MAIN.="<div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=query_date_D SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_D\"></div></div>";

$MAIN.=" "._QXZ("to")." <div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=query_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_T\"> </div></div> ";
$MAIN.="</td><TD VALIGN=TOP class='col-md-6 no-pading' align=center>\n";
//~ $MAIN.=_QXZ("User").":\n";
$MAIN.="<div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=agent_user SIZE=10 MAXLENGTH=20 VALUE=\"$agent_user\"><label>"._QXZ("User")."</label></div></div>";
...
$MAIN.="</tr><tr><td colspan=2 class=text-center><INPUT TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'><BR/>\n";
$MAIN.="</td></TD></TR></TABLE>\n";
...
if ($SUBMIT) {
	...
	*/
	...
	if (mysqli_num_rows($rpt_rslt)>0) {
		...
		$HTML.="<label>"._QXZ("AGENT SCREEN DEBUG LOG RECORDS FOR")." $query_date, $query_date_D "._QXZ("TO")." $query_date_T $server_rpt_string, "._QXZ("RECORDS")." #$lower_limit-$upper_limit";
		$HTML.="<a href=\"$PHP_SELF?SUBMIT=$SUBMIT&DB=$DB&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T&agent_user=$agent_user&lower_limit=$lower_limit&upper_limit=$upper_limit&file_download=1\">["._QXZ("DOWNLOAD")."]</a></label>";
