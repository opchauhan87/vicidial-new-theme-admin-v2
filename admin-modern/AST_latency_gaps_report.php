...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name").'</h3></div><div class="col-md-12"><div class="content">';
$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE BORDER=0 cellspacing=5 cellpadding=5><TR><TD VALIGN=TOP align=center>\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
//~ $MAIN.=_QXZ("Date").":\n";
$MAIN.="<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT TYPE=TEXT class='form-control' NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Dates")."</label></div></div>";
...
$MAIN.="<BR><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date_D SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_D\"></div></div>";
...
$MAIN.="<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date_D SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_D\"></div></div></TD>";

$MAIN.="<TD VALIGN=TOP align=center>\n";
...
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>"._QXZ("Display as")."</label></div></div></TD>";
$MAIN.="<TD VALIGN=TOP align=center></TD>\n";
//~ $MAIN.="<TD VALIGN=TOP align=center><INPUT TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
$MAIN.="</TR></TABLE>\n";
$MAIN.="<div align='center' class='col-md-12'><INPUT class='btn btn-success' TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></div>\n";
	...
	if (mysqli_num_rows($rpt_rslt)>0) 
		...
		for ($i=1; $i<=mysqli_num_rows($rpt_rslt); $i++) 
			...
			if ($i>=$lower_limit && $i<=$upper_limit) 
				...
				$HTML_rpt.="<TR valign='top'><td>$row[user]</td><td>$row[user_ip]</td><td>$row[gap_date]</td><td>$row[last_login_date]</td><td>$row[check_date]</td></TR>";
