...
echo "<h3> "._QXZ("Basic Lead Tools")." &nbsp; | &nbsp; <a href=\"lead_tools_advanced.php\">"._QXZ("Advanced Lead Tools")."</a></h3>\n";
echo "</font></div>\n";

echo "<table class='table1 col_table' width=$page_width  cellpadding=2 cellspacing=0>\n";
...
# main page display
	...
	# BEGIN lead move
	echo "<tr ><td colspan=2 align=center><font ><b>"._QXZ("Move Leads")."</b></font></td></tr>\n";
	echo "<tr ><td>"._QXZ("From List")."</td><td align=left>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=move_from_list>\n";
...
echo "</select></div></td></tr>\n";
	echo "<tr ><td>"._QXZ("To List")."</td><td align=left>\n";
	...
	echo "</select></div></td></tr>\n";
	echo "<tr ><td>"._QXZ("Status")."</td><td align=left>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=move_status>\n";
	...
	echo "</select></div></td></tr>\n";
	echo "<tr ><td >"._QXZ("Called Count")."</td><td align=left>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=move_count_op>\n";
	...
	echo "<option value='='>=</option>\n";
	echo "</select></div>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=move_count_num>\n";
	$i=0;
	while ( $i <= $max_count )
		{
	...
	echo "<tr ><td colspan=2 align=center><font ><b>"._QXZ("Update Lead Statuses")."</b></font></td></tr>\n";
	echo "<tr ><td >"._QXZ("List")."</td><td align=left>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=update_list>\n";
	echo "<option value='-'>"._QXZ("Select A List")."</option>\n";
	...
	while ( $i < $allowed_lists_count )
		...
		echo "</select></div></td></tr>\n";
	echo "<tr ><td>"._QXZ("From Status")."</td><td align=left>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=update_from_status>\n";
	echo "<option value='-'>"._QXZ("Select A Status")."</option>\n";
	...
	echo "</select></div></td></tr>\n";
	echo "<tr><td>"._QXZ("To Status")."</td><td align=left>\n";
	...
	echo "</select></div></td></tr>\n";
	echo "<tr ><td>"._QXZ("Called Count")."</td><td align=left>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=update_count_op>\n";
	echo "<option value='<'><</option>\n";
	echo "<option value='<='><=</option>\n";
	echo "<option value='>'>></option>\n";
	echo "<option value='>='>>=</option>\n";
	echo "<option value='='>=</option>\n";
	echo "</select></div>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=update_count_num>\n";
	$i=0;
	while ( $i <= $max_count )
		{
		echo "<option value='$i'>$i</option>\n";
	...
	if ( $delete_lists > 0 )
		...
		echo "</table></center>\n";
		echo "<br /><center><table width=$section_width cellspacing=3>\n";
		echo "<tr><td colspan=2 align=center><font ><b>"._QXZ("Delete Leads")."</b></font></td></tr>\n";
		echo "<tr><td>"._QXZ("List")."</td><td align=left>\n";
		echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=delete_list>\n";
		echo "<option value='-'>"._QXZ("Select A List")."</option>\n";
...
echo "</select></div></td></tr>\n";
		echo "<tr ><td>"._QXZ("Called Count")."</td><td align=left>\n";
		echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=delete_count_op>\n";
					echo "<option value='<'><</option>\n";
				echo "<option value='<='><=</option>\n";
				echo "<option value='>'>></option>\n";
				echo "<option value='>='>>=</option>\n";
				echo "<option value='='>=</option>\n";
		echo "</select></div>\n";
		echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=delete_count_num>\n";
		$i=0;
		while ( $i <= $max_count )
			{
			echo "<option value='$i'>$i</option>\n";
...
echo "</td></tr></table></div></div></div></div></div>\n";
?>
