...
*/
	...
	if ($vlog_calls>0) 
		...
		if ($file_download==1)
			...
			{
			$rslt_msg="<TABLE class='table_list hover centerline' BORDER=0 align='center' width='600' cellpadding=5 cellspacing=0>";
			$rslt_msg.="<thead><tr>";
			$rslt_msg.="<th>"._QXZ("Caller ID")."</th>";
			$rslt_msg.="<th>"._QXZ("CALLS W/STATUS")."</th>";
			$rslt_msg.="<th>"._QXZ("TOTAL CALLS")."</th>";
			$rslt_msg.="<th>"._QXZ("PCT")."</th>";
			$rslt_msg.="</tr></thead>\n";
			...
			$rslt_msg.="<tr>";
			$rslt_msg.="<td align='center'><font SIZE=2 FACE=\"Arial,Helvetica\" color=black align=left><B>"._QXZ("TOTAL")."</B></td>";
			$rslt_msg.="<td align='center'><font SIZE=2 FACE=\"Arial,Helvetica\" color=black align=left><B>$log_calls</B></td>";
			$rslt_msg.="<td align='center'><font SIZE=2 FACE=\"Arial,Helvetica\" color=black align=left><B>$total_calls</B></td>";
			$pct=round((1000*$log_calls)/$total_calls)/10;
			$rslt_msg.="<td align='center'><font SIZE=2 FACE=\"Arial,Helvetica\" color=black align=left><B>".$pct." %</td>";
			$rslt_msg.="</tr>\n";
...
//	echo "<FONT SIZE=3 FACE=\"Arial,Helvetica\"><B>"._QXZ("$report_name");
	...
	echo "<TABLE class=\"table1 col_table\" cellspacing=5 cellpadding=5><TR><TD class=\"no-border\" VALIGN=TOP>\n";
	echo "<div class=\"col-lg-4 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT  class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date Range")."</label></div></div><div class=\"col-lg-1\">";
	...
	<?php
	echo "</div><div class=\"col-lg-4 no-padding\"><INPUT class='form-control' TYPE=TEXT NAME=query_time SIZE=8 MAXLENGTH=8 VALUE=\"$query_time\"></div></div>";

	echo "<div><br><br><br><br><b>"._QXZ("to")."</b></div>\n";
	echo "<div class=\"col-lg-4 no-padding\"><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div><div class=\"col-lg-1\">";
	...
	<?php
	echo "</div><div class=\"col-lg-4 no-padding\"><INPUT class='form-control' TYPE=TEXT NAME=end_time SIZE=8 MAXLENGTH=8 VALUE=\"$end_time\"></div></div></div>";
	...
	//~ echo "<B>"._QXZ("Campaigns").":</B><BR>\n";
	echo "<div class=\"col-lg-12 no-padding\"><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=campaign[] multiple>\n";
		$o=0;
	...
	echo "</SELECT><label>"._QXZ("Campaigns")."</label></div></div>\n";

	echo "</TD><TD ALIGN=LEFT VALIGN=TOP>\n";
	//~ echo "<B>"._QXZ("Statuses").":</B>\n";
	echo "<div class=\"col-lg-12 no-padding\"><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=status[] multiple>\n";
		$o=0;
	...
	//~ echo "<font class=\"select_bold\"><B>"._QXZ("Log second diff").":</B></font><BR>\n";
	echo "<div class=\"col-lg-8 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=interval SIZE=2 MAXLENGTH=2 VALUE=\"".$interval."\"><label>"._QXZ("Log second diff")."</label></div></div>";
	//~ echo "<BR><BR><BR>";
	if ($archives_available=="Y") 
		{
		echo "<div class='col-md-12'><input type='checkbox' name='search_archived_data' value='checked' $search_archived_data>&nbsp;<b>"._QXZ("Search archived data")."</b></div><BR>\n";
		echo "<BR><BR>";
		}
	
	echo "</TD></TR><TR></TD><TD ALIGN=LEFT VALIGN=TOP COLSPAN=4> &nbsp; \n";
	echo "<center><INPUT  class='btn btn-bdr-sucess' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n</center><br>";	
	echo $rslt_msg;
