...
echo "<TITLE>"._QXZ("Reset Agent Password")."</TITLE></HEAD><BODY BGCOLOR=WHITE marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
	...
	echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("VICIDIAL: AGENT RESET OPTIONS")." </h3> </div>
...
if (strlen($reset_agent) < 1)
	...
	echo "<div class='col-lg-2'>"._QXZ("Reset Agent").": </div><div class='col-lg-4'><SELECT SIZE=1 NAME=reset_agent class='form-control'>\n";
	echo "$owner_menu";
	echo "</SELECT>\n";
	echo "</div>\n";
	echo "<INPUT TYPE=SUBMIT NAME=SUBMIT  class='btn btn-bdr-sucess'  VALUE='"._QXZ("SUBMIT")."'>\n";
	echo "</FORM>\n\n";
