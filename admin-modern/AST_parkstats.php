...
echo "<div class=\"pull-right\"><a class='btn btn-info' href=\"./admin.php?ADD=34&campaign_id=$group\">"._QXZ("MODIFY")."</a></div><div class=\"pull-right\">  <a class='btn btn-info' href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a> </div>\n";		
		
echo '</div><div class="col-md-12"><div class="content">';
//~ $MAIN.="<TABLE CELLPADDING=4 CELLSPACING=0><TR><TD>";
$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE BORDER=0 cellspacing=5 cellpadding=5><TR><TD class='col-md-4' valign='TOP'>\n";
...
$MAIN.="<div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=1 NAME=group>\n";
	$o=0;
...
$MAIN.="</TD><TD VALIGN=middle>\n";
$MAIN.="<div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT TYPE=checkbox NAME=show_details VALUE='checked' $show_details>&nbsp;&nbsp;"._QXZ("Show details")."</div></div>\n";
$MAIN.="</TD></tr>";
$MAIN.="<tr><td colspan=4 class=text-center><INPUT class='btn btn-bdr-sucess' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></td></tr>\n";
$MAIN.= "</TABLE>\n";
$MAIN.="</FORM>\n\n";
...
{
//~ $MAIN.="\n\n";
$TEXT.=_QXZ("PLEASE SELECT A GROUP AND DATE ABOVE AND CLICK SUBMIT")."\n";
}
...
$HTML.="<label>"._QXZ("Park Stats",48)." $NOW_TIME</label>";
...
$HTML.="<label>"._QXZ("USER PARK STATS")."</label>";
$HTML.="<BR><table class='table_list hover centerline' border='0' cellpadding='3' cellspacing='1'>";
$HTML.="<thead><tr>";
...
$HTML.="<label>"._QXZ("TIME STATS")."</label>";
$HTML.="<BR><table class='table_list hover centerline' border='0' cellpadding='3' cellspacing='1'>";
$HTML.="<tr>";
