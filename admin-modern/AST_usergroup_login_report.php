...
//$HTML_text.="<b>"._QXZ("$report_name")."</b> $NWB#usergroup_login$NWE\n";
$HTML_text.="<TR class='no-border' style=''>";
$HTML_text.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$HTML_text.="<INPUT TYPE=HIDDEN NAME=type VALUE=\"$type\">\n";
$HTML_text.="<TD class=\"col-md-6\" VALIGN=TOP>";
$HTML_text.="<div class='form-group custom-input mb-10'><SELECT SIZE=5 class=form-control NAME=user_group[] multiple>\n";
...
$HTML_text.="</FORM>\n";
	...
	if ($file_download < 1)
		{
		$ASCII_text.="<font size=2><PRE class='m-0'>"._QXZ("Usergroup Login Report",24).": $user                     $NOW_TIME ($db_source)\n";
