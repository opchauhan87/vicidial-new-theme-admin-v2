...
$select_list = "<TABLE class='realtime_settings_table' CELLPADDING=5 BGCOLOR='#D9E6FE' border='0'><TR><TD >";
$select_list .= "<font class='top_settings_header bold'><a href='#' onclick=\\\"hideDiv('campaign_select_list');\\\">"._QXZ("Close Panel")."</a></font><BR>"; #*
$select_list .= "<font class='top_settings_header'>"._QXZ("Select Campaigns").": </font><BR>";
$select_list .= "<SELECT class='form-control' NAME=groups[] ID=groups[] multiple>";
$o=0;
...
$select_list .= "<BR><font class='top_settings_header'>"._QXZ("Select User Groups").": </font><BR>";
$select_list .= "<SELECT class='form-control' NAME=user_group_filter[] ID=user_group_filter[] multiple>";
$o=0;
...
#*
$select_list .= "<BR><TABLE CELLPADDING=2 CELLSPACING=2 BORDER=0>";

$select_list .= "<TR><TD align=right><font class='top_settings_header'>";
$select_list .= _QXZ("Screen Refresh Rate").":  </font></TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=RR ID=RR>";
...
$select_list .= "<TR><TD align=right><font class='top_settings_header'>";
$select_list .= _QXZ("Inbound").":  </font></TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=with_inbound ID=with_inbound>";
...
$select_list .= "<TR><TD align=right><font class='top_settings_header'>";
$select_list .= _QXZ("Monitor").":  </font></TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=monitor_active ID=monitor_active>";
...
$select_list .= "<INPUT class='form-control' type=text size=10 maxlength=20 NAME=monitor_phone ID=monitor_phone VALUE='$monitor_phone'>";
$select_list .= "</TD></TR>";
...
$select_list .= "<TR><TD align=right><font class='top_settings_header'>";
$select_list .= _QXZ("Dialable Leads Alert").":  </font></TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=NOLEADSalert ID=NOLEADSalert>";
$select_list .= "<option value=''";
...
$select_list .= "<TR><TD align=right><font class='top_settings_header'>";
$select_list .= _QXZ("Show Drop In-Group Row").":  </font></TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=DROPINGROUPstats ID=DROPINGROUPstats>";
...
$select_list .= "<TR><TD align=right><font class='top_settings_header'>";
$select_list .= _QXZ("Show Carrier Stats").":  </font></TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=CARRIERstats ID=CARRIERstats>";
$select_list .= "<option value='0'";
...
if ($presets_enabled > 0)
	{
	$select_list .= "<TR><TD align=right><font class='top_settings_header'>";
	$select_list .= _QXZ("Show Presets Stats").":  </font></TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=PRESETstats ID=PRESETstats>";
	$select_list .= "<option value='0'";
...
$select_list .= "<TR><TD align=right><font class='top_settings_header'>";
$select_list .= _QXZ("Agent Time Stats").":  </font></TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=AGENTtimeSTATS ID=AGENTtimeSTATS>";
$select_list .= "<option value='0'";
...
$select_list .= "<TR><TD align=right><font class='top_settings_header'>";
$select_list .= _QXZ("In-group color override").":  </font></TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=INGROUPcolorOVERRIDE ID=INGROUPcolorOVERRIDE>";
$select_list .= "<option value='0'";
...
if (!preg_match("/WALL/",$report_display_type))
	...
	echo "<table class=''><input type='button' id='RTDisplayButton' style='margin-left: 20%;' class='red_btn_mobile' value='AGENT INFO' onClick='ToggleDisplay()'><input type=hidden id='RTDisplayInfo' value='CALL'></table>";
