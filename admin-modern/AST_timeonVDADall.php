...
.realtime_calls_table tr td:first-child{
	border-left: 0 !important;
	text-align: center;
}
td.agent-paused-dispo{
	background: #efefb7 !important;
}
.agent-paused-dispo .realtime_img_text{
	color: #808000 !important
}
.agent_realtime_text .realtime_img_text{
...
td.realtime_total_agent{
	outline: 1px solid #efefb7 !important;
}
td.agent_realtime_text{
	background: lightgrey;
}
td.agent_realtime_text_outline{
	outline: 1px solid lightgrey !important;
}
.realtime_total{
	text-align: center;
}
.realtime_text .realtime_img_text{
	color: #31708f;
}
.realtime_total .realtime_img_text{
	color: #31708f !important;
}
</style>
<?php 
...
$select_list = "<TABLE class=\"realtime_settings_table\" WIDTH=700 CELLPADDING=5 BGCOLOR='#D9E6FE'><TR><TD VALIGN=TOP>"._QXZ("Select Campaigns").": <BR>";
$select_list .= "<div class='col-lg-5'><SELECT class='form-control' SIZE=10 NAME=groups[] multiple>";
$o=0;
...
$select_list .= "<SELECT class='form-control' SIZE=8 NAME=user_group_filter[] ID=user_group_filter[] multiple>";
$o=0;
...
$select_list .= _QXZ("Inbound").":  </TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=with_inbound>";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Monitor").":  </TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=monitor_active>";
...
$select_list .= "<INPUT class='form-control' type=text size=10 maxlength=20 NAME=monitor_phone VALUE='$monitor_phone'>";
$select_list .= "</TD></TR>";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Dialable Leads Alert").":  </TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=NOLEADSalert>";
$select_list .= "<option value=''";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Show Drop In-Group Row").":  </TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=DROPINGROUPstats>";
...
$select_list .= "<TR><TD align=right>";
//end
$select_list .= _QXZ("Show Cust Phone Code").":  </TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=ShowCustPhoneCode>";
$select_list .= "<option value=\"0\"";
...
$select_list .= ">"._QXZ("YES")."</option>";
$select_list .= "</SELECT></TD></TR>";
$select_list .= _QXZ("Show Carrier Stats").":  </TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=CARRIERstats>";
$select_list .= "<option value='0'";
...
if ($presets_enabled > 0)
	{
	$select_list .= "<TR><TD align=right>";
	$select_list .= _QXZ("Show Presets Stats").":  </TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=PRESETstats>";
	$select_list .= "<option value='0'";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Agent Time Stats").":  </TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=AGENTtimeSTATS>";
$select_list .= "<option value='0'";
...
//end
$select_list .= _QXZ("Display as").":  </TD><TD align=left><SELECT class='form-control' SIZE=1 NAME=report_display_type ID=report_display_type>";
...
$select_list .= "<INPUT type=submit NAME=SUBMIT VALUE=SUBMIT class='btn btn-bdr-sucess'>";
$select_list .= "</TD></TR>";
...
echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("$report_name").'</h3> </div>
...
if ($RTajax < 1)
	...
	echo "<span style=\"left:560px;top:100px;z-index:19;background-color:#ddd\" id=campaign_select_list>\n";
...
if ( ($ALLINGROUPstats > 0) or ( (preg_match('/O/',$with_inbound)) and ($adastats > 1) ) )
	...
	while ($ingroups_to_print > $r)
		...
		if (preg_match('/0$|2$|4$|6$|8$/',$r)) {$bgcolor='';}
		else {$bgcolor='white';}
		$ingroup_detail .= "<TR bgcolor=\"\">";
...
if ( ($with_inbound != 'O') and ($NOLEADSalert == 'YES') )
	...
	if ($ctp > 0)
		{
		echo "<span style=\"position:absolute;left:268px;top:47px;z-index:15;\" id=no_dialable_leads_span>\n";
		echo "<TABLE class=\"realtime_settings_table\" WIDTH=700 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#E9E6EE\"><TR><TD ALIGN=CENTER style=\"text-align: center;background-color: E9E6EE;\">\n";
		echo "<BR><BR><BR><BR><button type='button' class='btn btn-primary btn-sm' href=\"#\" onclick=\"closeAlert('no_dialable_leads_span');\">"._QXZ("Close Alert")."</button>";
...
#	echo "<td width=5 rowspan=2> &nbsp; </td>";
	echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#015b91' rowspan=2><img src=\"images/icon_calls.png\" class='realtime_img_icon' width=42 height=42></td>";
	if ($campaign_allow_inbound > 0)
		{
		echo "<td class='realtime_text' align='center' valign='middle' bgcolor='#015b91'><font class=\"realtime_img_text\">"._QXZ("current active calls")."</font></td>";
		}
	else
		{
		echo "<td class='realtime_text' align='center' valign='middle' bgcolor='#015b91'><font class=\"realtime_img_text\">"._QXZ("calls being placed")."</font></td>";
		}
	echo "<td width=6 rowspan=2> &nbsp; </td>";
	echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#015b91' rowspan=2><img src=\"images/icon_ringing.png\" class='realtime_img_icon'></td>";
	echo "<td class='realtime_text' align='center' valign='middle' bgcolor='#015b91'><font class=\"realtime_img_text\">"._QXZ("calls ringing")."</font></td>";
	echo "<td width=6 rowspan=2> &nbsp; </td>";
	echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#015b91' rowspan=2><img src=\"images/icon_callswaiting.png\" class='realtime_img_icon'></td>";
	echo "<td class='realtime_text' align='center' valign='middle' bgcolor='#015b91'><font class=\"realtime_img_text\">"._QXZ("calls waiting for agents")."</font></td>";
	echo "<td width=6 rowspan=2> &nbsp; </td>";
	echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#015b91' rowspan=2><img src=\"images/icon_callsinivr.png\" class='realtime_img_icon'></td>";
	echo "<td class='realtime_text' align='center' valign='middle' bgcolor='#015b91'><font class=\"realtime_img_text\">"._QXZ("calls in IVR")."</font></td>";
	echo "<td width=6 rowspan=2> &nbsp; </td>";

	if ($allow_chats) 
		{
		echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#015b91' rowspan=2><img src=\"images/icon_chatswaiting.png\" class='realtime_img_icon'></td>";
		echo "<td class='realtime_text' align='center' valign='middle' bgcolor='#015b91'><font class=\"realtime_img_text\">"._QXZ("chats waiting for agents")."</font></td>";
		}
	else
		{
		echo "<td align='center' valign='middle' rowspan=2>&nbsp;</td>";
		echo "<td class='realtime_text' align='center' valign='middle'><font class=\"realtime_img_text\">&nbsp;</font></td>";
		}
	echo "<td width=6 rowspan=2> &nbsp; </td>";
	echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#015b91' rowspan=2><img src=\"images/icon_callswaiting.png\" class='realtime_img_icon'></td>";
	echo "<td class='realtime_text' align='center' valign='middle' bgcolor='#015b91'><font class=\"realtime_img_text\">"._QXZ("callback queue calls")."</font></td>";
	
	echo "</tr>";
	echo "<tr>";
	echo "<td class='realtime_total' align='center' valign='middle' bgcolor='#015b91'><font  class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$out_total</font></td>";
	echo "<td class='realtime_total' align='center' valign='middle' bgcolor='#015b91'><font  class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$out_ring</font></td>";
	...
	echo "<td class='realtime_total' align='center' valign='middle' $calls_waiting_td><font class='realtime_img_text' $calls_waiting_font>$out_live</font></td>";

	echo "<td class='realtime_total realtime_total_agent' align='center' valign='middle' bgcolor='#015b91'><font  class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$in_ivr</font></td>";
	if ($allow_chats) 
		{
		...
		echo "<td class='realtime_total' align='center' valign='middle' $chats_waiting_td><font class='realtime_img_text' $chats_waiting_font>$chats_waiting</font></td>";
		}
	else
		{
		echo "<td class='realtime_total' align='center' valign='middle'><font  class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">&nbsp;</font></td>";
		}
echo "<td class='realtime_total' align='center' valign='middle' bgcolor='#015b91'><font class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$icbq_live</font></td>";
	echo "</tr>";
...
//end
	{
	$Aecho = '';
	$Aecho .= "<span colspan=4><font class='top_head_key'>&nbsp;"._QXZ("Agents Time On Calls Campaign").":&nbsp;&nbsp;</font></span>";
	$Aecho .= "<span colspan=3><font class='top_settings_val'>&nbsp;</font></span>";
	$Aecho .= "<span colspan=4><font class='top_head_val'>$NOW_TIME\n</font></span>";
	$Aecho .= "<table class='table_list hover centerline' cellpadding=1 cellspacing=1 border=0 width=860>";
#   $Aecho .= "<tr>";
#   $Aecho .= "</tr>\n";
...
if ( ($report_display_type=='HTML') or ($report_display_type=='LIMITED') )
	...
	$HDbegin =			"";
	$HTbegin =			"<thead><tr bgcolor='#C6C6C6'>";
	$HDstation =		"";
	//$HTstation =		"<th NOWRAP><font class='top_head_key'>&nbsp; "._QXZ("STATION")." </th>";
	$HTstation =		"<th NOWRAP>"._QXZ("STATION")." </th>";
	...
	if ($RTajax > 0)
		{$HTphone =		"<th NOWRAP>&nbsp;<a href=\"#\" onclick=\"update_variables('orderby','phone');\">"._QXZ("PHONE")."</a></th>";}
	$HDuser =			"";
	...
	if ($RTajax > 0)
		{$HTuser =	"<th NOWRAP>&nbsp;<a href=\"#\" onclick=\"update_variables('orderby','user');\">"._QXZ("USER")."</a> ";}
	if ($UidORname>0)
		{
		if ($RTajax > 0)
			{$HTuser .=	"&nbsp;<a href=\"#\" onclick=\"update_variables('UidORname','');\">"._QXZ("SHOW ID")."</a> ";}
		else
			{
		...
		{
		if (isset($RTajax) and $RTajax > 0)
			{$HTuser .=	"&nbsp;<a href=\"#\" onclick=\"update_variables('UidORname','');\">"._QXZ("SHOW NAME")."</a> ";}
		else
			{
			$HTuser .= "&nbsp; <a href=\"$PHP_SELF?$usergroupQS$groupQS$ingroupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=1&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=$PHONEdisplay&MONITORdisplay=$MONITORdisplay&CUSTPHONEdisplay=$CUSTPHONEdisplay&CUSTINFOdisplay=$CUSTINFOdisplay&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=$ALLINGROUPstats&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&ShowCustPhoneCode=$ShowCustPhoneCode&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&AGENTlatency=$AGENTlatency&parkSTATS=$parkSTATS&SLAinSTATS=$SLAinSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal&report_display_type=$report_display_type\"><font class='top_head_key'>"._QXZ("SHOW NAME")."</a> ";
			}
		}
	$HTuser .= ""._QXZ("INFO",6)."</th>";
	...
	if ($RTajax > 0)
		{$HTusergroup =	"<th NOWRAP>&nbsp;<a href=\"#\" onclick=\"update_variables('orderby','group');\">"._QXZ("USER GROUP")."</a></th>";}
	$HDsessionid =		"";
	$HTsessionid =		"<th NOWRAP>"._QXZ("SESSIONID")." </th>";
	$HDlisten =			"";
 	$HTlisten =			"<th NOWRAP>"._QXZ("LISTEN")." </th>";
	$HDbarge =			"";
	$HTbarge =			"<th NOWRAP>"._QXZ("BARGE")." </th>";
	$HDwhisper =		"";
	$HTwhisper =		"<th NOWRAP>"._QXZ("WHISPER")." </th>";
	$HDstatus =			"";
	$HDmonitor =		"";
	$HTmonitor =		"<th NOWRAP>"._QXZ("MONITOR")." </th><th NOWRAP>"._QXZ("MON TYPE")." </th>";
	$HTstatus =			"<th NOWRAP>"._QXZ("STATUS")." </th><th></th>";
	$HDcustphone =		"";
	$HDcustinfo =		"";
	$HTcustinfo =		"<th NOWRAP>"._QXZ("CUST PHONE")." </th><th NOWRAP>"._QXZ("SOURCE ID")." </th><th NOWRAP>"._QXZ("ENTRY DATE")." </th><th NOWRAP>"._QXZ("STATE")." </th>";
	$HTcustphone =		"<th NOWRAP>"._QXZ("CUST PHONE")." </th>";
	$HDserver_ip =		"";
	$HTserver_ip =		"<th NOWRAP>"._QXZ("SERVER IP")." </th>";
	$HDcall_server_ip =	"";
	$HTcall_server_ip =	"<th NOWRAP>"._QXZ("CALL SERVER IP")." </th>";
	$HDtime =			"";
	...
	if ($RTajax > 0)
		{$HTtime =	"<th NOWRAP>&nbsp;<a href=\"#\" onclick=\"update_variables('orderby','time');\">MM:SS</a></th>";}
	$HDcampaign =		"";
	...
	if ($RTajax > 0)
		{$HTcampaign =	"<th NOWRAP>&nbsp;<a href=\"#\" onclick=\"update_variables('orderby','campaign');\">"._QXZ("CAMPAIGN",10)."</a></th>";}
	$HDcalls =			"";
	$HTcalls =			"<th NOWRAP>"._QXZ("CALLS")." </th>";
	$HDpause =	'';
	$HTpause =	'';
	$HDigcall =			"";
	$HTigcall =			"<th NOWRAP>"._QXZ("HOLD")." </th><th NOWRAP>"._QXZ("IN-GROUP",8)." </th>";
	if ($RS_DIDdesc > 0)
		{
		$HDigcall =			"";
		$HTigcall =			"<th NOWRAP><font class=''>&nbsp; "._QXZ("HOLD")." </th><th NOWRAP><font class=''>&nbsp; "._QXZ("IN-GROUP",8)." </th><th NOWRAP><font class='top_head_key'>&nbsp; "._QXZ("DID DESCRIPTION",15)." </th>";
		}
	if ($RS_INcolumnsHIDE > 0)
		{
		$HDigcall =			'';
	...
	if (strlen($RS_AGENTstatusTALLY) > 0)
		{
		$HDastcall =			'';
		$HTastcall =			"<th NOWRAP><font class='top_head_key'>&nbsp; "._QXZ("$RS_AGENTstatusTALLY",6)." </th>";
		}
	$HDlatency =			'';
	$HTlatency =			'';
	if ( ($AGENTlatency != 0) and ($RS_UGlatencyALLOWED > 0) )
		{
		$HDlatency =			'';
		$HTlatency =			"<td NOWRAP><font class=''>&nbsp; "._QXZ("LATENCY",7)." </td>";
		if (preg_match("/^3/",$AGENTlatency))
			{$HTlatency =			"<td NOWRAP><font class=''>&nbsp; "._QXZ("LATENCY  avg/peak (minutes)",43)." </td>";}

		}
	if ($agent_pause_codes_active > 0)
		{
		$HDstatus =			"";
		$HTstatus =			"<th NOWRAP><font class=''>&nbsp; "._QXZ("STATUS")." </th><th><font class='top_head_key'>&nbsp;</th>";
		$HDpause =			"";
		$HTpause =			"<th NOWRAP><font class=''>&nbsp; "._QXZ("PAUSE")." </th>";
		}
	if ( ($SIPmonitorLINK<1) and ($IAXmonitorLINK<1) and (!preg_match("/MONITOR|BARGE|WHISPER/",$monitor_active) ) ) 
		{
		$HDsessionid =	"";
...
#				{$G='<SPAN class="orange"><B>'; $EG='</B></SPAN>';}
		...
		if ($report_display_type=='TEXT')
			...
			if ( (strlen($monitor_phone)>1) and (preg_match("/BARGE|WHISPER/",$monitor_active) ) and (preg_match("/BARGE/",$RS_ListenBarge) ) )
				...
				$R=" | <b><a href=\"javascript:send_monitor('$Lsessionid','$Lserver_ip','$BARGEstage');\">"._QXZ("BARGE",5)."</a></b>";
				}
		...
		//end
			...
			if ( (strlen($monitor_phone)>1) and (preg_match("/MONITOR|BARGE|WHISPER/",$monitor_active) ) and (preg_match("/MONITOR/",$RS_ListenBarge) ) )
				{$L="<td NOWRAP align=center><b> <a href=\"javascript:send_monitor('$Lsessionid','$Lserver_ip','MONITOR');\">"._QXZ("LISTEN")."</a></b></td>";   $R='';}
			if ( (strlen($monitor_phone)>1) and (preg_match("/BARGE|WHISPER/",$monitor_active) ) and (preg_match("/BARGE/",$RS_ListenBarge) ) )
				{
				$BARGEstage = 'BARGE';
				if ($RS_BargeSwap > 0) {$BARGEstage = 'BARGESWAP';}
				$R=" <td NOWRAP align=center> <b><a href=\"javascript:send_monitor('$Lsessionid','$Lserver_ip','$BARGEstage');\">"._QXZ("BARGE")."</a></b></td>";
				}
			...
			if ( (strlen($monitor_phone)>1) and (preg_match("/WHISPER/",$monitor_active) ) and (preg_match("/WHISPER/",$RS_ListenBarge) ) )
				{$R=" <td NOWRAP> <b><a href=\"javascript:send_monitor('$Lsessionid','$Lserver_ip','WHISPER');\">WHISPER</a></b></td>";}
			...
			if ($agent_pause_codes_active > 0)	{$pausecodeHTML = "<td align=center><font class=''>$pausecode</td>";}
			else	{$pausecodeHTML = "";}
			...
			if ($filtered_ingroup==1) 
				...
				if ($realtime_block_user_info > 0)
					{
				$Aecho .= "<tr class='$tr_class'><td NOWRAP>$UGD $G$sessionid$EG$L$R$Aring_note[$i]</td><td NOWRAP align=center>$MO $G"._QXZ("$status",6)."$EG</td><td align=center><font class='Hblank'>$CM</td>$pausecodeHTML<td NOWRAP align=right>$CP$CI$SVD$G$call_time_MS$EG </td><td NOWRAP align=right> $G$campaign_id$EG </td><td NOWRAP align=right> $G$calls_today$EG </td>$LATENCY$ASTCT$INGRP</tr>\n";
				}
			if ($realtime_block_user_info < 1)
				{
				$Aecho .= "<tr class='$tr_class'><td NOWRAP> $G$extension$EG$Aring_note[$i]</td><td NOWRAP>$phoneD<a href=\"./user_status.php?user=$Luser\" target=\"_blank\">$G$user$EG</a> <a href=\"javascript:ingroup_info('$Luser','$j');\">$G+$EG</a> </td><td NOWRAP align=right>$UGD $G$sessionid$EG$L$R </td><td NOWRAP align=center>$MO $G"._QXZ("$status",6)."$EG</td><td align=center><font class='Hblank'>$CM</td>$pausecodeHTML<td NOWRAP align=right>$CP$CI$SVD$G$call_time_MS$EG </td><td NOWRAP align=right> $G$campaign_id$EG </td><td NOWRAP align=right> $G$calls_today$EG </td>$LATENCY$ASTCT$INGRP</tr>\n";
				}
			}
		}
		$j++;
...
#	$Aecho .= "  <SPAN class=\"orange\"><B>          </SPAN> - "._QXZ("Balanced call")."</B>\n";
	...
	if ( ($report_display_type=='TEXT') or ($report_display_type=='WALL_1') )
		...
		if ($report_display_type=='TEXT')
			{
			echo "<PRE class='m-0'><FONT SIZE=2>";
			echo "";
			echo "$Cecho";
			echo "$Aecho";
			}
...
#	echo "<TABLE width=$section_width cellpadding=3 cellspacing=0>\n";
	echo "<tr>";
#	echo "<td width=5 rowspan=2> &nbsp; </td>";
	echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#015b91' rowspan=2><img src=\"images/icon_users.png\" class='realtime_img_icon'></td>";
	echo "<td class='realtime_text' align='center' valign='middle' bgcolor='#015b91'><font class=\"realtime_img_text\">"._QXZ("agents logged in")."</font></td>";
	echo "<td width=6 rowspan=2> &nbsp; </td>";
	echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#015b91' rowspan=2><img src=\"images/icon_agentsincalls.png\" class='realtime_img_icon'></td>";
	echo "<td class='realtime_text' align='center' valign='middle' bgcolor='#015b91'><font class=\"realtime_img_text\">"._QXZ("agents in calls")."$AIDtx</font></td>";
	echo "<td width=6 rowspan=2> &nbsp; </td>";
	echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#015b91' rowspan=2><img src=\"images/icon_agentswaiting.png\" class='realtime_img_icon'></td>";
	echo "<td class='realtime_text' align='center' valign='middle' bgcolor='#015b91'><font class=\"realtime_img_text\">"._QXZ("agents waiting")."</font></td>";
	echo "<td width=6 rowspan=2> &nbsp; </td>";
	echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#808000' rowspan=2><img src=\"images/icon_agentspaused.png\" class='realtime_img_icon'></td>";
	echo "<td class='realtime_text agent-paused-dispo' align='center' valign='middle' bgcolor='#808000'><font class=\"realtime_img_text\">"._QXZ("paused agents")."</font></td>";
	echo "<td width=6 rowspan=2> &nbsp; </td>";
	echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='black' rowspan=2><img src=\"images/icon_agentsindeadcalls.png\" class='realtime_img_icon'></td>";
	echo "<td class='realtime_text agent_realtime_text' align='center' valign='middle' bgcolor='black'><font class=\"realtime_img_text\">"._QXZ("agents in dead calls")."</font></td>";
	echo "<td width=6 rowspan=2> &nbsp; </td>";
	echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#808000' rowspan=2><img src=\"images/icon_agentsindispo.png\" class='realtime_img_icon'></td>";
	echo "<td class='realtime_text agent-paused-dispo' align='center' valign='middle' bgcolor='#808000'><font class=\"realtime_img_text\">"._QXZ("agents in dispo")."</font></td>";
	echo "</tr>";
	echo "<tr>";
	echo "<td class='realtime_total' align='center' valign='middle' bgcolor='#015b91'><font  class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$agent_total</font></td>";
	echo "<td class='realtime_total' align='center' valign='middle' bgcolor='#015b91'><font  class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$agent_incall$AIDct</font></td>";
	...
	echo "<td class='realtime_total' align='center' valign='middle' $agents_waiting_td><font class='realtime_img_text' $agents_waiting_font>$agent_ready</font></td>";

	echo "<td class='realtime_total realtime_total_agent' align='center' valign='middle' bgcolor='#808000'><font class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$agent_paused</font></td>";
	echo "<td class='realtime_total agent_realtime_text_outline' align='center' valign='middle' bgcolor='black'><font class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$agent_dead</font></td>";
	echo "<td class='realtime_total realtime_total_agent' align='center' valign='middle' bgcolor='#808000'><font class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$agent_dispo</font></td>";
	echo "</tr>";
	//chirag parmar
	//15-03-21
		...
		echo "<td width=6 rowspan=2> &nbsp; </td>";
		echo "<td class='realtime-icon' align='center' valign='middle' bgcolor='#015b91' rowspan=2><img src=\"images/icon_inbound.png\" class='realtime_img_icon'></td>";
		echo "<td align='center' valign='middle' bgcolor='#015b91'><font class=\"realtime_img_text\">"._QXZ("inbound SLA")."</font></td>";
		echo "<td width=6 rowspan=2> &nbsp; </td>";
		echo "</tr>";
		echo "<tr>";
		echo "<td class='realtime_total' align='center' valign='middle' bgcolor='#015b91'><font  class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$avgwaitTODAY</font></td>";
		echo "<td class='realtime_total' align='center' valign='middle' bgcolor='#015b91'><font  class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$avgcustTODAY</font></td>";
		echo "<td class='realtime_total' align='center' valign='middle' bgcolor='#015b91'><font  class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$avgparksecallTODAY</font></td>";
		echo "<td class='realtime_total' align='center' valign='middle' bgcolor='#015b91'><font  class='realtime_img_text' style=\"font-family:HELVETICA;font-size:18;color:white;font-weight:bold;\">$PCThold_sec_stat_one%</font></td>";
