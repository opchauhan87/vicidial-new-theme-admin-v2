...
<link rel="stylesheet" href="css/callcenter_stylesheet.css">
...
echo "<table style='width:100%' width='620' border='0' cellpadding='5' cellspacing='0'>";
echo "<TR BGCOLOR='#E6E6E6'>\n";
echo "<td align='left' width='190' valign='top' style='padding:10px'><font class='arial'>"._QXZ("Chatting with").": </font><BR><span class='arial_bold' id='ActiveChatManager'>".$chat_managers_array[$priority_chat]."</span></td>";
echo "<td align='right' width='190' valign='top' style='padding:10px'><font class='arial'>"._QXZ("Chat started").": </font><BR><span class='arial_bold' id='ActiveChatStartDate'>".$chat_start_date_array[$priority_chat]."</span></td>";
echo "<td align='left' width='*' valign='bottom' style='padding:10px'><font class='arial'>"._QXZ("Your active chats").":</font></td>";
echo "</TR>";

echo "<TR BGCOLOR='#E6E6E6'>\n";
echo "<TD align='left' colspan='2' valign='top' width='380'>\n";
echo "\t<div style='width:96%;height: 35vh;border-radius: 10px;background-color: #FFF;padding: 5px;margin: 0 10px;' class='scrolling_transcript' id='ActiveManagerChatTranscript'></div><BR>\n";
echo "\t<div id='AllowAgentReplies' align='center' style='display:none;'>\n";
echo "\t<textarea class='small_arial' rows='2' cols='65' name='manager_message' id='manager_message' onkeypress='if (event.keyCode == 13) {SendMgrChatMessage();}'></textarea><BR><input class='iframe-btn-green' type='button' style='width:200px' value='"._QXZ("SEND MESSAGE")."' onClick=\"SendMgrChatMessage()\">\n";
echo "\t</div>\n";
echo "</TD>\n";
echo "<TD align='left' rowspan='2' valign='top' width='210'>\n";
echo "<div style='width: 91%;height: 33vh;border-radius: 10px;padding: 10px;' class='scrolling_chat_display' id='AllActiveChats'>\n";
...
#		while (list($manager_chat_id, $text) = each($chat_managers_array)) {
	...
	echo "</ul>\n";
echo "\t</div>\n";
echo "<font class='small_arial_bold' style='position: relative;top: 10px;'>("._QXZ("bolded chats = unread messages").")<BR><input type='checkbox' id='MuteChatAlert' name='MuteChatAlert'>"._QXZ("Mute alert sound")."</font>\n";
echo "\t<BR><input class='green_btn' type='button' style='width: auto;background: #00B8DA;color: #fff;font-size: 15px;border: none;border-radius: 10px;padding: 15px;margin-top: 17px;' value='"._QXZ("CHAT WITH LIVE AGENT")."' onClick=\"document.getElementById('AgentChatSpan').style.display='none'; document.getElementById('AgentNewChatSpan').style.display='block'; ReloadAgentNewChatSpan('$user');\">\n";
echo "\t<span id='AgentEndChatSpan' style='display: none;'><div align='left'><BR><input class='iframe-btn-red' type='button' style='width:200px' value='"._QXZ("END CHAT")."' onClick='EndAgentToAgentChat()'></div></span>";
echo "\t<span id='AgentAddChatSpan' style='display: none;'><BR><input class='iframe-btn-green' type='button' style='width:200px' value='"._QXZ("ADD AGENT TO CURRENT CHAT")."' onClick=\"LoadAvailableAgentsForChat('AllLiveNonChatAgents', 'agent_to_add'); ToggleSpan('AllLiveNonChatAgents');\"></span>\n";
