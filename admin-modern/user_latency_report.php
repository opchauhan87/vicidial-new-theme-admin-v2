...
echo '<div id="pcont4" class="container-fluid">
	...
	{echo "<div class='pull-right'><a class='btn btn-info' href=\"./admin.php?ADD=3&user=$user\">"._QXZ("MODIFY")."</a></div> \n";}		
		
		echo '</div><div class="col-md-12"><div class="content">';
echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET>\n";
//~ echo "<TABLE CELLPADDING=4 CELLSPACING=0><TR><TD align=left valign=top>\n";
echo "<div class='col-lg-6'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=user>\n";
echo "<option ";
...
echo "<div align='left' class='col-md-3' style='margin-top: 10px'><INPUT class='btn btn-success' TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></div>\n";
echo "</FORM>\n\n";
