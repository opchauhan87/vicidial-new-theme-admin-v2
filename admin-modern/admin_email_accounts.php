...
if ($eact=="DELETE" && $confirm_deletion=="yes" && $email_account_id) 
	...
	$message="<span class='message_block'>"."ACCOUNT $email_account_id DELETED</span><BR/>";
	$eact="";
	}
		...
		if ($SUBMIT=="SUBMIT") 
			...
			if ($add_copy_disabled > 0)
				...
				if (mysqli_affected_rows($link)==0) 
					{
					$error_msg.="
					<div>"._QXZ("There was an unknown error when attempting to create the new account")."<BR/></div>";
					if($DB>0) {$error_msg.="<B>$ins_stmt</B><BR>";}
					}
				else 
					{
					$message="<div id=\"pcont4\" class=\"container-fluid\">
					<div class=\"cl-mcont\">
					<div class=\"row\">
					<div class=\"col-md-12 no-padding\">
					<div class=\"block-flat\">"._QXZ("NEW ACCOUNT")." $email_account_id "._QXZ("SUCCESSFULLY CREATED");
			...
			if (mysqli_affected_rows($link)==0) 
				{
				$error_msg.="
					<div>"._QXZ("There was an unknown error when attempting to update account")." $email_account_id<BR/></div>";
				...
				$message="<div id=\"pcont4\" class=\"container-fluid\">
					...
					<div class=\"row\">
					<div class=\"col-md-12 no-padding\">
					<div class=\"block-flat\">"._QXZ("ACCOUNT")." $email_account_id "._QXZ("SUCCESSFULLY MODIFIED");
				$message="</div></div></div></div></div>";	
				# $eact="";
	...
	if (mysqli_num_rows($rslt)>0) 
		...
		if ($add_copy_disabled > 0)
			...
			if (mysqli_affected_rows($link)==0) 
				{
				$error_msg.="
					<div>"._QXZ("There was an unknown error when attempting to copy the new account")."<BR/></div>";
				...
				$message="<div id=\"pcont4\" class=\"container-fluid\">
					...
					<div class=\"row\">
					<div class=\"col-md-12 no-padding\">
					<div class=\"block-flat\">"._QXZ("NEW ACCOUNT")." $new_account_id "._QXZ("SUCCESSFULLY COPIED FROM")." $source_email_account<BR/></div></div></div></div></div>";
				$eact="";
		...
		{
		$error_msg="<div id=\"pcont4\" class=\"container-fluid\">
					<div class=\"cl-mcont\">
					<div class=\"row\">
					<div class=\"col-md-12 no-padding\">
					<div class=\"block-flat\">"._QXZ("Error - source email does not exist")."<BR/></div></div></div></div></div>";
	...
	if ($accounts_to_print>0) 
		...
		if ($error_msg) {
			echo "<div id=\"pcont4\" class=\"container-fluid\">
					...
					<div class=\"col-md-12 no-padding\">
					<div class=\"block-flat\">";
			echo "ACCOUNT NOT COPIED<BR/>"._QXZ("The data you submitted has the following errors").":<BR/>$error_msg";
			echo "</div></div></div></div></div>";
			}
		echo "<div id=\"pcont4\" class=\"container-fluid\">
		<div class=\"cl-mcont\">
        <div class=\"row\">
		<div class=\"col-md-12 no-padding\"><div class=\"block-flat\">
		<div class=\"header\"> <h3> "._QXZ("Copy New Account from Existing Account")."</h3></div>";
		echo "<form action='$PHP_SELF' method='GET'>\n";
		echo "<input type=hidden name=DB value=\"$DB\">\n";
		echo "<input type=hidden name=action value=COPY_EMAIL_SUBMIT>\n";
		echo "<center><div class=\"col-md-12\"><div class=\"content\"><TABLE width=$section_width cellspacing=3>\n";
		echo "<tr ><td align=right>"._QXZ("Account ID to Copy From").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=source_email_account>\n";
		echo "$accounts_list";
		echo "</select></div></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("New Account ID").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=new_account_id value='$new_account_id' size=10 maxlength=20></div></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("New Account Name").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_name size=40 maxlength=100></div> $NWB#email_accounts-carrier_name$NWE </td></tr>\n";
		echo "<tr ><td class=text-center colspan=2><input class='btn btn-success' type=submit name=SUBMIT value='"._QXZ("COPY")."'></td></tr>\n";
		echo "</TABLE></div></div></center></div></div></div></div></div>\n";
		//echo "</TD></TR></TABLE>\n";
		}
	else 
		{
		echo "<div class='container-fluid' id='pcont4'>\n";
		echo "<TABLE><TR><TD>\n";
		//echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";
...
### END copy fields to a list form
	...
	if ( ($LOGemails_modify==1) )
		...
		//echo "<TR><TD>\n";
		echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";
		if ($error_msg) {echo "<span class='message_block'>"."ACCOUNT NOT INSERTED<BR/>"._QXZ("The data you submitted has the following errors").":<BR/>$error_msg"."</span>";}
		echo "<div id=\"pcont4\" class=\"container-fluid\">
		<div class=\"cl-mcont\">
        <div class=\"row\">
		<div class=\"col-md-12 no-padding\"><div class=\"block-flat\">
		<div class=\"header\"> <h3> "._QXZ("ADD NEW INBOUND EMAIL ACCOUNT")."</h3></div>";
		echo "<form action='$PHP_SELF' method='GET'>\n";
		echo "<center><div class=\"col-md-12\"><div class=\"content\"><TABLE class='table_list hover' width=$section_width cellspacing=3>\n";

		echo "<tr ><td align=right>"._QXZ("Email Account ID").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_id size=15 maxlength=20 value='$email_account_id'></div> $NWB#email_accounts-email_account_id$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Name").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_name size=40 maxlength=100 value='$email_account_name'></div> $NWB#email_accounts-email_account_name$NWE </td></tr>\n";
		
		echo "<tr><td align=right>"._QXZ("Active").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=active><option value='Y'>"._QXZ("Y")."</option><option SELECTED value='N'>"._QXZ("N")."</option></select></div>$NWB#email_accounts-email_account_active$NWE</td></tr>\n";
		
	
		echo "<tr ><td align=right>"._QXZ("Email Account Description").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_description size=70 maxlength=255 value='$email_account_description'></div> $NWB#email_accounts-email_account_description$NWE </td></tr>\n";
		
		echo "<tr><td align=right>"._QXZ("Email Account Type").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=email_account_type><option value='INBOUND'>"._QXZ("INBOUND")."</option></select></div>$NWB#email_accounts-email_account_type$NWE</td></tr>\n";
		
		
		echo "<tr ><td align=right>"._QXZ("Admin User Group").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=user_group>\n";
		echo "$UUgroups_list";
		echo "<option SELECTED value=\"---ALL---\">"._QXZ("All Admin User Groups")."</option>\n";
		echo "</select></div> $NWB#email_accounts-admin_user_group$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Protocol").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=protocol><option SELECTED>IMAP</option><option>POP3</option></select></div> $NWB#email_accounts-protocol$NWE </td></tr>\n";
	
		
		echo "<tr><td align=right>"._QXZ("Auth Mode for POP3 protocol only").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=pop3_auth_mode><option SELECTED value='BEST'>"._QXZ("BEST")."</option><option value='PASS'>"._QXZ("PASS")."</option><option>APOP</option><option>CRAM-MD5</option></select></div>$NWB#email_accounts-pop3_auth_mode$NWE</td></tr>\n";
		
		echo "<tr ><td align=right>"._QXZ("Email Reply-to Address").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_replyto_address size=70 maxlength=255 value='$email_replyto_address'></div> $NWB#email_accounts-email_replyto_address$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Server").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_server size=70 maxlength=255 value='$email_account_server'></div> $NWB#email_accounts-email_account_server$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account User").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_user size=30 maxlength=255 value='$email_account_user'></div> $NWB#email_accounts-email_account_user$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Password").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_pass size=30 maxlength=100 value='$email_account_pass'></div> $NWB#email_accounts-email_account_pass$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Frequency Check Rate (mins)").": </td><td align=left><div class='col-lg-5'><select class='form-control' name='email_frequency_check_mins'>";
		$i=5;
		while ($i<=60) 
			{
		...
		echo "</select></div> $NWB#email_accounts-email_frequency_check_mins$NWE </td></tr>\n";
		echo "<tr ><td align=right><a href=\"admin.php?ADD=1000\">"._QXZ("In-Group ID")."</a>: </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=group_id>";
		echo "$Dgroups_menu";
		echo "</select></div> $NWB#email_accounts-in_group$NWE </td></tr>\n";
		
		echo "<tr ><td align=right><a href=\"admin.php?ADD=100\">"._QXZ("Default List ID")."</a>: </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=default_list_id size=20 maxlength=255 value='$default_list_id'></div> $NWB#email_accounts-default_list_id$NWE </td></tr>\n";
		
		echo "<tr ><td align=right>"._QXZ("In-Group Call Handle Method").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=call_handle_method><option value='EMAIL'>"._QXZ("EMAIL")."</option><option value='EMAILLOOKUP'>"._QXZ("EMAILLOOKUP")."</option><option value='EMAILLOOKUPRRL'>"._QXZ("EMAILLOOKUPRL")."</option><option value='EMAILLOOKUPRC'>"._QXZ("EMAILLOOKUPRC")."</option><option SELECTED value='$call_handle_method'>"._QXZ("$call_handle_method")."</option></select></div>$NWB#email_accounts-call_handle_method$NWE</td></tr>\n";
		
		
		
		echo "<tr ><td align=right>"._QXZ("In-Group Agent Search Method").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=agent_search_method><option value=\"LB\">LB -  "._QXZ("Load Balanced")."</option><option value=\"LO\">LO - "._QXZ("Load Balanced Overflow")."</option><option value=\"SO\">SO - "._QXZ("Server Only")."</option><option SELECTED>$agent_search_method</option></select></div>$NWB#email_accounts-agent_search_method$NWE</td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("In-Group List ID").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=list_id size=14 maxlength=14 value=\"$list_id\"></div> $NWB#email_accounts-ingroup_list_id$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("In-Group Campaign ID").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=campaign_id>\n";
		echo "$campaigns_list";
		echo "<option SELECTED>$campaign_id</option>\n";
		echo "</select></div> $NWB#email_accounts-ingroup_campaign_id$NWE </td></tr>\n";
		
		echo "<tr ><td class=text-center colspan=2><input class='btn btn-success' type=submit name=SUBMIT VALUE='"._QXZ("SUBMIT")."'><input type=hidden name='eact' value='ADD'></td></tr>\n";
		echo "</TABLE></div></div></center></form></div></div></div></div></div>\n";
		}
	else
		{
	...
	if ( ($LOGemails_modify==1) )
		...
		if ($eact=="DELETE" && $email_account_id)  
			{
			echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";
			echo "<br><span class='message_block'><B>"._QXZ("CONFIRM DELETION OF INBOUND EMAIL ACCOUNT")." $email_account_id</B><BR>\n";
			echo "<a href='$PHP_SELF?eact=DELETE&email_account_id=$email_account_id&confirm_deletion=yes'>"._QXZ("Click to delete account")." $email_account_id</a></span>\n";
			echo "</font>";
			}
		$stmt="SELECT campaign_id,campaign_name from vicidial_campaigns $whereLOGallowed_campaignsSQL order by campaign_id;";
		$rslt=mysql_to_mysqli($stmt, $link);
		...
		if ($error_msg) {
			echo "<div id=\"pcont4\" class=\"container-fluid\">
			  ...
			  <div class=\"col-md-12 no-padding\">
			  <div class=\"block-flat\">";
			echo _QXZ("ACCOUNT NOT UPDATED")."<BR/>"._QXZ("The data you submitted has the following errors").":<BR/>$error_msg";
			echo "</div></div></div></div></div>";
			}
		echo "<div id=\"pcont4\" class=\"container-fluid\">
			  <div class=\"cl-mcont\">
			  ...
			  <div class=\"block-flat\">
			  <div class=\"header\">
			  <h3>"._QXZ("UPDATE AN EXISTING INBOUND EMAIL ACCOUNT")."</h3>
			  </div>";
		echo "<form action='$PHP_SELF' method='GET'>\n";
		echo "<center><div class=\"col-md-12\"><div class=\"content\"><TABLE class='' width=$section_width cellspacing=3>\n";

		echo "<tr ><td align=right>"._QXZ("Email Account ID").": </td><td align=left><div class='col-lg-5'><input type=hidden name=email_account_id value='$email_account_id'><B>$email_account_id $NWB#email_accounts-email_account_id$NWE</B></div></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Name").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_name size=40 maxlength=100 value='$email_account_name'></div> $NWB#email_accounts-email_account_name$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Active").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=active>";
		echo "<option value='$active' selected>"._QXZ("$active")."</option>";
		echo "<option>"._QXZ("Y")."</option><option>"._QXZ("N")."</option></select></div> $NWB#email_accounts-email_account_active$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Description").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_description size=70 maxlength=255 value='$email_account_description'></div> $NWB#email_accounts-email_account_description$NWE </td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Email Account Type").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=email_account_type><option value='$email_account_type' selected>"._QXZ("$email_account_type")."</option><option value='INBOUND'>"._QXZ("INBOUND")."</option></select></div>$NWB#email_accounts-email_account_type$NWE</td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Admin User Group").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=user_group>\n";
		echo "<option value='$user_group' selected>"._QXZ("$user_group")."</option>";
		echo "$UUgroups_list";
		echo "<option SELECTED value=\"---ALL---\">"._QXZ("All Admin User Groups")."</option>\n";
		echo "</select></div> $NWB#email_accounts-admin_user_group$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Protocol").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=protocol><option>IMAP</option><option>POP3</option><option SELECTED>$protocol</option></select></div> $NWB#email_accounts-protocol$NWE </td></tr>\n";
			echo "<tr ><td align=right>"._QXZ("Auth Mode for POP3 protocol only").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=pop3_auth_mode><option value='BEST'>"._QXZ("BEST")."</option><option value='PASS'>"._QXZ("PASS")."</option><option>APOP</option><option>CRAM-MD5</option><option SELECTED value='$pop3_auth_mode'>"._QXZ("$pop3_auth_mode")."</option></select></div>$NWB#email_accounts-pop3_auth_mode$NWE</td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Reply-to Address").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_replyto_address size=70 maxlength=255 value='$email_replyto_address'></div> $NWB#email_accounts-email_replyto_address$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Server").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_server size=70 maxlength=255 value='$email_account_server'></div> $NWB#email_accounts-email_account_server$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account User").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_user size=30 maxlength=255 value='$email_account_user'></div> $NWB#email_accounts-email_account_user$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Email Account Password").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=email_account_pass size=30 maxlength=100 value='$email_account_pass'></div> $NWB#email_accounts-email_account_pass$NWE </td></tr>\n";
		...
		echo "</select></div> $NWB#email_accounts-email_frequency_check_mins$NWE </td></tr>\n";
		echo "<tr ><td align=right><a href=\"admin.php?ADD=3811&group_id=$group_id\">"._QXZ("In-Group ID")."</a>: </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=group_id>";
		echo "$Dgroups_menu";
		echo "<option value='$group_id' selected>$group_id</option></select></div> $NWB#email_accounts-in_group$NWE </td></tr>\n";

		echo "<tr ><td align=right><a href=\"admin.php?ADD=311&list_id=$default_list_id\">"._QXZ("Default List ID")."</a>: </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=default_list_id size=20 maxlength=255 value='$default_list_id'></div> $NWB#email_accounts-default_list_id$NWE </td></tr>\n";


###############
		echo "<tr><td align=right>"._QXZ("In-Group Call Handle Method").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=call_handle_method><option value='EMAIL'>"._QXZ("EMAIL")."</option><option value='EMAILLOOKUP'>"._QXZ("EMAILLOOKUP")."</option><option value='EMAILLOOKUPRRL'>"._QXZ("EMAILLOOKUPRL")."</option><option value='EMAILLOOKUPRC'>"._QXZ("EMAILLOOKUPRC")."</option><option SELECTED value='$call_handle_method'>"._QXZ("$call_handle_method")."</option></select></div>$NWB#email_accounts-call_handle_method$NWE</td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("In-Group Agent Search Method").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=agent_search_method><option value=\"LB\">LB - "._QXZ("Load Balanced")."</option><option value=\"LO\">LO - "._QXZ("Load Balanced Overflow")."</option><option value=\"SO\">SO - "._QXZ("Server Only")."</option><option SELECTED>"._QXZ("$agent_search_method")."</option></select></div> $NWB#email_accounts-agent_search_method$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("In-Group List ID").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=list_id size=14 maxlength=14 value=\"$list_id\"></div> $NWB#email_accounts-ingroup_list_id$NWE </td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("In-Group Campaign ID").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=campaign_id>\n";
		echo "$campaigns_list";
		echo "<option SELECTED>$campaign_id</option>\n";
		...
		echo "<tr ><td align=right>"._QXZ("Un-handled Emails").": </td><td align=left><div class='col-lg-5'><B>$unhandled_emails</B></div></td></tr>\n";
################
		
		echo "<tr ><td class=text-center colspan=2><input class='btn btn-success' type=submit name=SUBMIT VALUE='"._QXZ("UPDATE")."'><input type=hidden name='eact' value='UPDATE'></td></tr>\n";
		echo "</TABLE><BR><BR>";
		if ($LOGuser_level >= 9)
			{
			echo "<a class='btn btn-primary btn-sm' href=\"admin.php?ADD=720000000000000&category=EMAIL&stage=$email_account_id\">"._QXZ("Click here to see Admin changes to this record")."</a>\n";
			}
		echo "<a class='btn btn-danger btn-sm' href='$PHP_SELF?eact=DELETE&email_account_id=$email_account_id'>"._QXZ("DELETE EMAIL ACCOUNT")."</a></center></form>\n";
		}
	else
		{
		echo _QXZ("You do not have permission to view this page")."\n";
	...
	echo "<div id=\"pcont4\" class=\"container-fluid\">
		<div class=\"cl-mcont\">
        <div class=\"row\">
		<div class=\"col-md-12 no-padding\"><div class=\"block-flat\"><div class=\"header\"> <h3> "._QXZ("INBOUND EMAIL ACCOUNT LISTINGS").":</h3></div>\n";
	echo "<center><div class=\"col-md-12\"><div class=\"content\"><table class='hover table_list centerline' width='750' cellspacing='0' cellpadding='1'>\n";
	echo "<thead>\n";
	echo "<TR>\n";
	echo "<Th><b>"._QXZ("ACCOUNT ID")."</b></Th>\n";
	echo "<Th><b>"._QXZ("ACCOUNT NAME")."</b></Th>\n";
	echo "<Th><b>"._QXZ("DESCRIPTION")."</b></Th>\n";
	echo "<Th><b>"._QXZ("REPLY-TO ADDRESS")."</b></Th>\n";
	echo "<Th><b>"._QXZ("PROTOCOL")."</b></Th>\n";
	echo "<Th><b>"._QXZ("SERVER")."</b></Th>\n";
	echo "<Th><b>"._QXZ("FREQUENCY")."</b></Th>\n";
	echo "<Th><b>"._QXZ("ACTIVE")."</b></Th>\n";
	echo "<Th><b>"._QXZ("UNREAD EMAILS")."</b></Th>\n";
	echo "<Th><b>"._QXZ("MODIFY")."</b></Th></tr></thead>\n";
	...
	while ($accounts_to_print > $o) 
		...
		if (preg_match("/1$|3$|5$|7$|9$/i", $o))
			...
			{$bgcolor='';}
		echo "<tr $bgcolor><td><a href=\"$PHP_SELF?eact=UPDATE&email_account_id=$row[email_account_id]\">$row[email_account_id]</a></td>";
		echo "<td> $row[email_account_name]</td>";
		echo "<td> $row[email_account_description]</td>";
		echo "<td> $row[email_replyto_address]</td>";
		echo "<td> $row[protocol]</td>";
		echo "<td> $row[email_account_server]</td>";
		echo "<td>$row[email_frequency_check_mins] "._QXZ("mins")."</td>";
		echo "<td> $row[active]</td>";
		echo "<td> $unhandled_emails</td>";
		echo "<td><a class='btn alert-success' href=\"$PHP_SELF?eact=UPDATE&email_account_id=$row[email_account_id]\">"._QXZ("MODIFY")."</a></td></tr>\n";
		$o++;
		}

	echo "</table></div></div></font>";
	}
