...
echo "<h3>  <a href=\"lead_tools.php\">"._QXZ("Basic Lead Tools")."</a> &nbsp; | &nbsp; "._QXZ("Advanced Lead Tools")."</h3>\n";
echo "</font></div>\n";

echo "<table class='table1 col_table' width=$page_width bgcolor=#E6E6E6 cellpadding=2 cellspacing=0>\n";



echo "<tr ><td align=left colspan=2><font face='ARIAL,HELVETICA' color=black size=3> &nbsp; \n";
...
if ($move_submit == _QXZ("move") )
	...
	if ( $to_list_lead_count + $move_lead_count > $list_lead_limit )
		...
		echo "<p><a class='btn btn-info' href='$PHP_SELF$DBlink'>"._QXZ("Click here to start over").".</a></p>\n";
		echo "</body>\n</html>\n";
		}
	else
		{
		...
		echo "<input class='btn btn-success' type=submit name=confirm_move value='"._QXZ("confirm")."'>\n";
		echo "</form></center>\n";
		echo "<p><a class='btn btn-info' href='$PHP_SELF$DBlink'>"._QXZ("Click here to start over").".</a></p>\n";
		echo "</body>\n</html>\n";
		}
...
if ($update_submit == _QXZ("update") )
	...
	echo "<input type=hidden name=DB value='$DB'>\n";
	echo "<input class='btn btn-success' type=submit name=confirm_update value='"._QXZ("confirm")."'>\n";
	echo "</form></center>\n";
	echo "<p><a class='btn btn-info' href='$PHP_SELF$DBlink'>"._QXZ("Click here to start over").".</a></p>\n";
	echo "</body>\n</html>\n";
...
if ( ( $delete_submit == "delete" ) && ( $delete_lists > 0 ) )
	...
	echo "<input type=hidden name=DB value='$DB'>\n";
	echo "<input class='btn btn-success' type=submit name=confirm_delete value='"._QXZ("confirm")."'>\n";
	echo "</form></center>\n";
	echo "<p><a class='btn btn-info' href='$PHP_SELF$DBlink'>"._QXZ("Click here to start over").".</a></p>\n";
	echo "</body>\n</html>\n";
	}
...
if ( ( $reset_called_count_submit == _QXZ("reset called count") ) && ( $modify_leads > 0 ) )
	...
	echo "<input type=hidden name=DB value='$DB'>\n";
	echo "<input class='btn btn-success' type=submit name=confirm_reset_called_count value='"._QXZ("confirm")."'>\n";
	echo "</form></center>\n";
	echo "<p><a class='btn btn-info' href='$PHP_SELF$DBlink'>"._QXZ("Click here to start over").".</a></p>\n";
	echo "</body>\n</html>\n";
	}
...
if ($callback_submit == _QXZ("switchcallbacks") )
	...
	$callback_lead_count = $callback_lead_count_row[0];
		...
		echo "<input type=hidden name=DB value='$DB'>\n";
		echo "<input class='btn btn-success' type=submit name=confirm_callback value='"._QXZ("confirm")."'>\n";
		echo "</form></center>\n";
		echo "<p><a class='btn btn-info' href='$PHP_SELF$DBlink'>"._QXZ("Click here to start over").".</a></p>\n";
		echo "</body>\n</html>\n";
	}
...
if (
	...
	# BEGIN lead move
echo "<tr ><td colspan=2 align=center><font color=black><b>"._QXZ("Move Leads")."</b></font></td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("From List")."</td><td align=left>\n";
	echo "<div class=\"col-lg-5\"><select size=8 name=move_from_list[] class='form-control' id='move_from_list' multiple>\n";
	...
	echo "<tr ><td class='col-sm-3'>"._QXZ("To List")."</td><td align=left>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=move_to_list>\n";
	echo "<option value='-'>"._QXZ("Select A List")."</option>\n";
	...
	echo "</select></div></td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Status")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_move_status' id='enable_move_status' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><select class='form-control' size=1 name='move_status' id='move_status' disabled=true>\n";
	...
	echo "<tr ><td class='col-sm-3'>"._QXZ("Country Code")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace'  type='checkbox' name='enable_move_country_code' id='enable_move_country_code' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='move_country_code' id='move_country_code' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Vendor Lead Code")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace'  type='checkbox' name='enable_move_vendor_lead_code' id='enable_move_vendor_lead_code' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='move_vendor_lead_code' id='move_vendor_lead_code' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Source ID")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace'  type='checkbox' name='enable_move_source_id' id='enable_move_source_id' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='move_source_id' id='move_source_id' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Owner")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace'  type='checkbox' name='enable_move_owner' id='enable_move_owner' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='move_owner' id='move_owner' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("State")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace'  type='checkbox' name='enable_move_state' id='enable_move_state' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='move_state' id='move_state' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr><td class='col-sm-3'>"._QXZ("Entry Date")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_move_entry_date' id='enable_move_entry_date' value='enabled '><label class=\"lbl\"></label></div>\n";
	echo "<div class='col-lg-1 no-padding'><select class='form-control' size=1 name=move_entry_date_op id='move_entry_date_op' disabled=true>\n";
	...
	echo "</select></div>\n";
	echo "<div class='col-lg-2'><input class='form-control' type='text' name='move_entry_date' id='move_entry_date' value='' disabled=true length=20 maxlength=19> </div>"._QXZ("to")." <div class='col-lg-2'> <input class='form-control' type='text' name='move_entry_date_end' id='move_entry_date_end' value='' disabled=true length=20 maxlength=19></div> (YYYY-MM-DD) "._QXZ("or")." (YYYY-MM-DD HH:MM:SS)\n";
	echo "</td></tr>\n";
	echo "<tr ><td align=right>"._QXZ("Modify Date")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_move_modify_date' id='enable_move_modify_date' value='enabled'></div>\n";
	echo "<div class='col-lg-1 no-padding'><select class='form-control' size=1 name=move_modify_date_op id='move_modify_date_op' disabled=true>\n";
	echo "<option value='<'><</option>\n";
	echo "<option value='<='><=</option>\n";
	echo "<option value='>'>></option>\n";
	echo "<option value='>='>>=</option>\n";
	...
	echo "<option value='=' SELECTED>=</option>\n";
	echo "</select></div>\n";
	echo "<div class='col-lg-2'><input class='form-control' type='text' name='move_modify_date' id='move_modify_date' value='' disabled=true length=20 maxlength=19></div> "._QXZ("to")."<div class='col-lg-2'> <input class='form-control' type='text' name='move_modify_date_end' id='move_modify_date_end' value='' disabled=true length=20 maxlength=19></div> (YYYY-MM-DD) "._QXZ("or")." (YYYY-MM-DD HH:MM:SS)\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Security Phrase")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace'  type='checkbox' name='enable_move_security_phrase' id='enable_move_security_phrase' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='move_security_phrase' id='move_security_phrase' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Called Count")."</td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace'  type='checkbox' name='enable_move_count' id='enable_move_count' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-1 no-padding\"><select class='form-control' size=1 name=move_count_op id='move_count_op' disabled=true>\n";
	echo "<option value='<'><</option>\n";
	echo "<option value='<='><=</option>\n";
	echo "<option value='>'>></option>\n";
	echo "<option value='>='>>=</option>\n";
	echo "<option value='='>=</option>\n";
	echo "</select></div>";
	echo "<div class=\"col-lg-2\"><select class='form-control' size=1 name=move_count_num id='move_count_num' disabled=true>\n";
	$i=0;
	while ( $i <= $max_count )
		{
	...
	echo "</select></div></div></td></tr>\n";
	echo "<tr ><td colspan=2 align=center><p style='text-align:center;'><input class='btn btn-bdr-sucess' type=submit name=move_submit value='"._QXZ("move")."'></td></tr>\n";
	echo "</table></center>\n";
	# END lead move

	# BEGIN Status Update
		echo "<br /><center><table width=$section_width cellspacing=3>\n";
	echo "<tr ><td colspan=2 align=center><font color=black><b>"._QXZ("Update Lead Statuses")."</b></font></td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("List")."</td><td align=left>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=8 name=update_list[] id='update_list' multiple>\n";
	//echo "<option value='-'>"._QXZ("Select A List")."</option>\n";
	# echo "<option value='-'>"._QXZ("Select A List")."</option>\n";
	...
	echo "</select></div></td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("To Status")."</td><td align=left>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=update_to_status>\n";
	echo "<option value='-'>"._QXZ("Select A Status")."</option>\n";
	...
	echo "</select></div></td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("From Status")."</td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_from_status' id='enable_update_from_status' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><select class='form-control' size=1 name=update_from_status id='update_from_status' disabled=true>\n";
	echo "<option value='-'>"._QXZ("Select A Status")."</option>\n";
	...
	echo "</select></div></div></td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Country Code")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_country_code' id='enable_update_country_code' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='update_country_code' id='update_country_code' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Vendor Lead Code")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_vendor_lead_code' id='enable_update_vendor_lead_code' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='update_vendor_lead_code' id='update_vendor_lead_code' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Source ID")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_source_id' id='enable_update_source_id' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='update_source_id' id='update_source_id' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Owner")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_owner' id='enable_update_owner' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='update_owner' id='update_owner' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("State")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_state' id='enable_update_state' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='update_state' id='update_state' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr><td class='col-sm-3'>"._QXZ("Entry Date")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_entry_date' id='enable_update_entry_date' value='enabled'></div>\n";
	echo "<div class=\"col-lg-1 no-padding\"><select class='form-control' size=1 name=update_entry_date_op id='update_entry_date_op' disabled=true>\n";
	echo "<option value='<'><</option>\n";
	echo "<option value='<='><=</option>\n";
	echo "<option value='>'>></option>\n";
	echo "<option value='>='>>=</option>\n";
	...
	echo "<option value='=' SELECTED>=</option>\n";
	echo "</select></div>\n";
	echo "<div class='col-lg-2 '><input class='form-control' type='text' name='update_entry_date' id='update_entry_date' value='' disabled=true length=20 maxlength=19></div> "._QXZ("to")."<div class='col-lg-2 '> <input class='form-control' type='text' name='update_entry_date_end' id='update_entry_date_end' value='' disabled=true length=20 maxlength=19></div> (YYYY-MM-DD) "._QXZ("or")." (YYYY-MM-DD HH:MM:SS)\n";
	echo "</td></tr>\n";
	echo "<tr><td class='col-sm-3'>"._QXZ("Modify Date")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_modify_date' id='enable_update_modify_date' value='enabled'></div>\n";
	echo "<div class=\"col-lg-1 no-padding\"><select class='form-control' size=1 name=update_modify_date_op id='update_modify_date_op' disabled=true>\n";
	echo "<option value='<'><</option>\n";
	echo "<option value='<='><=</option>\n";
	echo "<option value='>'>></option>\n";
	echo "<option value='>='>>=</option>\n";
	...
	echo "<option value='=' SELECTED>=</option>\n";
	echo "</select></div>\n";
	echo "<div class='col-lg-2'><input class='form-control' type='text' name='update_modify_date' id='update_modify_date' value='' disabled=true length=20 maxlength=19></div> "._QXZ("to")." <div class='col-lg-2 '><input class='form-control' type='text' name='update_modify_date_end' id='update_modify_date_end' value='' disabled=true length=20 maxlength=19></div>(YYYY-MM-DD) "._QXZ("or")." (YYYY-MM-DD HH:MM:SS)\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Security Phrase")."</td></td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_security_phrase' id='enable_update_security_phrase' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='update_security_phrase' id='update_security_phrase' value='' disabled=true></div></div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Called Count")."</td><td align=left>\n";
	echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_update_count' id='enable_update_count' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-1 no-padding\"><select class='form-control' size=1 name='update_count_op' id='update_count_op' disabled=true>\n";
	echo "<option value='<'><</option>\n";
	echo "<option value='<='><=</option>\n";
	echo "<option value='>'>></option>\n";
	echo "<option value='>='>>=</option>\n";
	echo "<option value='='>=</option>\n";
	echo "</select></div>\n";
	echo "<div class=\"col-lg-2\"><select class='form-control' size=1 name='update_count_num' id='update_count_num' disabled=true>\n";
	$i=0;
	while ( $i <= $max_count )
		{
		echo "<option value='$i'>$i</option>\n";
		...
		echo "</select></div></div></td></tr>\n";
	echo "<tr ><td colspan=2 align=center><p style='text-align:center;'><input class='btn btn-bdr-sucess' type=submit name=update_submit value='"._QXZ("update")."'></td></tr>\n";
	# END Status Update
	...
	if ( $delete_lists > 0 )
		...
		# BEGIN Delete Leads
			echo "</table></center>\n";
		echo "<br /><center><table width=$section_width cellspacing=3>\n";
		echo "<tr ><td colspan=2 align=center><font color=black><b>"._QXZ("Delete Leads")."</b></font></td></tr>\n";
		echo "<tr ><td class='col-sm-3'>"._QXZ("List")."</td><td align=left>\n";
		echo "<div class=\"col-lg-5\"><select class='form-control' size=8 name=delete_list[] id='delete_list' multiple>\n";
		//echo "<option value='-'>"._QXZ("Select A List")."</option>\n";
		...
		echo "</select></div></td></tr>\n";
	echo "<tr ><td class='col-sm-3'>"._QXZ("Status")."</td><td align=left>\n";
		echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=delete_status>\n";
		echo "<option value='-'>"._QXZ("Select A Status")."</option>\n";
		...
		echo "</select></div></td></tr>\n";
		echo "<tr ><td class='col-sm-3'>"._QXZ("Country Code")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_country_code' id='enable_delete_country_code' value='enabled'><label class=\"lbl\"></label></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='delete_country_code' id='delete_country_code' value='' disabled=true></div></div>\n";
		echo "</td></tr>\n";
			echo "<tr ><td class='col-sm-3'>"._QXZ("Vendor Lead Code")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_vendor_lead_code' id='enable_delete_vendor_lead_code' value='enabled'><label class=\"lbl\"></label></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='delete_vendor_lead_code' id='delete_vendor_lead_code' value='' disabled=true></div></div>\n";
		echo "</td></tr>\n";
		echo "<tr ><td class='col-sm-3'>"._QXZ("Source ID")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_source_id' id='enable_delete_source_id' value='enabled'><label class=\"lbl\"></label></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='delete_source_id' id='delete_source_id' value='' disabled=true></div></div>\n";
		echo "</td></tr>\n";
			echo "<tr ><td class='col-sm-3'>"._QXZ("Owner")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_owner' id='enable_delete_owner' value='enabled'><label class=\"lbl\"></label></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='delete_owner' id='delete_owner' value='' disabled=true></div></div>\n";
		echo "</td></tr>\n";
		echo "<tr ><td class='col-sm-3'>"._QXZ("State")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_state' id='enable_delete_state' value='enabled'><label class=\"lbl\"></label></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='delete_state' id='delete_state' value='' disabled=true></div></div>\n";
		echo "</td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Entry Date")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_entry_date' id='enable_delete_entry_date' value='enabled'></div>\n";
		echo "<div class=\"col-lg-1 no-padding\"><select class='form-control' size=1 name=delete_entry_date_op id='delete_entry_date_op' disabled=true>\n";
		echo "<option value='<'><</option>\n";
		echo "<option value='<='><=</option>\n";
		echo "<option value='>'>></option>\n";
		echo "<option value='>='>>=</option>\n";
		...
		echo "<option value='=' SELECTED>=</option>\n";
		echo "</select></div>\n";
		echo "<div class='col-lg-2 '><input class='form-control' type='text' name='delete_entry_date' id='delete_entry_date' value='' disabled=true length=20 maxlength=19></div> "._QXZ("to")."<div class='col-lg-2 '> <input class='form-control' type='text' name='delete_entry_date_end' id='delete_entry_date_end' value='' disabled=true length=20 maxlength=19></div>(YYYY-MM-DD) "._QXZ("or")." (YYYY-MM-DD HH:MM:SS)\n";
		echo "</td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Modify Date")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_modify_date' id='enable_delete_modify_date' value='enabled'></div>\n";
		echo "<div class=\"col-lg-1 no-padding\"><select  class='form-control' size=1 name=delete_modify_date_op id='delete_modify_date_op' disabled=true>\n";
		echo "<option value='<'><</option>\n";
		echo "<option value='<='><=</option>\n";
		echo "<option value='>'>></option>\n";
		echo "<option value='>='>>=</option>\n";
		...
		echo "<option value='=' SELECTED>=</option>\n";
		echo "</select></div>\n";
		echo "<div class='col-lg-2 '><input class='form-control' type='text' name='delete_modify_date' id='delete_modify_date' value='' disabled=true length=20 maxlength=19></div> "._QXZ("to")."<div class='col-lg-2 '> <input class='form-control' type='text' name='delete_modify_date_end' id='delete_modify_date_end' value='' disabled=true length=20 maxlength=19></div>(YYYY-MM-DD) "._QXZ("or")." (YYYY-MM-DD HH:MM:SS)\n";
		echo "</td></tr>\n";
		echo "<tr ><td class='col-sm-3'>"._QXZ("Security Phrase")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_security_phrase' id='enable_delete_security_phrase' value='enabled'><label class=\"lbl\"></label></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='delete_security_phrase' id='delete_security_phrase' value='' disabled=true></div></div>\n";
		echo "</td></tr>\n";
			echo "<tr ><td class='col-sm-3'>"._QXZ("Lead ID")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_lead_id' id='enable_delete_lead_id' value='enabled'><label class=\"lbl\"></label></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='delete_lead_id' id='delete_lead_id' value='' disabled=true></div></div>\n";
		echo "</td></tr>\n";
		echo "<tr ><td class='col-sm-3'>"._QXZ("Called Count")."</td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_delete_count' id='enable_delete_count' value='enabled'><label class=\"lbl\"></label></div>\n";
		echo "<div class=\"col-lg-1 no-padding\"><select class='form-control' size=1 name='delete_count_op' id='delete_count_op' disabled=true></div></div>\n";
		echo "<option value='<'><</option>\n";
		echo "<option value='<='><=</option>\n";
		echo "<option value='>'>></option>\n";
		echo "<option value='>='>>=</option>\n";
		...
		echo "</select></div>\n";
		echo "<input type=hidden name=DB value='$DB'>\n";
		echo "<div class=\"col-lg-2\"><select class='form-control' size=1 name='delete_count_num' id='delete_count_num' disabled=true>\n";
		$i=0;
		while ( $i <= $max_count )
			{
			echo "<option value='$i'>$i</option>\n";
		...
		echo "</select></div></div></td></tr>\n";
		echo "<tr ><td colspan=2 align=center><p style='text-align:center;'><input class='btn btn-bdr-sucess' type=submit name=delete_submit value='"._QXZ("delete")."'></td></tr>\n";
		# END Delete Leads
		}
		...
		echo "</table></center>\n";
		echo "<br /><center><table width=$section_width cellspacing=3>\n";
		echo "<tr><td colspan=2 align=center><font color=black><b>"._QXZ("Reset Leads Called Count to Zero")."</b></font></td></tr>\n";
		echo "<tr><td align=right>"._QXZ("List")."</td><td align=left>\n";
		echo "<div class=\"col-lg-5\"><select size=8 class='form-control' name=reset_called_count_list[] id='reset_called_count_list' multiple>\n";
		# echo "<option value='-'>"._QXZ("Select A List")."</option>\n";
		...
		echo "</select></div></td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Status")."</td><td align=left>\n";
		echo "<div class=\"col-lg-5\"><select class='form-control' size=8 name=reset_called_count_status[] id='reset_called_count_status' multiple>\n";
		#echo "<option value='-'>"._QXZ("Select A Status")."</option>\n";
...
//~ echo "<tr ><td class='col-sm-3'>"._QXZ("Country Code")."</td></td><td align=left>\n";
		...
		#echo "<option value='---ALL---'>"._QXZ("-- ALL STATUSES --")."</option>\n";
		echo "</select></div></td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Country Code")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input type='checkbox' name='enable_reset_called_count_country_code' id='enable_reset_called_count_country_code' value='enabled'></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input type='text'  class='form-control' name='reset_called_count_country_code' id='reset_called_count_country_code' value='' disabled=true>\n";
		echo "</td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Vendor Lead Code")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input type='checkbox' name='enable_reset_called_count_vendor_lead_code' id='enable_reset_called_count_vendor_lead_code' value='enabled'></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input type='text' class='form-control'  name='reset_called_count_vendor_lead_code' id='reset_called_count_vendor_lead_code' value='' disabled=true>\n";
		echo "</td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Source ID")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input type='checkbox' name='enable_reset_called_count_source_id' id='enable_reset_called_count_source_id' value='enabled'></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input type='text' class='form-control'  name='reset_called_count_source_id' id='reset_called_count_source_id' value='' disabled=true>\n";
		echo "</td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Owner")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input type='checkbox' name='enable_reset_called_count_owner' id='enable_reset_called_count_owner' value='enabled'></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input type='text'  class='form-control' name='reset_called_count_owner' id='reset_called_count_owner' value='' disabled=true>\n";
		echo "</td></tr>\n";
		echo "<tr><td align=right>"._QXZ("State")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input type='checkbox' name='enable_reset_called_count_state' id='enable_reset_called_count_state' value='enabled'></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input type='text'  class='form-control' name='reset_called_count_state' id='reset_called_count_state' value='' disabled=true>\n";
		echo "</td></tr>\n";
		
		
		
		echo "<tr ><td align=right>"._QXZ("Entry Date")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_reset_called_count_entry_date' id='enable_reset_called_count_entry_date' value='enabled'></div>\n";
		echo "<div class=\"col-lg-1 no-padding\"><select class='form-control' size=1 name=reset_called_count_entry_date_op id='reset_called_count_entry_date_op' disabled=true>\n";
		echo "<option value='<'><</option>\n";
		echo "<option value='<='><=</option>\n";
		echo "<option value='>'>></option>\n";
		echo "<option value='>='>>=</option>\n";
		...
		echo "<option value='=' SELECTED>=</option>\n";
		echo "</select></div>\n";
		echo "<div class='col-lg-2 '><input class='form-control' type='text' name='reset_called_count_entry_date' id='reset_called_count_entry_date' value='' disabled=true length=20 maxlength=19></div> "._QXZ("to")."<div class='col-lg-2 '> <input class='form-control' type='text' name='reset_called_count_entry_date_end' id='reset_called_count_entry_date_end' value='' disabled=true length=20 maxlength=19></div>(YYYY-MM-DD) "._QXZ("or")." (YYYY-MM-DD HH:MM:SS)\n";
		echo "</td></tr>\n";
		
		
		echo "<tr><td align=right>"._QXZ("Modify Date")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_reset_called_count_modify_date' id='enable_reset_called_count_modify_date' value='enabled'></div>\n";
		echo "<div class=\"col-lg-1 no-padding\"><select  class='form-control' size=1 name=reset_called_count_modify_date_op id='reset_called_count_modify_date_op' disabled=true>\n";
		echo "<option value='<'><</option>\n";
		echo "<option value='<='><=</option>\n";
		echo "<option value='>'>></option>\n";
		echo "<option value='>='>>=</option>\n";
		...
		echo "<option value='=' SELECTED>=</option>\n";
		echo "</select></div>\n";
		echo "<div class='col-lg-2 '><input class='form-control' type='text' name='reset_called_count_modify_date' id='reset_called_count_modify_date' value='' disabled=true length=20 maxlength=19></div> "._QXZ("to")."<div class='col-lg-2 '> <input class='form-control' type='text' name='reset_called_count_modify_date_end' id='reset_called_count_modify_date_end' value='' disabled=true length=20 maxlength=19></div>(YYYY-MM-DD) "._QXZ("or")." (YYYY-MM-DD HH:MM:SS)\n";
		echo "</td></tr>\n";
		
		echo "<tr><td align=right>"._QXZ("Security Phrase")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input type='checkbox' name='enable_reset_called_count_security_phrase' id='enable_reset_called_count_security_phrase' value='enabled'></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input  class='form-control' type='text' name='reset_called_count_security_phrase' id='reset_called_count_security_phrase' value='' disabled=true>\n";
		echo "</td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Lead ID")."</td></td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input type='checkbox' name='enable_reset_called_count_lead_id' id='enable_reset_called_count_lead_id' value='enabled'></div>\n";
		echo "<div class=\"col-lg-3 no-padding\"><input type='text'  class='form-control' name='reset_called_count_lead_id' id='reset_called_count_lead_id' value='' disabled=true>\n";
		echo "</td></tr>\n";
		
		
		
		echo "<tr ><td class='col-sm-3'>"._QXZ("Called Count")."</td><td align=left>\n";
		echo "<div class='col-lg-12'><div class='col-lg-1 no-padding'><input class='ace' type='checkbox' name='enable_reset_called_count_count' id='enable_reset_called_count_count' value='enabled'><label class=\"lbl\"></label></div>\n";
		echo "<div class=\"col-lg-1 no-padding\"><select class='form-control' size=1 name='reset_called_count_count_op' id='reset_called_count_count_op' disabled=true></div></div>\n";
		echo "<option value='<'><</option>\n";
		echo "<option value='<='><=</option>\n";
		echo "<option value='>'>></option>\n";
		echo "<option value='>='>>=</option>\n";
		...
		echo "</select></div>\n";
		echo "<input type=hidden name=DB value='$DB'>\n";
		echo "<div class=\"col-lg-2\"><select class='form-control' size=1 name='reset_called_count_count_num' id='reset_called_count_count_num' disabled=true>\n";
		$i=0;
		while ( $i <= $max_count )
			{
			echo "<option value='$i'>$i</option>\n";
		...
		echo "<tr ><td colspan=2 align=center><p style='text-align:center;'><input class='btn btn-bdr-sucess' type=submit name=reset_called_count_submit value='"._QXZ("reset called count")."'></td></tr>\n";
...
echo "</table></center>\n";
	echo "<br /><center><table width=$section_width cellspacing=3>\n";
	echo "<tr ><td colspan=2 align=center><font color=black><b>"._QXZ("Switch Callbacks")."</b></font></td></tr>\n";
	echo "<tr ><td class='col-sm-3'  >"._QXZ("List")."</td><td align=left>\n";
	echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=callback_list>\n";
	echo "<option value='-'>"._QXZ("Select A List")."</option>\n";
	# echo "<option value='-'>"._QXZ("Select A List")."</option>\n";
...
echo "</select></div></td></tr>\n";
	echo "<tr ><td class='col-sm-3' >"._QXZ("Entry Date")."</td></td><td align=left>\n";
	echo "<div class='col-lg-1'><input class='ace' type='checkbox' name='enable_callback_entry_date' id='enable_callback_entry_date' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='callback_entry_start_date' id='callback_entry_start_date' value='' disabled=true><label class=\"lbl\"></label> </div><div class='col-lg-1'>"._QXZ("to")." ";
	echo "</div><div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='callback_entry_end_date' id='callback_entry_end_date' value='' disabled=true> </div><div>(YYYY-MM-DD)</div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td class='col-sm-3' >"._QXZ("Callback Date")."</td></td><td align=left>\n";
	echo "<div class='col-lg-1'><input class='ace' type='checkbox' name='enable_callback_callback_date' id='enable_callback_callback_date' value='enabled'><label class=\"lbl\"></label></div>\n";
	echo "<div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='callback_callback_start_date' id='callback_callback_start_date' value='' disabled=true><label class=\"lbl\"></label></div><div class='col-lg-1'> "._QXZ("to")." ";
	echo "</div><div class=\"col-lg-3 no-padding\"><input class='form-control' type='text' name='callback_callback_end_date' id='callback_callback_end_date' value='' disabled=true> </div><div>(YYYY-MM-DD)</div>\n";
	echo "</td></tr>\n";
	echo "<tr ><td colspan=2 align=center><p style='text-align:center;'><input class='btn btn-bdr-sucess' type=submit name=callback_submit value='"._QXZ("switch callbacks")."'></td></tr>\n";
