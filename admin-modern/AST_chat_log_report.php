...
$HTML_text.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class=pull-left> '._QXZ("$report_name")."</h3><div class=pull-right> <a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a></div></div>
		<div class='col-md-12'><div class='content'>";
$HTML_text.="<TABLE CELLPADDING=3 CELLSPACING=0  class='no-border'><TR><TD class='no-border'>";
...
$HTML_text.="<div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\">";
$HTML_text.="<label>"._QXZ("Dates")."</label></div></div>";

$HTML_text.="<div class='col-md-2' style='padding-left: 14px;padding-top: 5px;'>";
$HTML_text.="<script language=\"JavaScript\">\n";
...
$HTML_text.="<div align='center'><BR> "._QXZ("to")."</div><BR><div class='col-md-10'><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div></div>";

$HTML_text.="<div class='col-md-2' style='top:5px;padding-left: 14px;'>";
$HTML_text.="<script language=\"JavaScript\">\n";
$HTML_text.="var o_cal = new tcal ({\n";
$HTML_text.="	// form name\n";
$HTML_text.="	'formname': 'vicidial_report',\n";
...
//~ $HTML_text.=""._QXZ("Campaigns").":<BR>";
$HTML_text.="<div class='col-md-10'><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
$HTML_text.="<div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=inbound_group[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Inbound Groups")."</label></div>\n";
//~ $HTML_text.="</TD>";

//~ $HTML_text.=""._QXZ("User Groups").":<BR>";
$HTML_text.="<br><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=user_group[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("User Groups")."</label></div>\n";
$HTML_text.="</TD><TD VALIGN=TOP>";
$HTML_text.="<div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=users[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Users")."</label></div>\n";

//~ $HTML_text.=_QXZ("Chat type").": <BR>";
$HTML_text.="<br><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' NAME='chat_log_type'>\n";
if ($chat_log_type) {
...
$HTML_text.="</SELECT><label>"._QXZ("Chat type")."</label></div><BR><BR>";
$HTML_text.="</TD>\n";
$HTML_text.="<TD VALIGN=TOP>";
//~ $HTML_text.=_QXZ("Chat text").":<BR>";
$HTML_text.="<div class=\"form-group custom-input mb-10\"><textarea class='form-control' name='text_search' rows='3' cols='20'>$text_search</textarea><label>"._QXZ("Chat text")."</label></div>";
//~ $HTML_text.=_QXZ("Display as").":<BR>";
$HTML_text.="<br><div class=\"form-group custom-input mb-10\"><select class='form-control' name='report_display_type'>";
if ($report_display_type) {$HTML_text.="<option value='$report_display_type' selected>"._QXZ("$report_display_type")."</option>";}
$HTML_text.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>"._QXZ("Display as")."</label></div><BR><BR>\n";
$HTML_text.="</td><tr><td colspan=4 class=text-center><INPUT TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'>$NWB#agent_performance_detail$NWE\n";
$HTML_text.="</td></tr></TD>";
$HTML_text.="</TD></TR></TABLE>";

$HTML_text.="</FORM></table>\n\n";
