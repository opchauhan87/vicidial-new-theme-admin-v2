...
# 220812-0936 - Added User Group report permissions checking
#
...
if ($stage == 'detail')
	...
	echo "\n<br>"._QXZ("Older Shared Agent Campaign Log Entries").":     $row[0]\n\n";
...
require("admin_header.php");
	...
	echo "<div class='container-fluid' id='pcont4' style='right:8px;'><TABLE CELLPADDING=4 CELLSPACING=4 WIDTH=100%><TR><TD class=text-left COLSPAN=2 border=1>";
	echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET ID='vicidial_report' NAME='vicidial_report'>\n";
	echo "<INPUT style='width: 30%; display: inline;' TYPE=TEXT class='form-control' NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\">";
	...
	echo "</FORM>\n\n";
	echo "</TD></TR>\n\n";
	echo "<TR><TD class=col-md-3 ALIGN=LEFT VALIGN=TOP>\n";

	echo "<div class='col-lg-9 text-left'><FONT SIZE=2>\n\n";
	...
	if (!$query_date)
		...
		echo "\n<br><br>";
		echo "<a class='btn btn-info' href=\"$PHP_SELF?stage=detail&query_date_T=$NOW_TIME\" target=\"detail\">BUFFER ENTRIES</a>\n";
	...
	<iframe src="<?php echo $PHP_SELF ?>?stage=empty" style="width:100%;height:auto;background-color:transparent;z-index:10;" scrolling="auto" frameborder="1" allowtransparency="true" id="detail" name="detail" width="1000px" height="1000px" onload="window.parent.parent.scrollTo(0,0)"> </iframe>
	</TD></TR></TABLE></div></HEAD>
