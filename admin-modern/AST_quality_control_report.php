...
//~ $HTML_text.="<TABLE class='Quality_Control block-flat' CELLPADDING=3 CELLSPACING=0><TR><TD>";

//~ $HTML_text.="<div class='header' style='width:auto !important;'><h3>"._QXZ("$report_name").$NWB."quality_control_report".$NWE."</h3> </div>";
$HTML_text.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name").'</h3><div class="pull-right"><a class="btn btn-info" href="./admin.php?ADD=3311&did_id=$group[0]">'._QXZ("MODIFY").'</a></div><div class="col-md-12"><div class="content">';
		
$HTML_text.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$HTML_text.="<TABLE CELLSPACING=5 border='0' BGCOLOR=\"#".$SSframe_background."\"><TR><TD class='text-left' VALIGN=TOP nowrap> ";
$HTML_text.="<div class=\"d-flex date1 no-padding\"><INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
$HTML_text.="<div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><INPUT TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 class='form-control' VALUE=\"$query_date\"><label>"._QXZ("Call dates")."</label></div></div>";
...
$HTML_text.="<INPUT class='form-control' TYPE=TEXT NAME=query_time SIZE=10 MAXLENGTH=10 VALUE=\"$query_time\"></div>";

$HTML_text.="<div class='text-center'><label> "._QXZ("to")." </label></div><div class=\"d-flex date1 no-padding\"><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\">";
...
$HTML_text.=" &nbsp;<INPUT TYPE=TEXT class='form-control' NAME=end_time SIZE=10 MAXLENGTH=10 VALUE=\"$end_time\"><div>";
$HTML_text.="</TD>";

$HTML_text.="<TD VALIGN=TOP>";
$HTML_text.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
$HTML_text.="</SELECT><label>"._QXZ("Campaigns").":</label>\n";
$HTML_text.="</TD>";
...
$HTML_text.="</SELECT><label>"._QXZ("Users").":</label>\n";
$HTML_text.="</TD>";
...
$HTML_text.="<TR><TD VALIGN=TOP>";
$HTML_text.="<div class=\"d-flex date1 no-padding\"><div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><INPUT TYPE=TEXT NAME='qc_finish_start_date' class='form-control' SIZE=10 MAXLENGTH=10 VALUE=\"$qc_finish_start_date\"><label>"._QXZ("Finish date")."</label></div></div>";
...
$HTML_text.=" &nbsp;<INPUT class='form-control' TYPE=TEXT NAME='qc_finish_start_time' SIZE=10 MAXLENGTH=10 VALUE=\"$qc_finish_start_time\"></div>";

$HTML_text.="<div class='text-center'><label> "._QXZ("to")." </label></div><div class=\"d-flex date1 no-padding\"><INPUT class='form-control' TYPE=TEXT NAME='qc_finish_end_date' SIZE=10 MAXLENGTH=10 VALUE=\"$qc_finish_end_date\">";
...
$HTML_text.=" &nbsp;<INPUT class='form-control' TYPE=TEXT NAME='qc_finish_end_time' SIZE=10 MAXLENGTH=10 VALUE=\"$qc_finish_end_time\"></div>";
$HTML_text.="</TD>";

$HTML_text.="<TD VALIGN=TOP>";
$HTML_text.="<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=QCstatuses[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("QC Status").":</label>\n";
$HTML_text.="</TD>\n";
...
$HTML_text.="<TD VALIGN=TOP>";
$HTML_text.="<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=QCusers[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("QC Users").":</label>\n";
$HTML_text.="</TD>";
