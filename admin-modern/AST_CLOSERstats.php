...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")." $NWB#CLOSERstats$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=3111&group_id=$group[0]\">"._QXZ("MODIFY")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./AST_CLOSERstats_v2.php?group[]=$group[0]\">"._QXZ("v2")."</a></div><div class='pull-right'>";
		if ($DID!='Y')
	{
...
$MAIN.="</SELECT><label>"._QXZ("Shift")."</label></div></div></div>\n";
$MAIN.="<BR>&nbsp; ";
...
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></div></select><label>"._QXZ("Display as")."</label></div></div>\n<BR>";
