	...
	if (strlen($new_list_id) > 1)
		...
		if ( (strlen($orig_URL)> 10) and ($button_action == 'SubmitRefresh') )
			...
			if ($clear_form == 'ACKNOWLEDGE')
				{
				echo  "<p style='font-size:20px;'>"._QXZ("Custom Form Data Submitted")."</p>\n<BR>\n";
				}
...
if ($SUBMIT_only < 1)
	...
	echo "<link href=\"css/style_new_theme.css\" rel=\"stylesheet\">";
	
	echo "<link href='https://fonts.googleapis.com/css?family=Raleway:300,200,100' rel='style sheet' type='text/css'>";
	...
	echo "<link rel=\stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.9.0/css/bootstrap-datepicker3.min.css\">";
	...
	echo "	<link rel=\"stylesheet\" href=\"./css/callcenter_stylesheet.css\">\n";
