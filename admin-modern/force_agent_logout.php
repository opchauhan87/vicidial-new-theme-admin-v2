...
if (strlen($logout_agent) < 1)
	...
	echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET class='col-md-12' style=\"margin-top: 15px;\">\n";
	echo "<div class='col-lg-2'>"._QXZ("Logout Agent").": </div><div class='col-lg-4'><SELECT SIZE=1 NAME=logout_agent class='form-control'>\n";
	echo "$owner_menu";
	echo "</SELECT></div>\n";
	echo "<div class='col-lg-2'><INPUT TYPE=SUBMIT NAME=SUBMIT  class='btn btn-bdr-sucess' VALUE='"._QXZ("SUBMIT")."'></div>\n";
	echo "</FORM>\n\n";
	echo "<div class='col-lg-12' style=\"margin-bottom: 15px;\">";
	echo "<PRE class='no-margin'><FONT SIZE=2>\n\n";
