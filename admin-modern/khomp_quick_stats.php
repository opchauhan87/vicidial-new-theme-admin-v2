...
echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("$report_name").$NWB."khomp_quick_stats".$NWE.'</h3></div><div class="col-md-12"><div class="content">';
...
echo "<FORM ID='vicidial_report' NAME='vicidial_report' ACTION=\"$PHP_SELF\" METHOD=GET>\n";
...
echo "</SELECT></div></div>\n";
echo "<INPUT style='position: relative;top: 10px;' TYPE=SUBMIT class='btn btn-bdr-sucess' NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
echo "</FORM>\n\n";

echo "<PRE style='margin: 0 0px 10px !important;'><FONT>\n\n";
