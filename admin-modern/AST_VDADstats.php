...
$HEADER.="<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 836px; top: 188px; opacity: 1; z-index: 2;'></div>";
...
$list_options="<select class='form-control' name='list_ids[]' id='list_ids' multiple size=5>\n";
...
$MAIN.="<div class='header'><h3 class=\"pull-left\">"._QXZ("$report_name")."</h3> $NWB#VDADstats$NWE<div class='pull-right'>";
...
$MAIN.="<a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div></div>\n";


$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";

$MAIN.="<TABLE CELLPADDING=3 CELLSPACING=0 ><TR><TD class='col-md-4' VALIGN=TOP>";
...
$MAIN.="<div class='col-lg-10 no-padding'>";
...
$MAIN.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><select class='form-control' name='report_display_type'>";
if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>"._QXZ("$report_display_type")."</option>";}
$MAIN.="<option value='TEXT'>TEXT</option><option value='HTML'>HTML</option></select><label>"._QXZ("Display as").":</label></div></div><BR>\n";
$MAIN.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=shift>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Shift").":</label> </div></div>\n";

$MAIN.="</TD><TD class='col-md-4' VALIGN=TOP> ";
$MAIN.="<div class='form-group custom-input mb-10'><SELECT class='form-control' multiple SIZE=5 NAME=group[] id='group' $JS_events>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
$MAIN.="</SELECT><label>Campaigns</label><BR>";
$MAIN.="<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=include_rollover>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Campaigns(Include Drop Rollover)").":</label>\n";
$MAIN.="</div><BR>\n";
$MAIN.="<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=bottom_graph>\n";
$MAIN.="<option selected value=\"$bottom_graph\">"._QXZ("$bottom_graph")."</option>\n";
$MAIN.="<option value=\"YES\">"._QXZ("YES")."</option>\n";
$MAIN.="<option value=\"NO\">"._QXZ("NO")."</option>\n";
$MAIN.="<div class='form-group custom-input mb-10'></SELECT><label>"._QXZ("Bottom Graph").": &nbsp; </label></div>\n";

$MAIN.="</TD><TD class='col-md-4' VALIGN=TOP><div class='form-group custom-input mb-10'>";

$MAIN.=$list_options."<label>"._QXZ("Lists").": </label>";
if ($carrier_logging_active > 0)
	{
	$MAIN.=" &nbsp; <BR>";
	$MAIN.="<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=carrier_stats>\n";
	$MAIN.="<option selected value=\"$carrier_stats\">"._QXZ("$carrier_stats")."</option>\n";
	$MAIN.="<option value=\"YES\">"._QXZ("YES")."</option>\n";
	$MAIN.="<option value=\"NO\">"._QXZ("NO")."</option>\n";
	$MAIN.="</SELECT><label>"._QXZ("Carrier Stats").": </label></div></div>\n";
	}
if ($archives_available=="Y") 
	{
	$MAIN.="<BR><input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label>\n";
	}	
...
$MAIN.="</TR><TR><TD colspan='3'>";
$MAIN.="<div class='col-md-12 text-center'>";
$MAIN.="<INPUT class='btn btn-success'  type=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>";
$MAIN.="<a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?agent_hours=$agent_hours&outbound_rate=$outbound_rate&costformat=$costformat&print_calls=$print_calls&query_date=$query_date&end_date=$end_date$groupQS$list_idQS&include_rollover=$include_rollover&bottom_graph=$bottom_graph&carrier_stats=$carrier_stats&report_display_type=$report_display_type&shift=$shift&SUBMIT=$SUBMIT&file_download=1&search_archived_data=$search_archived_data\">"._QXZ("DOWNLOAD")."</a> ";
$MAIN.="</div>";
$MAIN.="</TD></TR></TABLE>";
$MAIN.="</FORM>\n\n";
