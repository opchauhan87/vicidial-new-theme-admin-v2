...
<TABLE class='no-border' WIDTH=<?php echo $page_width ?> cellpadding=2 cellspacing=0>
<TR></TR>
<!--<TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" SIZE=2>-->
<div class="header">
	<h3><?php echo _QXZ("Audio Store"); ?></h3>
</div>
<!--</TD>-->
<TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; </TD></TR>

<?php 

echo "<TR><TD ALIGN=LEFT COLSPAN=2 style='border-top:none;'><FONT FACE=\"ARIAL,HELVETICA\"  SIZE=3><B> &nbsp; \n";
...
<table align=center width="700" border=0 cellpadding=5 cellspacing=0 bgcolor=#D9E6FE>
  <tr>
	...
	<td align=left width="65%"><div class='col-lg-5'><input class='form-control' type=file name="audiofile" value=""></div><div class='col-lg-1'><?php echo "$NWB#audio_store$NWE"; ?></div></td></div></td>
  </tr>
  <tr>
	<td class=text-center colspan=2><input class='btn btn-bdr-sucess' type=submit name=submit value='<?php echo _QXZ("submit"); ?>'></td>
  </tr>
...
<BR><BR><font><?php echo _QXZ("All spaces will be stripped from uploaded audio file names"); ?></font><BR><BR>
<B><a href="javascript:launch_chooser('delete_file','date',30);"><?php echo _QXZ("audio file list"); ?></a></CENTER>

<?php

echo "<center style='color:black;'><BR><BR>"._QXZ("File to Copy").":<BR><BR>\n";
echo "<form action=$PHP_SELF method=post>\n";
echo "<input type=hidden name=action value=\"COPYFILE\">\n";
echo "<input type=hidden name=DB value=\"$DB\">\n";
echo "<input type=hidden name=force_allow value=\"$force_allow\">\n";
echo _QXZ("Original file").": <input type=text class='form-control' style='width:40% !important;' size=50 maxlength=50 name=master_audiofile id=master_audiofile value=\"\"><BR>\n";
echo _QXZ("New file").": <input type=text class='form-control' style='width:40% !important;' size=50 maxlength=100 name=new_audiofile id=new_audiofile value=\"\"><BR>\n";
echo "<input type=hidden name=DB value=\"$DB\">\n";
echo "<input type=submit class='btn btn-bdr-sucess' name=submit value='"._QXZ("submit")."'></form>\n";
?>
...
if ($auth_delete > 0)
	...
	echo "<div class='col-lg-3'></div><div class='col-lg-5'><input class='form-control' type=text size=50 maxlength=100 name=delete_file id=delete_file value=\"\"></div>";
	echo "<input type=hidden name=DB value=\"$DB\">\n";
	echo "<div class='col-lg-2' style='text-align:left;'><input class='btn btn-bdr-sucess' type=submit name=submit value='"._QXZ("submit")."'></div>\n";
	}
else
	{
	echo "<BR>\n";
...
echo "</B></B><br><br><a class='btn btn-primary btn-sm' href=\"admin.php?ADD=720000000000000&category=AUDIOSTORE&stage=manualupload\">"._QXZ("Click here to see a log of the uploads to the audio store")."</a>\n";
