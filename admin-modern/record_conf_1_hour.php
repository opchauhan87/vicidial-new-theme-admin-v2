...
echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("RECORD CONFERENCE: 1 hour").'</h3> </div>
...
if ($NEW_RECORDING)
	...
	{
	echo "<b>Start recording a conference for 1 hour</b>:<div class='col-md-12'></div><form action=$PHP_SELF method=POST>\n";
	echo "<input type=hidden name=NEW_RECORDING value=1>\n";
	echo "<input type=hidden name=DB value='$DB'>\n";
	echo "<div class='col-md-12'><div class='col-md-2'><b>server_ip</b>:</div><div class='col-md-3'> <input class='form-control' type=text name=server_ip size=15 maxlength=15></div></div></br></br>\n";
	echo "<div class='col-md-12'><div class='col-md-2'><b>session_id</b>: </div><div class='col-md-3'> <input class='form-control' type=text name=session_id size=7 maxlength=7></div></div></br></br>\n";
	echo "<div class='col-md-12'><div class='col-md-2'><b>station</b>: </div><div class='col-md-3'> <input class='form-control' type=text name=station size=5 maxlength=5> </div></div></br></br>\n";
	echo "<center><input class='btn btn-bdr-sucess' type=submit name=submit value='"._QXZ("Submit")."'></center>\n";
