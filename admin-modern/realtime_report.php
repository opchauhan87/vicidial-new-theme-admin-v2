...
<!--<script>
	//alert('hi');
	//jQuery('tr:firstchild > td > form > table').parent().parent().parent().css("background-color","#fff");
	$( document ).ready(function() {
   alert("hello");
	$('tr:firstchild > td > form > table').parent().parent().parent().css("background-color","#fff");});
	</script>-->
<?php 
...
$select_list = "<TABLE class='centerline hover' WIDTH=700 CELLPADDING=5><TR><TD VALIGN=TOP><div class='text-left'><b>"._QXZ("Select Campaigns").": </b></div><BR>";
$select_list .= "<div class='col-lg-10'><SELECT class='form-control' SIZE=8 NAME=groups[] ID=groups[] multiple>";
$o=0;
...
$select_list .= "<BR><BR><BR><BR><BR><BR><BR><BR><BR><BR>&nbsp;&nbsp;<div class='text-left'>("._QXZ("To select more than 1 campaign, hold down the Ctrl key and click").")</div>";

$select_list .= "<BR><BR><div class='text-left'><b>"._QXZ("Select User Groups").": </b></div><BR>";
$select_list .= "<div class='col-lg-10'><SELECT class='form-control' SIZE=8 NAME=user_group_filter[] ID=user_group_filter[] multiple>";
$o=0;
...
//ishwari
//10-jan-20
$select_list .= "<BR><BR><BR><BR><BR><BR><BR><BR><BR><BR>&nbsp;&nbsp;<BR><BR><div class='text-left'><b>"._QXZ("Select In-Groups").": </b></div><BR>";
$select_list .= "<div class='col-lg-10'><SELECT class='form-control' SIZE=8 NAME=ingroup_filter[] ID=ingroup_filter[] multiple>";
$o=0;
...
$select_list .= "<b><a href='#' onclick=\\\"hideDiv('campaign_select_list');\\\">"._QXZ("Close Panel")."</a></b><BR><BR>";
$select_list .= "<TABLE CELLPADDING=2 CELLSPACING=2 BORDER=0>";

$select_list .= "<TR><TD width='40%'>";
$select_list .= _QXZ("Screen Refresh Rate").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control' SIZE=1 NAME=RR ID=RR>";
...
$select_list .= "</SELECT></div></TD></TR>";

$select_list .= "<TR><TD width='40%'>";
$select_list .= _QXZ("Inbound").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control'  SIZE=1 NAME=with_inbound ID=with_inbound>";
...
$select_list .= "<TR><TD width='40%'>";
$select_list .= _QXZ("Monitor").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control'  SIZE=1 NAME=monitor_active ID=monitor_active>";
...
$select_list .= "<div class='col-lg-8'><INPUT class='form-control'  type=text size=10 maxlength=20 NAME=monitor_phone ID=monitor_phone VALUE='$monitor_phone'>";
$select_list .= "</div></TD></TR>";
...
if ($UGdisplay > 0)
	...
	$select_list .= "<div class='col-lg-8'><SELECT class='form-control'  SIZE=1 NAME=usergroup ID=usergroup>";
...
$select_list .= "<TR><TD width='40%'>";
$select_list .= _QXZ("Dialable Leads Alert").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control'  SIZE=1 NAME=NOLEADSalert ID=NOLEADSalert>";
$select_list .= "<option value=''";
...
$select_list .= "<TR><TD width='40%'>";
$select_list .= _QXZ("Show Drop In-Group Row").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control'  SIZE=1 NAME=DROPINGROUPstats ID=DROPINGROUPstats>";
...
$select_list .= _QXZ("Inbound SLA Stats").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control' SIZE=1 NAME=SLAinSTATS ID=SLAinSTATS>";
$select_list .= "<option value='0'";
...
$select_list .= "<TR><TD align=right>";
//end
$select_list .= _QXZ("Show Cust. Phone Code").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control' SIZE=1 NAME=ShowCustPhoneCode ID=ShowCustPhoneCode>";
$select_list .= "<option value='0'";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Show Carrier Stats").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control'  SIZE=1 NAME=CARRIERstats ID=CARRIERstats>";
$select_list .= "<option value='0'";
...
if ($presets_enabled > 0)
	{
	$select_list .= "<TR><TD width='40%'>";
	$select_list .= _QXZ("Show Presets Stats").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control'  SIZE=1 NAME=PRESETstats ID=PRESETstats>";
	$select_list .= "<option value='0'";
...
$select_list .= "<TR><TD width='40%'>";
$select_list .= _QXZ("Agent Time Stats").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control'  SIZE=1 NAME=AGENTtimeSTATS ID=AGENTtimeSTATS>";
$select_list .= "<option value='0'";
...
if ($RS_UGlatencyALLOWED > 0)
	{
	$select_list .= _QXZ("Agent Latency").":  </TD><TD align=left><div class='col-lg-8'><SELECT SIZE=1 class='form-control' NAME=AGENTlatency ID=AGENTlatency>";
	$select_list .= "<option value='0'";
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Parked Call Stats").":  </TD><TD align=left><div class='col-lg-8'><SELECT SIZE=1 class='form-control' NAME=parkSTATS ID=parkSTATS>";
$select_list .= "<option value='0'";
...
//end
$select_list .= _QXZ("In-group color override").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control' SIZE=1 NAME=INGROUPcolorOVERRIDE ID=INGROUPcolorOVERRIDE>";
$select_list .= "<option value='0'";
...
$select_list .= "</SELECT></div></TD></TR>";
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Display as").":  </TD><TD align=left><div class='col-lg-8'><SELECT class='form-control' SIZE=1 NAME=report_display_type ID=report_display_type>";
...
//ishwari
//10-jan-20
$select_list .= "<div class='text-center'><INPUT style='background-color:#$SSbutton_color' class='btn btn-bdr-sucess' type=button VALUE='"._QXZ("SUBMIT")."' onclick=\\\"update_variables('form_submit','');\\\"><FONT FACE='ARIAL,HELVETICA' COLOR=BLACK SIZE=2> </div> ";
//end
$select_list .= "</TD></TR>";
...
function ingroup_info(agent_user,count)
	...
	document.getElementById("agent_ingroup_display").style.top = '373px';
	//	alert(session_id + "|" + server_ip + "|" + monitor_phone + "|" + stage + "|" + user);
	var xmlhttp=false;
	/*@cc_on @*/
	/*@if (@_jscript_version >= 5)
...
<!--
	...
	.Hblank {color: black; background-color: white; font-size: 12;}
	.Hgreen {color: white; background-color: green; font-size: 12;}
	.Hred {color: white; background-color: red; font-size: 12;}
	.Hrust {color: black; background-color: #F47442; font-size: 12;}
	.Hlightblue {color: black; background-color: #ADD8E6; font-size: 12;}
	.Hblue {color: white; background-color: blue; font-size: 12;}
	.Hmidnightblue {color: white; background-color: #191970; font-size: 12;}
	.Hpurple {color: white; background-color: purple; font-size: 12;}
	.Hviolet {color: black; background-color: #EE82EE; font-size: 12;}
	.Hthistle {color: black; background-color: #D8BFD8; font-size: 12;}
	.Holive {color: white; background-color: #808000; font-size: 12;}
	.Hdarkolivegreen {color: white; background-color: #556B2F; font-size: 12;}
	.Hsaddlebrown {color: white; background-color: #8B4513; font-size: 12;}
	.Hlime {color: white; background-color: #006600; font-size: 12;}
	.Hyellow {color: black; background-color: yellow; font-size: 12;}
	.Hkhaki {color: black; background-color: #F0E68C; font-size: 12;}
	.Horange {color: black; background-color: orange; font-size: 12;}
	.Hblack {color: white; background-color: black; font-size: 12;}
	.Hsalmon {color: white; background-color: #FA8072; font-size: 12;}
	.Hdarkred {color: white; background-color: #990000}

	tr.TRblank {background-color: white !important;}
	tr.TRgreen {background-color: green !important;}
	tr.TRred {background-color: red !important;}
	tr.TRlightblue {background-color: #ADD8E6 !important;}
	tr.TRrust {background-color: #F47442 !important;}
	tr.TRblue {background-color: blue !important;}
	tr.TRmidnightblue {background-color: #191970 !important;}
	tr.TRpurple {background-color: purple !important;}
	tr.TRviolet {background-color: #EE82EE !important;} 
	tr.TRthistle {background-color: #D8BFD8 !important;} 
	tr.TRolive {background-color: #808000 !important;}
	tr.TRdarkolivegreen {background-color: #556B2F !important;}
	tr.TRsaddlebrown {background-color: #8B4513 !important;}
	tr.TRlime {background-color: #006600 !important;}
	tr.TRyellow {background-color: yellow !important;}
	tr.TRkhaki {background-color: #F0E68C !important;}
	tr.TRorange {background-color: orange !important;}
	tr.TRblack {background-color: black !important;}
	tr.TRsalmon {background-color: #FA8072 !important;}
	tr.TRdarkred {color: white; background-color: #990000 !important;}
	...
	.top_settings_key {color: black; font-family: HELVETICA; font-size: 13; font-weight: bold;}
	.top_settings_val {color: black; font-family: HELVETICA; font-size: 13;}
	.top_head_key {color: black; font-family: HELVETICA; font-size: 13; font-weight: bold;}
	.top_head_val {color: black; font-family: HELVETICA; font-size: 13;}

	.realtime_img_icon {width: 42px; height: 42px;}
	.realtime_img_text {font-family:HELVETICA; font-size:13; color:white; font-weight:bold;}
	.realtime_table {width: 960px; max-width: 960px; }
	.realtime_calls_table {width: 100%; max-width: 100%; border:0;}
	.realtime_settings_table {width: 780px; max-width: 780px; }
	.realtime_calls_table tr td:first-child{border-left: 1px solid #fff !important; }
	#realtime_content  th a{color: #ffffff !important}
	#realtime_content a:hover, #realtime_content a:focus {color: #2a6496;text-decoration: underline;}
	.realtime_calls_table tbody tr td{border: 0;}
	.cl-mcont{font-weight: unset !important;}
	.table_list td font{color: white !important;font-weight: 600;font-size: 13 !important;}
<?php 
...
<div id="pcont4" class="container-fluid">
		...
		<div class="col-md-12 no-padding">
			<div class="block-flat">
				<div class="header"><h3 class="pull-left"><?php echo _QXZ("$report_name") ?> <?php echo "<span style=\"position:absolute;left:160px;z-index:20;\" id=campaign_select_list_link>"; ?></h3>
		
		
		<?php 
	echo "<div class='pull-right'><a class='btn btn-primary btn-sm'   href=\"./AST_timeonVDADallSUMMARY.php?RR=$RR&DB=$DB&adastats=$adastats\">"._QXZ("SUMMARY")."</a> </div>\n";

if (preg_match('/ALL\-ACTIVE/i',$group_string))
	{echo "<div class='pull-right'><a class='btn btn-primary btn-sm'  href=\"./admin.php?ADD=10\">"._QXZ("MODIFY")."</a></div>";}
else
	{echo "<div class='pull-right'><a class='btn btn-primary btn-sm'  href=\"./admin.php?ADD=34&campaign_id=$group\">"._QXZ("MODIFY")."</a></div> ";}

		echo "<div class='pull-right'><a class='btn btn-primary btn-sm'  href='#' onclick=\"update_variables('form_submit','','YES')\">"._QXZ("RELOAD NOW")."</a></div>";

		//echo "<TABLE class=\"block-flat\" WIDTH=250 CELLPADDING=0 CELLSPACING=0 BGCOLOR=\"#D9E6FE\"><TR><TD class=\"\">\n";
		echo "<div class='pull-right'><a class='btn btn-primary btn-sm' href=\"#\" onclick=\"showDiv('campaign_select_list');\">"._QXZ("Choose Report Display Options")."</a></div>";
		//echo "</TD></TR></TABLE>\n";	
					

		
echo "<div class='pull-right mr-10'>"._QXZ("refresh").": </span><span id=refresh_countdown name=refresh_countdown style='font-size:14px;'></div>\n\n";
		?>		
		</span>
		</div>	
...
/*echo "<TABLE class=\"block-flat\" WIDTH=250 CELLPADDING=0 CELLSPACING=0 BGCOLOR='#D9E6FE'><TR><TD class=\"\">\n";
echo "<a href='#' onclick=\"showDiv('campaign_select_list');\">"._QXZ("Choose Report Display Options")."</a>";
echo "</TD></TR></TABLE>\n";*/

echo "<span class=\"col-md-12\" style=\"position:relative;left:0px;z-index:21;\" id=campaign_select_list>\n";
echo "<TABLE WIDTH=0 HEIGHT=0 CELLPADDING=0 CELLSPACING=0 ><TR><TD ALIGN=CENTER>\n";
echo "";
echo "</TD></TR></TABLE>\n";
echo "</span>\n";
...
echo "</TD></TR></TABLE>\n";
echo "</span>\n";
echo "<span style=\"position:absolute;left:25%;z-index:14;\" id=agent_ingroup_display>\n";
echo " &nbsp; ";
echo "</span>\n";
	// if ($LOGuser_level > 7)
	// 	{
...
echo "<div style=\"border:1px solid #ECECEC;\">";
if ($adastats<2)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('adastats','');\"><span id=adastatsTXT>+ "._QXZ("VIEW MORE")."</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('adastats','');\"><span id=adastatsTXT>- "._QXZ("VIEW LESS")."</span></a>";}
if ($UGdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('UGdisplay','');\"><span id=UGdisplayTXT>"._QXZ("HIDE USER GROUP")."</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('UGdisplay','');\"><span id=UGdisplayTXT>"._QXZ("VIEW USER GROUP")."</span></a>";}
if ($SERVdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('SERVdisplay','');\"><span id=SERVdisplayTXT>"._QXZ("HIDE SERVER INFO")."</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('SERVdisplay','');\"><span id=SERVdisplayTXT>"._QXZ("SHOW SERVER INFO")."</span></a>";}
if ($CALLSdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('CALLSdisplay','');\"><span id=CALLSdisplayTXT>"._QXZ("HIDE WAITING CALLS")."</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('CALLSdisplay','');\"><span id=CALLSdisplayTXT>"._QXZ("SHOW WAITING CALLS")."</span></a>";}
if ($ALLINGROUPstats>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('ALLINGROUPstats','');\"><span id=ALLINGROUPstatsTXT>"._QXZ("HIDE IN-GROUP STATS")."</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('ALLINGROUPstats','');\"><span id=ALLINGROUPstatsTXT>"._QXZ("SHOW IN-GROUP STATS")."</span></a>";}
if ($PHONEdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('PHONEdisplay','');\"><span id=PHONEdisplayTXT>"._QXZ("HIDE PHONES")."</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href='#' onclick=\"update_variables('PHONEdisplay','');\"><span id=PHONEdisplayTXT>"._QXZ("SHOW PHONES")."</span></a>";}
if ($MONITORdisplay>0)
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('MONITORdisplay','');\"><span id=MONITORdisplayTXT>"._QXZ("HIDE MONITORS")."</span></a>";}
else
	{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('MONITORdisplay','');\"><span id=MONITORdisplayTXT>"._QXZ("SHOW MONITORS")."</span></a>";}	
if ($RS_hide_CUST_info < 1)
		{
		if ($CUSTPHONEdisplay>0)
			{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CUSTPHONEdisplay','');\"><span id=CUSTPHONEdisplayTXT>"._QXZ("HIDE CUSTPHONES")."</span></a>";}
		else
			{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CUSTPHONEdisplay','');\"><span id=CUSTPHONEdisplayTXT>"._QXZ("SHOW CUSTPHONES")."</span></a>";}
		}
	if ($LOGuser_level >= $CUSTINFOminUL) 
		...
		if ($RS_hide_CUST_info < 1)
			...
			if ($CUSTINFOdisplay>0)
				{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CUSTINFOdisplay','');\"><span id=CUSTINFOdisplayTXT>"._QXZ("HIDE CUST INFO")."</span></a>";}
			else
				{echo " &nbsp; &nbsp; &nbsp; <a href=\"#\" onclick=\"update_variables('CUSTINFOdisplay','');\"><span id=CUSTINFOdisplayTXT>"._QXZ("SHOW CUST INFO")."</span></a>";}
			}
		}
	}
