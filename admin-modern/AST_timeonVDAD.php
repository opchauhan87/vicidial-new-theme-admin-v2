...
# 220812-0956 - Added User Group report permissions checking
#
...
$report_name='Agents Time On Calls';
...
echo'<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3>'._QXZ("Server-Specific Real-Time Report").'</h3></div><div class="col-md-12"><div class="content">';
