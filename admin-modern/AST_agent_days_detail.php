...
if ($file_download < 1)
	...
	echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")." $NWB#single_agent_daily$NWE</h3><div class='pull-right'><a class=\"btn btn-info btn-sm\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div><div class='pull-right'>";
		if (strlen($user) > 1)
	{
	echo "<center>";
	echo " <a class='btn btn-info btn-sm' href=\"$LINKbase&stage=$stage&file_download=1\">"._QXZ("DOWNLOAD")."</a>  ";
	echo " <a class='btn btn-info btn-sm' href=\"./admin.php?ADD=3&user=$user\">"._QXZ("USER")."</a>  ";
	echo " <a class='btn btn-info btn-sm' href=\"./user_stats.php?user=$user&begin_date=$query_date&end_date=$end_date\">"._QXZ("USER STATS")."</a>  ";

	}
else
echo "";
	{echo " <a class='btn btn-info btn-sm' href=\"./admin.php?ADD=0A\">"._QXZ("USERS")."</a>  ";}
	echo "</div> </div>
...
echo "<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Dates").":</label>";
echo "</div></div>";
...
echo "<BR> <div class='col-md-12' style='text-align:center;'><label>"._QXZ("to")." </label></div>";
echo "<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT TYPE=TEXT class='form-control' NAME=end_date  MAXLENGTH=10 VALUE=\"$end_date\"></div></div>";
...
echo "<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>"._QXZ("Display as").":"."</label></div>\n";

echo "</TD><TD class=\"col-md-4\" VALIGN=TOP>";
echo "<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT SIZE=10 NAME=user value=\"\"><label>"._QXZ("User").":</label></div></div><br>\n";

echo "<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=shift></div>\n";
echo "<option selected value= '$shift'><label>"._QXZ("$shift")."</label></option>\n";
echo "<option value=\"\">--</option>\n";
echo "<option value=\"AM\">"._QXZ("AM")."</option>\n";
echo "<option value=\"PM\">"._QXZ("PM")."</option>\n";
echo "<option value=\"ALL\">"._QXZ("ALL")."</option>\n";
echo "</SELECT><label>"._QXZ("Shift").":</label></div>\n";
...
echo "<BR><INPUT TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-success'>\n";
echo "</div>";
echo "</TD>";
echo "</TR>";
echo "</TABLE>";
