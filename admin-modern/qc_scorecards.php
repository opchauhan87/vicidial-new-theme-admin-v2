...
<style type="text/css">
	.tiny_blue_btn, .tiny_red_btn{
		padding: 10px;
		margin: 10px;
	}
	#scorecards_display tbody td {
    padding: 15px;
	}
	table td{
		border: none;
...
<?php
    //~ echo "<div class='container-fluid' id='pcont4' style='right:8px'><TABLE width='100%'><TR><TD>\n";
    //~ echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";

	//~ echo "<div class=\"cl-mcont\">
        //~ <div class=\"row\">
		//~ <div class=\"col-md-12 no-padding\"><div  class=\"block-flat\"><div class=\"header\"> <h3 class='pull-left'>"._QXZ("QUALITY CONTROL SCORECARDS")." </h3>";
	...
	echo "<div id=\"pcont4\" class=\"container-fluid\">
			...
			<div class=\"block-flat\"><div class=\"header\"><h3 class='pull-left'>"._QXZ("QUALITY CONTROL SCORECARDS")." </h3><div class=\"pull-right\"> &nbsp; </div><center><div class=\"col-md-12\"><div class=\"content\">";
	...
	if ($action=="delete_scorecard" && $scorecard_id && !$confirm_deletion) 
		{
		echo "<div><a href='$PHP_SELF?scorecard_id=$scorecard_id&action=delete_scorecard&confirm_deletion=Y'>"._QXZ("CLICK HERE TO CONFIRM SCORECARD")." \"$scorecard_id\" "._QXZ("DELETION")."</a></div>";
		}
	...
	echo "<table class=\"table_list hover centerline\" width=\"850\" cellspacing=\"0\" cellpadding=\"1\"><thead>\n";
...
$qc_scorecard_id= $row["qc_scorecard_id"];
		// echo "\t\t\t<td align=left><input type='button' onClick=\"LoadCheckpoints('$row[qc_scorecard_id]')\" value='"._QXZ("MODIFY")."'></td>\n";
	...
	echo "\t<tr style='margin: 10px !important;'>\n";
	 echo "\t\t<th colspan='10' style='text-align: center;'><font size=1 color='white'><input style='margin: 10px 10px !important;' type='button' class='btn btn-primary' onClick='NewScorecard()' value='"._QXZ("ADD NEW SCORECARD")."'></font></td>\n";
	echo "\t</tr>\n";
	echo "</table>\n";
	echo "</span>\n";

	echo "<BR><div name='display_tag'><span id='checkpoint_display'>";
	echo "</span>";
