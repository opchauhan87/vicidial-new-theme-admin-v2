...
$HTML_text.= ""._QXZ("$report_name")."\n";

$HTML_text.= '</h3> </div>
		<div class="col-md-12"><div class="content">';

$HTML_text.= "<TABLE CELLPADDING=4 CELLSPACING=0 class='table1 col_table'><TR><TD>";

$HTML_text.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$HTML_text.="<TABLE CELLSPACING=3><TR><TD VALIGN=TOP class=col-md-4>";
...
$HTML_text.="<div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=access_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$access_date_D\"><label>"._QXZ("Access date range")."</label></div></div><div class=col-md-2 text-center p-18>";
...
$HTML_text.="</script>\n";
$HTML_text.=" </div>&nbsp; <div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=access_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$access_date_T\"></div></div>";
$HTML_text.="<BR><div class=\"col-lg-12 text-center\"> "._QXZ("to")." </div><BR><div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=access_date_end_D SIZE=11 MAXLENGTH=10 VALUE=\"$access_date_end_D\"></div></div>";
$HTML_text.="<div class=col-md-2 text-center p-18><script language=\"JavaScript\">\n";
$HTML_text.="var o_cal = new tcal ({\n";
$HTML_text.="	// form name\n";
$HTML_text.="	'formname': 'vicidial_report',\n";
$HTML_text.="	// input name\n";
...
$HTML_text.="// o_cal.a_tpl.weekstart = 1; // Monday week start\n";
$HTML_text.="</script>\n";
$HTML_text.=" </div>&nbsp; <div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=access_date_end_T SIZE=9 MAXLENGTH=8 VALUE=\"$access_date_end_T\"></div></div>";
$HTML_text.="</TD>";
...
$HTML_text.="<div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=users[] multiple>\n";
...
//~ $HTML_text.=" "._QXZ("Recording date range").":<BR>";
$HTML_text.="<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
...
$HTML_text.="<div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=recording_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$recording_date_D\"><label>"._QXZ("Recording date range")."</label></div></div>";
$HTML_text.="<div class=col-md-2 text-center p-18><script language=\"JavaScript\">\n";
$HTML_text.="var o_cal = new tcal ({\n";
$HTML_text.="	// form name\n";
$HTML_text.="	'formname': 'vicidial_report',\n";
...
$HTML_text.="o_cal.a_tpl.yearscroll = false;\n";
$HTML_text.="// o_cal.a_tpl.weekstart = 1; // Monday week start\n";
$HTML_text.="</script></div>\n";
#$HTML_text.=" &nbsp; <INPUT TYPE=TEXT NAME=recording_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$recording_date_T\">";
$HTML_text.="<div class=\"col-lg-12 text-center\"> "._QXZ("to")." </div><BR><div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=recording_date_end_D SIZE=11 MAXLENGTH=10 VALUE=\"$recording_date_end_D\"></div></div>";
$HTML_text.="<div class=col-md-2 text-center p-18><script language=\"JavaScript\">\n";
$HTML_text.="var o_cal = new tcal ({\n";
$HTML_text.="	// form name\n";
$HTML_text.="	'formname': 'vicidial_report',\n";
...
$HTML_text.="<div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><select class='form-control' name='report_display_type'>";
...
if ($archives_available=="Y") 
	{
	$HTML_text.="<BR><BR><div class=\"col-md-12\"><input type='checkbox' name='search_archived_data' value='checked' $search_archived_data>&nbsp;&nbsp;<label>"._QXZ("Search archived data")."</label></div>\n";
	}
$HTML_text.="</TD></tr><tr><td colspan=3 class=text-center>";	
	$HTML_text.="<INPUT  class=\"btn btn-bdr-sucess\" TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
$HTML_text.="</TD>";
$HTML_text.="</TR></TABLE>";
$HTML_text.="</FORM>\n\n";
...
if ($SUBMIT) 
	...
	$HTML.="<label>"._QXZ("RECORDING ACCESS LOG FOR:")."<br>"._QXZ("RECORDS VIEWED ")."$access_date_from "._QXZ("TO")." $access_date_to$recording_date_title $agents_title";
	$HTML.="&nbsp&nbsp;<a href=\"$PHP_SELF?DB=$DB&access_date_D=$access_date_D&access_date_T=$access_date_T&access_date_end_D=$access_date_end_D&access_date_end_T=$access_date_end_T&recording_date_D=$recording_date_D&recording_date_end_D=$recording_date_end_D$userQS$user_groupQS&file_download=1&SUBMIT=$SUBMIT\">"._QXZ("DOWNLOAD")."</a></label>";
