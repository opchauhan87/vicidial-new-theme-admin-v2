...
$short_header=0;
$MAIN.="<div class=\"container-fluid\" id=\"pcont4\"><div class=\"cl-mcont\"><div class=\"row\"><div class=\"col-md-12 no-padding\"><div class=\"block-flat\">";
$MAIN.="<div class=\"header\">";
$MAIN.="<h3>"._QXZ("Webserver-URL Report")."</h3>";
$MAIN.="</div>";
$MAIN.="<div class=\"col-md-12\">";
$MAIN.="<div class=\"content\">";
$MAIN.="<TABLE CELLPADDING=4 CELLSPACING=0><TR><TD class=text-left>";
$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE class=\"no-border\" BORDER=0 cellspacing=5 cellpadding=5><TR><TD class=\"no-border col-lg-3\" VALIGN=TOP >\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$MAIN.="<div class=\"col-md-12 size no-padding\"><div class=\"col-lg-3 size no-padding\">";
//~ $MAIN.=_QXZ("Date").":\n<BR>";
$MAIN.="</div></div>";
$MAIN.="<div class=\"col-md-12 size\"><div class=\"col-lg-9 no-padding\">";
$MAIN.="<div class=\"form-group custom-input mb-10\"><INPUT class=\"form-control\" TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date")."</label></div></div>";
...
$MAIN.="<div class=\"col-md-12\"><div class=\"col-sm-9 size\" align=\"center\">\n "._QXZ("to")."</div></div><div class=\"col-md-12\"><div class=\"col-lg-9 no-padding\">  <INPUT class=\"form-control\" TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div>";
$MAIN.="<div class=\"col-lg-1 no-padding\">";
$MAIN.="<script language=\"JavaScript\">\n";
$MAIN.="var o_cal = new tcal ({\n";
$MAIN.="	// form name\n";
...
$MAIN.="<TD class=\"no-border col-lg-3\" ROWSPAN=2 VALIGN=TOP><div class=\"col-md-12 size no-padding\"><div class=\"col-lg-3 size no-padding\"></div></div><BR/>\n";
$MAIN.="<div class=\"col-lg-12 no-padding\"><div class=\"form-group custom-input mb-10\"><SELECT class=\"form-control\" SIZE=5 NAME=webserver[] multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Webservers")."</label></div>";


$MAIN.="</div></TD>";

$MAIN.="<TD class=\"no-border col-lg-3\"  ROWSPAN=2 VALIGN=TOP><div class=\"col-md-12 size no-padding\"><div class=\"col-lg-3 size no-padding\"></div></div><BR/>";
$MAIN.="<div class=\"col-lg-12 no-padding\"><div class=\"form-group custom-input mb-10\"><SELECT class=\"form-control\" SIZE=5 NAME=url[] multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("URLs")."</label></div></div>";

$MAIN.="</TD></tr>";

$MAIN.="<tr><TD colspan=3 class=\"no-border col-lg-2\" VALIGN=top align=center>\n";

$MAIN.="<div class=\"col-lg-3 no-padding\"><div class=\"form-group custom-input mb-10\"><select class='form-control' name='report_display_type'>";
if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>"._QXZ("$report_display_type")."</option>";}
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>"._QXZ("Display as")."</label></div></div></tr>";
$MAIN.="<tr><td colspan=3 class=text-center><INPUT  style='' class=\"btn btn-bdr-sucess\" TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'><BR/><BR/>\n";
$MAIN.="</TR></TABLE></form></td></tr></tbody></table>\n";
$MAIN.="<PRE style=''><font size=2>\n";
...
if ($SUBMIT && $query_date && $end_date) {
		...
		$HTML.="<label>"._QXZ("VICIDIAL USER LOG")."</label>";
		...
		$HTML.="<label>"._QXZ("VICIDIAL API LOG")."</label>";
		...
		$HTML.="<label>"._QXZ("VICIDIAL REPORT LOG")."</label>";
		$HTML.="<table border='0' cellpadding='3' class='table_list hover centerline' cellspacing='1'>";
		$HTML.="<thead><tr>";
		$HTML.="<th><font size='2'>"._QXZ("WEB SERVER")."</font></th>";
		$HTML.="<th><font size='2'>"._QXZ("COUNT")."</font></th>";
		$HTML.="</tr></thead>\n";
