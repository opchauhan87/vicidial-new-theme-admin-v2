...
$HEADER.="<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 874px; top: 234px; opacity: 1; z-index: 2;'></div>";
...
$HTML_head.="	<script type='text/javascript' src='js/behaviour/core.js'></script>";
...
$HTML_text.="<div class='header'><h3 class='pull-left'> "._QXZ("$report_name")." $NWB#team_performance_detail$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div></div>";
$HTML_text.="<div class='col-md-12'><div class='content'>";
$HTML_text.="<TR><TD style='max-width: 100;width: 100%;' class='no-border'>";
$HTML_text.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$HTML_text.="<TABLE  CELLSPACING=3 BGCOLOR=\"#e3e3ff\"><TR><TD class=\"col-md-4\" VALIGN=TOP>";
...
$HTML_text.="<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$query_date_D\"><label>"._QXZ("Date Range").":</label>";
$HTML_text.="</div></div>";
...
$HTML_text.=" <div style='padding-top: 42px !important;width: 84%;'><div class='form-group custom-input mb-10'> <INPUT class='form-control' TYPE=TEXT NAME=query_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_T\"></div></div>";

$HTML_text.="<div align='center'><label>"._QXZ("to")."</label> </div><div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$end_date_D\"></div></div>";
...
$HTML_text.="<div style='padding-top: 40px !important;width: 84%;'> <div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$end_date_T\"></div>";
...
//chirag parmar
//12-03-21
#$HTML_text.="<div class='col-lg-12'><SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
$HTML_text.="<div class='form-group custom-input mb-10'><div><SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
//end
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
$HTML_text.="</SELECT><label>"._QXZ("Campaigns").":</label></div><br><br>\n";
...
if ($archives_available=="Y") 
	{
	$HTML_text.="<input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("Search archived data")."</label>&nbsp&nbsp<br>";
	}

$HTML_text.="</TD><TD class=\"col-md-4\" VALIGN=TOP>";
$HTML_text.="<div class='col-lg-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=user_group[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Teams/User Groups").":</label></div>\n";





$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=call_status[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Show additional statuses").":</label></div>\n";
$HTML_text.="</br>\n";
...
$HTML_text.="<a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date&query_date_D=$query_date_D&query_date_T=$query_date_T&end_date_D=$end_date_D&end_date_T=$end_date_T$groupQS$user_groupQS$call_statusQS&file_download=1&search_archived_data=$search_archived_data&SUBMIT=$SUBMIT\">"._QXZ("DOWNLOAD")."</a>";
$HTML_text.="</div>";
$HTML_text.="</TD>";
$HTML_text.="</TR>";
$HTML_text.="</TABLE>";
