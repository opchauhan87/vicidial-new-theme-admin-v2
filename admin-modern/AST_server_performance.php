...
echo '</h3><div class= "pull-right"><a class="btn btn-info" href="./admin.php?ADD=999999">'._QXZ("BACK").'</a></div> </div>
		<div class="col-md-12"><div class="content">';
echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET class='table_grid'>\n";
echo "<TABLE CELLPADDING=4 CELLSPACING=0 class=''><TR><TD class='col-md-6' valign='TOP'>";
echo "<div class='col-md-12'><div class='form-group custom-input mb-10'> <INPUT TYPE=TEXT NAME=begin_query_time SIZE=22 class=form-control MAXLENGTH=19 VALUE=\"$begin_query_time\"><label>"._QXZ("Date/Time Range").":</label></div></div>";
echo "<div class='col-md-12' style=\"text-align:center;\"> \n";
echo "<label>"._QXZ("to")."</label> </div>";
echo "<div class='col-md-12'><div class='form-group custom-input mb-10'><INPUT TYPE=TEXT NAME=end_query_time SIZE=22 class=form-control MAXLENGTH=19 VALUE=\"$end_query_time\"></div></div>\n";
echo "</TD><TD class='col-md-6' valign='TOP'>";
echo "<div class='form-group custom-input mb-10'> <SELECT SIZE=1 NAME=group class=form-control>\n";
$o=0;
...
echo "</SELECT><label>"._QXZ("Server").":</label></div> \n";
echo "</TD></TR>";
