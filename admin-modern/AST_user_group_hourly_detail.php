...
if ($SUBMIT && $query_date && $start_hour && $end_hour) {
	...
	$table_columns=2;
	$HTML_text.="<table border='0' class='table_list hover centerline' cellpadding='3' cellspacing='1'>";
	$HTML_text.="<thead><tr bgcolor='#".$SSstd_row1_background."'>";
...
echo "<TABLE CELLSPACING=3 CELLPADDING=3 BGCOLOR=\"#e3e3ff\"><TR><TD class=\"col-md-4\" VALIGN=TOP>";
echo "<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
echo "<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date").":</label></div></div>";
echo "<div class='col-md-2 text-center p-18'>";
?>
...
<?php
echo "</div>";
echo "<div class='col-md-12'><div class='form-group custom-input input-group mb-10'><select class = 'form-control' name='start_hour'>";
for ($h=0; $h<=23; $h++) {
...
echo "</SELECT><label>"._QXZ("Teams/User Groups").":</label></div></div>\n";
...
echo "<option value='TEXT'>TEXT</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>Display as:</label></div>\n";
