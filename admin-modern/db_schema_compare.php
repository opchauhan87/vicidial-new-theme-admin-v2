...
echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("$report_name").$NWB."db_schema_compare".$NWE.'</h3></div><div class="col-md-12"><div class="content">';
if ( ($stage == 'empty') or (strlen($stage) < 1) )
	...
	echo "<TABLE CELLPADDING=4 CELLSPACING=4 WIDTH=100%><TR><TD>";
	...
	echo "<div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><select class='form-control' size=1 name=stage>";
	...
	echo "</select><label>"._QXZ("DB Type")."</label></div></div></td></tr>";
	echo "<TR><TD class=text-center><INPUT class='btn btn-bdr-sucess' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
	echo "</FORM>\n\n";
	echo "</TD></TR>\n\n";
	echo "</TABLE>\n";
	echo "</BODY></HTML>\n";
	...
	echo "<FONT SIZE=3 FACE=\"Ariel,Helvetica\"><b>\n";
	echo " &nbsp; &nbsp; &nbsp; &nbsp; $stage &nbsp; &nbsp; &nbsp; &nbsp; <a class='btn btn-info' href=\"$PHP_SELF\">"._QXZ("RESET")."</a><br><br>\n";
