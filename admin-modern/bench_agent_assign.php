...
if ( (strlen($absent_agent) < 1) or (strlen($bench_agent) < 1) )
 ...
 echo "<div id=\"pcont4\" class=\"container-fluid\">
   ...
   <div class=\"block-flat\"><div class=\"header\"><h3>"._QXZ("Bench Agent Assign")." </h3></div>";
          
echo "<center><div class=\"col-md-12\"><div class=\"content\">
	 <TABLE class=\"hover centerline\" width=$section_width cellspacing=0 cellpadding=1>\n";
	echo "<TABLE CELLPADDING=4 CELLSPACING=0><TR><TD>";
	echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET>\n";
	echo "<div class='col-lg-2'>"._QXZ("Absent Agent").":</div> <div class='col-lg-4'> <SELECT class='form-control' SIZE=1 NAME=absent_agent>\n";
	echo "$owner_menu";
	echo "</SELECT></div>\n";

	
	echo "<div class='col-lg-2'>"._QXZ("Bench Agent").":</div><div class='col-lg-4'> <SELECT class='form-control' SIZE=1 NAME=bench_agent>\n";
	echo "$bench_menu";
	echo "</SELECT></div>\n";

	echo "<center><div class='col-lg-12'><INPUT class='btn btn-bdr-sucess' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n</div></center>";
