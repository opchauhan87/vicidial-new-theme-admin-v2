...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class=\'pull-left\'>';
$MAIN.=""._QXZ("Timeclock Status for")." $user_group\n";
$MAIN.='</h3><div class=\'pull-right\'><a class="btn btn-info" href="./timeclock_report.php">'._QXZ("TIMECLOCK REPORT").'</a></div><div class=\'pull-right\'><a class= "btn btn-info" href= "./admin.php?ADD=311111&user_group=$user_group">'._QXZ("USER GROUP").'</a></div> ';
$MAIN.=' </div>
		<div class="col-md-12"><div class="content">';

$MAIN.="<font class=\"standard_bold\">"._QXZ("$report_name")."</font> $NWB#timeclockstatusreport$NWE\n<BR><BR>";
$MAIN.="<CENTER>\n";
$MAIN.="<TABLE WIDTH=750  cellpadding=2 cellspacing=0 class='block-flat'>\n";
...
$MAIN.="<div class='form-group custom-input mb-10'><select size=1 name=user_group class=form-control>$FORMuser_groups</select><label>User group</label></div></div><div class='col-md-2 text-left'><BR>";
$MAIN.="<input type=submit name=submit VALUE='"._QXZ("SUBMIT")."'  class='btn btn-success'></div>\n";

$MAIN.="</TD></TR>\n";
$MAIN.="<TR ><TD ALIGN=LEFT COLSPAN=2 class='no-border'>\n";
$MAIN.="<br><center>\n";
...
$MAIN.="<TR>\n";
$MAIN.="<TD bgcolor=\"#39EE4B\"> &nbsp; &nbsp; </TD><TD align=left> "._QXZ("TC Logged in and VICI active")."</TD>\n"; # bright green
$MAIN.="<TD bgcolor=\"#FFFF33\"> &nbsp; &nbsp; </TD><TD align=left> "._QXZ("TC Logged in only")."</TD>\n"; # bright yellow
$MAIN.="<TD bgcolor=\"#FF8B8B\"> &nbsp; &nbsp; </TD><TD align=left> "._QXZ("VICI active only")."</TD>\n"; # bright red
$MAIN.="</TR><TR>\n";
$MAIN.="<TD bgcolor=\"#2BA637\"> &nbsp; &nbsp; </TD><TD align=left> "._QXZ("TC Logged out and VICI active")."</TD>\n"; # dull green
...
$MAIN.="<TABLE width=700 cellspacing=0 class=\"table_list hover centerline\" cellpadding=1>\n";
$MAIN.="<thead><tr><td><font size=2># </td><td><font size=2>"._QXZ("USER")." </td><td align=left><font size=2>"._QXZ("NAME")." </td><td align=right><font size=2> "._QXZ("IP ADDRESS")."</td><td align=right><font size=2> "._QXZ("TC TIME")."</td><td align=right><font size=2>"._QXZ("TC LOGIN")."</td><td align=right><font size=2> "._QXZ("VICI LAST LOG")."</td><td align=right><font size=2> "._QXZ("VICI CAMPAIGN")."</td></tr></thead>\n";
