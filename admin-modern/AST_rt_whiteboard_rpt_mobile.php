...
$MAIN.="<FONT class=''>"._QXZ("Report Type").":</font> $NWB#rt_whiteboard_report-report_type$NWE<BR>";


$MAIN.="<SELECT class='form-control' NAME=report_type ID=report_type class='' style='width:270px' onChange=HighlightRelatedFields(this.value)>\n";
...
$MAIN.="<TD VALIGN=TOP width='300'> <FONT class=''>"._QXZ("Campaigns").":</font> $NWB#rt_whiteboard_report-parameters$NWE<BR>";
$MAIN.="<SELECT class='form-control' SIZE=5 NAME=campaigns ID=campaigns multiple class='' style='width:270px'>\n";
...
$MAIN.="<FONT class=''>"._QXZ("Status flags").":</font> $NWB#rt_whiteboard_report-parameters$NWE<BR>";
$MAIN.="<SELECT class='form-control' SIZE=5 NAME='status_flags' ID='status_flags' multiple class='' style='width:270px'>\n";
...
$MAIN.="<TD VALIGN=TOP width='300'><FONT class=''>"._QXZ("User Groups").":  $NWB#rt_whiteboard_report-parameters$NWE</font><BR>";
$MAIN.="<SELECT class='form-control' SIZE=5 NAME='user_groups' ID='user_groups' multiple class='' style='width:270px'>\n";
...
$MAIN.="<TD VALIGN=TOP width='300'><FONT class=''>"._QXZ("Users").": $NWB#rt_whiteboard_report-parameters$NWE</font><BR>";
$MAIN.="<SELECT class='form-control' SIZE=5 NAME='users' ID='users' multiple class='' style='width:270px'>\n";
...
$MAIN.="<TD VALIGN=MIDDLE ALIGN='LEFT' nowrap width='400'> <div class='col-lg-3'>"._QXZ("Start date/time").":</div>";
$MAIN.="<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
$MAIN.="<div class='col-lg-3'><INPUT class='form-control' TYPE=TEXT NAME=query_date ID=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\" class=''></div>";
...
$MAIN.="&nbsp;&nbsp;<INPUT  TYPE=TEXT NAME=query_time ID=query_time SIZE=10 MAXLENGTH=8 VALUE=\"$query_time\" class=''> $NWB#rt_whiteboard_report-start_date$NWE";
...
$MAIN.="<BR><BR>";
$MAIN.="<div class='col-lg-5'>"._QXZ("OR Past")." </div><div class='col-lg-5'><input class='form-control' type='text' class='' size='2' maxlength='2' name='hourly_display' id='hourly_display' value=''></div> "._QXZ("hours")."</font> $NWB#rt_whiteboard_report-show_results$NWE";
$MAIN.="</TD>\n";

$MAIN.="</TR>\n";
$MAIN.="<TR>";

$MAIN.="<TD VALIGN=TOP width='300'><FONT class=''>"._QXZ("In-groups").": $NWB#rt_whiteboard_report-parameters$NWE</font><BR>";
$MAIN.="<SELECT class='form-control' SIZE=5 NAME=groups ID=groups multiple class='' style='width:270px'>\n";
...
$MAIN.="<TD VALIGN=TOP width='300'><FONT class=''>"._QXZ("DIDs").": $NWB#rt_whiteboard_report-parameters$NWE</font><BR>";
$MAIN.="<SELECT class='form-control'  SIZE=5 NAME=dids ID=dids multiple class='' style='width:270px'>\n";
...
$MAIN.="<tr>";
$MAIN.="<td align='right' class=''><div class='col-lg-8'>"._QXZ("Target per unit").":</div></td>";
$MAIN.="<td align='left' class=''><div class='col-lg-8'><input class='form-control' type='text' size='5' maxlength='5' name='target_per_agent' id='target_per_agent' value='$target_per_agent' class=''></div> $NWB#rt_whiteboard_report-target_per_unit$NWE</td>";
$MAIN.="</tr><tr>";
$MAIN.="<td align='right' class=''><div class='col-lg-8'>"._QXZ("Target gross sales").":</div></td>";
$MAIN.="<td align='left' class=''><div class='col-lg-8'><input class='form-control' type='text' size='5' maxlength='5' name='target_gross' id='target_gross' value='$target_gross' class=''> </div> $NWB#rt_whiteboard_report-target_gross_sales$NWE</td>";
$MAIN.="</tr></table>";
$MAIN.="<BR><INPUT TYPE=button NAME='run_report' class='btn btn-success' style='width:150px' VALUE='"._QXZ("RUN REPORT")."' onClick='StartRefresh()'>&nbsp;&nbsp;&nbsp;<INPUT TYPE=button NAME='goto_reports' ID='goto_reports' class='btn btn-danger' style='width:150px' VALUE='"._QXZ("REPORTS")."'>";
$MAIN.="</TD>\n";
...
$MAIN.="<input type='button' id='stop_report' name='stop_report' class='btn btn-danger' style='width:140px' value='<< "._QXZ("BACK")."' onClick='StopRefresh()'>";
$MAIN.="</TD>";
...
$MAIN.="&nbsp;&nbsp;"._QXZ("OR Past")." <input type='text' class='' size='2' maxlength='2' name='hourly_display2' id='hourly_display2' value=''> "._QXZ("hours");
$MAIN.="</TD>";

$MAIN.="<TD ALIGN=right width='150' class=''>";
$MAIN.="<input type='button' id='adjust_report' name='adjust_report' class='btn btn-success' style='width:180px' value='"._QXZ("ADJUST RATE/TIME")."'>";
$MAIN.="</TD>";

$MAIN.="<TD VALIGN=TOP width='180' align='left' rowspan=3 class=''><BR><BR><BR>";
...
$MAIN.="<p align='center'><input type='button' class='btn btn-success' style='width:250px' value='"._QXZ("SHOW TOP 10 PERFORMERS")."' onClick=\"ToggleVisibility('top_10_display'); ToggleVisibility('graph_display');\"></p>";
$MAIN.="</span>";
$MAIN.="</TD>";
$MAIN.="</TR>";
