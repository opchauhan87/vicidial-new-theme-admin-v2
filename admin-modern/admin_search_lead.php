...
echo "<div class='message_block'> "._QXZ("Lead search").": $vendor_id $phone $lead_id $status $list_id $user\n";
...
if ( (!$vendor_id) and (!$phone)  and (!$lead_id) and (!$log_phone)  and (!$log_lead_id) and (!$log_phone_archive)  and (!$log_lead_id_archive) and ( (strlen($status)<1) and (strlen($list_id)<1) and (strlen($user)<1) and (strlen($owner)<1) ) and ( (strlen($first_name)<1) and (strlen($last_name)<1) and (strlen($email)<1) ))
	...
	echo "<TABLE class=\" table1\" CELLPADDING=3 CELLSPACING=3>";
	echo "<TR style='display: flex;'>";
	echo "<TD colspan=3 align=center><font color=#000000><b>"._QXZ("Lead Search Options").":</b></font></TD>";
	echo "</TR>";
	...
	if (mysqli_num_rows($archive_rslt)>0) 
		{
		echo "<TR >";
		echo "<TD>"._QXZ("Archive search").": &nbsp; </TD><TD ALIGN=left><div class=\"col-lg-5\"><select class=\"form-control\" size=1 name=archive_search><option>"._QXZ("No")."</option><option>"._QXZ("Yes")."</option><option	SELECTED>"._QXZ("$archive_search")."</option></select></div></TD>";
		echo "<TD> &nbsp; </TD>\n";
		echo "</TR><TR >";
	...
	echo "<TR >";
	echo "<TD class=\"col-md-3\">$label_vendor_lead_code("._QXZ("vendor lead code")."): &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=vendor_id size=10 maxlength=20></div></TD>";
	echo "<TD class=\"col-md-5\"><INPUT class=\"btn btn-bdr-sucess\" TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></TD>\n";

	echo "</TR><TR >";
	echo "<TD colspan=3 align=center height=1></TD>";
	echo "</TR><TR >";

	echo "<TD class=\"col-md-3\">$label_phone_number: &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=phone size=14 maxlength=18></div></TD>";
	echo "<TD class=\"col-md-5\" rowspan='2'><INPUT class=\"btn btn-bdr-sucess\"  TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></TD>\n";
	echo "</TR><TR >";
	echo "<TD class=\"col-md-3\">$label_alt_phone "._QXZ("search").": &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><select class=\"form-control\" size=1 name=alt_phone_search><option>"._QXZ("No")."</option><option>"._QXZ("Yes")."</option><option SELECTED>"._QXZ("$alt_phone_search")."</option></select></div></TD>";

	echo "</TR><TR >";
	echo "<TD colspan=3 align=center height=1></TD>";
	echo "</TR><TR >";

	echo "<TD class=\"col-md-3\">"._QXZ("Lead ID").": &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=lead_id size=10 maxlength=10></div></TD>";
	echo "<TD class=\"col-md-5\"><INPUT class=\"btn btn-bdr-sucess\"  TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></TD>\n";
	echo "</TR><TR >";
	echo "<TD colspan=3 align=center height=3></TD>";
	echo "</TR><TR >";

	echo "<TD class=\"col-md-3\">"._QXZ("Status").": &nbsp; </TD><TD  class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=status size=7 maxlength=6></div></TD>";
	echo "<TD rowspan=4 class=\"col-md-5\" ><INPUT class=\"btn btn-bdr-sucess\"  TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></TD>\n";
	echo "</TR><TR >";

	echo "<TD class=\"col-md-3\">"._QXZ("List ID").": &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=list_id size=15 maxlength=14></div></TD>";

	echo "</TR><TR >";
	echo "<TD class=\"col-md-3\">"._QXZ("User").": &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=user size=15 maxlength=20></div></TD>";
	echo "</TR><TR >";
	echo "<TD class=\"col-md-3\">"._QXZ("Owner").": &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=owner size=15 maxlength=50></div></TD>";
	echo "</TR><TR >";
	echo "<TD colspan=3 align=center height=1></TD>";
	echo "</TR><TR >";
echo "<TD class=\"col-md-3\">$label_first_name: &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=first_name size=15 maxlength=30></div></TD>";
	echo "<TD rowspan=2 class=\"col-md-5\" ><INPUT class=\"btn btn-bdr-sucess\"  TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></TD>\n";
	echo "</TR><TR >";
	echo "<TD class=\"col-md-3\">$label_last_name: &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=last_name size=15 maxlength=30></div></TD>";
	echo "</TR><TR >";
echo "<TD colspan=3 align=center height=1></TD>";
		echo "</TR><TR >";
	//ruchita
	//added 100 maxlength for email instead of 30
	//25-july-2019	
	echo "<TD class=\"col-md-3\" >$label_email: &nbsp; </TD><TD 
	class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=email size=15 maxlength=100></div></TD>";
	echo "<TD class=\"col-md-5\" ><INPUT class='btn btn-bdr-sucess' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></TD>\n";
	echo "</TR><TR>";
	echo "</TR>";
	...
	echo "</TR><TR style='display:flex;'>";
	echo "<TD colspan=3 align=center><font color=#000000><b>"._QXZ("Log Search Options").":</b></font></TD>";
	echo "</TR><TR >";

	echo "<TD class=\"col-md-3\">"._QXZ("Lead ID").": &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=log_lead_id size=10 maxlength=10></div></TD>";
	echo "<TD class=\"col-md-5\"><INPUT class=\"btn btn-bdr-sucess\"  TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></TD>\n";
	echo "</TR><TR >";
	echo "<TD colspan=3 align=cente height=1></TD>";
	echo "</TR><TR >";

		echo "<TD class=\"col-md-3\">$label_phone_number "._QXZ("Dialed").": &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=log_phone size=18 maxlength=18></div></TD>";
	echo "<TD class=\"col-md-5\"><INPUT class=\"btn btn-bdr-sucess\"  TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></TD>\n";
	echo "</TR><TR>";
	echo "<TD colspan=3 align=center> &nbsp; </TD>";
	echo "</TR>";
	echo "<TR style='display:flex;'>";
	echo "<TD colspan=3 align=center><font color=#000000><b>"._QXZ("Archived Log Search Options").":</b></font></TD>";
	echo "</TR><TR >";
	...
	if ( (strlen($SScoldstorage_server_ip) > 1) and (strlen($SScoldstorage_login) > 0) and (strlen($SScoldstorage_pass) > 0) )
		...
		echo "</TR><TR>";
		echo "<TD class=\"col-md-3\">"._QXZ("Archive Type").": &nbsp; </TD><TD class=\"col-md-3\"><div class=\"col-lg-12\"><select class=\"form-control\" size=1 name=archive_type><option value='ARCHIVE'>"._QXZ("Archive Only")."</option><option value='COLDSTORAGE'>"._QXZ("Cold-Storage Only")."</option><option value='ARCHIVE_AND_COLDSTORAGE'>"._QXZ("Archive and Cold-Storage")."</option><option	SELECTED value='$archive_type'>"._QXZ("$archive_type")."</option></select></div></TD><td></td>";
		echo "</TR><TR>";
		//~ echo "<TD colspan=3 align=center height=1></TD>";
		}
	else
	...
	echo "<TD class=\"col-md-3\">"._QXZ("Lead ID").": &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=log_lead_id_archive size=10 maxlength=10></div></TD>";
	echo "<TD class=\"col-md-5\"><INPUT class=\"btn btn-bdr-sucess\"  TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></TD>\n";
	echo "</TR><TR >";
	echo "<TD colspan=3 align=center height=1></TD>";
	echo "</TR><TR >";

	echo "<TD class=\"col-md-3\">$label_phone_number "._QXZ("Dialed").": &nbsp; </TD><TD class=\"col-md-3\" ALIGN=left><div class=\"col-lg-12\"><input class=\"form-control\" type=text name=log_phone_archive size=18 maxlength=18></div></TD>";
	echo "<TD class=\"col-md-5\"><INPUT class=\"btn btn-bdr-sucess\"  TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></TD>\n";
	echo "</TR><TR>";
	echo "<TD colspan=3 align=center> &nbsp; </TD>";
	echo "</TR><TR >";
	...
	if ( (strlen($log_lead_id)>0) or (strlen($log_phone)>0) )
		...
		echo "<div id=\"pcont4\" class=\"container-fluid\">
			  ...
			  <div class=\"row\">
			  <div class=\"col-md-12 no-padding\">
			  <div class=\"block-flat\"><div class=\"col-md-12\"><div class=\"content\">";
			echo "\n<br><br><center>\n";
			echo "<b>"._QXZ("There are no outbound calls matching your search criteria")."</b><br>\n";
			echo "</center></div></div>\n";
			}
		else
			{
			  ...
			  <div class=\"block-flat\">
			  <div class=\"header\">
			  <h3>"._QXZ("OUTBOUND LOG RESULTS").": $results_to_print</h3>
			  </div>
			<div class=\"col-md-12\"><div class=\"content\">";
			echo "<TABLE BGCOLOR=WHITE CELLPADDING=1 CELLSPACING=0 WIDTH=770>\n";
			echo "<TR>\n";
			echo "<TD ALIGN=LEFT VALIGN=TOP><B>#</B></FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("LEAD ID")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("PHONE")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("CAMPAIGN")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("CALL DATE")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("STATUS")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("USER")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("LIST ID")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("LENGTH")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("DIAL")."</B></FONT></TD>\n";
			echo "</TR>\n";
			$o=0;
		...
		if ( ($results_to_print < 1) and ($results_to_printX < 1) )
			...
			echo "<b>"._QXZ("There are no inbound calls matching your search criteria")."</b><br>\n";
			echo "</center></div></div>\n";
			}
		else
			{
			echo "<div class=\"col-md-12\"><div class=\"content\">";	
			echo "<center><b>"._QXZ("INBOUND LOG RESULTS").": $results_to_print</b></center>\n";
			echo "<TABLE BGCOLOR=WHITE CELLPADDING=1 CELLSPACING=0 WIDTH=770>\n";
			echo "<TR >\n";
			echo "<TD ALIGN=LEFT VALIGN=TOP><B>#</B></FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("LEAD ID")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("PHONE")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("INGROUP")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("CALL DATE")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("STATUS")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("USER")."</B> &nbsp;</FONT></TD>\n";
			echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("LIST ID")."</B> &nbsp;</FONT></TD>\n";
		...
		if (strlen($stmtC) > 10)
			...
			if ( ($results_to_print < 1) and ($results_to_printX < 1) )
				...
				echo "<TR >\n";
				echo "<TD ALIGN=LEFT VALIGN=TOP><B>#</B></FONT></TD>\n";
				echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("DID")."</B> &nbsp;</FONT></TD>\n";
				echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("PHONE")."</B> &nbsp;</FONT></TD>\n";
				echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("DID ID")."</B> &nbsp;</FONT></TD>\n";
				echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("CALL DATE")."</B> &nbsp;</FONT></TD>\n";
				echo "</TR>\n";
				$o=0;
				while ($results_to_print > $o)
		...
		echo "\n\n\n<br>&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"$PHP_SELF\">NEW SEARCH</a>";
	...
	if ( ($results_to_print < 1) and ($results_to_printX < 1) )
		...
		echo "</center></div></div></div></div></div></div></div>\n";
		echo "</body></html>\n";
		exit;
		}
	else
		...
		echo "<div id=\"pcont4\" class=\"container-fluid\">
			  ...
			  <div class=\"block-flat\">
			  <div class=\"header\">	
		  <h3>"._QXZ("RESULTS").": $results_to_print</h3>
		   </div>
		    <div class=\"col-md-12\"><div class=\"content\">";
		echo "<TABLE BGCOLOR=WHITE CELLPADDING=1 CELLSPACING=0 WIDTH=770>\n";
		echo "<TR >\n";
		...
		echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("LEAD ID")."</B> &nbsp;</FONT></TD>\n";
		echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("STATUS")."</B> &nbsp;</FONT></TD>\n";
		echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("VENDOR ID")."</B> &nbsp;</FONT></TD>\n";
		echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("LAST AGENT")."</B> &nbsp;</FONT></TD>\n";
		echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("LIST ID")."</B> &nbsp;</FONT></TD>\n";
		echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("PHONE")."</B> &nbsp;</FONT></TD>\n";
		echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("NAME")."</B> &nbsp;</FONT></TD>\n";
		echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("CITY")."</B> &nbsp;</FONT></TD>\n";
		echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("SECURITY")."</B> &nbsp;</FONT></TD>\n";
		echo "<TD ALIGN=CENTER VALIGN=TOP><B>"._QXZ("LAST CALL")."</B></FONT></TD>\n";
		echo "</TR>\n";
		$o=0;
		while ($results_to_print > $o)
			{
			...
			if (preg_match('/1$|3$|5$|7$|9$/i', $o))
				...
				{$bgcolor='';} 
			echo "<TR>\n";
			echo "<TD ALIGN=LEFT>$o</FONT></TD>\n";
			echo "<TD ALIGN=CENTER><FONT FACE=\"ARIAL,HELVETICA\" SIZE=1><A HREF=\"admin_modify_lead.php?lead_id=$row[0]&archive_search=$archive_search&archive_log=$log_archive_link\" onclick=\"javascript:window.open('admin_modify_lead.php?lead_id=$row[0]&archive_search=$archive_search&archive_log=$log_archive_link', '_blank');return false;\">$row[0]</A></FONT></TD>\n";
			echo "<TD ALIGN=CENTER>$row[3]</FONT></TD>\n";
			echo "<TD ALIGN=CENTER>$row[5]</FONT></TD>\n";
			echo "<TD ALIGN=CENTER>$row[4]</FONT></TD>\n";
			echo "<TD ALIGN=CENTER>$row[7]</FONT></TD>\n";
			echo "<TD ALIGN=CENTER>$row[11]</FONT></TD>\n";
			echo "<TD ALIGN=CENTER>$row[13] $row[15]</FONT></TD>\n";
			echo "<TD ALIGN=CENTER>$row[19]</FONT></TD>\n";
			echo "<TD ALIGN=CENTER>$row[28]</FONT></TD>\n";
			echo "<TD ALIGN=CENTER>$row[31]</FONT></TD>\n";
			echo "</TR>\n";
