...
echo '<div id="pcont4" class="container-fluid">
			  ...
			  <div class="header"><h3 class=pull-left>'._QXZ("VICIDIAL: Manual CID call")."</h3>";
			  echo "<div class=pull-right><a class='btn btn-info' href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a></div></div>";
echo '<div class="col-md-12"><div class="content">';
echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET>\n";
echo "<div class=\"col-lg-2\"><div class=\"form-group custom-input mb-10\"><INPUT TYPE=TEXT NAME=sender SIZE=12 MAXLENGTH=10 VALUE=\"$sender\" class='form-control'><label>"._QXZ("Sender")."</label></div></div>\n";
echo "<div class=\"col-lg-2\"><div class=\"form-group custom-input mb-10\"><INPUT TYPE=TEXT NAME=receiver SIZE=12 MAXLENGTH=10 VALUE=\"$receiver\"  class='form-control'><label>"._QXZ("Receiver")."</label></div></div>\n";
echo "<div class=\"col-lg-2\"><div class=\"form-group custom-input mb-10\"><INPUT TYPE=TEXT NAME=cid_number SIZE=12 MAXLENGTH=10 VALUE=\"$cid_number\"  class='form-control'><label>"._QXZ("CID Number")."</label></div></div>\n";
echo "<div class=\"col-lg-2\"><div class=\"form-group custom-input mb-10\"><SELECT SIZE=1 NAME=server_ip class='form-control'>\n";
$o=0;
...
echo "</SELECT><label>"._QXZ("Server")."</label></div></div><div class=\"col-lg-1 no-padding\"><div class=\"pull-right\">\n";
echo "<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
echo "<INPUT TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'></div></div>\n";
echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </FONT>\n";
echo "</FORM><BR><center>\n\n";
...
if ( (strlen($sender) < 6) or (strlen($receiver) < 6) or (strlen($cid_number) < 6) or (strlen($server_ip) < 7) )
	{
	echo "\n\n";
	echo "<label>"._QXZ("PLEASE ENTER A CALLER, RECEIVER AND CALLERID NUMBER ABOVE AND CLICK SUBMIT")."</label><br>\n";
	}
