...
<?php 
	...
	require("admin_header.php");
		...
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("VICIDIAL: Agent Performance")." </h3> </div>
...
echo "<div class='col-lg-4'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=19 MAXLENGTH=19 VALUE=\"$query_date\"></div>\n";
...
echo "</SELECT></div>\n";
echo "<div class='col-lg-2'><SELECT class='form-control' SIZE=1 NAME=shift>\n";
