...
echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("ADMIN: Agent Time Sheet")." </h3> </div>
		<div class='col-md-12'><div class='content'>";
//~ echo "<TITLE>"._QXZ("ADMIN: Agent Time Sheet")."</TITLE></HEAD><BODY BGCOLOR=WHITE>\n";
echo "<center><a href=\"./admin.php\">"._QXZ("ADMIN")."</a>: "._QXZ("Agent Time Sheet")."\n";
...
echo "<div class='col-lg-1'>"._QXZ("Date").": </div><div class='col-lg-2'><input class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=19 VALUE=\"$query_date\"></div>\n";
echo "<div class='col-lg-1'>"._QXZ("User ID").": </div><div class='col-lg-2'><input class='form-control' TYPE=TEXT NAME=agent SIZE=20 MAXLENGTH=20 VALUE=\"$agent\"></div>\n";
