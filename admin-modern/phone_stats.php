...
<TABLE WIDTH=620 BGCOLOR=#D9E6FE cellpadding=2 cellspacing=0>
<!-- <TR BGCOLOR=#015B91><TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B> &nbsp; <?php echo _QXZ("ADMIN: Administration"); ?></TD><TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo date("l F j, Y G:i:s A") ?> &nbsp; </TD></TR>
...
<?php 
echo "<TR><TD ALIGN=LEFT COLSPAN=2><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2><B> &nbsp; \n";

echo "<form action=$PHP_SELF method=POST>\n";
echo "<input type=hidden name=extension value=\"$extension\">\n";
echo "<input type=hidden name=server_ip value=\"$server_ip\">\n";
echo "<div class='col-lg-2'><input class='form-control' type=text name=begin_date value=\"$begin_date\" size=10 maxsize=10></div><div class='col-xs-1 spacer'> "._QXZ("to")." </div>\n";
echo "<div class='col-lg-2'><input class='form-control' type=text name=end_date value=\"$end_date\" size=10 maxsize=10></div> &nbsp;\n";
