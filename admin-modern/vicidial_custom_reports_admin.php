...
<?php
	...
	echo "<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 823px; top: 186px; opacity: 1; z-index: 2;'></div>";
...
echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("Vicidial Custom Reports").'</h3></div><div class="col-md-12"><div class="content">';

	//echo "<CENTER><BR>\n";
	//echo "<FONT SIZE=3 FACE=\"Arial,Helvetica\"><B>";
//	echo "</B></FONT><BR>\n";
	...
	echo "<tr    ><td align=right>"._QXZ("Report Name").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=report_name size=20 maxlength=100></div>$NWB#custom_reports_admin-report_name$NWE</td></tr>\n";
	echo "<tr    ><td align=right>"._QXZ("Domain").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=domain size=20 maxlength=70></div> ("._QXZ("leave blank if on same server as dialer admin").")$NWB#custom_reports_admin-domain$NWE</td></tr>\n";
	echo "<tr    ><td align=right>"._QXZ("Path Name").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=path_name size=20 maxlength=100></div>$NWB#custom_reports_admin-path_name$NWE</td></tr>\n";
	echo "<tr><td align=right>"._QXZ("Preset constants").": </td><td align=left><div class='col-lg-5'>"._QXZ("Variable name")." <input class='form-control' type='text' id='new_preset_name' name='new_preset_name' size='10' maxlength='100'></div>&nbsp;&nbsp;"._QXZ("Value").": ";
	
		echo "<div class='col-lg-3'><select class='form-control' name='new_preset_value' id='new_preset_value'><option value=''>"._QXZ("Custom value")." --->></option><option value='today'>"._QXZ("today")."</option><option value='yesterday'>"._QXZ("yesterday")."</option><option value='datetime'>"._QXZ("datetime")."</option><option value='filedatetime'>"._QXZ("filedatetime")."</option><option value='6days'>"._QXZ("6days")."</option><option value='7days'>"._QXZ("7days")."</option><option value='8days'>"._QXZ("8days")."</option><option value='13days'>"._QXZ("13days")."</option><option value='14days'>"._QXZ("14days")."</option><option value='15days'>"._QXZ("15days")."</option><option value='30days'>"._QXZ("30days")."</option></select></div>&nbsp;";
	
	
	
	
	echo "<div class='col-lg-3'><input type='text' class='form-control' name='new_preset_custom' id='new_preset_custom' size='10' maxlength='100'>&nbsp;<br><input class='btn btn-bdr-sucess'  type='button' onClick='AddConstant()' value='"._QXZ("ADD")."'></div>$NWB#custom_reports_admin-constants$NWE</div></td></tr>\n";
	
	echo "<tr ><td align=right>"._QXZ("Current constants").":</td><td align=left><span id='new_presets'></span>$NWB#custom_reports_admin-current_constants$NWE<input type='hidden' name='presets_string' id='presets_string'></td></tr>\n";
	...
	echo "<tr    ><td align=right>"._QXZ("User groups").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=5 name=custom_reports_user_groups[] multiple><option value='---ALL---'>"._QXZ("ALL USER GROUPS")."</option>";
	...
	echo "</select></div>$NWB#custom_reports_admin-custom_reports_user_groups$NWE</td></tr>\n";
	echo "<tr ><td class='text-center' colspan='2'><input class='btn btn-bdr-sucess' type='submit' name='add_custom_report' id='add_custom_report' value='"._QXZ("ADD REPORT")."'></td></tr>\n";
	echo "</table>";
	echo "</form>";
	...
	if (mysqli_num_rows($rpt_rslt)>0) {
		...
		echo "<tr >";
		echo "<td>"._QXZ("REPORT NAME")."</font></td>";
		echo "<td>"._QXZ("DOMAIN")."</font></td>";
#		echo "<td><font size=1 color=white align=left>"._QXZ("PATH NAME")."</font></td>";
		echo "<td>"._QXZ("PRESET CONSTANTS")."$NWB#custom_reports_admin-preset_constants$NWE</font></td>";
		echo "<td>&nbsp;</td>";
		# echo "<td><font size=1 color=white align=left>"._QXZ("SLAVE")."</font></td>";
		echo "<td>"._QXZ("USER GROUPS")."</font></td>";
		echo "<td>&nbsp;</td>";
		echo "</tr>";
		...
		while($rpt_row=mysqli_fetch_array($rpt_rslt)) {
			...
			echo "<tr>";
			echo "<td align=left><input type=text class='form-control' id='report_name".$id."' name='report_name".$id."' size=20 maxlength=100 value='".$rpt_row["report_name"]."'></td>\n";
			echo "<td align=left><input type=text class='form-control' id='domain".$id."' name='domain".$id."' size=20 maxlength=70 value='".$rpt_row["domain"]."'></td>\n";
			echo "<td align=left rowspan='2'><textarea class='form-control' rows='5' cols='35' id='presets_string".$id."' name='presets_string".$id."'>".$custom_variables."</textarea></td>\n";
			...
			echo "<td align=left rowspan='2'><select size=5 class='form-control' id=custom_reports_user_groups".$id." name=custom_reports_user_groups".$id." multiple><option value='---ALL---'>"._QXZ("ALL USER GROUPS")."</option>";
			...
			while ($i<$usergroups_to_print) {
				...
				echo "<td align='center'><input class='btn btn-bdr-sucess' type='button' value='"._QXZ("UPDATE")."' onClick=\"SubmitIDValues($id)\"><BR><BR><a href='vicidial_custom_reports_admin.php?delete_custom_report=".$id."'>"._QXZ("DELETE")."</a></td>";
			echo "</tr>\n";
			echo "<tr >";
			echo "<td colspan='2' align=left nowrap>PATH:<input type=text class='form-control' id='path_name".$id."' name='path_name".$id."' size=40 maxlength=100 value='".$rpt_row["path_name"]."'></font></td>\n";
