...
echo "<TITLE>"._QXZ("VICIDIAL: Time On VDAD Campaign").": $group</TITLE></HEAD><BODY BGCOLOR=WHITE>\n";
	...
	echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("$report_name")." $NWB#agent_time_detail$NWE</h3> </div>
		<div class='col-md-12'><div class='content'>";

echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET>\n";
echo "<div class='col-md-2'>"._QXZ("VICIDIAL Campaign").": </div>\n";
...
echo "<div class='col-md-2'><SELECT SIZE=1 NAME=group class='form-control' >\n";
...
if ($UGdisplay > 0)
	{
	echo "<div class='col-md-3'><SELECT SIZE=1 NAME=usergroup class='form-control'>\n";
...
echo "<INPUT type=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>   &nbsp;  \n";
echo "<font size=2><a href=\"$PHP_SELF?group=$group&RR=4000&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&RECmonitorLINK=$RECmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay\">"._QXZ("STOP")."</a> | ";
echo "<font size=2><a href=\"$PHP_SELF?group=$group&RR=40&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&RECmonitorLINK=$RECmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay\">"._QXZ("SLOW")."</a> | ";
echo "<font size=2><a href=\"$PHP_SELF?group=$group&RR=4&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&RECmonitorLINK=$RECmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay\">"._QXZ("GO")."</a>";
echo " &nbsp; &nbsp;  <font size=2><a href=\"./admin.php?ADD=34&campaign_id=$group\">"._QXZ("MODIFY")."</a> | \n";
echo "<font size=2><a href=\"./AST_timeonVDADallSUMMARY.php?group=$group&RR=$RR&DB=$DB&adastats=$adastats\">"._QXZ("SUMMARY")."</a> | \n";
echo "<font size=2><a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a> </FONT>\n";
echo "\n\n";
...
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("DIAL LEVEL").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $DIALlev&nbsp; &nbsp; </TD>";
echo "<TD ALIGN=RIGHT><font size1 style='color:#000;'><B>"._QXZ("TRUNK SHORT/FILL").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $balanceSHORT / $balanceFILL &nbsp; &nbsp; </TD>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("FILTER").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $DIALfilter &nbsp; </TD>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B> "._QXZ("TIME").":</B> &nbsp; </TD><TD ALIGN=LEFT><font size=1 style='color:#000;'> $NOW_TIME </TD>";
echo "";
echo "</TR>";
...
if ($adastats>1)
	{
	echo "<TR>";
	echo "<TD ALIGN=RIGHT><a href=\"$PHP_SELF?group=$group&RR=4&DB=$DB&adastats=1\"><font size=1 style='color:#000;'>- min </font></a><font size=1 style='color:#000;'>&nbsp; <B>MAX LEVEL:</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $maxDIALlev &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("DROPPED MAX").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $DROPmax% &nbsp; &nbsp;</TD>";
	echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("TARGET DIFF").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $targetDIFF &nbsp; &nbsp; </TD>";
	echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("INTENSITY").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $ADAintense &nbsp; &nbsp; </TD>";
	echo "</TR>";

	echo "<TR>";
	echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("DIAL TIMEOUT").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $DIALtimeout &nbsp;</TD>";
	echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("TAPER TIME").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $TAPERtime &nbsp;</TD>";
	echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("LOCAL TIME").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $CALLtime &nbsp;</TD>";
	echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("AVAIL ONLY").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $ADAavailonly &nbsp;</TD>";
	echo "</TR>";
	}

echo "<TR>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("DIALABLE LEADS").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $DAleads &nbsp; &nbsp; </TD>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("CALLS TODAY").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $callsTODAY &nbsp; &nbsp; </TD>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("AVG AGENTS").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $agentsONEMIN &nbsp; &nbsp; </TD>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("DIAL METHOD").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $DIALmethod &nbsp; &nbsp; </TD>";
echo "</TR>";

echo "<TR>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("HOPPER LEVEL").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $HOPlev &nbsp; &nbsp; </TD>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("DROPPED / ANSWERED").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $dropsTODAY / $answersTODAY &nbsp; </TD>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("DL DIFF").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $diffONEMIN &nbsp; &nbsp; </TD>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("STATUSES").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $DIALstatuses &nbsp; &nbsp; </TD>";
echo "</TR>";

echo "<TR>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("LEADS IN HOPPER").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $VDhop &nbsp; &nbsp; </TD>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("DROPPED PERCENT").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $drpctTODAY% &nbsp; &nbsp;</TD>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("DIFF").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $diffpctONEMIN% &nbsp; &nbsp; </TD>";
echo "<TD ALIGN=RIGHT><font size=1 style='color:#000;'><B>"._QXZ("ORDER").":</B></TD><TD ALIGN=LEFT><font size=1 style='color:#000;'>&nbsp; $DIALorder &nbsp; &nbsp; </TD>";
echo "</TR>";
