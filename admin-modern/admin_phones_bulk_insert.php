...
<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 827px; top: 190px; opacity: 1; z-index: 2;'></div>
...
if ($action == "BLANK")
	{
	echo "<div id=\"pcont4\" class=\"container-fluid\"><div class=\"cl-mcont\"><div class=\"row\"><div class=\"col-md-12 no-padding\"><div class=\"block-flat\"><div class=\"header\"><h3>"._QXZ("Add Multi-Server Phones Form")."</h3></div>";
	...
	echo "<tr ><td>"._QXZ("Servers").": <BR><BR> ("._QXZ("one server_ip per line only").")<BR></td><td align=left><div class=\"col-lg-5\"><TEXTAREA name=servers   class=\"form-control\"></TEXTAREA></div> $NWB#admin_phones_bulk_insert-servers$NWE </td></tr>\n";
	
	echo "<tr ><td >"._QXZ("Phones").": <BR><BR> ("._QXZ("one extension per line only").")<BR></td><td align=left><div class=\"col-lg-5\"><TEXTAREA name=phones  class=\"form-control\"></TEXTAREA></div> $NWB#admin_phones_bulk_insert-phones$NWE </td></tr>\n";
	
	echo "<tr ><td>"._QXZ("Registration Password").": </td><td align=left><div class=\"col-lg-5\"><input class=\"form-control\" type=text name=conf_secret size=20 maxlength=20> </div>$NWB#admin_phones_bulk_insert-registration_password$NWE </td></tr>\n";
	echo "<tr><td>"._QXZ("Login Password").": </td><td align=left><div class=\"col-lg-5\"><input class=\"form-control\" type=text name=pass size=20 maxlength=20></div> $NWB#admin_phones_bulk_insert-login_password$NWE </td></tr>\n";
	...
	echo "</select> </div>$NWB#admin_phones_bulk_insert-create_alias$NWE </td></tr>\n";
	echo "<tr><td>"._QXZ("Alias Suffix").": </td><td align=left><div class=\"col-lg-5\"><input class=\"form-control\" type=text name=alias_suffix size=2 maxlength=4></div> $NWB#admin_phones_bulk_insert-alias_suffix$NWE </td></tr>\n";
	echo "<tr><td align=right>"._QXZ("Client Protocol").": </td><td align=left><div class=\"col-lg-5\"><select class=\"form-control\" size=1 name=protocol>";
	...
	echo "</select></div> $NWB#admin_phones_bulk_insert-protocol$NWE </td></tr>\n";
	echo "<tr ><td>"._QXZ("Local GMT").": </td><td align=left><div class=\"col-lg-5\"><select class=\"form-control\" size=1 name=local_gmt><option>12.75</option><option>12.00</option><option>11.00</option><option>10.00</option><option>9.50</option><option>9.00</option><option>8.00</option><option>7.00</option><option>6.50</option><option>6.00</option><option>5.75</option><option>5.50</option><option>5.00</option><option>4.50</option><option>4.00</option><option>3.50</option><option>3.00</option><option>2.00</option><option>1.00</option><option>0.00</option><option>-1.00</option><option>-2.00</option><option>-3.00</option><option>-3.50</option><option>-4.00</option><option selected>-5.00</option><option>-6.00</option><option>-7.00</option><option>-8.00</option><option>-9.00</option><option>-10.00</option><option>-11.00</option><option>-12.00</option></select></div> ("._QXZ("Do NOT Adjust for DST").") $NWB#admin_phones_bulk_insert-gmt$NWE </td></tr>\n";
	echo "<tr><td>"._QXZ("Phone Context").": </td><td align=left><div class=\"col-lg-5\"><input class=\"form-control\" type=text name=phone_context size=20 maxlength=20></div> $NWB#admin_phones_bulk_insert-phone_context$NWE </td></tr>\n";
	echo "<tr ><td>"._QXZ("Set As Webphone").": </td><td align=left><div class=\"col-lg-5\"><select class=\"form-control\" size=1 name=is_webphone><option value='Y'>"._QXZ("Y")."</option><option selected value='N'>"._QXZ("N")."</option><option value='Y_API_LAUNCH'>"._QXZ("Y_API_LAUNCH")."</option></select></div>$NWB#admin_phones_bulk_insert-is_webphone$NWE</td></tr>\n";
	echo "<tr><td>"._QXZ("Webphone Dialpad").": </td><td align=left><div class=\"col-lg-5\"><select class=\"form-control\" size=1 name=webphone_dialpad><option selected value='Y'>"._QXZ("Y")."</option><option value='N'>"._QXZ("N")."</option><option value='TOGGLE'>"._QXZ("TOGGLE")."</option><option value='TOGGLE_OFF'>"._QXZ("TOGGLE_OFF")."</option></select></div>$NWB#admin_phones_bulk_insert-webphone_dialpad$NWE</td></tr>\n";
	echo "<tr><td>"._QXZ("Webphone Auto-Answer").": </td><td align=left><div class=\"col-lg-5\"><select class=\"form-control\" size=1 name=webphone_auto_answer><option selected value='Y'>"._QXZ("Y")."</option><option value='N'>"._QXZ("N")."</option></select></div>$NWB#admin_phones_bulk_insert-webphone_auto_answer$NWE</td></tr>\n";
	echo "<tr ><td>"._QXZ("Use External Server IP").": </td><td align=left><div class=\"col-lg-5\"><select class=\"form-control\" size=1 name=use_external_server_ip><option value='Y'>"._QXZ("Y")."</option><option selected value='N'>"._QXZ("N")."</option></select></div>$NWB#admin_phones_bulk_insert-use_external_server_ip$NWE</td></tr>\n";
    echo "<tr><td>"._QXZ("Template ID").": </td><td align=left><div class=\"col-lg-5\"><select class=\"form-control\" size=1 name=template_id>\n";
...
#	echo "<option SELECTED value=\"\">---NONE---</option>\n";
	echo "</select></div>$NWB#admin_phones_bulk_insert-template_id$NWE</td></tr>\n";
					...
					while ($p < $PNct)
						...
						if ( ($phone_exists < 1) and (strlen($PN[$p]) > 1) )
							...
							#	if ($DB) {echo "|$stmt|\n";}
								...
								{echo "<span class='message_block'>"._QXZ("ERROR: Problem inserting phone").":  $affected_rows|$stmt\n<BR></span>";}
							}
						else
							{echo "<span class='message_block'>"._QXZ("ERROR: Phone already exists").":  $SN[$s]|$PN[$p]|$phone_exists\n<BR></span>";}
						$p++;
						}
					}
				else
					{echo "<span class='message_block'>"._QXZ("ERROR: Server does not exist").": $SN[$s]|$server_exists\n<BR></span>";}
				$s++;
				}
				...
				while ($p < $PNct)
					...
					if ( (strlen($phone_alias_entry[$p]) > 1) and (strlen($PN[$p]) > 1) )
						...
						#	if ($DB) {echo "|$stmt|\n";}
							...
							{echo "<span class='message_block'>"._QXZ("ERROR: Problem inserting phone alias").":  $affected_rows|$stmt\n<BR></span>";}
						}
					$p++;
					}
				}
			echo "<span class='message_block'>"._QXZ("Phones Inserted").":: $phones_inserted\n<BR></span>";
			echo "<span class='message_block'>"._QXZ("Phones Aliases Inserted").":: $phone_alias_inserted\n<BR></span>";
			echo "<span class='message_block'>"._QXZ("You now need to manually trigger a conf file rebuild from the System Settings screen").":\n<BR></span>";
			echo "<BR><span class='message_block'><a href=\"$PHP_SELF\">Start Over</a><BR></span>\n";
			}
		else
			{echo "<span class='message_block'>"._QXZ("ERROR: You must enter servers").":: $servers\n<BR></span>";}
		}
	else
		{echo "<span class='message_block'>"._QXZ("ERROR: You must enter extensions").":: $phones\n<BR></span>";}
	}
