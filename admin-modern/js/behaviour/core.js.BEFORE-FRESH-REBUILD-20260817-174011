    ...
    if(!$("#cl-wrapper").hasClass("fixed-menu")){
      ...
      /*SubMenu hover */
        ...
        function showMenu(_this, e){
          /* Modern VICIdial sidebar: use native CSS submenu on desktop */
          if($("#cl-wrapper").hasClass("vicidial-modern-enabled") &&
             $(window).width() >= 963){
            return;
          }
       ...
       /*   var menu = $("ul",_this);
        ...
        /* Modern VICIdial theme uses native CSS submenus.
           Do not activate the legacy cloned "tool" flyout. */
        if (!$("#cl-wrapper").hasClass("vicidial-modern-enabled")) {
          $(".cl-vnavigation li").hover(function(e){
            ...
            setTimeout(function(){
              if(
                !tool.hasClass("over") &&
                !$(".cl-vnavigation li:hover").length &&
                !tool.is(":hover")
              ){
                tool.hide();
              }
        ...
        /* Modern theme: completely disable legacy submenu flyout handlers */
        if (!$("#cl-wrapper").hasClass("vicidial-modern-enabled")) {
          ...
          $(".top-menu li").hover(function(e){
            ...
            setTimeout(function(){
              if(!tool.hasClass("over") && !$(".top-menu li:hover").length > 0){
                tool.hide();
              }
            },500);
          });
