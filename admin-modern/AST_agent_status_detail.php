...
if ( (strlen($group[0]) < 1) or (strlen($user_group[0]) < 1) )
	...
	if ($file_download < 1)
		...
		$GRAPH.=_QXZ("$report_name")." "._QXZ("Report")."                     $NOW_TIME\n";
		$GRAPH.=_QXZ("Time range").": $query_date_BEGIN "._QXZ("to")." $query_date_END\n\n";
		}
	else
		{
	...
	if ($file_download < 1)
		{
		$ASCII_text.=_QXZ("CALLS STATS BREAKDOWN").":\n";
...
echo "<TABLE CELLSPACING=3 ><TR><TD class=\"col-md-4\" VALIGN=TOP>";
echo "<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
echo "<div class='col-md-12'><div class='col-md-10'>";
echo "<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Dates")."</label></div>";
echo "</div>";
...
echo "<BR> <div class='col-md-12'style=\"text-align:center;\"><label> "._QXZ("to")."</label> </div><BR><div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div></div>";

?>
<div class='col-md-2' style='padding: 6px;top:3px;'>
<script language="JavaScript">
var o_cal = new tcal ({
	// form name
	'formname': 'vicidial_report',
...
echo "<FONT style='float: left;' FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> \n";

echo "</FONT>";
echo "</FONT>\n";
echo "</TD><TD class=\"col-md-4\" VALIGN=TOP>";
echo "<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=shift>\n";
...
echo "</SELECT><label>"._QXZ("Shift").":</label></div><BR>\n";
...
echo "<option value='TEXT'>TEXT</option><option value='HTML'>HTML</option></select><label>"._QXZ("Display as").":</label></div>\n<BR><BR>";
...
echo "</TR><TR><TD class='text-center' colspan=3>";
