...
$MAIN.="<TD VALIGN=TOP width='300'> <FONT class=''>"._QXZ("Campaigns").":</font><BR><select name=types onBlur='RefreshReportWindow()' size='5' multiple class=''>\n";
...
$MAIN.="</br><th><ul class=\"dropdown_android\" style='list-style:none'><li><a class='nodec' onClick=\"ToggleVisibility('graph_display', 0); ToggleVisibility('settings_display', 1); ToggleVisibility('percentages_display', 0)\"><div id='settings_button' class='btn btn-success' style='margin: 19px 0px 5px -114px'>"._QXZ("SETTINGS")."</div></a></li></ul></th>";
$MAIN.="<th><ul class=\"dropdown_android\" style='list-style:none'><li><a class='nodec' onClick=\"ToggleVisibility('graph_display', 0); ToggleVisibility('settings_display', 0); ToggleVisibility('percentages_display', 1)\"><div id='percentage_graph_button' class='btn btn-danger' style='margin: 17px 0px 5px 10px'>"._QXZ("PERCENTS")."</div></a></li></ul></th>";
$MAIN.="</tr>";
$MAIN.="<tr valign='top'>";

$MAIN.="<th>";
$MAIN.="<ul class=\"dropdown_android\" style='list-style:none'><li><div class='btn btn-info' ><a class='' type='button' style='color:#fff' href=\"#\">REPORT</a></div>\n";
...
$MAIN.="<th>";
$MAIN.="<ul class=\"dropdown_android\" style='list-style:none'><li><div class='btn btn-info' style='margin: -52px 77px 4px 195px;'><a class='' style='color:#fff' href=\"#\">REFRESH</a></div>\n";
	$MAIN.="<ul class=\"sub_menu\" style=\"z-index:1;list-style:none\">\n";
...
$MAIN.="<div id='canvas_container' style='height: 75vh; width:1033px;overflow-y:scroll;'>";
