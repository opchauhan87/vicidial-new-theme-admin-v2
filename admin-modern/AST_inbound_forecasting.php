...
$MAIN.="<div class='header'><h3 class=\"pull-left\">"._QXZ("$report_name")."$NWB#inbound_forecasting$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./Erlang_report.php\">"._QXZ("Advanced Forecasting Report")."</a></div></div>\n";
...
#$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE CELLPADDING=3 CELLSPACING=0 BORDER=0 WIDTH='1024'><TR ><TD class='col-md-4' VALIGN=TOP> <BR>";
...
$MAIN.="<BR><div class='col-md-12' style='text-align:center;'><label>"._QXZ("to")."</label></div>";
...
$MAIN.="</div>";
$MAIN.="</div>";
$MAIN.="<BR><div class='col-md-10'><div class='form-group custom-input mb-10'><input class='form-control' type='text' size='3' maxlength='4' name='drop_percent' value='$drop_percent'><label>"._QXZ("Target drop rate (% optional)")."</label>";
# $MAIN.="<b>"._QXZ("Target queue prob.").":</b><input type='text' size='3' maxlength='4' name='target_pqueue' value='$target_pqueue'>% (C report)";
$MAIN.="</div></TD>\n";

$MAIN.="<TD VALIGN=TOP class='col-md-4'><BR>";
$MAIN.="<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=campaign[] multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Campaigns")."</label></div>\n";


$MAIN.=" <BR><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("In-groups")."</label></div>\n";
$MAIN.="</TD>\n";
...
if ($IDR_calltime_available==1)
	{
	$MAIN.="<div class='form-group custom-input mb-10'><SELECT SIZE=1 NAME='shift'>\n";
...
$MAIN.="<TR>";
$MAIN.="<TD colspan='3'>";
$MAIN.="<div class='col-md-12 text-center'>";
$MAIN.="<INPUT class='btn btn-success' TYPE=submit NAME='SUBMIT' VALUE='"._QXZ("SUBMIT")."'><a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?query_date=$query_date&end_date=$end_date&drop_percent=$drop_percent&actual_agents=$actual_agents&hourly_pay=$hourly_pay&revenue_per_sale=$revenue_per_sale&sale_chance=$sale_chance&retry_rate=$retry_rate$campaignQS$groupQS&SUBMIT=$SUBMIT&file_download=1\">"._QXZ("DOWNLOAD")."</a></TD></TR>";
$MAIN.="</div>";
$MAIN.="</TD>";
$MAIN.="</TR>";
$MAIN.="</TABLE>\n";
...
#		$HTML_text.="<tr class='records_list_x'><td><font size=1>"._QXZ("Grade of service: ")."</font></td><td><font size=1>".sprintf("%0.2f", (100*$GoS))."%</font></td></tr>"; # B
	...
	if ($erlang_type=="C") {
		$HTML_text.="<tr class=''><td><font size=1>"._QXZ("Estimated queue probability: ")."</font></td><td><font size=1>".sprintf("%.2f", (100*$Pqueue))."%</font></td></tr>"; # C
		$HTML_text.="<tr class=''><td><font size=1>"._QXZ("Average speed of answering: ")."</font></td><td><font size=1>".sec_convert($ASA,'H')."</font></td></tr>"; # C
	}
#	$HTML_text.="<tr class='records_list_y'><td><font size=1>"._QXZ("Estimated agents fielding calls: ")."</font></td><td><font size=1>".$lines."</font></td></tr>";
	...
	$HTML_text2.="<tr ><td colspan='2' align='center'><B>"._QXZ("INBOUND SUMMARY")."</B></td></tr>";
	if ($actual_agents>0) {
		$HTML_text2.="<tr><td>"._QXZ("Actual agents: ")."</td><td nowrap>".$actual_agents."</td></tr>";
	}
	$HTML_text2.="<tr><td>"._QXZ("Total calls: ")."</td><td nowrap>".$erlang_calls."</td></tr>";
	$HTML_text2.="<tr><td>"._QXZ("Total drops: ")."</td><td nowrap>".$drops_blocks."</td></tr>";
	$HTML_text2.="<tr><td>"._QXZ("Desired drop rate: ")."</td><td nowrap>".sprintf("%5.2f", "$drop_percent")." %</td></tr>";
	$HTML_text2.="<tr><td>"._QXZ("Total blocking/drop rate: ")."</td><td nowrap>".sprintf("%-5.2f", (100*$total_blocking))." %</td></tr>";
	...
	$HTML_text2.="<tr><td>"._QXZ("Sale rate: ")."</td><td nowrap>".sprintf("%-5.2f", (100*$sale_percent))." %</td></tr>";
	$HTML_text2.="<tr><td>"._QXZ("Average call duration: ")."</td><td nowrap><font size=1>".sprintf("%18.2f", "$average_call_length")."</td></tr>";
	$HTML_text2.="<tr><td>"._QXZ("Erlangs: ")."</td><td nowrap>".sprintf("%18.4f", $total_erlangs)."</font></td></tr>";
	$HTML_text2.="<tr><td>"._QXZ("Grade of service: ")."</td><td nowrap>".sprintf("%0.2f", (100*$est_GoS))."%</td></tr>"; # B
	$HTML_text2.="<tr><td>"._QXZ("Estimated agents fielding calls: ")."</td><td nowrap>".$est_lines."</font></td></tr>";
	$HTML_text2.="<tr><td>"._QXZ("Recommended agent count: ")."</td><td nowrap>".$lines."</td></tr>";
	$HTML_text2.="</table>";
	$HTML_text2.="</td>";
	...
	$HTML_text2.="<TR >\n";
	$HTML_text2.="<TD><B>"._QXZ("CALLING HOUR")."</B></TD>\n";
	$HTML_text2.="<TD><B>"._QXZ("CALLS")."</B></TD>\n";
	$HTML_text2.="<TD><B>"._QXZ("SALES")."</B></TD>\n";
	$HTML_text2.="<TD><B>"._QXZ("TOTAL TIME")."</B></TD>\n";
	$HTML_text2.="<TD><B>"._QXZ("AVG TIME")."</B></TD>\n";
	$HTML_text2.="<TD><B>"._QXZ("DROPPED HRS")."</B></TD>\n";
	$HTML_text2.="<TD><B>"._QXZ("BLOCKING")."</B></TD>\n";
	$HTML_text2.="<TD><B>"._QXZ("ERLANGS")."</B></TD>\n";

	if ($erlang_type=="B") {
		$HTML_text2.="<TD><B>"._QXZ("GRADE OF SERVICE")."</B></TD>\n"; # B
	}
	if ($erlang_type=="C") {
		$HTML_text2.="<TD><B>"._QXZ("QUEUE PROB")."</B></TD>\n"; # C
		$HTML_text2.="<TD><B>"._QXZ("AVG ANSWER")."</B></TD>\n"; # C
	}

	$HTML_text2.="<TD><B>"._QXZ("REC AGENTS")."</B></TD>\n";
	$HTML_text2.="<TD><B>"._QXZ("EST AGENTS")."</B></TD>\n";
	$HTML_text2.="<TD><B>"._QXZ("CALLS PER AGENT")."</B></TD>\n";
	...
	foreach($erlang_array as $key => $val) {
		...
		$HTML_text2.="<tr >\n";
		$HTML_text2.="<td>".date("Y-m-d ha", mktime(substr($key, -2), 0, 0, substr($key, 5, 2), substr($key, 8, 2), substr($key, 0, 4)))."</td>\n";
		$HTML_text2.="<td>".$val[2]."</td>\n";
		$HTML_text2.="<td>".$sales."</td>\n";
		$HTML_text2.="<td>".sec_convert($val[0],'H')."</td>\n";
		$HTML_text2.="<td>".sec_convert($average_time,'H')."</td>\n";
		$HTML_text2.="<td>".sec_convert($val[1],'H')."</td>\n";
		$HTML_text2.="<td>".sprintf("%01.4f", $blocking)."</td>\n";
		$HTML_text2.="<td>".sprintf("%01.4f", $erlangs)."</td>\n";
		...
		if ($erlang_type=="B") {
			$HTML_text2.="<td>".sprintf("%0.2f", (100*$GoS))."%</td>\n"; # B
		}
		if ($erlang_type=="C") {
			$HTML_text2.="<td>".sprintf("%.4f", (100*$Pqueue))."%</td>\n"; # C
			$HTML_text2.="<td>".sec_convert($ASA,'H')."</td>\n"; # C
		}
		$HTML_text2.="<td><font size=1>$recommended_agents</td>\n";
...
#		$CSV_text.="\"$".number_format((($revenue_per_sale*$sales)-($lines*$hourly_pay)),2,".",",")."\"\n";
		...
		$HTML_text2.="<td>$lines</td>\n";
		$HTML_text2.="<td>".sprintf("%.2f", ($val[2]/$lines))."</td>\n";
