...
if ( ($stage == 'empty') or (strlen($stage) < 1) )
	...
	echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("Settings Compare Utility").'</h3></div><div class="col-md-12"><div class="content">';
	
	echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET ID='vicidial_report' NAME='vicidial_report'>\n";
	echo "<input type=hidden name=DB value=\"$DB\">\n";
	echo "<div class='col-lg-6' style='display:flex;align-items: center;
    margin-bottom: 18px;'>";
	echo "<FONT SIZE=2 style='width: 140px;'>"._QXZ("Settings Type").": </FONT></br>";
	echo "<select class='form-control' size=1 name=stage></div>";
	...
	echo "<TABLE class='settings-table' CELLPADDING=4 CELLSPACING=4 WIDTH=100%><TR><TD COLSPAN=2 border=0>";

	echo "<FONT SIZE=3 FACE=\"Ariel,Helvetica\"><b>\n";
	echo "<div class='col-md-12 no-padding'><div class='block-flat'><div class='header'><h3 class='pull-left'>"._QXZ("Settings Compare Utility").$NWB."settings_compare".$NWE." &nbsp; &nbsp; &nbsp; &nbsp; $stage &nbsp; &nbsp; &nbsp; &nbsp; <a class='btn btn-info' href=\"$PHP_SELF\">"._QXZ("RESET")."</a></h3><br><br>\n";
	...
	if (strlen($stmt) > 10)
		...
		echo "<div class=\"form-group custom-input mb-10\"><select class='form-control' size=1 name=first_id>";
		echo "$first_id_menu";
		echo "</select><label>"._QXZ("$stage")." 1: </label></div></div>";
		
		echo "<div class='col-lg-5'>";
		//~ echo "<FONT SIZE=2>"._QXZ("$stage")." 2: </FONT>";
		echo "<div class=\"form-group custom-input mb-10\"><select class='form-control' size=1 name=second_id>";
		echo "$second_id_menu";
		echo "</select><label>"._QXZ("$stage")." 2: </label></div></div> &nbsp; ";
		echo "<br>\n";
