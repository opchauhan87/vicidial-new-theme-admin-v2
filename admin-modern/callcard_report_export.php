...
##### END RUN THE EXPORT AND OUTPUT FLAT DATA FILE #####
	...
	echo "<div id=\"pcont4\" class=\"container-fluid\">
			  ...
			  <div class=\"header\">
			  <h3>"._QXZ("Export CallCard Calls Report")."</h3>
			  </div>";
	echo "<BR>\n";
	...
	/*echo "<B>"._QXZ("Date Range").":</B></div>";
	echo "<div class=\"col-lg-2 no-padding\">";
	echo "<div class=\"col-md-9 no-padding\">";
	echo "<div class=\"col-md-12\">";
	echo "<INPUT class=\"form-control\" TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\">&nbsp;";
	echo "</div></div>";
	echo "<div class=\"col-md-1\" style='margin-top:9px;margin-left:-10px;'>";*/
...
//	echo "</TD><TD ALIGN=LEFT VALIGN=TOP ROWSPAN=2>\n";
	...
	echo "<TABLE class='table1 col_table' width=400 cellspacing=3>\n";
	
	echo "<tr><td>";
	
	echo "<div>"._QXZ("Date Range")."</div></td><td>";
	echo "<div class='col-lg-10' style='padding:0;'><INPUT class=\"form-control\" TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"></div>";
	echo "<div class='col-lg-2' style='margin-top:7px;'>";
	...
	<?php
	echo "</td><td>";
	echo "<span>"._QXZ("to")."</span></div></td><td>";
	echo "<div class='col-lg-10' style='padding:0;'><INPUT class=\"form-control\" TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div>";
	echo "<div class='col-lg-2' style='margin-top:7px;'>";
	
	
	/*echo "</div></div></div>";
	echo "<div class=\"col-xs-1\" style='width:4%;margin-left:-20px;margin-top:7px;'>"._QXZ("to")."</div>";
	echo "<div class=\"col-lg-2 no-padding\">";
	echo "<div class=\"col-md-9 no-padding\">";
	echo "<div class=\"col-md-12\">";
	echo "<INPUT class=\"form-control\" TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\">";
	echo "</div></div>";
	echo "<div class=\"col-md-1\" style='margin-top:9px;margin-left:-10px;'>";*/
	?>
	<script language="JavaScript">
	...
	echo "<tr><td>"._QXZ("Card ID").": </td><td align=left><div class=\"col-md-12 no-padding\"><input class=\"form-control\" type=text name=card_id size=20 maxlength=20></div></td><td align=right>"._QXZ("Agent").": </td><td align=left><div class=\"col-md-12 no-padding\"><input class=\"form-control\" type=text name=agent size=20 maxlength=20></div></td></tr>\n";
	echo "<tr><td>"._QXZ("DID").": </td><td align=left><div class=\"col-md-12 no-padding\"><input class=\"form-control\" type=text name=did size=18 maxlength=18></div></td><td align=right>"._QXZ("CallerID").": </td><td align=left><div class=\"col-md-12 no-padding\"><input class=\"form-control\" type=text name=callerid size=18 maxlength=18></div></td></tr>\n";
	echo "<tr><td>"._QXZ("Run").": </td><td align=left><div class=\"col-md-12 no-padding\"><input class=\"form-control\" type=text name=run size=5 maxlength=4></div></td><td align=right>"._QXZ("Batch").": </td><td align=left><div class=\"col-md-12 no-padding\"><input class=\"form-control\" type=text name=batch size=6 maxlength=5></div></td></tr>\n";
	echo "<tr><td>"._QXZ("Sequence").": </td><td align=left><div class=\"col-md-12 no-padding\"><input class=\"form-control\" type=text name=sequence size=6 maxlength=5></div></td></tr>\n";
	echo "</TABLE>\n";
	echo "</div>";

	
	echo "<div class=\"col-lg-12 spacer\"><center><INPUT class='btn btn-bdr-sucess' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></center></div>";
	echo "</div></div>\n";
