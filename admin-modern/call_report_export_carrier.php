...
//	echo "<CENTER><BR>\n";
	...
	if ($ivr_export == 'YES')
		{echo " IVR";}
	//echo "</B></FONT><BR>\n";
	echo "<div class='size no-border spacer'><b>"._QXZ("This report will export the same data as the Calls Export Report, but with Dial Log and Carrier Log entries  as well, when they are found. After submitting the form, click on the link at the bottom of the screen to download your results.")."</b></div>\n";
	...
	echo "<TABLE BORDER=0 CELLSPACING=8 class='block-flat spacer no-border'><TR><TD class='no-border col-sm-2' ALIGN=LEFT VALIGN=TOP >\n";

	echo "<div class='col-lg-12 no-padding'></font></div><BR><CENTER>\n";
	echo "<div class='col-md-9 no-padding'><div class=\"form-group custom-input mb-10\"><INPUT TYPE=TEXT NAME=query_date class=form-control SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date Range")."</label></div></div></div><div class='col-md-2'>";
...
echo "</div></br><div class='col-lg-9 no-padding'><b>"._QXZ("to")."</b><BR></div>\n";
	echo "<div class='col-md-9 no-padding'><INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div><div class='col-md-2'>";
	...
	echo "</TD><TD ALIGN=LEFT VALIGN=TOP class='no-border col-sm-2'>\n";
	echo "<font class=\"select_bold\"></font><BR><CENTER>\n";
	echo "<div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><SELECT SIZE=6 class=form-control NAME=campaign[] multiple>\n";
		$o=0;
	...
	echo "</SELECT><label>"._QXZ("Campaigns")."</label></div></div></div>\n";

	if ($ivr_export != 'YES')
		{
		echo "</TD><TD ALIGN=LEFT VALIGN=TOP class='no-border col-sm-2'>\n";
		echo "<font class=\"select_bold\"></font><BR><CENTER>\n";
		echo "<div class='col-lg-12 no-padding'><div class=\"form-group custom-input mb-10\"><SELECT class=form-control SIZE=6 NAME=group[] multiple>\n";
			$o=0;
	...
	echo "</SELECT><label>"._QXZ("Inbound Groups")."</label></div></div>\n";
		}
	echo "</TD><TD ALIGN=left VALIGN=TOP class='no-border col-sm-2'>\n";
	echo "<font class=\"select_bold\"></font><CENTER>\n";
	echo "<div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><SELECT class=form-control SIZE=6 NAME=list_id[] multiple>\n";
		$o=0;
...
echo "</SELECT><label>"._QXZ("Lists")."</label></div></div>\n";
	echo "</TD><TD ALIGN=LEFT VALIGN=TOP class='no-border col-sm-2'>\n";
	echo "<font class=\"select_bold\"></font><CENTER>\n";
	echo "<div class='col-lg-14 no-padding'><div class=\"form-group custom-input mb-10\"><SELECT class=form-control SIZE=6 NAME=status[] multiple>\n";
		$o=0;
	...
	echo "</SELECT><label>"._QXZ("Statuses")."</label></div></div>\n";
	if ($ivr_export != 'YES')
		{
			echo "</TD><TD ALIGN=LEFT VALIGN=TOP class='no-border col-sm-2'>\n";
	echo "<font class=\"select_bold\"></font><CENTER>\n";
		echo "<div class=\"form-group custom-input mb-10\"><SELECT class=form-control SIZE=6 NAME=user_group[] multiple>\n";
			$o=0;
	...
	echo "</TD></TR><TR>\n";
	echo "<td class='no-border col-sm-2'><div class='col-lg-12 no-padding'></div>\n";
	echo "<div class='col-lg-9 no-padding'><div class=\"form-group custom-input mb-10\"><select size=1 name=header_row class=form-control><option selected><br/><br/>"._QXZ("YES")."</option><option>"._QXZ("NO")."</option></select><label>"._QXZ("Header Row")."</label></div></div></td>\n";

	echo "<td class='no-border col-sm-2'><div class='col-lg-12 no-padding'></div>\n";
	echo "<div class='col-lg-9 no-padding'><div class=\"form-group custom-input mb-10\"><select size=1 name=rec_fields class=form-control>";
	echo "<option value='ID'><br/><br/>"._QXZ("ID")."</option>";
	echo "<option value='FILENAME'><br/><br/>"._QXZ("FILENAME")."</option>";
	echo "<option value='LOCATION'><br/><br/>"._QXZ("LOCATION")."</option>";
	echo "<option value='ALL'><br/><br/>"._QXZ("ALL")."</option>";
	echo "<option value='NONE' selected><br/><br/>"._QXZ("NONE")."</option>";
	echo "</select><label>"._QXZ("Recording Fields")."</label></div></div></td>\n";

if ($custom_fields_enabled > 0)
		{
		echo "<td class='no-border col-sm-2'><div class='col-lg-12 no-padding'>";

		echo "</div>\n";
		echo "<div class='col-lg-9 no-padding'><div class=\"form-group custom-input mb-10\"><select size=1 name=custom_fields class=form-control><option value='YES'>"._QXZ("YES")."</option><option value='NO' selected><br/><br/>"._QXZ("NO")."</option></select><label>"._QXZ("Custom Fields")."</label></div></div></td>\n";
		}

	echo "\n";

	echo "<td class='no-border col-sm-2'><div class='col-lg-12 no-padding'></div>\n";
	echo "<div class='col-lg-9 no-padding'><div class=\"form-group custom-input mb-10\"><select size=1 name=call_notes class=form-control><option>"._QXZ("YES")."</option><option selected>"._QXZ("NO")."</option></select><label>"._QXZ("Per Call Notes")."</label></div></div></td>\n";


	echo "\n";

	echo "<td class='no-border col-sm-2'><div class='col-lg-9 no-padding'></div>\n";
	echo "<div class='col-lg-12 no-padding'><div class=\"form-group custom-input mb-10\"><select size=1 name=export_fields class=form-control><option selected><br/><br/>"._QXZ("STANDARD")."</option><option><br/><br/>"._QXZ("EXTENDED")."</option></select><label>"._QXZ("Export Fields")."</label></div></div></td>\n";
	if (($outbound_to_print > 0) or ($inbound_to_print > 0)) {
		$rslt_msg="<a class='btn btn-success' href='$PHP_SELF?run_export=$run_export&ivr_export=$ivr_export&query_date=$query_date&end_date=$end_date&header_row=$header_row&rec_fields=$rec_fields&custom_fields=$custom_fields&call_notes=$call_notes&export_fields=$export_fields$campaignQS$groupQS$user_groupQS$listQS$statusQS&SUBMIT=SUBMIT&file_download=1'>Download file here</a>";
	}

		echo "</TD></TR><TR></TD><TD class=text-CENTER VALIGN=TOP COLSPAN=6 class='no-border'>\n";
	echo "<br/><INPUT TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'>\n";
	echo "$rslt_msg\n";
	echo "</TD></TR></TABLE>\n";
	echo "</FORM>\n\n";
