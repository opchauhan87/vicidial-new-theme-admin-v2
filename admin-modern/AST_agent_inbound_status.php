...
if ($file_download < 1)
	...
	echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")." $NWB#agent_status_detail$NWE</h3><div class='pull-right'><a class='btn btn-info' href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div> </div>
...
if ( (strlen($group[0]) < 1) or (strlen($user_group[0]) < 1) )
	...
	if ($file_download < 1)
		...
		$HTML_text.="<table border='0' cellpadding=2 cellspacing='0' class='table_list hover centerline'>";
		$HTML_text.="<thead><tr bgcolor=''>";
		$HTML_text.="<th><a style='color:#fff !important;' href=\"$LINKbase\">"._QXZ("USER NAME")."</a>&nbsp;</th>";
		$HTML_text.="<th><a style='color:#fff !important;' href=\"$LINKbase&stage=ID\">"._QXZ("ID")."</a>&nbsp;</th>";
		$HTML_text.="<th><a style='color:#fff !important;' href=\"$LINKbase&stage=LEADS\">"._QXZ("CALLS")."</a>&nbsp;</th>";
		$HTML_text.="<th><a style='color:#fff !important;' href=\"$LINKbase&stage=CI\">"._QXZ("CIcalls")."</a>&nbsp;</th>";
		$HTML_text.="<th><a style='color:#fff !important;' href=\"$LINKbase&stage=DNCCI\">DNC/CI%</a>&nbsp;</th>";
	...
	#	$DNCcountPCTs = sprintf("%3.2f", $DNCcountPCTs);
		...
		if ($file_download < 1)
			...
			$ToutputHTML  = "<tr bgcolor=''><td align='center'><font size=2 face=\"Arial,Helvetica\">$Sfull_name</td><td align='center'><a href=\"./user_stats.php?user=$RAWuser\"><font size=2 face=\"Arial,Helvetica\">$Suser</a></td><td align='center'><font size=2 face=\"Arial,Helvetica\">$Scalls</td><td align='center'><font size=2 face=\"Arial,Helvetica\">$CIScount</td><td align='center'><font size=2 face=\"Arial,Helvetica\">$DNCcountPCTs%</td>$SHTML_statuses</tr>\n";
			$ToutputHTML .= "<tr bgcolor=''><td colspan='5'><font size=1 face=\"Arial,Helvetica\">&nbsp;</td>$SHTML_statusespct</tr>\n";
...
echo "<TABLE CELLSPACING=3 BGCOLOR=\"\"><TR><TD class='col-md-4' VALIGN=TOP> ";
echo "<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
echo "<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date  MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Dates").":</label></div></div>";

?>
<div class='col-md-2 text-center p-18'>
...
echo "<div class='col-md-12' style='text-align:center;'> "._QXZ("to")." </div><div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div></div>";
...
echo "<div class='col-lg-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
...
echo "<div class='col-lg-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=user_group[] multiple>\n";
...
echo "</TD><TD class='col-md-4' VALIGN=TOP><div class='col-md-12'><div class='form-group custom-input mb-10'>";
echo "<SELECT class='form-control' SIZE=1 NAME=shift>\n";
...
echo "</SELECT><label>"._QXZ("Shift").":</label></div></div><BR><BR>\n";

echo "<div class='col-md-12'><div class='form-group custom-input mb-10'><select class='form-control' name='report_display_type'>";
if ($report_display_type) {echo "<option value='$report_display_type' selected>"._QXZ("$report_display_type")."</option>";}
echo "<option value='TEXT'>TEXT</option><option value='HTML'>HTML</option></select><label>"._QXZ("Display as").":</label></div></div>\n<BR>";

echo "<input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label><BR>\n";
echo "<input type='checkbox' name='show_defunct_users' value='checked' $show_defunct_users><label>"._QXZ("&nbsp;Show defunct users")."</label><BR><BR>\n";
echo "</TD>";
...
echo "</TR><TR><TD colspan=3><div class='col-md-12 text-center'>";
echo " <INPUT class='btn btn-success' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
echo "<a class='btn btn-bdr-blue' href=\"$LINKbase&stage=$stage&file_download=1\">"._QXZ("DOWNLOAD")."</a>";
...
if (!$report_display_type || $report_display_type=="TEXT")
	{
	echo "<span style=\"\"  id=agent_status_bars>\n";
	echo "<PRE class='m-0' ><FONT SIZE=2>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n";
