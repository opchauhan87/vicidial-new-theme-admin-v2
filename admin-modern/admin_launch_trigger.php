...
if ( ($stage=="LAUNCH") && (strlen($container_id) > 1) ) 
	...
	echo "<div id=\"pcont4\" class=\"container-fluid\">
			  ...
			  <div class=\"header\">
			  <h4>"._QXZ("Custom Process trigger page for TEST. Select a Container below and click SUBMIT to launch the process.")."</h4>
			  </div>";
...
echo "<table align=left width='770' border=1 cellpadding=0 cellspacing=0 >";

echo "<tr><td align=right>"._QXZ("Container").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=container_id>\n";
...
echo "<tr><td align=center colspan=2><input class= btn btn-bdr-sucess type=submit name=SUBMIT value='"._QXZ("SUBMIT")."'></td></tr>\n";
