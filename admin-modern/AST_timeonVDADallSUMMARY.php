...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")."$NWB#CLOSERstats$NWE</h3> ";
		// $NWB = "<IMG SRC=\"help.png\" onClick=\"FillAndShowHelpDiv(event, '";
		$MAIN.="<div class='pull-right'>  <a class='btn btn-info' href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div>";
...
$MAIN.="<div class='col-xs-2'><a href=\"$PHP_SELF?group=$group&RR=4000&DB=$DB&adastats=$adastats&types=$types\">"._QXZ("STOP")."</a> | ";
$MAIN.="<a href=\"$PHP_SELF?group=$group&RR=40&DB=$DB&adastats=$adastats&types=$types\">"._QXZ("SLOW")."</a> | ";
$MAIN.="<a href=\"$PHP_SELF?group=$group&RR=4&DB=$DB&adastats=$adastats&types=$types\">"._QXZ("GO")."</a> </div>";
//~ $MAIN.=" &nbsp; &nbsp; \n";
if ($adastats<2)
	{
	$MAIN.="<div class='col-md-2 no-padding'><a href=\"$PHP_SELF?group=$group&RR=$RR&DB=$DB&adastats=2&types=$types\">+ "._QXZ("VIEW MORE SETTINGS")."</a></div>";
	}
else
	{
	$MAIN.="<div class='col-md-2 no-padding'><a href=\"$PHP_SELF?group=$group&RR=$RR&DB=$DB&adastats=1&types=$types\">- "._QXZ("VIEW LESS SETTINGS")."</a></div>";
	}
...
$MAIN.="<div class='col-md-6 realtime-campaign-col no-padding'><select class='form-control' size=1 style='width:90%; margin 0px 19px' name=types>\n";
...
$MAIN.="</select> </div>\n";
$MAIN.="<input class='btn btn-success realtime-report-submit' type=submit name=submit value='"._QXZ("SUBMIT")."'>\n";
$MAIN.="<a class='btn btn-bdr-blue realtime-report-download' href=\"$PHP_SELF?group=$group&RR=$RR&DB=$DB&adastats=$adastats&types=$types&file_download=1\">"._QXZ("DOWNLOAD")."</a>";
$MAIN.="<BR><BR>\n\n";
...
$MAIN.="<div class='col-md-10 text-left'><b><a href=\"./realtime_report.php?group=$group&RR=$RR&DB=$DB&adastats=$adastats\">$group</a></b> &nbsp; - &nbsp; ";
$MAIN.="<a  href=\"./admin.php?ADD=34&campaign_id=$group\">"._QXZ("Modify")."</a></div>";
...
$MAIN.="<BR><table class='centerline hover' cellpadding=0 cellspacing=0><TR>";
...
$MAIN.="<TR>";
$MAIN.="<TD class='text-center' ALIGN=LEFT COLSPAN=8>";
...
$talking_to_print = mysqli_num_rows($rslt);
	...
	while ($i < $talking_to_print)
		...
		$MAIN.="<span class='badge badge-info'>$NFB$agent_total$NFE</span> "._QXZ("agents logged in")." &nbsp; &nbsp; &nbsp; &nbsp; \n";
		$MAIN.="<span class='badge badge-info'>$NFB$agent_incall$NFE</span> "._QXZ("agents in calls")." &nbsp; &nbsp; &nbsp; \n";
		$MAIN.="$NFB$B &nbsp;<span class='badge badge-info'>$agent_ready $BG$NFE </span>"._QXZ("agents waiting")." &nbsp; &nbsp; &nbsp; \n";
		$MAIN.="<span class='badge badge-info'>$NFB$agent_paused$NFE </span> "._QXZ("paused agents")." &nbsp; &nbsp; &nbsp; \n";
