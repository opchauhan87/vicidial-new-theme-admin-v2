...
<!--
   ...
   table td i{width:auto !important}
-->
 </STYLE>
...
echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")."$NWB#DQreport$NWE".'</h3>';

echo "<div class=pull-right><a class='btn btn-info' href=\"./admin.php?ADD=31&campaign_id=$group\">"._QXZ("MODIFY")."</a> <a class='btn btn-info' href=\"./campaign_debug.php?group=$group\">"._QXZ("DQ Debug")."</a></div>";		
		
	echo '</div><div class="col-md-12"><div class="content">';
echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET>\n";
echo "<TABLE CELLPADDING=4 CELLSPACING=0><TR><TD align=left valign=top>\n";
echo "<div class='col-lg-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=group>\n";
$o=0;
...
echo "<tr><td><div align='center' class='col-md-12'><INPUT class='btn btn-success' TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></div></td></tr></TABLE></FORM>\n";
...
if (!$group)
	...
	echo "<table border=0 cellspacing=2 cellpadding=0> <tr bgcolor=''><td>"._QXZ("Campaign").": </td><td>$group - $campaign_name &nbsp; $campaign_activeSTATUS</td></tr>\n";
	echo "<tr bgcolor=''><td>"._QXZ("Total leads in hopper right now").": </td><td>$TOTALcalls &nbsp; <i>"._QXZ("level").": $hopper_level</i> &nbsp; "._QXZ("dialable").": $dialable_leads</td></tr>\n";
	echo "<tr bgcolor=''><td>"._QXZ("Dial statuses").": </td><td>$dial_statuses</td></tr>\n";
	echo "<tr bgcolor=''><td>"._QXZ("Campaign last call date").": </td><td>$campaign_calldate &nbsp; <i>"._QXZ("calls today").": $calls_today &nbsp; ("._QXZ("calls, last hour / five-min").": $calls_hour / $calls_fivemin)</i></td></tr>\n";
	echo "<tr bgcolor=''><td>"._QXZ("Campaign last agent login date").": </td><td>$campaign_logindate</td></tr>\n";
	echo "<tr bgcolor=''><td>"._QXZ("Demographic Quotas").": </td><td>$demographic_quotas &nbsp; $DQdebug</td></tr>\n";
	echo "<tr bgcolor=''><td><a href=\"admin.php?ADD=392111111111&container_id=$demographic_quotas_container\">"._QXZ("Demographic Quotas Container")."</a>: </td><td>$demographic_quotas_container</td></tr>\n";
	echo "<tr bgcolor=''><td>"._QXZ("Demographic Quotas Re-Rank").": </td><td>$demographic_quotas_rerank &nbsp; <i>"._QXZ("last re-rank").": $demographic_quotas_last_rerank</i></td></tr>\n";
	echo "<tr bgcolor=''><td>"._QXZ("Demographic Quotas List Resets").": </td><td>$demographic_quotas_list_resets</td></tr>\n";
