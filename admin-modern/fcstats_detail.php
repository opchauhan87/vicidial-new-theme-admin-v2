...
$HTML_head.="<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 874px; top: 234px; opacity: 1; z-index: 2;'></div>";
...
$HTML_text.='<div id="pcont4" class="container-fluid">
		...
		';
$HTML_text.="<div class='header'><h3 class='pull-left'>"._QXZ("$report_name")." $NWB#fcstats$NWE</h3><div class='pull-right'> <a class='btn btn-info' href=\"./admin.php?ADD=3111&group_id=$group\">"._QXZ("MODIFY")."</a> <a class='btn btn-info' href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div></div>\n";
...
$HTML_text.="<TABLE CELLPADDING=3 CELLSPACING=0  valign=top><TR><TD class='col-md-4' valign=top>";

$HTML_text.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date").":</label></div></div><div class='col-md-2 text-center p-18'>";
...
$HTML_text.="</script> </div><div class='col-md-10' style='text-align:center;'>"._QXZ("to")."</div> ";
$HTML_text.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT  class='form-control'
 TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div></div><div class='col-md-2 text-center p-18'>";
$HTML_text.="<script language=\"JavaScript\">\n";
$HTML_text.="var o_cal = new tcal ({\n";
$HTML_text.="	// form name\n";
$HTML_text.="	'formname': 'vicidial_report',\n";
...
$HTML_text.="o_cal.a_tpl.yearscroll = false;\n";
$HTML_text.="// o_cal.a_tpl.weekstart = 1; // Monday week start\n";
$HTML_text.="</script></div><BR> <BR>";

$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=users[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Users").":</label></div></div>\n";




$HTML_text.="</td><td class='col-md-4' valign=top>";
$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'> <SELECT class='form-control' SIZE=1 NAME=group>\n";
	$o=0;
...
$HTML_text.="</SELECT><label>"._QXZ("Ingroup")."</label></div></div>\n";
...
$HTML_text.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>"._QXZ("Display").":</label></div></div>";
	$HTML_text.=" <div class='col-md-12'><div class='form-group custom-input mb-10'> <SELECT class='form-control' SIZE=1 NAME=shift>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Shift").":</label></div></div>\n";
$HTML_text.="<div class='col-md-12'><input type='checkbox' name='show_summary' value='checked' $show_summary><label>"._QXZ("&nbsp;Show fronter/closer summary")."</label></div>";
...
if ($archives_available=="Y") 
	{
	$HTML_text.="<BR><div class='col-md-12'><input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label></div>\n";
	}
$HTML_text.="</td>";

$HTML_text.="<TD class='col-md-4' VALIGN=TOP> <div class='col-md-12'><div class='form-group custom-input mb-10'>";
$HTML_text.="<SELECT class='form-control' SIZE=5 NAME=campaign[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$campaign_string))
...
$HTML_text.="</SELECT><label>"._QXZ("Campaigns")."</label></div></div>\n";


$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=user_group[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("User Groups").":</label></div></div>\n";

$HTML_text.="</TD>";



$HTML_text.="</TR><TR><TD colspan=3><div class='col-md-12 text-center'>";

$HTML_text.="<INPUT TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-success'>\n";
$HTML_text.="<a class='btn btn-bdr-blue' href=\"$PHP_SELF?query_date=$query_date&end_date=$end_date&group=$group&shift=$shift&file_download=1&show_unanswered_xfers=$show_unanswered_xfers&search_archived_data=$search_archived_data&show_summary=$show_summary$campaignQS$user_groupQS$userQS\">"._QXZ("DOWNLOAD")."</a>";
$HTML_text.="</TD></TR></div></TABLE>\n";
$HTML_text.="</FORM>\n\n";
$HTML_text.="<PRE class='m-0'><FONT SIZE=2>$report_display_type\n\n";
