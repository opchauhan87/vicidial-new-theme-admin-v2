...
<?php echo _QXZ("Group Hourly Stats"); ?>
<?php echo " - ".$group ?></h3> </div>
<div class="col-md-12"><div class="content">


<CENTER>
<TABLE WIDTH=620 cellpadding=2 cellspacing=0>
...
echo "<tr><td><font size=2>"._QXZ("TSR")." </td><td align=left><font size=2>"._QXZ("ID")." </td><td align=right><font size=2> &nbsp; $status</td><td align=right><font size=2> &nbsp; "._QXZ("TOTAL CALLS")."</td><td align=right><font size=2> &nbsp; $status "._QXZ("DAY")."</td></tr>\n";
	...
	while($o < $tsrs_to_print)
		...
		if (preg_match('/1$|3$|5$|7$|9$/i', $o))
			...
			{$bgcolor='bgcolor=';} 
		echo "<tr ><td>$VDuser[$o]</td>";
		echo "<td align=left> $VDname[$o]</td>\n";
		echo "<td align=right> $VDcount[$o]</td>\n";
		echo "<td align=right> $VDtotal[$o]</td>\n";
		echo "<td align=right> $VDday[$o]</td>\n";
		echo "<td align=center><a class='btn btn-bdr-sucess' href=\"./admin.php?ADD=3&user=$VDuser[$o]\">"._QXZ("MODIFY")."</a>  <a class='btn btn-bdr-pink' href=\"./user_stats.php?user=$VDuser[$o]\">"._QXZ("STATS")."</a></td></tr>\n";
	...
	echo "<tr><td>"._QXZ("TOTAL")." </td><td align=right> $status </td><td align=right> $hour_calls</td><td align=right> $total_calls</td><td align=right> $day_calls</td></tr>\n";
...
echo "<table class='table1 col_table'><tr><td>";
...
echo "<div class='row'>";
		...
		echo "<select class='form-control' size=1 name=group>";
...
while ($groups_to_print > $o) 
	...
	echo "$groups_list</select><label>"._QXZ("Group")."</label>";
		...
		echo "<div class='col-md-6'>";		
		echo "<div class='form-group custom-input input-group mb-10'>";
		echo "<input class='form-control' type=text name=status size=10 maxlength=10 value=\"$status\"><label>"._QXZ("status(example:XFER)")."</label>";
		echo "</div>";
		echo "</div>";
		echo "</div>";
		...
		echo "<div class='col-md-6'>";		
		echo "<div class='form-group custom-input input-group mb-10'>";
		echo "<input class='form-control' type=text name=date_with_hour size=14 maxlength=13 value=\"$date_with_hour\"><label>"._QXZ("Date with hour(example: 2004-06-25 14)")."</label>";
		echo "</div>";
		echo "</div>";
		echo "</div>";
...
echo "<tr><td colspan=2  class=text-center><div class=''>"."<input class='btn btn-success' type=submit name=submit value='"._QXZ("SUBMIT")."' ></div></td></tr>\n";
echo "</table>\n";
