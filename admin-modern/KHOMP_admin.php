...
# print_r($khomps);
	...
	echo  "<!--\n";
	echo  "   .green {color: white; background-color: green}\n";
	...
	echo "<tr>";
	echo "<th NOWRAP colspan=3><font size=2>KHOMP</font></th>";
	echo "<th NOWRAP colspan=3><font size=2>VICIDIAL</font></th>";
	echo "<td NOWRAP>&nbsp;</td>";
	echo "</tr>";

	echo "<tr >";
	echo "<td NOWRAP width='$td_max_width2'><font><B>"._QXZ("CONCLUSION")."</B></font></td>";
	echo "<td width='$td_max_width' NOWRAP><font><B>"._QXZ("PATTERN")."</B></font></td>";
	echo "<td NOWRAP width='*'>&nbsp;</td>";
	echo "<td NOWRAP width='$td_max_width3'><font><B>"._QXZ("ACTION")." &nbsp; </B></font></td>";
	echo "<td NOWRAP width='$td_max_width3'><font><B>"._QXZ("STATUS")." &nbsp; </B></font></td>";
	echo "<td NOWRAP width='$td_max_width3'><font><B>"._QXZ("DIAL STATUS")." &nbsp; </B></font></td>";
	echo "<td align=center NOWRAP width='$td_max_width3'><font><B>"._QXZ("MODIFY")."</B></font></td></tr>\n";
	...
	foreach($blank_khomps as $key => $value)
		...
		echo "<tr >";
		echo "<td width='$td_max_width2'><font>".$kvalues[0]."</font></td>";
		echo "<td class='text_overflow' width='$td_max_width' style='max-width: ".$td_max_width."px'><font size=1 >".$kvalues[1]."</td>";
		echo "<th width='*'><font  align=center><B>=></B></font></th>";
		echo "<td width='$td_max_width3'><font  align=left>".$vvalues[0]."</font></td>";
		echo "<td width='$td_max_width3'><font align=left>".$vvalues[1]."</font></td>";
		echo "<td width='$td_max_width3'><font  align=left>".$vvalues[2]."</font></td>";
		echo "<td align='center' width='$td_max_width3'><font  align=left><input type='button'  class='btn btn-success' value='"._QXZ("MODIFY")."' onClick=\"ModifyKhompCode(event, '".$kvalues[0]."', '".$kvalues[1]."', '".$vvalues[0]."', '".$vvalues[1]."', '".$vvalues[2]."')\"</td>";
		echo "</tr>";
		$p++;
		}
	...
	foreach($khomps as $key => $value)
		...
		$vvalues=explode(".", $value);
		echo "<tr >";
		echo "<td width='$td_max_width2'><font align=left>".$kvalues[0]."</font></td>";
		...
		echo "<td width='$td_max_width3'><font align=left>".$vvalues[1]."</font></td>";
		echo "<td width='$td_max_width3'><font align=left>".$vvalues[2]."</font></td>";
		echo "<td align='center' width='$td_max_width3'><font size=1  align=left><input type='button' class='btn btn-success' value='"._QXZ("MODIFY")."' onClick=\"ModifyKhompCode(event, '".$kvalues[0]."', '".$kvalues[1]."', '".$vvalues[0]."', '".$vvalues[1]."', '".$vvalues[2]."')\"</td>";
		echo "</tr>";
		$p++;
		}
	...
	if (preg_match('/1$|3$|5$|7$|9$/i', $p))
		...
		{$bgcolor='class="records_list_y"';}
	echo "<tr>";
	echo "<th NOWRAP colspan=7><font >** "._QXZ("ADD NEW KHOMP DEFINITION")." **</font></th>";
	echo "</tr>";
	echo "<tr >";
	echo "<td NOWRAP ><input type='text' name='new_conclusion' class='form-control' size='15' maxlength='100'></td>";
	echo "<td NOWRAP ><input type='text' name='new_pattern' class='form-control' size='40' maxlength='300'></td>";
	echo "<th NOWRAP width='*'><font ><B>=></B></font></th>";
	echo "<td NOWRAP ><input type='text' name='new_action' class='form-control' size='10' maxlength='20'></td>";
	echo "<td NOWRAP ><input type='text' name='new_status' class='form-control' size='10' maxlength='20'></td>";
	echo "<td NOWRAP ><input type='text' name='new_dialstatus' class='form-control' size='10' maxlength='20'></td>";
	echo "<td NOWRAP align='center'><input type='submit' name='submit_khomp' value='"._QXZ("ADD")."' class='btn btn-primary'></td>";
	echo "</tr>";
