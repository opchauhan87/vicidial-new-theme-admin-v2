...
$MAIN.="<div id=\"pcont4\" class=\"container-fluid\"><div class=\"cl-mcont\"><div class=\"row\"><div class=\"col-md-12 no-padding\"><div class=\"block-flat\"><div class=\"header\"><h3>"._QXZ("Carrier Log Report")."</h3></div><div class=\"col-md-12\"><div class=\"content\"><TABLE CELLPADDING=4 CELLSPACING=0><TR><TD>";
$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE class=\"table1 col_table\" cellspacing=5 cellpadding=5><TR><TD class=\"no-border\" VALIGN=TOP >\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$MAIN.="<div class=\"col-md-12 size no-padding\">";
$MAIN.="<div class=\"col-lg-3 size no-padding\">";
//~ $MAIN.=_QXZ("Date").":\n";
$MAIN.="</div></div>";
$MAIN.="<div class=\"col-md-12 size\">";
$MAIN.="<div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\">";
$MAIN.="<INPUT class=\"form-control\" TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date")."</label></div></div>";
$MAIN.="<div class=\"col-lg-1 no-padding\">";
...
$MAIN.="<BR><BR><br><div class=\"col-lg-10 no-padding\"><INPUT class=\"form-control\" TYPE=TEXT NAME=query_date_D SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_D\"></div>";

$MAIN.="<div class=\"col-md-12 no-padding text-center\"> "._QXZ("to")."</div><div class=\"col-lg-10 no-padding\"><INPUT class=\"form-control\" TYPE=TEXT NAME=query_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_T\"></div>";

$MAIN.="</TD><TD ROWSPAN=2 VALIGN=TOP><BR/>\n";
$MAIN.="<div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><SELECT class=\"form-control\" SIZE=5 NAME=server_ip[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$server_ip_string))
...
$MAIN.="</SELECT><label>"._QXZ("Server IP")."</label></div></div></TD><TD ROWSPAN=2 VALIGN=middle align=center>\n";
...
$MAIN.="</br><INPUT class=\"btn btn-bdr-sucess\" TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'><BR/><BR/>\n";
$MAIN.="</TD></TR></TABLE>\n";
...
if ($SUBMIT && $server_ip_ct>0) {
	...
	if (mysqli_num_rows($rslt)>0) {
		...
		$HTML.="<table class='table_list hover centerline' border='0' cellpadding='3' cellspacing='1'>";
		$HTML.="<thead><tr>";
		...
		if (mysqli_num_rows($rslt)>0) {
			...
			$HTML.="<label>"._QXZ("SIP ERROR REASON BREAKDOWN FOR")." $query_date, $query_date_D "._QXZ("TO")." $query_date_T $server_rpt_string</label>";
			$HTML.="<table class='table_list hover centerline' border='0' cellpadding='3' cellspacing='1'>";
			$HTML.="<thead><tr>";
		...
		$HTML.="<label>"._QXZ("CARRIER LOG RECORDS FOR")." $query_date, $query_date_D "._QXZ("TO")." $query_date_T $server_rpt_string, "._QXZ("RECORDS")." #$lower_limit-$upper_limit</label>";
