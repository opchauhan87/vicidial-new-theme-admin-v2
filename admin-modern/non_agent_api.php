			...
			if ($admin_permission < 1)
				...
				if ($session_exists < 1)
					...
					if ($stage == 'text')
						...
						$output .= "<a href=\"#\" onclick=\"hide_ingroup_info();\">"._QXZ("Close")."</a></TD></TR><TR><TD COLSPAN=3>\n";
						...
						if ( ($allowed_user_change_ingroups > 0) and ($stage == 'change') )
							...
							$output .= "<SELECT style='width:70%' class='form-control' SIZE=1 NAME=ingroup_add_remove_change ID=ingroup_add_remove_change>\n";
							...
							$output .= "</TD><TD ALIGN=LEFT>\n";
							$output .= "<SELECT class='form-control' style='width:70%' SIZE=1 NAME=blended ID=blended";
							...
							$output .= "</TD><TD ALIGN=LEFT>\n";
							$output .= "<SELECT class='form-control' style='width:70%' SIZE=1 NAME=set_as_default ID=set_as_default";
							...
							$output .= "<INPUT class='btn btn-bdr-sucess' TYPE=BUTTON NAME=SUBMIT ID=SUBMIT VALUE=\""._QXZ("Submit Changes")."\" onclick=\"submit_ingroup_changes('$agent_user')\">\n";
							$output .= "</TD></TR>\n";
