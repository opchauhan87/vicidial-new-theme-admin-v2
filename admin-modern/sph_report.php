...
echo "<TABLE BORDER=0 CELLSPACING=6 style='margin: 0;border-bottom: 0;'><TR><TD ALIGN=LEFT VALIGN=TOP ROWSPAN=3>\n";

echo "<font class=\"select_bold\"><B>"._QXZ("Date Range").":</B></font><BR><CENTER>\n";
echo "<div class='col-md-12'><div class='col-md-10'><INPUT TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\" class='form-control'>";
...
echo " "._QXZ("to")." <div class='col-md-12'><div class='col-md-10'><INPUT class='form-control'  TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div>";
...
echo "<SELECT SIZE=5 NAME=group[] multiple class='form-control'>\n";
	$o=0;
...
echo "<SELECT SIZE=5 NAME=user_group[] multiple class='form-control'>\n";
	$o=0;
...
echo "</SELECT>\n";
echo "</TD><TD ALIGN=LEFT class='no-border'>\n";
echo "<font class=\"select_bold\"><B>"._QXZ("Shift").":</B></font><BR>\n";
echo "<SELECT SIZE=1 NAME=shift class='form-control'>\n";
...
echo "</TD><TD ALIGN=LEFT VALIGN=TOP COLSPAN=2 class='no-border'>\n";
echo "<font class=\"select_bold\"><B>"._QXZ("Role").":</B></font><BR>\n";
echo "<SELECT SIZE=1 NAME=role class='form-control'>\n";
...
echo "</TD><TD ALIGN=CENTER class='no-border' >\n";
echo "<FONT class=\"select_bold\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; <a href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a> </FONT>\n";

echo "</TD></TR><TR></TD><TD ALIGN=LEFT VALIGN=TOP class='no-border' >\n";
echo "<font class=\"select_bold\"><B>"._QXZ("Order").":</B></font><BR>\n";
echo "<SELECT SIZE=1 NAME=order class='form-control'>\n";
...
echo "</TD><TD ALIGN=LEFT VALIGN=TOP class='no-border'>\n";
echo "<font class=\"select_bold\"><B>"._QXZ("User").":</B></font><BR>\n";
echo "<INPUT TYPE=text NAME=user SIZE=7 MAXLENGTH=20 VALUE=\"$user\" class='form-control'>\n";

echo "</TD></TR></TABLE>\n";
echo '<table style="border-top: 0;" cellspacing="6" border="0"><tbody><tr style="margin: 0 auto;"><td class="no-border" colspan="6" valign="TOP" align="center"><input type="SUBMIT" name="SUBMIT" value="SUBMIT" class="btn btn-bdr-sucess">
</td></tr></tbody></table>';
echo "</FORM>\n\n";
...
echo "<TD ALIGN=CENTER><FONT >&nbsp; "._QXZ("USER")." &nbsp;</TD>\n";
echo "<TD ALIGN=CENTER><FONT >&nbsp; "._QXZ("NAME")." &nbsp;</TD>\n";
echo "<TD ALIGN=CENTER><FONT >&nbsp; "._QXZ("ROLE")." &nbsp;</TD>\n";
echo "<TD ALIGN=CENTER><FONT >&nbsp; "._QXZ("GROUP")." &nbsp;</TD>\n";
echo "<TD ALIGN=CENTER><FONT >&nbsp; "._QXZ("CALLS")." &nbsp;</TD>\n";
echo "<TD ALIGN=CENTER><FONT >&nbsp; "._QXZ("HOURS")." &nbsp;</TD>\n";
echo "<TD ALIGN=CENTER><FONT >&nbsp; "._QXZ("SALES")." &nbsp;</TD>\n";
echo "<TD ALIGN=CENTER><FONT >&nbsp; "._QXZ("SPH")." &nbsp;</TD>\n";
echo "</TR>\n";
