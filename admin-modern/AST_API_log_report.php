...
$HTML_text.="<TABLE CELLPADDING=3 CELLSPACING=0  class='no-border'><TR><TD class='no-border col-md-3'  VALIGN=TOP>";
...
$HTML_text.="<div class='col-md-10'>";
$HTML_text.="<div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=api_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$api_date_D\">";
$HTML_text.="<label>"._QXZ("Access date range")."</label></div></div>";

$HTML_text.="<div class='col-md-2' style='padding: 6px;'>";
$HTML_text.="<script language=\"JavaScript\">\n";
...
$HTML_text.=" <div style='padding-top: 42px !important;width: 84%;'> <INPUT class='form-control' TYPE=TEXT NAME=api_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$api_date_T\"></div>";
$HTML_text.="<div align='center'>"._QXZ("to")." </div><div class='col-md-12'><div class='col-md-10'><INPUT class='form-control'  TYPE=TEXT NAME=api_date_end_D SIZE=11 MAXLENGTH=10 VALUE=\"$api_date_end_D\"></div>";

$HTML_text.="<div class='col-md-2' style='padding: 6px;top:2px;'>";
$HTML_text.="<script language=\"JavaScript\">\n";
$HTML_text.="var o_cal = new tcal ({\n";
$HTML_text.="	// form name\n";
$HTML_text.="	'formname': 'vicidial_report',\n";
...
$HTML_text.="<div style='padding-top: 40px !important;width: 84%;'><INPUT class='form-control' TYPE=TEXT NAME=api_date_end_T SIZE=9 MAXLENGTH=8 VALUE=\"$api_date_end_T\"></div>";
$HTML_text.="</TD>";

$HTML_text.="<TD class='no-border col-md-3' VALIGN=TOP>";
$HTML_text.="<div class=\"col-lg-12\"><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=users[] multiple>\n";
...
//$HTML_text.="<input class='ace' type='checkbox' name='show_urls' value='checked' $show_urls>"._QXZ("Show URLs,slower")."\n";
//~ $HTML_text.="</TD>\n";

//~ $HTML_text.="<TD class='no-border' VALIGN=TOP>";
$HTML_text.="<div class=\"col-lg-12\"><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=agent_users[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Agent users")."</label></div></div>\n";
$HTML_text.="</TD>\n";


$HTML_text.="<TD class='no-border col-md-3' VALIGN=TOP>";
$HTML_text.="<div class=\"col-lg-12\"><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=functions[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Functions")."</label></div></div>\n";
//~ $HTML_text.="</TD>\n";


//~ $HTML_text.="<TD  class='no-border' VALIGN=TOP>";
$HTML_text.="<div class=\"col-lg-12\"><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=results[] multiple>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Results")."</label></div></div>\n";
$HTML_text.="</TD>\n";

$HTML_text.="<TD class='no-border col-md-3' VALIGN='TOP'>";
//~ $HTML_text.=_QXZ("Display as:")."<BR>";
$HTML_text.="<div class=\"col-lg-12\"><div class=\"form-group custom-input mb-10\"><select class='form-control' name='report_display_type'>";
if ($report_display_type) {$HTML_text.="<option value='$report_display_type' selected></option></div>"._QXZ("$report_display_type")."</option>";}
$HTML_text.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>"._QXZ("Display as")."</label></div>\n<BR><BR>";
$HTML_text.="<INPUT TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'>\n";
...
if ($SUBMIT && $api_date_D && $api_date_T && $api_date_end_D && $api_date_end_T) 
	...
	$HTML.="<label>$ASCII_rpt_header</label>";
	$HTML.="<label><a href=\"$PHP_SELF?api_date_D=$api_date_D&api_date_T=$api_date_T&api_date_end_D=$api_date_end_D&api_date_end_T=$api_date_end_T$resultQS$functionQS$agent_userQS$userQS&file_download=1&show_urls=$show_urls&search_archived_data=$search_archived_data&SUBMIT=$SUBMIT\">&nbsp;&nbsp;"._QXZ("DOWNLOAD")."</a></label>";
	...
	while ($row=mysqli_fetch_array($rslt)) 
		...
		$api_script[$g] =		sprintf("%-10s", $row["api_script"], 10);
		$function[$g] =			sprintf("%-20s", $row["function"], 20);
		$result[$g] =			sprintf("%-10s", $row["result"], 10);
		$source[$g] =			sprintf("%-20s", $row["source"], 20);
