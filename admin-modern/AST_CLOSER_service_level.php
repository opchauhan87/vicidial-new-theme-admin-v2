...
# 220303-0905 - Added allow_web_debug system setting
#
...
$HEADER.="<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 876px; top: 243px; opacity: 1; z-index: 2;'></div>";
...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")." $NWB#CLOSER_service_level$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=3111&group_id=$group\">"._QXZ("MODIFY")."</a><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div></div>
		<div class='col-md-12'><div class='content'>";
$MAIN.="<TR><TD class='no-border'>";
...
$MAIN.="<TABLE CELLPADDING=3><TR><td class=\"col-md-4\" valign='TOP'><div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control'  TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>Date:</label>";

$MAIN.="</div></div>";
$MAIN.="<div class='col-md-2 text-center p-18'><script language=\"JavaScript\">\n";
...
$MAIN.="</div><div class='col-md-12 text-center'><label>"._QXZ("to")."</label></div>";
$MAIN.="<div class='col-lg-10 no-padding'> <div class='form-group custom-input mb-10'><INPUT TYPE=TEXT class='form-control' NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div></div>";
...
$MAIN.="<div class=''><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=group>\n";
	$o=0;
...
$MAIN.="</SELECT><label>Inbound groups</label></div></div>\n";
$MAIN.="</td><td class=\"col-md-4\" valign=\"TOP\">\n";
...
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>Display as</label></div><br>\n";
...
$MAIN.="</SELECT><label>Shift</label></div></div><br>\n";

if ($archives_available=="Y") 
	{
	$MAIN.="<input class='' type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label>\n";
	}
...
$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> <a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date&group=$group&shift=$shift&SUBMIT=$SUBMIT&file_download=1&search_archived_data=$search_archived_data\">"._QXZ("DOWNLOAD")."</a>";
