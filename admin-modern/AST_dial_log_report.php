...
$MAIN.="<TABLE class=\"table1 col_table\" cellspacing=5 cellpadding=5><TR><TD class=\"no-border\" VALIGN=TOP>\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$MAIN.="<div class=\"col-md-12  no-padding\">";
$MAIN.="<div class=\"col-md-3  no-padding\">";
//~ $MAIN.=_QXZ("Date").":\n";
$MAIN.="</div></div>";
$MAIN.="<div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date")."</label></div></div>";
...
$MAIN.="<BR><BR><BR><BR><div class=\"col-lg-4 no-padding\"><INPUT class='form-control' TYPE=TEXT NAME=query_date_D SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_D\">";

$MAIN.="</div><div class=\"col-lg-1\"> "._QXZ("to")."</div><div class=\"col-lg-4 no-padding\"> <INPUT class='form-control' TYPE=TEXT NAME=query_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_T\"></div>";

$MAIN.="</TD><TD ROWSPAN=2 VALIGN=TOP>\n";
$MAIN.="<div class=\"col-lg-12 no-padding\"><div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=server_ip[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$server_ip_string))
...
$MAIN.="</SELECT><label>"._QXZ("Server IP")."</label></div></div></div></TD>";

$MAIN.="<TD ROWSPAN=2 VALIGN=top>";
$MAIN.="<div class=\"col-lg-12 no-padding\"><div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=sip_hangup_cause[] multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("SIP Response")."</label></div></div></div>";
$MAIN.="</TD>";
//chirag parmar
//12-03-21
//$MAIN.="<TD ROWSPAN=2 VALIGN=middle>" ._QXZ("Display as:")."<BR/>";
$MAIN.="<TD ROWSPAN=2 VALIGN=top>\n";
//~ $MAIN.=_QXZ("Display as:")."<BR>";

#$MAIN.="<div class=\"col-lg-10 no-padding\"><select class='form-control' name='report_display_type'>";
//chirag
//17-03-21
$MAIN.="<div class=\"col-lg-7 no-padding\"><div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><select class='form-control' name='report_display_type'>";
//end
if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>"._QXZ("$report_display_type")."</option>";}
//chirag parmar
//12-03-21
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>"._QXZ("Display as")."</label></div></div></div><BR><BR>";
if ($archives_available=="Y") {
	$MAIN.="<div class=\"col-md-12\"><input type='checkbox'  name='search_archived_data' value='checked' $search_archived_data><span style=\"margin-left: 5px;\">"._QXZ("Search archived data")."</span><BR><BR>\n";
}
//end
...
$MAIN.="</TABLE>\n";
$MAIN.="<div align ='center' class='col-md-12'><INPUT class='btn btn-bdr-sucess' TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'></div><BR/><BR/>\n";
...
if ($SUBMIT && $query_date) {
	...
	$HTML.="<label>"._QXZ("DIAL LOG RECORDS FOR")." $query_date, $query_date_D "._QXZ("TO")." $query_date_T $server_rpt_string, $HC_rpt_string, "._QXZ("RECORDS")." #$lower_limit-$upper_limit</label>";
	//chirag parmar
	//12-03-21
	$HTML.="<label><a href=\"$PHP_SELF?SUBMIT=$SUBMIT&DB=$DB&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$server_ipQS$sip_hangup_causeQS&lower_limit=$lower_limit&upper_limit=$upper_limit&file_download=1&search_archived_data=$search_archived_data\">["._QXZ("DOWNLOAD")."]</a></label>";
	
	$HTML.="<BR><table class='table_list hover centerline' border='0' cellpadding='3' cellspacing='1'>";
	//~ $HTML.="<tr>";
	...
	//~ $HTML.="</tr>\n";
	$HTML.="<thead><tr>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("CALLER CODE")."</font></th>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("LEAD ID")."</font></th>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("SERVER IP")."</font></th>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("CALL DATE")."</font></th>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("EXTENSION")."</font></th>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("CHANNEL")."</font></th>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("CONTEXT")."</font></th>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("TIMEOUT")."</font></th>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("OUTBOUND CID")."</font></th>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("SIP HANGUP CAUSE")."</font></th>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("UNIQUE ID")."</font></th>";
	$HTML.="<th nowrap><font size='2'>"._QXZ("SIP HANGUP REASON")."</font></th>";
	$HTML.="</tr></thead>\n";
