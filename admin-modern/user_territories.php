...
if ( ($action == "CHANGE_TERRITORY_OWNER_ACCOUNT") and ($enable_vtiger_integration > 0) )
	...
	echo "<tr ><td align=right>"._QXZ("Account ID").": </td><td align=left><input type=text name=accountid value=\"$accountid\"></td></tr>\n";
	echo "<tr ><td align=right>"._QXZ("New Owner").": </td><td align=left><select size=1 name=user>\n";
	...
	echo "<tr ><td align=right>"._QXZ("Update ViciDial List Owner").": </td><td align=left><select size=1 name=vl_owner>\n";
...
<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> List Territories</h3> </div>
		<div class="col-md-12"><div class="content">
-->
<!--
<FORM action="<?php echo $PHP_SELF;?>" method=POST><TABLE CELLPADDING=4 CELLSPACING=0>

<TR >
<TD ALIGN=LEFT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; <a class="btn btn-bdr-blue" href="<?php echo "$PHP_SELF" ?>"><?php echo _QXZ("List Territories"); ?></a></TD>
<TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; <a class="btn btn-bdr-blue" href="<?php echo "$PHP_SELF" ?>?action=ADD_TERRITORY"><?php echo _QXZ("Add Territory"); ?></a></TD>
<TD ALIGN=RIGHT><FONT FACE="ARIAL,HELVETICA" SIZE=2><B> &nbsp; <a class="btn btn-bdr-blue" href="<?php echo "$PHP_SELF" ?>?action=ADD_USER_TERRITORY"><?php echo _QXZ("Add User Territory"); ?></a></TD>
<?php
//if ($enable_vtiger_integration > 0)
	//{ ?>
...
<div class="container-fluid" id="pcont4">
    ...
    <div class="fd-tile detail">
    		<div class="page-head"><a class="" href="<?php echo "$PHP_SELF" ?>"><?php echo _QXZ("List Territories"); ?></a>&nbsp; | &nbsp;<a class="" href="<?php echo "$PHP_SELF" ?>?action=ADD_TERRITORY"><?php echo _QXZ("Add Territory"); ?></a>&nbsp; | &nbsp;<a class="" href="<?php echo "$PHP_SELF" ?>?action=ADD_USER_TERRITORY"><?php echo _QXZ("Add User Territory"); ?></a>&nbsp;
    		<?php
if ($enable_vtiger_integration > 0)
	{ ?>
    		
    		 | &nbsp; <a href="<?php echo "$PHP_SELF" ?>?action=CHANGE_TERRITORY_OWNER"><?php echo _QXZ("Change Vtiger Territory Owner"); ?></a>
...
echo "<TR><TD ALIGN=LEFT COLSPAN=$colspan><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=3><B> &nbsp; \n";
...
if ( ($action == "CHANGE_TERRITORY_OWNER") and ($enable_vtiger_integration > 0) )
	...
	echo "<center><TABLE width=$section_width cellspacing=3>\n";
	echo "<tr ><td align=right>"._QXZ("Territory").": </td><td align=left><select size=1 name=territory>\n";
...
if ($action == "ADD_USER_TERRITORY")
	...
	echo "<div id=\"pcont4\" class=\"container-fluid\">
			  ...
			  <div class=\"header\">
			  <h3>"._QXZ("Add User Territory")."</h3>
			  </div>";
	echo "<form action=$PHP_SELF method=POST>\n";
	echo "<input type=hidden name=action value=PROCESS_ADD_USER_TERRITORY>\n";
	echo "<center><TABLE width=$section_width cellspacing=3>\n";
	echo "<tr ><td align=right>"._QXZ("Agent").": </td><td align=left><div class='col-lg-5'><select class='form-control'  size=1 name=user>\n";
	...
	echo "<tr ><td align=right>"._QXZ("Territory").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=territory>\n";
	...
	echo "$territories_list";
	echo "</select></div></td></tr>\n";
	echo "<tr><td align=right>"._QXZ("Level").": </td><td align=left><div class='col-lg-5'><select class='form-control' size=1 name=level><option value='TOP_AGENT'>"._QXZ("TOP_AGENT")."</option><option value='STANDARD_AGENT'>"._QXZ("STANDARD_AGENT")."</option><option value='BOTTOM_AGENT'>"._QXZ("BOTTOM_AGENT")."</option></select></div></td></tr>\n";
...
if ($action == "PROCESS_ADD_USER_TERRITORY")
	...
	if ( (strlen($territory)<1) or (strlen($user)<1) or (strlen($level)<1) )
		...
		if ($row[0] > 0)
			{
			echo "<span class='message_block'>"._QXZ("ERROR: this territory user is already in the system")."<BR></span>\n";
			}
		else
			{
			...
			echo "<span class='message_block'>"._QXZ("User Territory Added").": $user $territory<BR></span>\n";
...
if ($action == "PROCESS_MODIFY_USER_TERRITORY")
	...
	if ( (strlen($territory)<1) or (strlen($user)<1) or (strlen($level)<1) )
		{
		echo "<span class='message_block'>"._QXZ("ERROR: Territory, User and Level must be filled in")."<BR></span>\n";
		}
	else
		{
		$stmt="SELECT count(*) from vicidial_user_territories where territory='$territory' and user='$user';";
...
if ($action == "DELETE_USER_TERRITORY")
	...
	if ( (strlen($territory)<1) or (strlen($user)<1) )
		...
		if ($row[0] < 0)
			...
			echo "<span class='message_block'>"._QXZ("User Territory Deleted").": $user $territory</span><BR>\n";
...
if ($action == "ADD_TERRITORY")
	...
	echo "<div id=\"pcont4\" class=\"container-fluid\">
			  ...
			  <div class=\"block-flat\">
			  <div class=\"header\">
			  <h3>"._QXZ("Add Territory")."</h3>
			  </div>";
			  
	echo "<form action=$PHP_SELF method=POST>\n";
	echo "<input type=hidden name=action value=PROCESS_ADD_TERRITORY>\n";
	echo "<center><TABLE width=$section_width cellspacing=3>\n";
	echo "<tr ><td align=right>"._QXZ("Territory").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=territory size=30 maxlength=100></div></td></tr>\n";
	echo "<tr ><td align=right>"._QXZ("Territory Description").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=territory_description size=50 maxlength=255></div></td></tr>\n";
	echo "<tr ><td align=center colspan=2><p style='text-align:center'><input class='btn btn-bdr-sucess' type=submit name=SUBMIT value='"._QXZ("SUBMIT")."'></p></td></tr>\n";
	echo "</TABLE></center>\n";
	}
...
if ($action == "PROCESS_ADD_TERRITORY")
	...
	if ( (strlen($territory)<1) or (strlen($territory_description)<1) )
		{
		echo "<span class='message_block'>"._QXZ("ERROR: Territory and Territory Description must be filled in")."</span><BR>\n";
		}
	else
		{
		...
		if ($row[0] > 0)
			{
			echo "<span class='message_block'>"._QXZ("ERROR: there is already a territory in the system with this name")."</span><BR>\n";
			}
		else
			{
			...
			echo "<span class='message_block'>"._QXZ("Territory Added").": $territory<BR></span>\n";
...
if ($action == "DELETE_TERRITORY")
	...
	if (strlen($territory)<1)
		...
		if ($row[0] < 0)
			...
			echo "<span class='message_block'>"._QXZ("Territory Deleted").": $territory</span><BR>\n";
...
if ($action == "MODIFY_TERRITORY")
	...
	if ($territories_to_print > 0) 
		...
		echo "<center><TABLE width=$section_width cellspacing=3>\n";
		echo "<tr ><td align=right>"._QXZ("Territory").": </td><td align=left><B>$rowx[0]</B></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Territory Description").": </td><td align=left><div class='col-lg-5'><input class='form-control' type=text name=territory_description size=50 maxlength=255 value=\"$rowx[1]\"></div></td></tr>\n";
		...
		echo "<tr ><td align=right>"._QXZ("Agents").": </td><td align=left><B>$user_count</B></td></tr>";
		...
		echo "<tr ><td align=right>"._QXZ("Accounts").": </td><td align=left><B>$owner_count</B></td></tr>";
		...
		if ($enable_vtiger_integration > 0)
			...
			echo "<tr ><td align=right>"._QXZ("Vtiger Accounts").": </td><td align=left><B>$vtiger_count</B></td></tr>";
			}
		echo "<tr ><td align=center colspan=2><p style='text-align:center'><input class='btn btn-bdr-sucess' type=submit name=SUBMIT value='"._QXZ("SUBMIT")."'></p></form></td></tr>\n";
		echo "</TABLE></center>\n";
		echo "<BR><BR>\n";
		echo "<div id=\"\" class=\"container-fluid\" style='padding: 0;>
			  <div class=\"cl-mcont\">
			  <div class=\"row\">
			  <div class=\"col-md-12 no-padding\">
			  <div class=\"block-flat\" style='margin-bottom: 0;'>
			  <div class=\"header\">
			  <h3>"._QXZ("Users in this Territory")."</h3>
			  </div>";
		echo "<TABLE CELLPADDING=3 CELLSPACING=1 WIDTH=600>\n";
		...
		#	echo "<TD>Accounts: $owner_count</TD>";
			...
			echo "<div class='col-lg-5'><select class='form-control' size=1 name=level><option SELECTED>$Tlevel[$o]</option><option value='TOP_AGENT'>"._QXZ("TOP_AGENT")."</option><option value='STANDARD_AGENT'>"._QXZ("STANDARD_AGENT")."</option><option value='BOTTOM_AGENT'>"._QXZ("BOTTOM_AGENT")."</option></select></div> ";
			//echo "<tr ><td align=center colspan=2><p style='text-align:center'><input class='btn btn-success' type=submit name=SUBMIT value='"._QXZ("SUBMIT")."'></p></td></tr>\n";
			echo "<td align=center><p style='text-align:center'><input class='btn btn-bdr-sucess' type=submit name=SUBMIT value='"._QXZ("SUBMIT")."'></p></td>\n";
			echo "</form>";
			echo "</TD>";
			echo "<TD><a class='btn btn-danger btn-sm' href=\"$PHP_SELF?action=DELETE_USER_TERRITORY&territory=$territory&user=$Tuser[$o]\">"._QXZ("DELETE")."</a></TD>";
			echo "</TR>\n";
			$o++;
			}
		...
		echo "<div class=text-center><a class='btn btn-danger btn-sm' href=\"$PHP_SELF?action=DELETE_TERRITORY&territory=$territory\">"._QXZ("Delete This Territory")."</a></div>\n";
		echo "<BR><BR>\n";
		}
	else
		{
...
if ($action == "LIST_ALL_TERRITORIES")
	...
	//echo "<TABLE><TR><TD>\n";
	//echo "<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>";
	//echo "<h4 class='text-left'>"._QXZ("List All Territories").":<h4>\n";
	echo "<div id=\"pcont4\" class=\"container-fluid\">
			  <div class=\"cl-mcont\">
			  <div class=\"row\">
			  <div class=\"col-md-12 no-padding\">
			  <div class=\"block-flat\">
			  <div class=\"header\">
			  <h3>"._QXZ("List All Territories")."</h3>
			  </div>";
	echo "<center><TABLE class='table_list hover centerline' width=$section_width cellspacing=0 cellpadding=1>\n";
	echo "<thead><TR>";
	echo "<TH><B>#</B></TH>";
	echo "<TH><B>"._QXZ("ID")."</B></TH>";
	echo "<TH><B>"._QXZ("TERRITORY")."</B></TH>";
	echo "<TH><B>"._QXZ("DESCRIPTION")."</B></TH>\n";
	echo "<TH><B>"._QXZ("AGENTS")."</TH>\n";
	echo "<TH><B>"._QXZ("ACCOUNTS")."</TH>\n";
	if ($enable_vtiger_integration > 0)
		{
		echo "<Th><B>"._QXZ("VT ACCOUNTS")."</Th>\n";
		}
	echo "</TR></thead>\n";
	...
	while ($vt_ct > $i)
		...
		if (preg_match("/1$|3$|5$|7$|9$/i", $i))
			...
			{$bgcolor='';}
		echo "<tr "; if ($SSadmin_row_click > 0) {echo " onclick=\"window.document.location='$PHP_SELF?action=MODIFY_TERRITORY&territory=$Lterritory[$i]'\"";} echo "><td>$i</td>";
		echo "<td>$Lterritory_id[$i] </td>";
		echo "<td> <a href=\"$PHP_SELF?action=MODIFY_TERRITORY&territory=$Lterritory[$i]\">$Lterritory[$i]</a></td>";
		echo "<td> $Lterritory_description[$i]</td>";
		echo "<td> $Lterritory_count[$i]</td>";
		echo "<td> $Lterritory_owner_count[$i]</td>";
		if ($enable_vtiger_integration > 0)
			{
			echo "<td> $Lvtiger_count[$i]</td>";
			}
		echo "</tr>\n";
