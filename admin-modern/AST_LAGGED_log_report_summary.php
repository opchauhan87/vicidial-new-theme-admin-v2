...
//~ $MAIN.="<TABLE class='table1 col_table' BORDER=0 cellspacing=5 cellpadding=5 class='col-lg-12 spacer' CELLPADDING=4 CELLSPACING=0><TR><TD>";
$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE class='table1 col_table' BORDER=0 cellspacing=5 cellpadding=5><TR><TD class='no-border col-lg-3 spacer' VALIGN=TOP align=center>\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
//~ $MAIN.=_QXZ("Date Begin").":\n";
//~ $MAIN.="<div class='col-lg-2 size'>"._QXZ("Date Begin").":</div>";
$MAIN.="<div class='col-lg-7'><div class=\"form-group custom-input mb-10\"><INPUT TYPE=TEXT class='form-control' NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date Begin")."</label></div></div>";
$MAIN.="<div class='col-md-1 no-padding'><script language=\"JavaScript\">\n";
...
$MAIN.="<TD VALIGN=TOP align=center class='no-border col-lg-3 spacer'>";
$MAIN.="<div class='col-lg-7'><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=query_date_end SIZE=10 MAXLENGTH=10 VALUE=\"$query_date_end\"><label>"._QXZ("Date End")."</label></div></div>";
$MAIN.="<div class='col-md-1 no-padding'><script language=\"JavaScript\">\n";
$MAIN.="var o_cal = new tcal ({\n";
$MAIN.="	// form name\n";
$MAIN.="	'formname': 'vicidial_report',\n";
...
$MAIN.="// o_cal.a_tpl.weekstart = 1; // Monday week start\n";
$MAIN.="</script></div></TD>\n";
$MAIN.="<TD VALIGN=TOP align=center><INPUT class='btn btn-bdr-sucess' TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
$MAIN.="</TD><TD VALIGN=TOP align=center><a class='btn btn-info' href='AST_LAGGED_log_report.php'>"._QXZ("SINGLE DAY")."</a>";
$MAIN.="</TD></TR></TABLE>\n";	
...
if ($SUBMIT && $query_date && $query_date_end)
	...
	if (mysqli_num_rows($rslt)>0)
		...
		// Server breakdown
		$HTML_text.="<label>"._QXZ("SERVER IP BREAKDOWN FOR LAGGED RECORDS <br>")." $query_date "._QXZ("TO")." $query_date_end</label>";
		...
		while ($row=mysqli_fetch_array($rslt))
			{
			$HTML_text.="<TR><TD class=''>$row[server_ip]</td><TD class=''>$row[ct]</td></tr>";
			$total_count+=$row["ct"];
			}
		$HTML_text.="<TR><TH class=''>"._QXZ("TOTAL")."</th><TH class=''>$total_count</th></tr></table>";
		...
		$HTML_text.="<label>"._QXZ("AGENT IP BREAKDOWN FOR LAGGED RECORDS <br>")." $query_date "._QXZ("TO")." $query_date_end</label>";	
		$HTML_text.="<table class='table_list hover centerline' border='0' cellpadding='0' cellspacing='2' width='350'>";
		
		$HTML_text.="<thead><TR><TH class=''>"._QXZ("AGENT IP")."</th><TH class=''>"._QXZ("COUNT")."</th></tr></thead>";	
		foreach ($computer_ip_list as $computer_ip => $count)
			{
			$HTML_text.="<TR><TD class=''>$computer_ip</td><TD class=''>$count</td></tr>";
			}
		$HTML_text.="<TR><TH class=''>"._QXZ("TOTAL")."</th><TH class=''>$total_count</th></tr></table>";
		}
	else
