...
# 220812-0945 - Added User Group report permissions checking
#
...
$HTML_text.='<div id="pcont4" class="container-fluid">
		...
		<div class='col-md-12'><div class='content'><pre>";
...
$HTML_text.=" <INPUT class=btn btn-bdr-success TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
