...
$HTML_head.="<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 836px; top: 188px; opacity: 1; z-index: 2;'></div>";
...
$HTML_text.="<div class='header' ><h3 class=\"pull-left\" >"._QXZ("$report_name")." $NWB#performance_comparison_report$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div></div><div class='col-md-12'><div class='content'>";
...
$HTML_text.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date  MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date").":</label></div></div>";
...
$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control'  NAME=group[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control'  NAME=user_group[] multiple>\n";
...
$HTML_text.="</TD><TD class=\"col-md-4\" VALIGN=TOP> ";
$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' NAME=users[] multiple>\n";
...
$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' NAME=shift>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Shift").":</label></div></br>\n";
...
$HTML_text.="<INPUT  TYPE=SUBMIT  class='btn btn-success' NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>$NWB#agent_performance_detail$NWE\n<br><br>";
