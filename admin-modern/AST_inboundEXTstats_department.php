...
echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("ASTERISK: Inbound Calls Stats - By Department")." </h3> </div>
...
echo "<div class='col-lg-1'>Date:</div><div class='col-lg-2'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"></div>\n";
echo "<div class='col-lg-1'>To:</div><div class='col-lg-2'><INPUT class='form-control' TYPE=TEXT NAME=end_query_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_query_date\"></div>\n";
echo "<div class='col-lg-1'><SELECT class='form-control' SIZE=1 NAME=group>\n";
	$o=0;
