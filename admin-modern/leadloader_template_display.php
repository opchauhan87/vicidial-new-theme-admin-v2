...
#		echo "  </tr>\r\n";
	...
	while ($fieldinfo=mysqli_fetch_field($rslt))
		...
		echo "  <tr >\r\n";
		echo "    <td  nowrap><font class=standard>".strtoupper(preg_replace('/_/i', ' ', $rslt_field_name)).": </font></td>\r\n";
		if ($rslt_field_name!="list_id") 
			{
			echo "    <td width='75%'><div class='col-lg-5'><select class='form-control' name='$field_prefix".$rslt_field_name."_field' onChange='DrawTemplateStrings()'>\r\n";
