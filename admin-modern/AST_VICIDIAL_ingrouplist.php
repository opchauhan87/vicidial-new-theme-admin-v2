...
echo'<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left">'._QXZ("Live In-Group Agent Report").'</h3><div class="pull-right"><a class="btn btn-info" href="./admin.php?ADD=3111&group_id=$group">'._QXZ("MODIFY").'</a></div></div><div class="col-md-12"><div class="content">';
