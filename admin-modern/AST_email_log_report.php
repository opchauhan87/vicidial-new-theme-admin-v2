...
$stmt = "SELECT use_non_latin,outbound_autodial_active,slave_db_server,reports_use_slave_db,allow_emails,enable_languages,language_method,allow_web_debug FROM system_settings;";
...
$email_type = preg_replace('/[^-_0-9a-zA-Z]/', '', $email_type);
$date_type = preg_replace('/[^-_0-9a-zA-Z]/', '', $date_type);
...
$MAIN.="<TABLE BORDER=0 class='col-lg-12 spacer no-border'><TR><TD VALIGN=TOP class='col-md-3'>";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";

$MAIN.="<div class='col-lg-10 no-padding'>";
$MAIN.="<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>Date Range</label>";
$MAIN.="</div></div>";
$MAIN.="<div class='col-md-2' style='padding: 6px;'>";
...
$MAIN.="<BR><div class='col-md-12 text-center'> <label>"._QXZ("to")." </label></div>";
...
$MAIN.="</TD><TD class=\"col-md-3\" valign=top>\n";
$MAIN.="<div class=\"col-md-12\"><div class='form-group custom-input mb-10'><SELECT SIZE=5 class='form-control' NAME=group[] multiple>\n";
$o=0;
...
$MAIN.="</SELECT><label>"._QXZ("Email groups")."</label>\n";
$MAIN.="</FONT></TD>";
$MAIN.="<TD class=\"col-md-3\" valign=top>";
$MAIN.="<label>"._QXZ("Select date criteria").":&nbsp;</label><BR>";
...
$MAIN.="<input type='radio' class='' name='date_type' value='email_date' $emailed>"._QXZ("Date email received")."<BR>\n";
$MAIN.="<input type='radio' class='' name='date_type' value='call_date' $called>"._QXZ("Date email viewed")."<BR>\n";
$MAIN.="<input type='radio' class='' name='date_type' value='date_answered' $answrd>"._QXZ("Date email answered")."<BR>\n";
$MAIN.="</FONT></TD><TD class=\"col-md-3\" valign=top>\n";
$MAIN.="<label>"._QXZ("Select report type to display").":&nbsp;</label><BR>";
...
$MAIN.="<input type='radio' class='' name='email_type' value='received' $rcvd>"._QXZ("Emails received")."<BR>\n";
$MAIN.="<input type='radio' class='' name='email_type' value='viewed' $view>"._QXZ("Emails viewed")."<BR>\n";
$MAIN.="<input type='radio' class='' name='email_type' value='answered' $answ>"._QXZ("Emails answered")."<BR>\n";
$MAIN.="</FONT></TD></TR>";

$MAIN.="<tr><TD class='no-border' VALIGN=TOP align='center' colspan='4'>\n";
$MAIN.="<FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ";
if ($DID!='Y')
	{
	$MAIN.="<br><a class='btn btn-info' href=\"./admin.php?ADD=3111&group_id=$group[0]\">"._QXZ("MODIFY")."</a>  ";
	$MAIN.="<a class='btn btn-info' href=\"./AST_IVRstats.php?query_date=$query_date&end_date=$end_date&shift=$shift$groupQS\">"._QXZ("IVR REPORT")."</a>  \n";
	}
$MAIN.="<a class='btn btn-info' href=\"./admin.php?ADD=999999\">"._QXZ("REPORTS")."</a>  ";
$MAIN.="</TD></tr>\n";

$MAIN.="<tr><td class='text-center' colspan='4'>";
$MAIN.="<br><INPUT TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'>\n";
$MAIN.="</FONT></td></tr>\n";

$MAIN.="</TABLE>\n";
$MAIN.="</FORM>&nbsp;\n\n";
$MAIN.="<PRE style='text-align: left;'><FONT SIZE=2>\n\n";
