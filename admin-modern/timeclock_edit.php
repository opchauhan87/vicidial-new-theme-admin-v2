...
if ( ($invalid_record < 1) or (strlen($timeclock_id)<1) )
	...
	#	$LOGOUTevent_id =	$tcid_link;
		...
		//~ echo "<div id=\"pcont\" class=\"container-fluid\">
			  ...
			  //~ <div class=\"header\">
			  //~ <h3>"._QXZ("Timeclock Record Edit for").":$user</h3>
			  //~ </div>";
			echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("Timeclock Record Edit for").$user.'</h3> </div>
		...
		echo "<input type=hidden name=stage value=edit_TC_log>\n";
		echo "<div class=\"col-md-12\"><div class=\"content\"><TABLE class='hover' BORDER=0><TR><TD COLSPAN=3 ALIGN=LEFT>\n";
		...
		echo "<TR><TD>\n";
		echo "<TABLE BORDER=0>\n";
		echo "<TR><TD >"._QXZ("LOGIN TIME").": </TD><TD ><div class='col-lg-12'><input class='form-control' type=text name=LOGINbegin_date id=LOGINbegin_date value=\"$LOGINevent_date\" size=20 maxlength=20 onchange=\"calculate_hours();\"></div></TD></TR>\n";
		echo "<TR><TD>"._QXZ("TIMECLOCK ID").": </TD><TD ALIGN=RIGHT>$LOGINevent_id</TD></TR>\n";
		echo "<TR><TD>"._QXZ("USER GROUP").": </TD><TD ALIGN=RIGHT>$LOGINuser_group</TD></TR>\n";
		echo "<TR><TD>"._QXZ("IP ADDRESS").": </TD><TD ALIGN=RIGHT>$LOGINip_address</TD></TR>\n";
		echo "<TR><TD>"._QXZ("MANAGER USER").": </TD><TD ALIGN=RIGHT>$LOGINmanager_user</TD></TR>\n";
		echo "<TR><TD>"._QXZ("MANAGER IP").": </TD><TD ALIGN=RIGHT>$LOGINmanager_ip</TD></TR>\n";
		echo "<TR><TD>"._QXZ("NOTES").": </TD><TD ALIGN=RIGHT>$LOGINnotes</TD></TR>\n";
		echo "<TR><TD>"._QXZ("LAST CHANGE").": </TD><TD ALIGN=RIGHT>$LOGINevent_datestamp</TD></TR>\n";
		echo "</TABLE>\n";

		echo "</TD><TD> &nbsp; &nbsp; &nbsp; &nbsp; \n";
		echo "</TD><TD>\n";
		echo "<TABLE BORDER=0>\n";
		echo "<TR><TD >"._QXZ("LOGOUT TIME").": </TD><TD ><div class='col-lg-12'><input class='form-control' type=text name=LOGOUTbegin_date id=LOGOUTbegin_date value=\"$LOGOUTevent_date\" size=20 maxlength=20 onchange=\"calculate_hours();\"></div></TD></TR>\n";
		echo "<TR><TD>"._QXZ("TIMECLOCK ID").": </TD><TD ALIGN=RIGHT>$LOGOUTevent_id</TD></TR>\n";
		echo "<TR><TD>"._QXZ("USER GROUP").": </TD><TD ALIGN=RIGHT>$LOGOUTuser_group</TD></TR>\n";
		echo "<TR><TD>"._QXZ("IP ADDRESS").": </TD><TD ALIGN=RIGHT>$LOGOUTip_address</TD></TR>\n";
		echo "<TR><TD>"._QXZ("MANAGER USER").": </TD><TD ALIGN=RIGHT>$LOGOUTmanager_user</TD></TR>\n";
		echo "<TR><TD>"._QXZ("MANAGER IP").": </TD><TD ALIGN=RIGHT>$LOGOUTmanager_ip</TD></TR>\n";
		echo "<TR><TD>"._QXZ("NOTES").": </TD><TD ALIGN=RIGHT>$LOGOUTnotes</TD></TR>\n";
		echo "<TR><TD>"._QXZ("LAST CHANGE").": </TD><TD ALIGN=RIGHT>$LOGOUTevent_datestamp</TD></TR>\n";
		echo "</TABLE>\n";
		echo "</TD></TR>\n";

	
		echo "<TR><TD COLSPAN=3 ALIGN=LEFT>\n";
		echo "<div class='col-lg-2'>"._QXZ("NEW NOTES").":</div><div class='col-lg-5'> <input class='form-control' type=text name=notes value='' size=80 maxlength=255></div>\n";
		echo "</TD></TR>\n";
		echo "<TR><TD COLSPAN=3 ALIGN=CENTER>\n";
		echo "<input class='btn btn-bdr-sucess' type=button name=go_submit id=go_submit value="._QXZ("SUBMIT")." onclick=\"run_submit();\"><BR></form>\n";
