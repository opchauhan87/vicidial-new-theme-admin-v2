...
$MAIN.="<div class='header'><h3 class=\"pull-left\">"._QXZ("$report_name")."$NWB#Callmenu Survey Report$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./admin.php?ADD=31&campaign_id=$group[0]\">"._QXZ("MODIFY")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./AST_VDADstats.php?query_date=$query_date&end_date=$end_date&shift=$shift$groupQS\">"._QXZ("OUTBOUND REPORT")."</a></div></div>\n";
...
$MAIN.="<TABLE CELLPADDING=3 CELLSPACING=0 border='0' ><TR><TD class=\"col-md-4\" VALIGN='TOP'>";
...
$MAIN.="<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=11 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date Range").":</label>";
$MAIN.="</div></div>";
...
$MAIN.="<div class='col-md-12'>";
$MAIN.="<div class='col-md-10'>";
$MAIN.="<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=11 MAXLENGTH=10 VALUE=\"$end_date\">";
$MAIN.="</div></div>";
$MAIN.="<div class='col-md-2 text-center p-18'>";
$MAIN.="<script language=\"JavaScript\">\n";
$MAIN.="var o_cal = new tcal ({\n";
...
*/
	...
	$MAIN.=" \n";
	$MAIN.="<div class=\"col-lg-12\"><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=callmenus[] multiple>\n";
	$o=0;
	...
	$MAIN.="</SELECT><label>"._QXZ("Callmenu")."/"._QXZ("Tracking Group").":</label></div></div>\n";
...
$MAIN.="<div class='form-group custom-input mb-10'><select class='form-control' name='report_type'>";
if ($report_type) {$MAIN.="<option value='$report_type' selected>$report_type</option>";}
$MAIN.="<option value=''>"._QXZ("Select report type")."</option><option value='SINGLE_AGENT'>"._QXZ("SINGLE_AGENT")."</option><option value='ALL_AGENTS'>"._QXZ("ALL_AGENTS")."</option></select><label>"._QXZ("Report type").":</label></div>\n";
$MAIN.="<BR> \n";
$MAIN.="<div class='form-group custom-input mb-10'><input class='form-control' type='text' name='user' value='$user' size='10' maxlength='10'><label>"._QXZ("User ID (Single agent only)").":</label></div>\n";
...
$MAIN.="&nbsp; &nbsp; <input class='btn btn-success' type=submit value=\""._QXZ("SUBMIT")."\" name=submit id=submit>";
$MAIN.="<a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?DB=$DB&type=$type&query_date=$query_date&end_date=$end_date$callmenuQS&shift=$shift&file_download=1&search_archived_data=$search_archived_data&user=$user&report_type=$report_type&submit=1\">"._QXZ("DOWNLOAD")."</a>  ";
$MAIN.="</div>";
...
*/
	...
	if ($report_type=="SINGLE_AGENT") {
		...
		$HTML_text.="<tr><th>PHONE</th><th><font color='#FFF'>"._QXZ("START TIME")."</font></th>";
		$HTML_text_end="<tr><th>"._QXZ("TOT. CALLS").": $total_calls</th><th align='right'><font color='#FFF'>"._QXZ("POINT TOTALS").":</font></th>";
		...
		//end 
			...
			$CSV_text_end.="\"$val\",";
			$HTML_text.="<th>$key</th>";
			$HTML_text_end.="<th>$val</th>";
			}	
		$HTML_text_end.="<th>$grand_total</th></tr>";
		$CSV_text_end.="\"$grand_total\"\n";
		$HTML_text.="<th>"._QXZ("TOTAL POINTS").":</th></tr>";
		...
		//end
			...
			$HTML_text.="<tr><th>".$calls_array[$key]["phone"]."</th><th>".$calls_array[$key]["start_time"]."</th>";
			reset($prompts_array);
			$call_points=0; 
			//chirag parmar
			//12-03-21
		...
		$HTML_text="<table border='0' cellpadding='2' cellspacing='1'>";
		$HTML_text.="<tr ><th>"._QXZ("AGENT")."</th>";
		$HTML_text_end="<tr><th>"._QXZ("TOTALS").":</th>";
		...
		$HTML_text.="<th>"._QXZ("TOTAL POINTS").":</th>";
		$HTML_text.="<th>"._QXZ("TOTAL CALLS").":</th></tr>";
		$CSV_text.="\""._QXZ("TOTAL POINTS")."\",";
		...
		//end
			...
			$HTML_text.="<tr><th>".$agent_array[$key]["AGENT"]."</th>";
			reset($prompts_array);
			//chirag parmar
			//12-03-21
		 #while (list($key2, $val2)=each($prompts_array))
		...
		$HTML_text_end.="<th>$grand_total</th><th>$total_calls</th></tr>";
