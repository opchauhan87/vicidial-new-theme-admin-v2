...
while($i < $hangup_cause_ct)
	{
	$hangup_cause[$i] = preg_replace("/\<|\>|\'|\"|\\\\|;/", '', $hangup_cause[$i]);
...
while($j < $dial_status_ct)
	{
	$dial_status[$i] = preg_replace("/\<|\>|\'|\"|\\\\|;/", '', $dial_status[$i]);
...
$MAIN.="<TABLE BORDER=0 cellspacing=5 cellpadding=5 class='spacer col-lg-12'><TR><TD VALIGN=TOP class=\"col-md-4\">\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
$MAIN.= "<div class=\"col-lg-10\"><div class=\"form-group custom-input mb-10\">";
$MAIN.="<INPUT TYPE=TEXT NAME=query_date class='form-control' SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date")."</label>";
$MAIN.="</div></div><div class=\"col-md-2 text-center p-18\"><script language=\"JavaScript\">\n";
...
$MAIN.="</script>\n";
$MAIN.="</div></div></br></br>";
$MAIN.="<br/><div class='col-lg-10'><div class='form-group custom-input mb-10'><INPUT TYPE=TEXT NAME=query_date_D SIZE=9 class='form-control' MAXLENGTH=8 VALUE=\"$query_date_D\">";

$MAIN.="</div><div class='col-md-12' style='text-align:center;'>"._QXZ("to")."</div><div class='col-lg-10><div class='form-group custom-input mb-10'><INPUT TYPE=TEXT NAME=query_date_T SIZE=9 class='form-control' MAXLENGTH=8 VALUE=\"$query_date_T\">";

$MAIN.="</div></div>";
$MAIN.="<div class=\"col-md-12\" style='margin-top:10px;'><div class=\"form-group custom-input mb-10\"><SELECT SIZE=5 NAME=server_ip[] multiple class='form-control'>\n";
if  (preg_match('/\-\-ALL\-\-/',$server_ip_string))
...
$MAIN.="</SELECT><label>"._QXZ("Server IP")."</label></div></div></TD>";

$MAIN.="<TD VALIGN=top class=\"col-md-4\">";
$MAIN.="<div class=\"col-md-12\"><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=hangup_cause[] multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Hangup Cause")."</label></div></div>";
//~ $MAIN.="</TD>";

//~ $MAIN.=""._QXZ("Dial status").":<BR/>";
$MAIN.="<div class=\"col-md-12\"><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' SIZE=5 NAME=dial_status[] multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Dial status")."</label></div></div>";
$MAIN.="</TD>";

$MAIN.="<TD VALIGN=top class=\"col-md-4\">";
$MAIN.="<div class=\"col-md-12\"><div class=\"form-group custom-input mb-10\"><SELECT SIZE=5 class='form-control' NAME=sip_hangup_cause[] multiple>\n";
...
//~ $MAIN.="<TD VALIGN=top class='no-border  col-lg-2'>\n";
...
$MAIN.="</td></tr><tr><td colspan=3 class=text-center><INPUT class='btn btn-bdr-sucess' TYPE=submit NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'><BR/><BR/>\n";
$MAIN.="</TD></TR></TABLE>\n";
...
if ($SUBMIT && $server_ip_ct>0) {
	...
	if (mysqli_num_rows($rslt)>0) {
		...
		$HTML.="<label>"._QXZ("DIAL STATUS BREAKDOWN FOR")." $query_date, $query_date_D "._QXZ("TO")." $query_date_T $server_rpt_string</label>";
		...
		$HTML.="<label>"._QXZ("CARRIER LOG RECORDS FOR")." $query_date, $query_date_D "._QXZ("TO")." $query_date_T $server_rpt_string, $HC_rpt_string, $DS_rpt_string\n --- "._QXZ("RECORDS")." #$lower_limit-$upper_limit</label>";
		//end
		$HTML.="<label>&nbsp;&nbsp;<a href=\"$PHP_SELF?SUBMIT=$SUBMIT&DB=$DB&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$server_ipQS&lower_limit=$lower_limit&upper_limit=$upper_limit&file_download=1\">["._QXZ("DOWNLOAD")."]</a></label>";
		$HTML.="<table border='0' class='table_list hover centerline' cellpadding='3' cellspacing='1'>";
		//~ $HTML.="<tr>";
		//~ //chirag parmar
		//~ //12-03-21
