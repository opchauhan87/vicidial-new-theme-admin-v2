...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")." $NWB#LISTS_campaign_stats$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"AST_LISTS_stats.php?DB=$DB\">"._QXZ("SWITCH TO LISTS")."</a></div><div class='pull-right'>";
		if (strlen($group[0]) > 1)
	{
...
$MAIN.="</SELECT><label>"._QXZ("Campaigns").":</label></div></div></TD><TD VALIGN=TOP class='col-md-4'>";
