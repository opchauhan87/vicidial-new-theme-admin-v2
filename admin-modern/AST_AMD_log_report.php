...
$MAIN.='<div class="cl-mcont">';
$MAIN.='<div class="row">';
$MAIN.='<div class="col-md-12 no-padding">';
$MAIN.='<div class="block-flat">';
$MAIN.="<div class='header'> <h3>"._QXZ("$report_name")."</h3></div>";
$MAIN.='<div class="col-md-12">';
$MAIN.='<div class="content">';
//$MAIN.="<TABLE CELLPADDING=4 CELLSPACING=0><TR><TD>";
$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE BORDER=0 cellspacing=5 cellpadding=5><TR><TD VALIGN=TOP>\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">\n";
//~ $MAIN.=_QXZ("Date").":<BR>";
$MAIN.='<div class="col-md-12">';
$MAIN.='<div class="col-md-10">';
$MAIN.="<div class=\"form-group custom-input mb-10\"><INPUT TYPE=TEXT class='form-control' NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\">";
$MAIN.="<label>"._QXZ("Date")."</label></div></div>";
...
$MAIN.='<div style="padding-top: 12px !important;padding-right: 25px;">';
$MAIN.="<BR><BR><INPUT class='form-control' TYPE=TEXT NAME=query_date_D SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_D\">";
$MAIN.='</div>';

$MAIN.='<div class="col-md-12">';
$MAIN.='<div class="col-md-10">';
$MAIN.="<div align='center'> "._QXZ("to")." </div><INPUT class='form-control' TYPE=TEXT NAME=query_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_T\">";
$MAIN.='</div>';
$MAIN.='</div>';


$MAIN.="</TD><TD  VALIGN=TOP>\n";
$MAIN.="<div class=\"form-group custom-input mb-10\"><SELECT SIZE=5 NAME=server_ip[] class='form-control' multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Server IP")."</label></div></TD>";

$MAIN.="<TD  VALIGN=top>";
$MAIN.="<div class=\"form-group custom-input mb-10\"><SELECT SIZE=5 NAME=AMDSTATUS[] class='form-control' multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("AMD Status")."</label></div>";
$MAIN.="</TD>";

$MAIN.="<TD  VALIGN=top>";
$MAIN.="<div class=\"form-group custom-input mb-10\"><SELECT SIZE=5 NAME=AMDRESPONSE[] class='form-control' multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("AMD Response")."</label></div>";
$MAIN.="</TD>";

$MAIN.="<TD  VALIGN=middle align=center>\n";
//~ $MAIN.=_QXZ("Display as:")."<BR>";
$MAIN.="<div class=\"form-group custom-input mb-10\"><select name='report_display_type' class='form-control'>";
...
$MAIN.="</td></tr><tr><td colspan=4 class=text-center><INPUT TYPE=submit class='btn btn-bdr-sucess' NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'><BR/><BR/>\n";
$MAIN.="</td></tr></TD></TR></TABLE>\n";
...
if ($SUBMIT && $server_ip_ct>0) {
	...
	$rslt=mysql_to_mysqli($stmt, $link);
	$TEXT.="<span style=\"z-index:19;\" id=agent_status_stats>\n";
	...
	if (mysqli_num_rows($rslt)>0) {
		...
		$HTML.="<label>"._QXZ("AMD BREAKDOWN FOR")." $query_date, $query_date_D "._QXZ("TO")." $query_date_T $server_rpt_string</label>";
		...
		$HTML.="<label>"._QXZ("AMD LOG RECORDS FOR")." $query_date, $query_date_D "._QXZ("TO")." $query_date_T $server_rpt_string, $HC_rpt_string, $DS_rpt_string\n --- "._QXZ("RECORDS")." #$lower_limit-$upper_limit</label>";
		$HTML.="<label><a href=\"$PHP_SELF?SUBMIT=$SUBMIT&DB=$DB&type=$type&query_date=$query_date&query_date_D=$query_date_D&query_date_T=$query_date_T$server_ipQS$AMDSTATUSQS$AMDRESPONSEQS&lower_limit=$lower_limit&upper_limit=$upper_limit&file_download=1\">["._QXZ("DOWNLOAD")."]</a></label>";
		$HTML.="<table class='table_list hover centerline' border='0' cellpadding='3' cellspacing='1'>";
		$HTML.="<thead><tr>";
