...
while ($help_row=mysqli_fetch_row($help_rslt)) 
	...
	echo "<TABLE  CELLPADDING=2 CELLSPACING=0 border='0' class='table table-striped table-dark' width='300' >";
	echo "<TR ><TD  style='background-color: #cacaca' VALIGN='TOP' width='280'><FONT class='help_bold'>"._QXZ("$help_row[0]")."</font></td><TD  style='background-color: #cacaca' VALIGN='TOP' align='right' width='20' onClick='ClearAndHideHelpDiv()'><B>[X]</B></tr>";
