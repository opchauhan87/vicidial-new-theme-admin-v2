...
if ($stage == "one_user_group_change")
	...
	$rslt=mysql_to_mysqli($stmt, $link);
		...
		echo "<div id=\"pcont4\" class=\"container-fluid\">
			  ...
			  <div class=\"header\">
			  <h3>User Group Bulk Change</h3>
			  </div>
			<div class=\"col-md-12\">
			<div class=\"content\">"._QXZ("All User Group %1s Users changed to the %2s User Group",0,'',$old_group,$group)."</div></div></div></div></div></div></div>\n";
...
if ($stage == "all_user_group_change")
	...
	$rslt=mysql_to_mysqli($stmt, $link);
		...
		echo "<div id=\"pcont4\" class=\"container-fluid\">
			...
			<div class=\"col-md-12\">
			<div class=\"content\">"._QXZ("All non-Admin Users changed to the")." $group "._QXZ("User Group")."</div></div></div></div></div></div></div>\n";
...
echo "<div class=\"col-md-6\"><div class='form-group custom-input mb-10 '> <SELECT class='form-control' SIZE=1 NAME=old_group>\n";
$o=0;
...
echo "</SELECT><label>"._QXZ("Change Users in this group")."</label></div></div>\n";
echo " <div class=\"col-md-6\"><div class='form-group custom-input mb-10 '><SELECT class='form-control' SIZE=1 NAME=group>\n";
$o=0;
while ($groups_to_print > $o)
	{
	echo "<option value=\"$groups[$o]\">$groups[$o] - $group_names[$o]</option>\n";
...
echo "</SELECT><label>"._QXZ("to this group")."</label></div></div>\n";
echo "<BR><br><br><CENTER><input class=\"btn btn-success\" type=submit name=submit value='"._QXZ("SUBMIT")."'></CENTER><BR></form>\n";
...
echo "</SELECT><label>"._QXZ("Change ALL non-Admin Users to this group")."</label></div></div>\n";
echo "<input class=\"btn btn-success\" style=\"margin-top:10\" type=submit name=submit value='"._QXZ("SUBMIT")."'><BR></form>\n";
