...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 "><div class="block-flat"><div class="header"> <h3 class="pull-left"> ';
if ($did > 0)
	{$MAIN.="<B> &nbsp; "._QXZ("DID Call Stats for")." $user";}
else
	{$MAIN.="<B> &nbsp; "._QXZ("User Stats for")." $user ($user - $full_name)";}
$MAIN.='</h3><div class="pull-right">';
if ($did > 0)
	{
	...
	{
	$MAIN.="<a class='btn btn-info btn-sm' href=\"./AST_agent_time_sheet.php?agent=$user\">"._QXZ("Agent Time Sheet")."</a>\n";
	$MAIN.="  <a  class='btn btn-info btn-sm'  href=\"./user_status.php?user=$user\">"._QXZ("User Status")."</a>\n";
	$MAIN.="  <a  class='btn btn-info btn-sm'  href=\"./admin.php?ADD=3&user=$user\">"._QXZ("Modify User")."</a>\n";
	$MAIN.="  <a  class='btn btn-info btn-sm'  href=\"./AST_agent_days_detail.php?user=$user&query_date=$begin_date&end_date=$end_date&group[]=--ALL--&shift=ALL\">"._QXZ("User multiple day status detail report")."</a>";
	}
$MAIN.='</div> </div><div class="col-md-12"><div class="content">';
	$MAIN.="<form action=$PHP_SELF method=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE class=\"\"  cellpadding=2 cellspacing=0>\n";
//$MAIN.="</TD><TD ALIGN=RIGHT><FONT FACE=\"ARIAL,HELVETICA\" SIZE=2> &nbsp; </TD></TR>\n";
$MAIN.="<TR ><TD class='col-md-4' valign='TOP'>  \n";
...
$MAIN.="<div class='col-md-4'><div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><input class='form-control' type=text name=begin_date value=\"$begin_date\" size=10 maxsize=10><label>"._QXZ("Date").":</label></div>";
...
if (strlen($user)>1)
	...
	{
	 $MAIN.="<div class='col-md-4'><div class='form-group custom-input mb-10'><input class='form-control' type=text name=user size=12 maxlength=10><label>"._QXZ("User").":</label></div></div>\n";}
	 $MAIN.="<div class='col-md-4'><div class='form-group custom-input mb-10'><input class='form-control' type=text name=call_status size=7 maxlength=6 value=\"$call_status\"><label>"._QXZ("Call status").":</label></div>";
...
$MAIN.="</B></TD><TR><TD colspan=3>";
$MAIN.="<div class=\"col-md-12 text-center\"><input class=\"btn btn-success\" style=\"margin-left: 28px;\" type=submit name=submit value='"._QXZ("Submit")."'></div>\n";
$MAIN.="</TD></TR></TR>\n";
...
if ($pause_code_rpt >= 1)
	...
	$MAIN.="<center><TABLE width=600 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<tr><td>"._QXZ("EVENT TIME")."</td><td>"._QXZ("CAMPAIGN ID")."</td><td>"._QXZ("USER GROUP")."</td><td >"._QXZ("PAUSE CODE")."</td><td>"._QXZ("PAUSE LENGTH (HH:MM:SS)")."</td></tr>\n";
	...
	while ($pause_row=mysqli_fetch_array($rslt))
		...
		$MAIN.="<tr $bgcolor><td>$pause_row[event_time]</td>";
		$MAIN.="<td > $pause_row[campaign_id]</td>\n";
		$MAIN.="<td > $pause_row[user_group]</td>\n";
		$MAIN.="<td > $pause_row[sub_status]</td>\n";
		$MAIN.="<td > $pause_row[pause_length]</td></tr>\n";
	...
	$MAIN.="<tr><td> </td><td> </td><TD></td><td> <B>"._QXZ("TOTAL").":</B></td><td> $total_pause_time</td></tr>\n";
...
elseif ($park_rpt >= 1)
	...
	$MAIN.="<center><TABLE class='hover centerline' width=600 cellspacing=0 cellpadding=1>\n";
	$MAIN.="<thead><tr><th>"._QXZ("PARKED TIME")."</th><th >"._QXZ("STATUS")."</th><th >"._QXZ("LEAD ID")."</th><th >"._QXZ("PARKED SEC")."</th></tr>\n";
	...
	while ($park_row=mysqli_fetch_array($rslt))
		...
		$MAIN.="<tr $bgcolor><td>$park_row[parked_time]</td>";
		$MAIN.="<td align=right> $park_row[status]</td>\n";
		$MAIN.="<td align=right> <a href=\"admin_modify_lead.php?lead_id=$park_row[lead_id]\">$park_row[lead_id]</a></td>\n";
		$MAIN.="<td align=right> $park_row[parked_sec]</td></tr>\n";
	...
	if ($did < 1)
		...
		$MAIN.="<center><TABLE class='table_list hover centerline' width=300 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<thead><tr><th>"._QXZ("STATUS")."</th><th>"._QXZ("COUNT")."</th><th>"._QXZ("HOURS:MM:SS")."</th></tr></thead>\n";
		...
		while ($o < $p)
			...
			$MAIN.="<tr $bgcolor><td>$status[$o]</td>";
			$MAIN.="<td align=right> $counts[$o]</td>\n";
			$MAIN.="<td align=right> $call_hours_minutes</td></tr>\n";
		...
		$MAIN.="<tr><td>"._QXZ("TOTAL CALLS")." </td><td > $total_calls</td><td > $call_hours_minutes</td></tr>\n";
		...
		$MAIN.="<TABLE class='table_list hover centerline' width=850 cellspacing=0 cellpadding=1>\n";

		//$MAIN.="<TABLE class='hover centerline' width=850 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<thead><tr><th>"._QXZ("EVENT")." </th><th > "._QXZ("DATE")."</th><th > "._QXZ("CAMPAIGN")."</th><th > "._QXZ("GROUP")."</th><th >"._QXZ("SESSION")."<BR>"._QXZ("HOURS:MM:SS")."</th><th >"._QXZ("SERVER")."</th><th >"._QXZ("PHONE")."</th><th >"._QXZ("COMPUTER")."</th><th >"._QXZ("PHONE")."<BR>"._QXZ("LOGIN")."</th><th >"._QXZ("PHONE IP")."</th></tr></thead>\n";
		...
		while ($events_to_print > $o) 
			...
			if (preg_match('/LOGOUT/', $row[0]))
				...
				if ($event_start_seconds)
					...
					$MAIN.="<td > $row[3]</td>\n";
					$MAIN.="<td > $row[4]</td>\n";
					$MAIN.="<td > $event_hours_minutes</td>\n";
					$MAIN.="<td  colspan=2>&nbsp; $row[7]</td>\n";
					$MAIN.="<td  colspan=3> &nbsp;</td></tr>\n";
					$event_start_seconds='';
					$event_stop_seconds='';
		...
		$MAIN.="<tr><td>"._QXZ("TOTAL")."</td>";
		$MAIN.="<td > </td>\n";
		$MAIN.="<td > </td>\n";
		$MAIN.="<td > </td>\n";
		$MAIN.="<td > $total_login_hours_minutes</td></tr>\n";
		...
		if ($LOGuser_level==9)
			...
			$MAIN.="<TABLE class='table_list hover centerline' width=800 cellspacing=0 cellpadding=1>\n";
			$MAIN.="<thead><tr><th align=right><font size=2> "._QXZ("DATE")."</th><th align=right><font size=2> "._QXZ("CAMPAIGN")."</th><th align=right><font size=2> "._QXZ("GROUP")."</th><th align=right><font size=2>"._QXZ("DIALER SERVER")."</th><th align=right><font size=2>"._QXZ("WEB SERVER")."</th><th align=right><font size=2>"._QXZ("LOGIN URL")."</th></tr></thead>\n";
	...
	$MAIN.="<TABLE class='table_list hover centerline' width=550 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<thead><tr><th>"._QXZ("ID")." </th><th>"._QXZ("EDIT")." </th><th>"._QXZ("EVENT")." </th><th> "._QXZ("DATE")."</th><th> "._QXZ("IP ADDRESS")."</th><th> "._QXZ("GROUP")."</th><th>"._QXZ("HOURS:MM:SS")."</th></tr></thead>\n";
		...
		while ($events_to_print > $o) {
			...
			if (preg_match('/LOGIN/', $row[0]))
				...
				$MAIN.="<td >$manager_edit</td>";
				$MAIN.="<td >$row[0]</td>";
				$MAIN.="<td > $TC_log_date</td>\n";
				$MAIN.="<td > $row[4]</td>\n";
				$MAIN.="<td > $row[2]</td>\n";
				$MAIN.="<td > </td></tr>\n";
		...
		$MAIN.="<TABLE class='table_list hover centerline' width=670 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<thead><tr><th># </th><th>"._QXZ("DATE/TIME")." </th><th> "._QXZ("CAMPAIGN")."</th><th>"._QXZ("BLEND")."</th><th> "._QXZ("GROUPS")."</th><th > "._QXZ("MANAGER")."</th></tr></thead>\n";
		...
		while ($logs_to_print > $u) 
			...
			$MAIN.="<td>$u</td>";
			$MAIN.="<td>$row[2]</td>";
			$MAIN.="<td align=left> $row[1]</td>\n";
			$MAIN.="<td align=left> $row[3]</td>\n";
			$MAIN.="<td align=left> $row[4] </td>\n";
			$MAIN.="<td align=left> $row[5]</td>\n";
		...
		$MAIN.="<TABLE class='table_list hover centerline' width=700 cellspacing=0 cellpadding=1>\n";
		if ($firstlastname_display_user_stats > 0)
			{
		$MAIN.="<thead><tr><th># </th><th>"._QXZ("DATE/TIME")." </th><th >"._QXZ("LENGTH")."</th><th > "._QXZ("STATUS")."</th><th > "._QXZ("PHONE")."</th><th > "._QXZ("CAMPAIGN")."</th><th > "._QXZ("GROUP")."</th><th > "._QXZ("LIST")."</th><th> "._QXZ("LEAD")."</th><th> "._QXZ("NAME")."</th><th> "._QXZ("HANGUP REASON")."</th></tr></thead>\n";
			}
		else
			{
			$MAIN.="<thead><tr><th># </th><th>"._QXZ("DATE/TIME")." </th><th>"._QXZ("LENGTH")."</th><th> "._QXZ("STATUS")."</th><th> "._QXZ("PHONE")."</th><th> "._QXZ("CAMPAIGN")."</th><th> "._QXZ("GROUP")."</th><th> "._QXZ("LIST")."</th><th> "._QXZ("LEAD")."</th><th> "._QXZ("HANGUP REASON")."</th></tr></thead>\n";
			}
		...
		while ($logs_to_print > $u) 
			...
			$MAIN.="<td>$u</td>";
			$MAIN.="<td>$row[4]</td>";
			$MAIN.="<td align=left> $row[7]</td>\n";
			$MAIN.="<td align=left> $row[8]</td>\n";
			$MAIN.="<td align=left> $row[10] </td>\n";
			$MAIN.="<td > $row[3] </td>\n";
			$MAIN.="<td > $row[14] </td>\n";
			$MAIN.="<td > $row[2] </td>\n";
			...
			if ($firstlastname_display_user_stats > 0)
				{
					$MAIN.="<td > $row[17] $row[18] </td>\n";
				}
			$MAIN.="<td > $row[15] </td></tr>\n";
			if ($firstlastname_display_user_stats > 0)
				{
		...
		if ($allow_emails>0) 
			...
			$MAIN.="<TABLE class='table_list hover centerline' width=670 cellspacing=0 cellpadding=3>\n";
			$MAIN.="<thead><tr><th># </th><th>"._QXZ("DATE/TIME")." </th><th>"._QXZ("USER")."</th><th> "._QXZ("CAMPAIGN")."</th><th> "._QXZ("EMAIL TO")."</th><th> "._QXZ("ATTACHMENTS")."</th><th > "._QXZ("LEAD")."</th></tr></thead>\n";
			...
			while ($logs_to_print > $u) 
				...
				$MAIN .= "<td align=left> &nbsp; $row[5]</td>\n";
				$MAIN .= "<td align=left> &nbsp; $row[8] </td>\n";
				$MAIN .= "<td align=left> &nbsp;  <A HREF=\"admin_modify_lead.php?lead_id=$row[2]\" target=\"_blank\">$row[2]</A> </td>\n";
				$MAIN .= "</tr>\n";
				$MAIN .= "<tr>";
				$MAIN .= "<td> &nbsp; </td>\n";
				$MAIN .= "<td align=left colspan=6 $bgcolor> "._QXZ("MESSAGE").": $row[6] </td>\n";
				$MAIN .= "</tr>\n";
	...
	$MAIN.="<TABLE class='table_list hover centerline' width=750 cellspacing=0 cellpadding=1>\n";
	if ($firstlastname_display_user_stats > 0)
		{
		$MAIN.="<thead><tr><th># </th><th>"._QXZ("DATE/TIME")." </th><th>"._QXZ("LENGTH")."</th><th> "._QXZ("STATUS")."</th><th> "._QXZ("PHONE")."</th><th> "._QXZ("CAMPAIGN")."</th><th> "._QXZ("WAIT (S)")."</th><th> "._QXZ("AGENT (S)")."</th><th> "._QXZ("LIST")."</th><th> "._QXZ("LEAD")."</th><th> "._QXZ("NAME")."</th><th> "._QXZ("HANGUP REASON")."</th></tr></thead>\n";
		}
	else
		{
		$MAIN.="<thead><tr><th># </th><th>"._QXZ("DATE/TIME")." </th><th>"._QXZ("LENGTH")."</th><th> "._QXZ("STATUS")."</th><th> "._QXZ("PHONE")."</th><th> "._QXZ("CAMPAIGN")."</th><th> "._QXZ("WAIT (S)")."</th><th> "._QXZ("AGENT (S)")."</th><th> "._QXZ("LIST")."</th><th> "._QXZ("LEAD")."</th><th> "._QXZ("HANGUP REASON")."</th></tr></thead>\n";
		}
	...
	$MAIN.="<tr $bgcolor>";
		...
		$MAIN.="<td>$row[0]</td>";
		$MAIN.="<td align=left> $row[1]</td>\n";
		$MAIN.="<td align=left> $row[2]</td>\n";
		$MAIN.="<td align=left> $row[3] </td>\n";
		$MAIN.="<td > $row[4] </td>\n";
		$MAIN.="<td > $row[5] </td>\n";
		$MAIN.="<td > $AGENTseconds </td>\n";
		$MAIN.="<td > $row[6] </td>\n";
		$MAIN.="<td > <A HREF=\"admin_modify_lead.php?lead_id=$row[7]\" target=\"_blank\">$row[7]</A> </td>\n";
		if ($firstlastname_display_user_stats > 0)
			{$MAIN.="<td> $row[10] $row[11] </td>\n";}
		...
		$MAIN.="<tr >";
	$MAIN.="<td colspan=2>"._QXZ("TOTALS")."</td>";
	$MAIN.="<td align=left> $TOTALinSECONDS</td>\n";
	$MAIN.="<td colspan=4> &nbsp; </td>\n";
	$MAIN.="<td > $TOTALagentSECONDS</td>\n";
	$MAIN.="<td colspan=3> &nbsp; </td></tr>\n";
	...
	if ($did < 1)
		...
		$MAIN.="<B>"._QXZ("AGENT ACTIVITY FOR THIS TIME PERIOD: (10000 record limit)")."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=7'>["._QXZ("DOWNLOAD")."]</a></B><br>\n";
		$MAIN.="<span style='float:left'>these fields are in seconds</span>";
		$MAIN.="<TABLE class='table_list hover centerline' width=750 cellspacing=0 cellpadding=1>\n";
		...
		$MAIN.="<thead><tr><th># </th><th>"._QXZ("DATE/TIME")." </th><th>"._QXZ("PAUSE")."</th><th> "._QXZ("WAIT")."</th><th> "._QXZ("TALK")."</th><th> "._QXZ("DISPO")."</th><th> "._QXZ("DEAD")."</th><th> "._QXZ("CUSTOMER")."</th><th> "._QXZ("VISIBLE")."</th><th> "._QXZ("HIDDEN")."</th><th> "._QXZ("STATUS")."</th><th> "._QXZ("LEAD")."</th><th> "._QXZ("TYPE")."</th><th> "._QXZ("CAMPAIGN")."</th><th> "._QXZ("PAUSE CODE")."</th></tr></thead>\n";
		...
		while ($logs_to_print > $u) 
			...
			if ($DB > 0)
				...
				$MAIN.="<tr>";
				$MAIN.="<td> &nbsp;</td>";
				$MAIN.="<td>$DBcall_end</td>";
				$MAIN.="<td > $DBtotal_sec </td>\n";
				$MAIN.="<td > &nbsp; </td>\n";
				$MAIN.="<td > &nbsp; </td>\n";
				$MAIN.="<td > &nbsp; </td>\n";
				$MAIN.="<td > &nbsp; </td>\n";
			...
			$MAIN.="<tr $bgcolor>";
			$MAIN.="<td>$u</td>";
			$MAIN.="<td>$event_time</td>";
			$MAIN.="<td> $pause_sec</td>\n";
			$MAIN.="<td> $wait_sec</td>\n";
			$MAIN.="<td> $talk_sec </td>\n";
			$MAIN.="<td> $dispo_sec </td>\n";
			$MAIN.="<td> $dead_sec </td>\n";
			$MAIN.="<td> $customer_sec </td>\n";
			$MAIN.="<td align=right><font size=2> $VISIBLE_sec </td>\n";
			$MAIN.="<td align=right><font size=2> $HIDDEN_sec </td>\n";
			$MAIN.="<td> $status </td>\n";
			$MAIN.="<td> <A HREF=\"admin_modify_lead.php?lead_id=$lead_id\" target=\"_blank\">$lead_id</A> </td>\n";
			$call_type='';
			if (strlen($lead_id) > 0)
				{
				$call_type='A';
		...
		$MAIN.="<tr>";
		$MAIN.="<td colspan=2>"._QXZ("TOTALS")."</td>";
		$MAIN.="<td > $TOTALpauseSECONDS</td>\n";
		$MAIN.="<td > $TOTALwaitSECONDS</td>\n";
		$MAIN.="<td > $TOTALtalkSECONDS</td>\n";
		$MAIN.="<td > $TOTALdispoSECONDS</td>\n";
		$MAIN.="<td > $TOTALdeadSECONDS</td>\n";
		$MAIN.="<td > $TOTALcustomerSECONDS</td>\n";
		$MAIN.="<td align=right><font size=2> $TOT_VISIBLE</td>\n";
		$MAIN.="<td align=right><font size=2> $TOT_HIDDEN</td>\n";
		$MAIN.="<td colspan=4> &nbsp; </td></tr>\n";
		...
		$MAIN.="<tr>";
		$MAIN.="<td colspan=2>"._QXZ("(in HH:MM:SS)")."</td>";
		$MAIN.="<td > $TOTALpauseSECONDShh</td>\n";
		$MAIN.="<td > $TOTALwaitSECONDShh</td>\n";
		$MAIN.="<td > $TOTALtalkSECONDShh</td>\n";
		$MAIN.="<td > $TOTALdispoSECONDShh</td>\n";
		$MAIN.="<td > $TOTALdeadSECONDShh</td>\n";
		$MAIN.="<td > $TOTALcustomerSECONDShh</td>\n";
	...
	$MAIN.="<center><B>"._QXZ("RECORDINGS FOR THIS TIME PERIOD: (10000 record limit)")."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=8'>["._QXZ("DOWNLOAD")."]</a></B>\n";
	$MAIN.="<TABLE class='table_list hover centerline' width=750 cellspacing=0 cellpadding=1>\n";
	
	$MAIN.="<thead><tr><th># </th><th>$agent_column</th><th> "._QXZ("LEAD")."</th>$ANI_column<th>"._QXZ("DATE/TIME")." </th><th>"._QXZ("SECONDS")." </th><th> &nbsp; "._QXZ("RECID")."</th><th>"._QXZ("FILENAME")."</th><th>"._QXZ("LOCATION")." &nbsp; </th>$mute_column</tr></thead>\n";
	...
	while ($logs_to_print > $u) 
		...
		$u++;
			...
			if ($NVAuser > 0)
			{
			$MAIN.="<td align=right> $agent_user &nbsp; </td>\n";
			$NVAuser_csv_record=",\"$agent_user\"";
			}
			$MAIN.="<td align=left> <A HREF=\"admin_modify_lead.php?lead_id=$row[12]\" target=\"_blank\">$row[12]</A> </td>";
			if ($NVAuser > 0)
			{
			$MAIN.="<td align=right> $ANI &nbsp; </td>\n";
			$NVAuser_csv_record=",\"$ANI\"";
			}
			$MAIN.="<td align=left> $row[4] </td>\n";
			$MAIN.="<td align=left> $row[8] </td>\n";
			$MAIN.="<td align=left> $row[0] </td>\n";
			$MAIN.="<td align=center> $row[10] </td>\n";
			$MAIN.="<td > $location &nbsp; </td>\n";
			$MAIN.="<td align=center><audio controls preload='none'><source src='$rec_url' type='audio/mpeg'> <source src='$rec_url' type='audio/wav'>Your browser does not support the audio element.</audio></td>\n";
			if ($SSmute_recordings > 0)
			{
	...
	if ($did < 1)
		...
		$MAIN.="<center><B>"._QXZ("MANUAL OUTBOUND CALLS FOR THIS TIME PERIOD: (10000 record limit)")."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=9'>["._QXZ("DOWNLOAD")."]</a></B>\n";
		$MAIN.="<TABLE class='table_list hover centerline' width=750 cellspacing=0 cellpadding=1>\n";

		$MAIN.="<thead><tr><th># </th><th>"._QXZ("DATE/TIME")." </th><th> "._QXZ("CALL TYPE")."</th><th> "._QXZ("SERVER")."</th><th> "._QXZ("PHONE")."</th><th> "._QXZ("DIALED")."</th><th> "._QXZ("LEAD")."</th><th> "._QXZ("CALLERID")."</th><th> "._QXZ("ALIAS")."</th><th> "._QXZ("PRESET")."</th><th>"._QXZ("C3HU")."</th></tr></thead>\n";
		...
		if ($LOGadmin_hide_phone_data != '0')
			...
			$MAIN.="<td align=left> $row[3] </td>\n";
			$MAIN.="<td > $row[4] </td>\n";
			$MAIN.="<td > <A HREF=\"admin_modify_lead.php?lead_id=$row[5]\" target=\"_blank\">$row[5]</A> </td>\n";
			$MAIN.="<td > $row[6] </td>\n";
			$MAIN.="<td > $row[7] </td>\n";
			$MAIN.="<td > $row[8] </td>\n";
			$MAIN.="<td  NOWRAP> $C3HU </td></tr>\n";
	...
	if ($did < 1)
		...
		$MAIN.="<center><B>"._QXZ("LEAD SEARCHES FOR THIS TIME PERIOD: (10000 record limit)")."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=10'>["._QXZ("DOWNLOAD")."]</a></B>\n";
		$MAIN.="<TABLE class='table_list hover centerline' width=750 cellspacing=0 cellpadding=1>\n";

		$MAIN.="<thead><tr><th># </th><th NOWRAP>"._QXZ("DATE/TIME")." &nbsp; </th><th NOWRAP> "._QXZ("TYPE")." &nbsp; </th><th NOWRAP> "._QXZ("RESULTS")." &nbsp; </th><th NOWRAP> "._QXZ("SEC")." &nbsp; </th><th NOWRAP> "._QXZ("QUERY")."</th></tr></thead>\n";
	...
	if ($did < 1)
		...
		$MAIN.="<center><B>"._QXZ("PREVIEW LEAD SKIPS FOR THIS TIME PERIOD: (10000 record limit)")."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=11'>["._QXZ("DOWNLOAD")."]</a></B>\n";
		$MAIN.="<TABLE class='table_list hover centerline' width=750 cellspacing=0 cellpadding=1>\n";

		$MAIN.="<thead><tr><th># </th><th NOWRAP>"._QXZ("DATE/TIME")." &nbsp; </th><th NOWRAP> "._QXZ("LEAD ID")." &nbsp; </th><th NOWRAP> "._QXZ("STATUS")." &nbsp; </th><th NOWRAP> "._QXZ("COUNT")." &nbsp; </th><th NOWRAP> "._QXZ("CAMPAIGN")."</th></tr></thead>\n";
		...
		while ($logs_to_print > $u) 
			...
			$MAIN.="<td>$u</td>";
			$MAIN.="<td>$row[1]</td>";
			$MAIN.="<td > <A HREF=\"admin_modify_lead.php?lead_id=$row[2]\" target=\"_blank\">$row[2]</A> </td>\n";
			$MAIN.="<td > $row[4] </td>\n";
			$MAIN.="<td > $row[5] </td>\n";
			$MAIN.="<td > $row[3] </td></tr>\n";
	...
	##### BEGIN switch lead log entries #####
		$MAIN.="<center><B>"._QXZ("AGENT LEAD SWITCHES FOR THIS TIME PERIOD: (10000 record limit)")."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=13'>["._QXZ("DOWNLOAD")."]</a></B>\n";
		$MAIN.="<TABLE class='table_list hover centerline' width=750 cellspacing=0 cellpadding=1>\n";

		$MAIN.="<thead><tr><th># </th><th NOWRAP>"._QXZ("DATE/TIME")." &nbsp; </th><th NOWRAP>"._QXZ("FROM LEAD ID")." &nbsp; </th><th NOWRAP> "._QXZ("TO LEAD ID")." &nbsp; </th><th NOWRAP> "._QXZ("CALL ID")." &nbsp; </th><th  NOWRAP>"._QXZ("UNIQUEID")." &nbsp; </th><th NOWRAP>"._QXZ("PHONE")." &nbsp; </th><th NOWRAP>"._QXZ("CAMPAIGN")."</th></tr></thead>\n";
	...
	##### BEGIN manager pause code approval entries #####
		$MAIN.="<center><B>"._QXZ("MANAGER PAUSE CODE APPROVALS FOR THIS TIME PERIOD: (10000 record limit)")."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='$download_link&file_download=14'>["._QXZ("DOWNLOAD")."]</a></B>\n";
		$MAIN.="<TABLE class='table_list hover centerline' width=750 cellspacing=0 cellpadding=1>\n";
		$MAIN.="<thead><tr><th># </th><th NOWRAP>"._QXZ("DATE/TIME")." &nbsp; </th><th NOWRAP>"._QXZ("AGENT")." &nbsp; </th><th NOWRAP>"._QXZ("AGENT USER GROUP")." &nbsp; </th><th NOWRAP>"._QXZ("CAMPAIGN")." &nbsp; </th><th  NOWRAP>"._QXZ("PAUSE CODE")." &nbsp; </th></tr></thead>\n";
		...
		while ($logs_to_print > $u) 
			...
			$MAIN.="<td>$u</td>";
			$MAIN.="<td>$row[0]</td>";
			$MAIN.="<td  <A HREF=\"$PHP_SELF?user=$row[1]\" target=\"_blank\">$row[1]</A> </td>\n";
			$MAIN.="<td $row[2]</td>";
			$MAIN.="<td $row[3]</td>";
			$MAIN.="<td $row[4] </td>\n";
