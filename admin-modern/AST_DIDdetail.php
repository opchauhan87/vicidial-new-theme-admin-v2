...
$MAIN.="<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Dates")."</label></div></div>";
$MAIN.="<div class='col-md-2 p-18'>";
...
$MAIN.="<BR><div style='padding-top: 24px !important;width: 84%;'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=time_BEGIN SIZE=10 MAXLENGTH=10 VALUE=\"$time_BEGIN\"></div></div>";

$MAIN.="<BR><div class='col-md-12' style=\"text-align:center;\"> <label>"._QXZ("to")."</label> </div>";

$MAIN.="<div class='col-md-12'><div class='col-md-10'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div></div>";

$MAIN.="<div class='col-md-2 p-18'><script language=\"JavaScript\">\n";
$MAIN.="var o_cal = new tcal ({\n";
$MAIN.="	// form name\n";
$MAIN.="	'formname': 'vicidial_report',\n";
$MAIN.="	// input name\n";
...
$MAIN.="<BR><div style='padding-top: 29px !important;width: 84%;'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=time_END SIZE=10 MAXLENGTH=10 VALUE=\"$time_END\"></div></div></div>";


$MAIN.="</TD><TD class=\"col-md-4\" VALIGN=TOP><BR>";
...
$MAIN.="</SELECT><label>"._QXZ("DIDs")."</label></div></div>\n";
//~ $MAIN.="</TD><TD align=left valign=top><FONT FACE=\"ARIAL,HELVETICA\" COLOR=BLACK SIZE=2>"._QXZ("Shift").":<BR>\n";
$MAIN.="<div class='col-lg-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=shift>\n";
...
$MAIN.="<div class='col-lg-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=route>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Call Route")."</label></div></div>\n";
...
if ($archives_available=="Y") 
	...
	$MAIN.="<input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label><BR>\n";
	}
