...
<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 826px; top: 310px; opacity: 1; z-index: 2;'></div>
...
<div id="pcont4" class="container-fluid">
			  ...
			  <div class="header">
			  <h3><?php echo _QXZ("Listloader Custom Template Maker"); ?><?php echo "$NWB#vicidial_template_maker$NWE"; ?></h3>
			  </div> 
			  <div class="col-md-12">
			  <div class="content">
<table class="hover" border=0 cellpadding=15 cellspacing=0 width="90%" align="center" >

<?php
if ($error_msg) 
	{
	echo "<tr>";
	echo "<th colspan='2'><font >$error_msg</font></th>";
	echo "</tr>";
	}
if ($success_msg) 
	{
	echo "<tr>";
	echo "<th colspan='2'><font >$success_msg</font></th>";
	echo "</tr>";
	}
?>
	<tr>
		<th height="40px" width="50%"><font class="standard_bold"><?php echo "&nbsp;&nbsp;"._QXZ("Create a new template"); ?></font></th>
		<th height="40px" width="50%"><font class="standard_bold"><?php echo "&nbsp;&nbsp;"._QXZ("Delete an existing template"); ?></font></th>
	<tr valign="top">
		...
		<form id="listloader_file_primer" action="leadloader_template_display.php?form_action=prime_file" method="post" enctype="multipart/form-data" target="file_holder">
			<font class="standard"><?php echo _QXZ("Sample file fitting template"); ?>:<BR><font size="-2">(<?php echo _QXZ("needed for field assignation"); ?>)</font></font><?php echo "$NWB#template_maker-create_template$NWE"; ?><BR><BR><div class="col-lg-6 no-padding"><input type=file name="sample_template_file" value="<?php echo $sample_template_file; ?>" onChange="loadIFrame('prime_file', this.value); this.form.submit();"></div>
		</form>
		</td>
...
?>
</select><BR/><BR/><input type="button" value="<?php echo _QXZ("EDIT TEMPLATE"); ?>" style='background-color:#<?php echo $SSbutton_color; ?>' name="edit_template" style="align:right; width: 150px" onClick="EditTemplate(this.form.template_id.value)">&nbsp;&nbsp;<input type="submit" value="<?php echo _QXZ("DELETE TEMPLATE"); ?>" style='background-color:#<?php echo $SSbutton_color; ?>' name="delete_template" style="align:center; width: 150px">		</form></td>
	</tr>
	<tr>
			<td align=left colspan="2" height='40px'><font size=2> &nbsp; &nbsp; &nbsp; &nbsp; <a href="admin.php?ADD=100" target="_parent"><?php echo _QXZ("BACK TO ADMIN"); ?></a> &nbsp; &nbsp; &nbsp; &nbsp; <a href="./admin_listloader_fourth_gen.php"><?php echo _QXZ("Go to Lead Loader"); ?></a> &nbsp; &nbsp; </font></td>
	</tr>
	</tr>
</table>
</form>
...
<table border=0 cellpadding=3 cellspacing=0 width="100%" align="center">
	<tr>
	<th colspan="2" height='40px' ><font class="standard" style='padding-left:10px;'><?php echo _QXZ("New template form"); ?></font></th>
	</tr>
	<tr>
		<td align="right" width='25%'><font class="standard"><?php echo _QXZ("Template ID"); ?>:</font></td>
		<td align="left" width='75%'><div class="col-lg-5"><input class="form-control" type='text' name='template_id' size='15' maxlength='20'></div><?php echo "$NWB#template_maker-template_id$NWE"; ?></td>
	</tr>
	<tr >
		<td align="right" width='25%'><font class="standard"><?php echo _QXZ("Template Name"); ?>:</font></td>
		<td align="left" width='75%'><div class="col-lg-5"><input class="form-control" type='text' name='template_name' size='15' maxlength='30'></div><?php echo "$NWB#template_maker-template_name$NWE"; ?></td>
	</tr>
	<tr >
		<td align="right" width='25%'><font class="standard"><?php echo _QXZ("Template Description"); ?>:</font></td>
		<td align="left" width='75%'><div class="col-lg-5"><input class="form-control" type='text' name='template_description' size='50' maxlength='255'></div><?php echo "$NWB#template_maker-template_description$NWE"; ?></td>
	</tr>
	<tr >
		<td width='25%' align="right"><font class="standard"><?php echo _QXZ("List ID template will load into"); ?>:</font></td>
		<td width='75%'><div class="col-lg-5">
			<select  class="form-control" id='template_list_id' name='template_list_id' onChange="DisplayTemplateFields(this.value)">
				<!-- chirag parmar 12-3-21 -->
			...
			?>
			</select></div></font><?php echo "$NWB#template_maker-list_id$NWE"; ?>
		</td>
	</tr>
	<tr>
		<td width='25%' align="right"><font class="standard"><?php echo _QXZ("Statuses to dedupe against (optional)"); ?>:</font></td>
		<td width='75%'>
		<span id='statuses_display'><div class="col-lg-5">
			<select class="form-control" id='template_statuses' name='template_statuses[]' size=5 multiple>
		...
		<tr style='border:1px solid #FFF'>
			...
			<th colspan='2'><br/><input class='btn btn-bdr-sucess' type='submit' name='submit_template' onClick="return checkForm(this.form)" value='<?php echo _QXZ("SUBMIT TEMPLATE"); ?>'></th>
			</tr>
		<tr  class='no-padding' style='border:1px solid #FFF'><td align="center" colspan=2 class='no-padding' style='border:1px solid #FFF'>
		<br/>
		<br/>
<table class="col-md-12 content" border=0 cellpadding=3 cellspacing=1 width="100%" align="center">
		<tr>
	...
	<tr valign="top">
		<td border="1" align="center"  width="50%"><font class="standard"><?php echo _QXZ("Standard Field"); ?></font></td>
<td border="0" align="center" bgcolor="#<?php echo $SSalt_row1_background; ?>" width="50%"><font class="standard"><?php echo _QXZ("Custom Field"); ?></font></td>	</tr>
	<tr valign="top">
		<td colspan="2" align="center">
