...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")."  $NWB#IVRstats$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./admin.php?ADD=3111&group_id=$group[0]\">"._QXZ("MODIFY")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./AST_CLOSERstats.php?query_date=$query_date&end_date=$end_date&shift=$shift$groupQS\">"._QXZ("CLOSER REPORT")."</a></div><div class=\"pull-right\"></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./AST_VDADstats.php?query_date=$query_date&end_date=$end_date&shift=$shift$groupQS\">"._QXZ("OUTBOUND REPORT")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./admin.php?ADD=31&campaign_id=$group[0]\">"._QXZ("MODIFY CAMPAIGNS")."</a></div> </div>
...
$MAIN.="<TABLE CELLPADDING=3 CELLSPACING=0 BGCOLOR=\"#e3e3ff\"><TR><TD class=\"col-md-4\" VALIGN='TOP'>";
...
$MAIN.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$query_date_D\"><label>"._QXZ("Date Range").":</label></div>";
$MAIN.="</div></div>";
...
$MAIN.="<div class='col-lg-10 no-padding'> <div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_T\"></div></div>";

$MAIN.="<div class=\"col-md-12\" style=\"text-align:center;\"><label>"._QXZ("to")."</label></div><div class=\"col-lg-10 no-padding\"><div class='form-group custom-input mb-10'> <INPUT class='form-control' TYPE=TEXT NAME=end_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$end_date_D\"></div></div>";
$MAIN.="<div class=\"col-md-2 text-center p-18\">";
$MAIN.="<script language=\"JavaScript\">\n";
$MAIN.="var o_cal = new tcal ({\n";
$MAIN.="	// form name\n";
...
$MAIN.=" &nbsp;<div class=\"col-md-12\"><div class=\"col-md-10\">  <div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$end_date_T\"></div>";
...
if ($type == 'inbound')
	...
	$MAIN.="<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
	$o=0;
	...
	$MAIN.="</SELECT><label>"._QXZ("Inbound Groups").":</label></div><BR>\n";
	
	$MAIN.="<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=shift>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Shift").":</label></div>";
	...
	$MAIN.="</SELECT>\n";
	$MAIN.="<label>"._QXZ("Campaigns").":</label></div></div><br/>\n";
...
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>"._QXZ("Display as").":</label></div>";
if ($archives_available=="Y") 
	{
	$MAIN.="<div class='col-md-12'><input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label></div>\n";
	}
$MAIN.="</TD></TR>\n";
...
$MAIN.=" <input type=button value=\""._QXZ("SUBMIT")."\" name=smt id=smt onClick=\"submit_form()\" class='btn btn-success'>";
$MAIN.="<a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?DB=$DB&type=$type&query_date=$query_date&end_date=$end_date&query_date_D=$query_date_D&query_date_T=$query_date_T&end_date_D=$end_date_D&end_date_T=$end_date_T$groupQS&shift=$shift&file_download=1&search_archived_data=$search_archived_data\">"._QXZ("DOWNLOAD")."</a>  ";
$MAIN.="</div>";
