...
if ($file_download < 1)
	...
	echo "<span style=\"z-index:20;\"  id=admin_header>";
...
echo "<TABLE CELLSPACING=3 class='spacer col-lg-12' BGCOLOR=\"#".$SSframe_background."\"><TR><TD VALIGN=TOP>";
echo "<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
echo "<div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Dates")."</label></div></div><div class='col-md-2 p-18'>";
...
echo "</div><div class='col-lg-10 text-center'> "._QXZ("to")." </div><BR><div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div></div><div class='col-md-2 p-18'>";
...
echo "<div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT SIZE=18 MAXLENGTH=20 NAME=user value=\"$user\"><label>"._QXZ("User")."</label></div></div>\n";
//~ echo _QXZ("Phone Number").":<BR>";
echo "<div class='col-lg-10 no-padding'><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT SIZE=12 MAXLENGTH=18 NAME=phone_number value=\"$phone_number\"><label>"._QXZ("Phone Number")."</label></div></div>\n";
...
echo "<BR><BR><INPUT class='btn btn-bdr-sucess' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
echo "</TD><TD VALIGN=TOP> &nbsp; &nbsp; &nbsp; &nbsp; ";
...
echo "<span style=\"z-index:18;\"  id=agent_status_bars>\n";
//~ echo "<PRE><FONT SIZE=2>\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n";
