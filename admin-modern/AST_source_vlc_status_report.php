...
# r aource_id ,user's choice, of the calls and their statuses for all lists 
...
$group_by = preg_replace('/[^-_0-9a-zA-Z]/', '', $group_by);
$sort_by = preg_replace('/[^-_0-9a-zA-Z]/', '', $sort_by);
...
$HTML_head.="<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 850px; top: 361px; opacity: 1; z-index: 2;'></div>";
...
$HTML_text.='<div id="pcont4" class="container-fluid">
		...
		';
$HTML_text.="<div class='header'><h3 class=\"pull-left\">"._QXZ("$report_name")."</b> $NWB#source_vlc_status_report$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div></div>\n";
$HTML_text.="<div class=\"col-md-12\"><div class=\"content\">";
$HTML_text.="<TR><TD>";
//$HTML_text.="<b>\n";

$HTML_text.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$HTML_text.="<TABLE CELLPADDING=3 CELLSPACING=0><TR><TD VALIGN=TOP class='col-md-4'> ";
...
$HTML_text.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$query_date_D\"><label>"._QXZ("Entry date").":</label></div></div>";
...
$HTML_text.=" &nbsp;</div> <div class='col-md-10 mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_T\"></div>";

$HTML_text.="<BR><div class='col-md-12' style=\"text-align:center;\"><label> "._QXZ("to")."</div> </label><BR><div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$end_date_D\"></div></div>";
$HTML_text.="<div class='col-md-2 text-center p-18'>";
$HTML_text.="<script language=\"JavaScript\">\n";
$HTML_text.="var o_cal = new tcal ({\n";
$HTML_text.="	// form name\n";
...
$HTML_text.=" &nbsp;</div> <div class='col-md-10 mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$end_date_T\"></div>";

$HTML_text.="</TD><TD VALIGN=TOP class='col-md-4'> ";
$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' NAME=group[]>\n";
...
$HTML_text.="</SELECT><label>"._QXZ("Campaign").":</label></div></div><BR><BR><BR>\n";


$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'><select class='form-control' name='group_by'>";
if ($group_by) {$HTML_text.="<option value='$group_by' selected>$group_by</option>";}
$HTML_text.="<option value='vendor_lead_code'>"._QXZ("vendor_lead_code")."</option><option value='source_id'>"._QXZ("source_id")."</option></select><label>"._QXZ("Group by").":</label></div></div>\n";

$HTML_text.="</TD>";
$HTML_text.="<TD VALIGN=TOP class='col-md-4'>\n";

$HTML_text.="<div class='col-md-12'><div class='form-group custom-input mb-10'><select class='form-control' name='report_display_type'>";
if ($report_display_type) {$HTML_text.="<option value='$report_display_type' selected>"._QXZ("$report_display_type")."</option>";}
$HTML_text.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>"._QXZ("Display as").":</label></div></div>";
...
$HTML_text.="<TD colspan='3'>";
$HTML_text.="<div class='col-md-12' style='text-align:center;'>";
$HTML_text.="<INPUT class='btn btn-success' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
$HTML_text.="<a class=\"btn btn-bdr-blue\" href=\"$report_URL&sort_by=$sort_by&file_download=1\">"._QXZ("DOWNLOAD")."</a> ";
...
$HTML_text.="</FORM></div></div></div>\n\n";

$HTML_text.="<PRE class='m-0'>";
$i=0;
$group_string='|';
$group_ct = count($group);
$HTML_body="";
...
while($i < $group_ct)
	...
	$HTML_body.="<span colspan='3'><b>"._QXZ("$rpt_group_title")." : "._QXZ("TOTALS")."</b></span>";
	$HTML_body.="<table border='0' cellpadding='0' class=\"table_list hover centerline\" cellspacing='0' width='600'>";
	//$HTML_body.="<thead><tr bgcolor='#".$SSmenu_background."'><th colspan='3'><font color='#FFFFFF'>"._QXZ("$rpt_group_title")." : "._QXZ("TOTALS")."</font></th></tr></thead>";
	$HTML_body.="<thead><tr bgcolor='#FFFFFF'><th align='left'><a href='$report_URL&sort_by=".($sort_by == "dispo_asc" ? "dispo_desc" : "dispo_asc")."'>"._QXZ("DISPOSITION",40)."</a></th><th align='center'><a href='$report_URL&sort_by=".($sort_by == "count_desc" ? "count_asc" : "count_desc")."'>"._QXZ("CALLS",6)."</a></th><th align='center'>"._QXZ("PERCENT", 7)."</th></tr></thead>";
	...
	$HTML_body.="<tr><td align='left'><b>"._QXZ("GRAND TOTAL")."</b></td><td align='center'>".$grand_total."</td><td align='center'>&nbsp;</td></tr>";
	$HTML_body.="</table><BR>\n";
	$ASCII_text.="+------------------------------------------+--------+----------+\n";
