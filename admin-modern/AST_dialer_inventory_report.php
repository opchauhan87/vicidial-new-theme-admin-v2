...
$campaign_span_txt.="<div class=\"col-md-12\"><div class=\"form-group custom-input mb-10\"><SELECT SIZE=5 class='form-control' NAME=group[] multiple>";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
$campaign_span_txt.="</SELECT><label>"._QXZ("Campaigns")."</label></div></div>";

//~ $list_span_txt=_QXZ("Lists").":<BR>";
$list_span_txt.="<div class=\"col-md-12\"><div class=\"form-group custom-input mb-10\"><SELECT class='form-control' NAME='selected_list'>";
$o=0;
if ($selected_list) 
	{
...
$list_span_txt.="</SELECT><label>"._QXZ("Lists")."</label></div></div>";
...
$snapshot_span_txt.="<SELECT class='form-control' NAME='snapshot_time'>\n";
...
$HTML_text='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3>'._QXZ("$report_name").'</h3></div><div class="col-md-12">';
...
$HTML_text.="<TABLE CELLPADDING=3 CELLSPACING=0 ><TR height='150'><TD class='col-md-3 text-left' VALIGN=TOP>\n";
//~ $HTML_text.="	<table width='*' align='center'>\n";
//~ $HTML_text='<div id="pcont4" class="container-fluid">
		//~ <div class="cl-mcont">
        //~ <div class="row">
		//~ <div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3>'._QXZ("$report_name").'</h3></div><div class="col-md-12">';
$HTML_text.="<label>"._QXZ("Report type").":</label><br>\n";
if ($report_type=='LIST') {$cmp_checked=""; $list_checked="checked";} else {$cmp_checked="checked"; $list_checked="";}
$HTML_text.="	<input type='radio' name='report_type' value='CAMPAIGNS' onClick=\"ToggleSpan('campaign_span', 'list_span')\" $cmp_checked>"._QXZ("Campaigns")."<br>\n";
$HTML_text.="	<input type='radio' name='report_type' value='LIST' onClick=\"ToggleSpan('list_span', 'campaign_span')\" $list_checked>"._QXZ("List")."<br>\n";
//~ $HTML_text.="	</table>\n";
$HTML_text.="</TD>\n";
//~ $HTML_text.="<td width='30'>&nbsp;</td>\n";
$HTML_text.="<TD class='col-md-3' VALIGN=TOP>\n";
...
$HTML_text.="<TD class='col-md-3' VALIGN=TOP>\n";
//~ $HTML_text.="	<table width='*' align='center'>\n";
$HTML_text.="<label>"._QXZ("Time setting").":</label><br>\n";
...
$HTML_text.="	<input type='radio' name='time_setting' value='SERVER' $svr_checked>"._QXZ("Server")."<br>\n";
$HTML_text.="	<input type='radio' name='time_setting' value='LOCAL' $local_checked>"._QXZ("Local")."<br>\n";
$HTML_text.="	<input type='checkbox' name='override_24hours' value='OVERRIDE' $override_checked>"._QXZ("Ignore local campaign call time")."<BR>("._QXZ("default to 24 hours").")<br>\n";
//~ $HTML_text.="	</table>\n";
$HTML_text.="</TD>\n";
$HTML_text.="<TD VALIGN=TOP class='col-md-3'>\n";
//~ $HTML_text.="	<table width='*' align='center'>\n";
$HTML_text.="<label>"._QXZ("Report source").":</label><br>\n";
if ($report_source=='REALTIME') {$ss_checked=""; $rt_checked="checked";} else {$ss_checked="checked"; $rt_checked="";}
$HTML_text.="	<input type='radio' name='report_source' value='SNAPSHOT' onClick=\"ToggleSpan('snapshot_span', '')\" $ss_checked>"._QXZ("Snapshot")."<br>\n";

if ($inventory_allow_realtime > 0)
	{
	$HTML_text.="<input type='radio' name='report_source' value='REALTIME' onClick=\"ToggleSpan('', 'snapshot_span')\" $rt_checked>"._QXZ("Real-time")."<br>\n";
	}
else
	{
	$HTML_text.="	<br>\n";
...
$HTML_text.="<span id='snapshot_span' style='display:block;'>$snapshot_span_txt</span>\n";
//~ $HTML_text.="	</table>\n";
$HTML_text.="</TD></tr><tr>\n";
$HTML_text.="<TD colspan=4 VALIGN='top' align='center'>\n";
$HTML_text.="<font color='BLACK' face='ARIAL,HELVETICA' size='2'> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a class='btn btn-info' href='$PHP_SELF?DB=$DB$groupQS&selected_list=$selected_list&report_type=$report_type&time_setting=$time_setting&report_source=$report_source&snapshot_time=$snapshot_time&file_download=1&SUBMIT=$SUBMIT'>"._QXZ("DOWNLOAD")."</a>  <a class='btn btn-info' href='./admin.php?ADD=999999'>"._QXZ("REPORTS")."</a> </font><BR><BR>\n";
$HTML_text.="</TD>\n";
$HTML_text.="</TR>\n";
$HTML_text.="<tr><td colspan=2><input class='btn btn-success' name='SUBMIT' value='"._QXZ("SUBMIT")."' type='submit'></td></tr>\n";
$HTML_text.="</TD>\n";
$HTML_text.="</TR>\n";
$HTML_text.="</TABLE>\n";
