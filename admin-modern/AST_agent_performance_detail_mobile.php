...
while ($i < $campaigns_to_print)
	...
	if (preg_match('/\-ALL/',$group_string) )
		{$group[$i] = $groups[$i];  $all_groups=1;}
	$i++;
	}
for ($i=0; $i<count($user_group); $i++)
	{
	$user_group[$i] = preg_replace('/[^-_0-9\p{L}]/u', '', $user_group[$i]);
	if (preg_match('/\-\-ALL\-\-/', $user_group[$i])) {$all_user_groups=1; $user_group=array();}
	}
...
if ( (preg_match('/\-\-ALL\-\-/',$user_string) ) or ($user_ct < 1) )
	{
	$user_SQL = "";
	if (preg_match('/\-\-ALL\-\-/',$user_string) ) {$userQS="&users[]=--ALL--"; $user_string="--ALL--";}
	}
else
	{
...
$HTML_head.="	.top_settings_val {color: black; font-family: HELVETICA; font-size: calc(8px + (11 - 8) * ((100vw - 300px) / (1600 - 300)));}\n";
...
$HTML_head.="<TITLE>"._QXZ("$report_name")."</TITLE></HEAD><BODY BGCOLOR=\"#".$SSframe_background."\" marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";

#	require("admin_header.php");

$HTML_text.="<TABLE class='admin_stats_table' CELLPADDING=3 CELLSPACING=0><TR><TD class='top_settings_key'>";
...
$HTML_text.="<TABLE class='admin_stats_table' CELLSPACING=6 BGCOLOR=\"#".$SSframe_background."\"><TR>\n";

$HTML_text.="<TD VALIGN=TOP class='android_standard'> "._QXZ("Campaigns").":<BR>";
$HTML_text.="<SELECT NAME=group[] multiple class='form_field_android sm_shadow round_corners mobile_whiteboard_select'>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
$HTML_text.="<TD VALIGN=TOP class='android_standard'>"._QXZ("Users").": <BR>";
$HTML_text.="<SELECT NAME=users[] multiple class='form_field_android sm_shadow round_corners mobile_whiteboard_select'>\n";
...
$HTML_text.="<TR>";
$HTML_text.="<TD VALIGN=TOP class='android_standard'>"._QXZ("User Groups").":<BR>";
$HTML_text.="<SELECT NAME=user_group[] multiple class='form_field_android sm_shadow round_corners mobile_whiteboard_select'>\n";
...
$HTML_text.="<TD VALIGN=TOP class='android_standard' rowspan='2'> "._QXZ("Dates").":<BR>";
$HTML_text.="<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
$HTML_text.="<INPUT TYPE=TEXT NAME=query_date SIZE=11 MAXLENGTH=10 VALUE=\"$query_date\" class='form_field_android sm_shadow round_corners'>";
/*
...
$HTML_text.="</script>\n";
*/
$HTML_text.="&nbsp;&nbsp;<INPUT TYPE=TEXT NAME=query_time SIZE=9 MAXLENGTH=8 VALUE=\"$query_time\" class='form_field_android sm_shadow round_corners'>";

$HTML_text.="<BR> "._QXZ("to")." <BR><INPUT TYPE=TEXT NAME=end_date SIZE=11 MAXLENGTH=10 VALUE=\"$end_date\" class='form_field_android sm_shadow round_corners'>";
/*
$HTML_text.="<script language=\"JavaScript\">\n";
$HTML_text.="var o_cal = new tcal ({\n";
$HTML_text.="	// form name\n";
...
$HTML_text.="</script>\n";
*/
$HTML_text.="&nbsp;&nbsp;<INPUT TYPE=TEXT NAME=end_time SIZE=9 MAXLENGTH=8 VALUE=\"$end_time\" class='form_field_android sm_shadow round_corners'>";

$HTML_text.="</TD>\n";
$HTML_text.="</TR>";

$HTML_text.="<TR>";
$HTML_text.="<TD VALIGN=TOP class='android_standard'>";
...
$HTML_text.="<SELECT NAME=shift  class='form_field_android sm_shadow round_corners'>\n";
...
$HTML_text.="<TR>";
$HTML_text.="<TD VALIGN=TOP align='center' class='android_standard' colspan='2'>";
$HTML_text.="<INPUT TYPE=SUBMIT NAME=SUBMIT class='red_btn_mobile' VALUE='"._QXZ("SUBMIT")."'>\n";
$HTML_text.="</TD></TR>";
