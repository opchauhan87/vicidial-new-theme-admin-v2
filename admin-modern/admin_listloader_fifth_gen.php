...
<?php } ?>
		  ...
		  <td ><font face="arial, helvetica" size=2><?php echo _QXZ("USA-Canada Check"); ?>:</font></td>
			...
			</select></div> <?php echo "$NWB#list_loader-usacan_check$NWE"; ?></td>
		  </tr>
		  <tr>
		  <td ><font face="arial, helvetica" size=2><?php echo _QXZ("Lead Time Zone Lookup"); ?>:</font></td>
			...
			</select></div> <?php echo "$NWB#list_loader-timezone_lookup$NWE"; ?></td>
		  </tr>
		  <tr>
			...
			</select></div> <?php echo "$NWB#list_loader-state_conversion$NWE"; ?></td>
		  </tr>
		  <tr>
			...
			<?php } ?>
			</select></div> <?php echo "$NWB#list_loader-required_phone_length$NWE"; ?></td>
		  </tr>
		  <tr>
			<td align=right width="25%"><font face="arial, helvetica" size=2><?php echo _QXZ("Invalid Phone Number Replacement"); ?>: </font></td>
			<td align=left width="75%"><font face="arial, helvetica" size=1><div class="col-lg-5"><select class="form-control"   size=1 name=invalid_phone_override>
		...
		<?php } ?>
			</select></div> <?php echo "$NWB#list_loader-invalid_phone_override$NWE"; ?></td>
		  </tr>
...
if ($OK_to_process) 
	...
	if (count($field_check)>=2) 
		...
		{
			print "<center><font face='arial, helvetica' size=3 color='#990000'><span class='message_block' style='margin-bottom: 35px !important;'><B>"._QXZ("ERROR").": "._QXZ("The file does not have the required number of fields to process it").".</B></span></font></center>";
		}
	}
