...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("$report_name")."$NWB#CLOSERstats$NWE</h3>".'<div class=\'pull-right\'><a class= "btn btn-info" href="./admin.php?ADD=999999">'._QXZ("BACK").'</a></div> </div>
...
// $MAIN.="<font class=\"select_bold\">"._QXZ("$report_name");
$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<INPUT TYPE=HIDDEN NAME=DB VALUE=\"$DB\">";
$MAIN.="<TABLE BORDER=0 CELLSPACING=4><TR><TD ALIGN=LEFT VALIGN=TOP nowrap>\n";
$MAIN.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT TYPE=TEXT NAME=query_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date Range")."</label></div></div>";
...
$MAIN.="<div class='col-md-12' align='center'><label>"._QXZ("to")."</label></div> <div class='col-md-12'>";
$MAIN.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT TYPE=TEXT NAME=end_date SIZE=10 class=form-control MAXLENGTH=10 VALUE=\"$end_date\"></div></div><div class='col-md-2 text-center p-18'>";
...
$MAIN.="<div class='form-group custom-input mb-10'><SELECT SIZE=5 class=form-control NAME=user_group[] multiple>\n";
	$o=0;
...
$MAIN.="</SELECT><label>"._QXZ("User Groups")."</label></div><BR>\n";

$MAIN.="<div class='form-group custom-input mb-10'><INPUT TYPE=text NAME=user SIZE=7 class=form-control MAXLENGTH=20 VALUE=\"$user\"><label>"._QXZ("User")."</label></div>\n";


$MAIN.="</TD></TD><TD class='col-md-4' valign=top>";
...
$MAIN.="<BR>\n";
$MAIN.="<div class='form-group custom-input mb-10'><SELECT SIZE=1 NAME=order class=form-control>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Order")."</label></div></TD>\n";
...
$MAIN.="</TR>";
$MAIN.="<TR><TD colspan='3'><div class='col-md-12' style='text-align:center;'>";
$MAIN.="<INPUT TYPE=SUBMIT NAME=SUBMIT  VALUE='"._QXZ("SUBMIT")."' class='btn btn-success'>";
$MAIN.="<FONT class=\"standard\" COLOR=BLACK SIZE=2> &nbsp; &nbsp; <a class='btn btn-bdr-blue' href=\"$PHP_SELF?DB=$DB$user_groupQS&query_date=$query_date&end_date=$end_date&order=$order&user=$user&SUBMIT=$SUBMIT&file_download=1\">"._QXZ("DOWNLOAD")."</a> &nbsp;\n";
...
if (!$report_display_type || $report_display_type=="TEXT") 
	...
	$MAIN.="<TABLE class='table_list hover centerline' BORDER=0 CELLSPACING=1 CELLPADDING=3><TR >\n";
	$MAIN.="<thead><th ALIGN=CENTER>#</th>\n";
	$MAIN.="<th ALIGN=CENTER>&nbsp; "._QXZ("USER")." &nbsp;</th>\n";
	$MAIN.="<th ALIGN=CENTER>&nbsp; "._QXZ("NAME")." &nbsp;</th>\n";
	$MAIN.="<th ALIGN=CENTER>&nbsp; "._QXZ("GROUP")." &nbsp;</th>\n";
	$MAIN.="<th ALIGN=CENTER>&nbsp; "._QXZ("HOURS")." &nbsp;</th>\n";
	$MAIN.="</TR></thead>\n";
