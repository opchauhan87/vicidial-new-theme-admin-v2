...
$MAIN.="<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>Dates</label>";
$MAIN.="</div></div>";
...
$MAIN.="<BR><div style='width: 84%;'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=time_BEGIN SIZE=10 MAXLENGTH=8 VALUE=\"$time_BEGIN\"></div>";
$MAIN.="</div></div>";
...
$MAIN.="</script>\n";
$MAIN.="</div>";
$MAIN.="<BR><div style='width: 84%;'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=time_END SIZE=10 MAXLENGTH=8 VALUE=\"$time_END\"></div>";
$MAIN.="</div></div>";
...
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>Display as</label></div></div>\n";

if ($archives_available=="Y") 
	{
	$MAIN.="<BR><BR><BR><input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label>\n";
	}
...
$MAIN.="<a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?query_date=$query_date&end_date=$end_date$groupQS&shift=$shift&DB=$DB&SUBMIT=$SUBMIT&file_download=1\">"._QXZ("DOWNLOAD")."</a> \n";
