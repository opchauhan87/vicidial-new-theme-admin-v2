...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name").'</h3><div class="pull-right"><INPUT TYPE=button NAME="goto_reports" ID="goto_reports" class="btn btn-info" VALUE="'._QXZ("BACK").'"></div></div>
...
$MAIN.="<TABLE CELLPADDING=3 CELLSPACING=3 border='0' ><TR>";
$MAIN.="<TD VALIGN='TOP'><div class='col-md-12'><div class='form-group custom-input mb-10'>";


$MAIN.="<SELECT class='form-control' NAME=report_type ID=report_type class='' onChange=HighlightRelatedFields(this.value)>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Report Type").":$NWB#rt_whiteboard_report-report_type$NWE</label>\n";

$MAIN.="</div></div></TD>\n";

$MAIN.="<TD VALIGN=TOP ><div class='col-md-12'><div class='form-group custom-input mb-10'> ";
$MAIN.="<SELECT class='form-control' SIZE=5 NAME=campaigns ID=campaigns multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Campaigns").": $NWB#rt_whiteboard_report-parameters$NWE</label>\n";
$MAIN.="</div></div></TD>\n";

$MAIN.="<TD VALIGN=TOP ALIGN='LEFT'><div class='col-md-12'><div class='form-group custom-input mb-10'>";

$MAIN.="<SELECT class='form-control' SIZE=5 NAME='status_flags' ID='status_flags' multiple class=''>\n";
...
$MAIN.="</SELECT>\n";
$MAIN.="<label>"._QXZ("Status flags").":$NWB#rt_whiteboard_report-parameters$NWE</label></div></div></TD>\n";
$MAIN.="</TR>\n";
$MAIN.="<TR>";

$MAIN.="<TD VALIGN=TOP><div class='col-md-12'><div class='form-group custom-input mb-10'>";
$MAIN.="<SELECT class='form-control' SIZE=5 NAME='user_groups' ID='user_groups' multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("User Groups").":  $NWB#rt_whiteboard_report-parameters$NWE</label>\n";
$MAIN.="</div></div></TD>\n";

$MAIN.="<TD VALIGN=TOP ><div class='col-md-12'><div class='form-group custom-input mb-10'>";
$MAIN.="<SELECT class='form-control' SIZE=5 NAME='users' ID='users' multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Users").": $NWB#rt_whiteboard_report-parameters$NWE</label></div></div>\n";
$MAIN.="</TD>\n";

$MAIN.="<TD VALIGN=MIDDLE ALIGN='LEFT' nowrap width='400'>";
$MAIN.="<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";
$MAIN.="<div class='col-md-12'><div class='col-md-10'>";
$MAIN.="<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date ID=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\" class=''><label>"._QXZ("Start date/time").": $NWB#rt_whiteboard_report-start_date$NWE</label></div></div>";

$MAIN.="<div class='col-md-2 p-18 text-center'>";
...
$MAIN.="&nbsp;&nbsp;<div class=\"col-md-10\"><div class=\"form-group custom-input mb-10\"><INPUT class='form-control' TYPE=TEXT NAME=query_time ID=query_time SIZE=10 MAXLENGTH=8 VALUE=\"$query_time\"> ";
$MAIN.="</div></div></div>";
/*
...
$MAIN.="<BR><label class='col-md-12 text-center'><span class='badge badge-info'>"._QXZ("OR")."</span></label><BR>";
$MAIN.="<div class='col-md-12'><div class='form-group custom-input input-group mb-10'><input class='form-control' type='text' class='' size='2' maxlength='2' name='hourly_display' id='hourly_display' value=''> <label>"._QXZ("Show results for the past")."</label><span class='input-group-addon'>"._QXZ("hours")."$NWB#rt_whiteboard_report-show_results$NWE</span></div></div>";
$MAIN.="</TD>\n";

$MAIN.="</TR>\n";
$MAIN.="<TR>";

$MAIN.="<TD VALIGN=TOP width='300'><div class='col-md-12'><div class='form-group custom-input mb-10'>";
$MAIN.="<SELECT class='form-control' SIZE=5 NAME=groups ID=groups multiple class=''>\n";
...
$MAIN.="</SELECT><label>"._QXZ("In-groups").": $NWB#rt_whiteboard_report-parameters$NWE</label>\n";
$MAIN.="</div></div></TD>\n";

$MAIN.="<TD VALIGN=TOP><div class='col-md-12'><div class='form-group custom-input mb-10'>";
$MAIN.="<SELECT class='form-control'  SIZE=5 NAME=dids ID=dids multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("DIDs").": $NWB#rt_whiteboard_report-parameters$NWE</label></div></div>\n";
$MAIN.="</TD>\n";

$MAIN.="<TD VALIGN='TOP' ALIGN='CENTER' width='400'>";
$MAIN.="<div class='col-md-12'><div class='form-group custom-input input-group mb-10'><input class='form-control' type='text' size='5' maxlength='5' name='target_per_agent' id='target_per_agent' value='$target_per_agent'><label>"._QXZ("Target per unit").":</label><span class='input-group-addon'>$NWB#rt_whiteboard_report-target_per_unit$NWE</span></div></div>";
$MAIN.="<div class='col-md-12'><div class='form-group custom-input input-group mb-10'><input type='text' size='5' maxlength='5' name='target_gross' id='target_gross' value='$target_gross' class='form-control'><label>"._QXZ("Target gross sales").":</label><span class='input-group-addon'>$NWB#rt_whiteboard_report-target_gross_sales$NWE</span></div></div>";
$MAIN.="</TD>\n";

$MAIN.="</TR><TR><TD colspan='3' class='text-center'>";
$MAIN.="<INPUT TYPE=button NAME='run_report' class='btn btn-success' style='width:150px' VALUE='"._QXZ("RUN REPORT")."' onClick='StartRefresh()'>";
$MAIN.="</TD>\n";
...
$MAIN.="<TABLE CELLPADDING=0 border='0' CELLSPACING=3 ' width='90%' height='*' class=''><TR>";

$MAIN.="<TD ALIGN=left width='150' class=''>";
...
$MAIN.="<TD ALIGN=center width='*' class=''>";
$MAIN.=_QXZ("Refresh rate").":&nbsp;";
$MAIN.="<select name='refresh_rate' id='refresh_rate' class=''>";
...
$MAIN.="<INPUT TYPE=TEXT NAME=query_date2 ID=query_date2 SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\" class=''>";
$MAIN.="<script language=\"JavaScript\">\n";
$MAIN.="function openNewWindow(url)\n";
$MAIN.="	{\n";
$MAIN.="	window.open (url,\"\",'width=620,height=300,scrollbars=yes,menubar=yes,address=yes');\n";
...
$MAIN.="// o_cal.a_tpl.weekstart = 1; // Monday week start\n";
$MAIN.="</script>\n";
$MAIN.="<INPUT TYPE=TEXT NAME=query_time2 ID=query_time2 SIZE=10 MAXLENGTH=8 VALUE=\"$query_time\" class=''>";

$MAIN.="&nbsp;"._QXZ("OR")."&nbsp;"._QXZ("Show results for the past")." <input type='text' class='' size='2' maxlength='2' name='hourly_display2' id='hourly_display2' value=''> "._QXZ("hours");
$MAIN.="</TD>";

$MAIN.="<TD ALIGN=right width='150' class=''>";
...
$MAIN.="<TD VALIGN=TOP width='180' align='left' rowspan=2 class=''><BR><BR><BR>";
$MAIN.="<div class='' style='width:160px'>"._QXZ("Total Calls").":<BR><span id='total_calls_div'></span>&nbsp;</div><BR>";
$MAIN.="<div class='' style='width:160px'>"._QXZ("Total Sales").":<BR><span id='total_sales_div'></span>&nbsp;</div><BR>";
$MAIN.="<div class='' style='width:160px'>"._QXZ("Total Conv Rate").":<BR><span id='total_conv_div'></span>&nbsp;</div><BR>";
$MAIN.="<div class='' style='width:160px'>"._QXZ("Total Time").":<BR><span id='total_time_div'></span>&nbsp;</div><BR>";
$MAIN.="<div class='' style='width:160px'>"._QXZ("Total CPH").":<BR><span id='total_cph_div'></span>&nbsp;</div><BR>";
$MAIN.="<div class='' style='width:160px'>"._QXZ("Total SPH").":<BR><span id='total_sph_div'></span>&nbsp;</div>";
$MAIN.="</TD>";
$MAIN.="</TR>";
...
$MAIN.="<BR><BR><BR><BR><BR><div align='center' class='' style='background-color:#FFF;width:250px;height:125px'><BR><BR>"._QXZ("LOADING.  PLEASE WAIT...")."<BR><BR><img src='/vicidial/images/loader.gif' width='220' height='19'></div>";
$MAIN.="</div>";
