...
echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> 
		<h3> '._QXZ("Bulk Tools").'</h3></div><div class="col-md-12"><div class="content">';
...
echo "<html><form action=$PHP_SELF method=POST>";
	...
	echo "<tr  ><td colspan=2 align=center><input class=btn btn-bdr-sucess type=submit name=did_submit value='CONFIRM'></td></tr>\n";
...
elseif ($form_to_run == "ACCIDDELETEselect")
	...
	echo "<tr    ><td colspan=2 align=center>   <b>"._QXZ("Campaign")." $ACCIDdelete_campaign "._QXZ("AC-DID Bulk Delete")."</b></font></td></tr>\n";
	echo "<tr  ><td align=right>"._QXZ("AC-CIDs to delete").": </td><td align=left>\n";
	...
	echo "</select></td></tr>\n";
	echo "<tr  ><td colspan=2 align=center><input class='btn btn-bdr-sucess'  type=submit name=did_submit value='"._QXZ("SUBMIT")."'></td></tr>\n";
...
elseif ($form_to_run == "ACCIDDELETEconfirm" || $form_to_run == "ACCIDDELETEconfirmTB")
	...
	echo "<br><font color=red><b><center>"._QXZ("WANRING! You are about to remove all AC-CID entries for campaign")." $ACCIDdelete_campaign "._QXZ("WARNING!")."</center></b></font><br><br>";
		...
		echo "<tr  ><td colspan=2 align=center><input type=submit name=did_submit value='CONFIRM'></td></tr>\n";
		echo "</table></center></form>\n";
		echo "</html>";
		}
	else
...
#### Build forms
	...
	if ( $modify_dids < 1 )
		{
			echo "<center><table width=$section_width cellspacing='3'>";
		echo "<tr  ><td colspan=2 class=text-left><font color=black><b>"._QXZ("DID Bulk Copy")."</b></font>$NWB#DIDADD$NWE</td></tr>\n";
		echo "<tr  ><td colspan=2 align=center><font color=black><b>"._QXZ("You do not have permission to use this section.")."</b></font></td></tr>\n";
		echo "</table></center>\n";
		}
	else 
		{
echo "<form action=$PHP_SELF method='post'>";
		...
		echo "<center><table width=$section_width cellspacing='3'>";
		echo "<col width=50%><col width=50%>";
		echo "<tr bgcolor='#1A486C' ><td colspan=2 class=text-left> <font color=white>  <b>"._QXZ("DID Bulk Copy")."</b>$NWB#DIDADD$NWE</font></td></tr>\n";
		echo "<tr  ><td align=right>"._QXZ("DID to copy from").": </td><td align=left>\n";;
		...
		while ($i < $did_count)
			...
			echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=DIDcopy_from>\n";
		...
		echo "<tr><td align=right>"._QXZ("DIDs to insert").":</td><td align=left><div class='col-lg-5'><textarea class='form-control' name='DIDto_insert' cols='11' rows='10'></textarea></div></td></td></tr>";
		echo "<tr  ><td colspan=2 class=text-center><input  class=\"btn btn-bdr-sucess\" type=submit name=did_submit value='"._QXZ("Submit")."'></td></tr>\n";
		echo "</table></center></form>\n";
		}
	...
	if ( $modify_dids < 1  || $delete_dids < 1 )
		{
		echo "<center><table width=$section_width cellspacing='3'>";
		echo "<tr   bgcolor='#1A486C'  ><td colspan=2 class=text-left>   <b>"._QXZ("DID Bulk Delete")."</b>$NWB#DIDDELETE$NWE</font></td></tr>\n";
		echo "<tr  bgcolor='#1A486C' ><td colspan=2 align=center><font color=black><b>"._QXZ("You do not have permission to use this section.")."</b></font></td></tr>\n";
		echo "</table></center>\n";
		}
	else
		{
		...
		echo "<center><table width=$section_width cellspacing='3'>";
		echo "<col width=50%><col width=50%>";
		echo "<tr bgcolor='#1A486C'><td colspan=2 class=text-left><font color=white><b>"._QXZ("DID Bulk Delete Select")."</b>$NWB#DIDDELETE$NWE</font></td></tr>\n";
		echo "<tr  ><td align=right>"._QXZ("DIDs to delete").": </td><td align=left>\n";
		...
		echo "<div class=\"col-lg-5\"><select class='form-control' multiple size=10 name='DIDdelete_from[]'>\n";
		$i = 0;
		while ( $i < $did_count )
			{
	...
	echo "</select></div></td></tr>\n";
		...
		echo "<center><table width=$section_width cellspacing='3'>";
		echo "<col width=50%><col width=50%>";
		echo "<tr  bgcolor='#1A486C'><td colspan=2 class=text-left><font color=white><b>"._QXZ("DID Bulk Delete")."</b>$NWB#DIDDELETE$NWE</font></td></tr>\n";
		echo "<tr><td align=right>"._QXZ("DIDs to delete").":</td><td align=left><textarea class='form-control' name='DIDto_delete_TB' cols='11' rows='10'></textarea></td></td></tr>";
		echo "<tr><td colspan=2 class=text-center><input class='btn btn-bdr-sucess' type=submit name=did_submit value='"._QXZ("Submit")."'></td></tr>\n";
		echo "</table></center></form>\n";
		echo "</table></center></form>\n";
		echo "</html>";
	...
	if ( $modify_campaigns < 1 )
		{
	echo "<center><table width=$section_width cellspacing='3'>";
		echo "<tr   bgcolor='#1A486C'  ><td colspan=2 align=center> <font color=white>  <b>"._QXZ("CID Groups and AC-CID Bulk Add")."</b>$NWB#ACCIDADD$NWE</font></td></tr>\n";
		echo "<tr  ><td colspan=2 align=center><font color=black><b>"._QXZ("You do not have permission to use this section.")."</b></font></td></tr>\n";
		echo "</table></center>\n";
		}
	else 
		...
		echo "<center><table width=$section_width cellspacing='3'>";
		echo "<col width=50%><col width=50%>";
		echo "<tr   bgcolor='#1A486C'  ><td colspan=2 class=text-left> <font color=white>  <b>"._QXZ("CID Groups and AC-CID Bulk Add")."</b>$NWB#ACCIDADD$NWE</font></td></tr>\n";
		echo "<tr  ><td align=right>"._QXZ("Method").": </td><td align=left><div class=\"col-lg-5\"><select class=\"form-control\" size=1 name=ACCIDmethod>\n";	
		...
		echo "</select></div></td></tr>\n";
		echo "<tr  ><td align=right>"._QXZ("Campaign or CID Group").":</td><td align=left>\n";
		...
		echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=ACCIDcampaign>\n";
		...
		echo "</select></div></td></tr>\n";	
		echo "<tr ><td align=right>"._QXZ("Active?").":</td><td align=left><div class=\"col-lg-5\"><select class='form-control' size=1 name=ACCIDactive>\n";	
		echo "<option value='N'>"._QXZ("No")."</option>\n";
		echo "<option value='Y'>"._QXZ("Yes")."</option>\n";
		echo "<option value='F'>"._QXZ("Input")."</option>\n";
		echo "</select></div></td></tr>\n";	
		echo "<tr ><td align=right>"._QXZ("CID Group and AC-CID entries").":</td><td align=left><div class=\"col-lg-5\"><textarea class='form-control' name='ACCIDdids' cols='70' rows='10'></textarea></div></td>\n";	
		echo "<tr><td colspan=2 class=text-center><input  class=\"btn btn-bdr-sucess\" type=submit name=accid_submit value='"._QXZ("Submit")."'></td></tr>\n";
		echo "</table></center></form>\n";
		echo "</html>";
		}
	...
	if ( $delete_campaigns < 1 )
		{
		echo "<center><table width=$section_width cellspacing='3'>";
		echo "<tr  bgcolor='#1A486C'   ><td colspan=2 class=text-left>   <b>"._QXZ("CID Groups and AC-CID Bulk Delete")."</b>$NWB#ACCIDDELETE$NWE</font></td></tr>\n";
		echo "<tr  ><td colspan=2 align=center><font color=black><b>"._QXZ("You do not have permission to use this section.")."</b></font></td></tr>\n";
		echo "</table></center>\n";
		}
	else 
		...
		echo "<center><table width=$section_width cellspacing='3'>";
		echo "<col width=50%><col width=50%>";
		echo "<tr  bgcolor='#1A486C'><td colspan=2 class=text-left><font color=white><b>"._QXZ("CID Groups and AC-CID Bulk Delete Select")."</b>$NWB#ACCIDDELETE$NWE</font></td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Campaign or CID Group").":</td><td align=left>\n";
		...
		echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=ACCIDdelete_campaign>\n";
		echo "<option value='BLANK'>"._QXZ("Select a campaign or CID group")."</option>\n";
		...
		echo "</select></div></td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Clear all CID Group or AC-CID entries?").":</td><td align=left><div class=\"col-lg-5\"><select class='form-control' size=1 name=ACCIDclear_all>\n";	
		echo "<option value='N'>"._QXZ("No")."</option>\n";
		echo "<option value='Y'>"._QXZ("Yes")."</option>\n";
		echo "</select></div></td></tr>\n";		
	echo "<tr  ><td colspan=2 class=text-center><input  class=\"btn btn-bdr-sucess\" type=submit name=accid_submit value='"._QXZ("Submit")."'></td></tr>\n";
		...
		echo "<center><table width=$section_width cellspacing='3'>";
		echo "<col width=50%><col width=50%>";
		echo "<tr bgcolor='#1A486C'><td colspan=2 class=text-left><font color=white><b>"._QXZ("CID Groups and AC-CID Bulk Delete")."</b>$NWB#ACCIDDELETE$NWE</font></td></tr>\n";
		echo "<tr><td align=right>"._QXZ("Campaign or CID Group").":</td><td align=left>\n";
		...
		echo "<select class='form-control' size=1 name=ACCIDdelete_campaign>\n";
		echo "<option value='BLANK'>"._QXZ("Select a campaign or CID group")."</option>\n";
		...
		echo "</select></td></tr>\n";
		echo "<tr><td align=right>"._QXZ("CIDs to delete").":</td><td align=left><textarea class='form-control' name='ACCIDdelete_from' cols='11' rows='10'></textarea></td></td></tr>";
		echo "<tr><td colspan=2 class=text-center><input class='btn btn-bdr-sucess' type=submit name=did_submit value='"._QXZ("Submit")."'></td></tr>\n";
		echo "</table></center></form>\n";
	...
	if ( $modify_users < 1 )
		{
			echo "<center><table width=$section_width cellspacing='3'>";
		echo "<tr  bgcolor='#1A486C'   ><td colspan=2 align=center>   <b>"._QXZ("User Bulk Copy")."</b>$NWB#USERADD$NWE</font></td></tr>\n";
		echo "<tr  ><td colspan=2 align=center><font color=black><b>"._QXZ("You do not have permission to use this section.")."</b></font></td></tr>\n";
		echo "</table></center>\n";
		}
	else
		...
		echo "<center><table width=$section_width cellspacing='3'>";
		echo "<col width=50%><col width=50%>";
		echo "<tr  bgcolor='#1A486C'><td colspan=2 class=text-left><font color=white><b>"._QXZ("User Bulk Copy")."</b>$NWB#USERADD$NWE</font></td></tr>\n";
		echo "<tr><td align=right>"._QXZ("User to copy from").": </td><td align=left>\n";
		...
		echo "<div class=\"col-lg-5\"><select class='form-control' size=1 name=USERcopy_from>\n";
		...
		echo "</select></div></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("User Start ID").":</td><td align=left><div class=\"col-lg-5\"><input class='form-control' type='text' name='USERstart'></div></td></td></tr>";
		echo "<tr ><td align=right>"._QXZ("User Stop ID").":</td><td align=left><div class=\"col-lg-5\"><input class='form-control' type='text' name='USERstop'></div></td></td></tr>";
		echo "<tr><td align=right>"._QXZ("Force PW change?").":</td><td align=left><div class=\"col-lg-5\"><select class='form-control' size=1 name=USERforce_pw>\n";	
		echo "<option value='N'>"._QXZ("No")."</option>\n";
		echo "<option value='Y'>"._QXZ("Yes")."</option>\n";
		echo "</select></div></td></tr>\n";
			echo "<tr  ><td colspan=2 class=text-center><input  class=\"btn btn-bdr-sucess\" type=submit name=did_submit value='"._QXZ("Submit")."'></td></tr>\n";
	...
	if ( $delete_users < 1 || $modify_users < 1)
		{
		echo "<center><table width=$section_width cellspacing='3'>";
		echo "<tr   bgcolor='#1A486C'  ><td colspan=2 align=center>  <font color=white> <b>"._QXZ("User Bulk Delete")."</b>$NWB#USERDELETE$NWE</font></td></tr>\n";
		echo "<tr  ><td colspan=2 align=center><font color=black><b>"._QXZ("You do not have permission to use this section.")."</b></font></td></tr>\n";
		echo "</table></center>\n";
		}
	else
		...
		echo "<center><table width=$section_width cellspacing='3'>";
		echo "<col width=50%><col width=50%>";
		echo "<tr  bgcolor='#1A486C'><td colspan=2 class=text-left><font color=white><b>"._QXZ("User Bulk Delete")."</b>$NWB#USERDELETE$NWE</font></td></tr>\n";
		echo "<tr ><td align=right>"._QXZ("Users to delete").": </td><td align=left>\n";
		...
		echo "<div class=\"col-lg-5\"><select class='form-control' multiple size=10 name='USERdelete_from[]'>\n";
		$i = 0;
		while ( $i < $user_count )
			{
