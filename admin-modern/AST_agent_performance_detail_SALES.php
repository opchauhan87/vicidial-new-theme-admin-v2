...
//~ $HTML_head.="<TITLE>$report_name</TITLE></HEAD><BODY BGCOLOR=WHITE marginheight=0 marginwidth=0 leftmargin=0 topmargin=0>\n";
	...
	$HTML_text.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3> '._QXZ("$report_name")." $NWB#agent_status_detail$NWE</h3> </div>
...
$HTML_text.="<INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\">";
...
$HTML_text.="<BR> to <BR><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\">";
...
$HTML_text.="<SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
if  (preg_match('/\-\-ALL\-\-/',$group_string))
...
$HTML_text.="<SELECT class='form-control' SIZE=5 NAME=user_group[] multiple>\n";
...
$HTML_text.="<SELECT class='form-control' SIZE=5 NAME=users[] multiple>\n";
...
$HTML_text.="<SELECT class='form-control' SIZE=1 NAME=shift>\n";
...
$HTML_text.="<select class='form-control' name='report_display_type'>";
...
$HTML_text.="<div class='col-md-12'><INPUT TYPE=SUBMIT class='btn btn-bdr-sucess NAME=SUBMIT VALUE=SUBMIT></div>$NWB#agent_performance_detail$NWE\n";
