...
var maxParticleCount = <?php echo $maxParticleCount; ?>; //set max confetti count
var particleSpeed = <?php echo $particleSpeed; ?>; //set the particle animation speed
...
(function() {
	...
	function startConfettiInner() {
		...
		if (canvas === null) {
			...
			canvas.setAttribute("style", "display:block;z-index:999999;pointer-events:none;position: fixed;left: 0px; top: 0px; width: 100%; height: 100%;");
