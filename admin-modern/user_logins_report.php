...
echo "<TABLE CELLPADDING=4 CELLSPACING=0><TR><TD class=text-left>";
echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET><div style='display: flex;
    align-items: center;'> \n";
echo "<div class='col-md-4'><SELECT class='form-control' SIZE=1 NAME=user>\n";
echo "<option ";
...
echo "</SELECT></div>\n";
echo "<div class='col-md-3'><INPUT class='btn btn-success' TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."'>\n";
if ( ($user != '--MOST-RECENT-ACTIVE-ARCHIVE--') and ($user != '--MOST-RECENT-ACTIVE-TODAY--') )
	{echo " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <a class='btn btn-bdr-sucess' href=\"./admin.php?ADD=3&user=$user\">"._QXZ("MODIFY")."</a></div> \n";}
echo "</div></FORM>\n\n";

echo "<PRE style='width:94%'><FONT SIZE=2>\n\n";
