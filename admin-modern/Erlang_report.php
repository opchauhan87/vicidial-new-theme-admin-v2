...
$HEADER.="<div id='HelpDisplayDiv' class='help_info' style='display: block;left: 755px;top: 206px;opacity: 1;z-index: 2;'></div>";
...
$MAIN.="<div class='header'><h3 class=\"pull-left\">"._QXZ("$report_name")."$NWB#LISTS_pass_report$NWE</h3><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div><div class=\"pull-right\"><a class=\"btn btn-info\" href=\"./admin.php?ADD=3111&group_id=$group[0]\">"._QXZ("MODIFY")."</a><a class=\"btn btn-info\"  href=\"./AST_inbound_forecasting.php\">"._QXZ("Basic Forecasting Report")."</a></div>\n";
$MAIN.="<div class='col-md-12'><div class='content'><TR><TD>";
$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
#$MAIN.="<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
$MAIN.="<TABLE CELLPADDING=3 CELLSPACING=0 BORDER=1><TR><TD class='col-md-4' VALIGN=TOP> ";
$MAIN.="<INPUT TYPE=hidden NAME=DB VALUE=\"$DB\">\n";

$MAIN.="<div class='col-md-12'>";
$MAIN.="<div class='col-md-10'>";
$MAIN.="<div class='form-group custom-input mb-10'><INPUT class='form-control'  TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Dates").":</label>";
$MAIN.="</div></div>";
$MAIN.="<div class='col-md-2 text-center p-18'>";
...
$MAIN.="<BR><div class='col-md-12' style='text-align:center;'>"._QXZ("to")."</div>";
$MAIN.="<div class='col-md-12'>";
$MAIN.="<div class='col-md-10'>";
$MAIN.="<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\">";
$MAIN.="</div></div>";
$MAIN.="<div class='col-md-2 text-center p-18'>";
$MAIN.="<script language=\"JavaScript\">\n";
$MAIN.="var o_cal = new tcal ({\n";
...
$MAIN.="<div class='col-md-12'><br><div class='form-group custom-input input-group mb-10'><input class='form-control' type='text' size='3' maxlength='4' name='drop_percent' value='$drop_percent'><label>"._QXZ("Target drop rate (B report)").":</label><span class='input-group-addon'>%</span></div><BR>";
$MAIN.="<div class='col-md-12'><div class='form-group custom-input input-group mb-10'><input class='form-control' type='text' size='3' maxlength='4' name='target_pqueue' value='$target_pqueue'>";
$MAIN.="<label>"._QXZ("Target queue prob.(C report)").":</label><span class='input-group-addon'>%</span></div></TD>\n";

$MAIN.="<TD class='col-md-4' VALIGN=TOP> ";
$MAIN.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=campaign[] multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("Campaigns").":</label> </div></div>\n";


$MAIN.="<div class='col-md-12'><div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
...
$MAIN.="</SELECT><label>"._QXZ("In-groups").":</label></div></div>\n<BR>";

$MAIN.="<label>"._QXZ("Erlang type").":</label><BR>";
...
$MAIN.="<div class='form-group custom-input mb-10'><select class='form-control' name='report_display_type'>";
if ($report_display_type) {$MAIN.="<option value='$report_display_type' selected>"._QXZ("$report_display_type")."</option>";}
$MAIN.="<option value='TEXT'>"._QXZ("TEXT")."</option><option value='HTML'>"._QXZ("HTML")."</option></select><label>Display as</label></div>&nbsp; ";
...
$MAIN.="</TD>\n";
$MAIN.="<TD class='col-md-4' VALIGN=TOP><div class='h5'>"._QXZ("Cost analysis stats (optional)").":</div>";
$MAIN.="<div class='form-group custom-input mb-10 mt-20'><INPUT class='form-control' TYPE=TEXT NAME='actual_agents' SIZE=5 MAXLENGTH=5 VALUE=\"$actual_agents\"><label>"._QXZ("Actual agents").":</label></div>";
$MAIN.="<br><div class='form-group custom-input input-group mb-10'><INPUT class='form-control' TYPE=TEXT NAME='hourly_pay' SIZE=5 MAXLENGTH=5 VALUE=\"$hourly_pay\"><label>"._QXZ("Hourly pay per agent").":</label><span class='input-group-addon'>$</span></div>";
$MAIN.="<BR><div class='form-group custom-input input-group mb-10'><INPUT class='form-control' TYPE=TEXT NAME='revenue_per_sale' SIZE=5 MAXLENGTH=5 VALUE=\"$revenue_per_sale\"><label>"._QXZ("Revenue per sale").":</label><span class='input-group-addon'>$</span></div>";
$MAIN.="<BR><div class='form-group custom-input input-group mb-10'><INPUT class='form-control' TYPE=TEXT NAME='sale_chance' SIZE=5 MAXLENGTH=5 VALUE=\"$sale_chance\"><label>"._QXZ("Chance of sale").":</label><span class='input-group-addon'>%</span></div>";
$MAIN.="<BR><div class='form-group custom-input input-group mb-10'><INPUT class='form-control' TYPE=TEXT NAME='retry_rate' SIZE=5 MAXLENGTH=5 VALUE=\"$retry_rate\"><label>"._QXZ("Retry rate (B reports only)").":</label><span class='input-group-addon'>%</span></div>";
$MAIN.="</TD>\n";




$MAIN.="</TR><TR><TD colspan=3 class='text-center'>";
$MAIN.="<INPUT  TYPE=submit class='btn btn-success' NAME='SUBMIT' VALUE='"._QXZ("SUBMIT")."'>";
$MAIN.="<a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?query_date=$query_date&end_date=$end_date&drop_percent=$drop_percent&actual_agents=$actual_agents&hourly_pay=$hourly_pay&revenue_per_sale=$revenue_per_sale&sale_chance=$sale_chance&retry_rate=$retry_rate$campaignQS$groupQS&SUBMIT=$SUBMIT&file_download=1\">"._QXZ("DOWNLOAD")."</a>";
$MAIN.="</TD></TR></TABLE>\n";
# $MAIN.="<TR><TD colspan='5'>";
$MAIN.="<PRE class='m-0'><FONT SIZE=2>\n\n";
...
if ($groups_selected==0 && $campaigns_selected==0)
	...
	if ($actual_agents>0) {
		$HTML_text.="<tr class='records_list_y'><td><font size=1>"._QXZ("Actual agents: ")."</font></td><td><font size=1>".$actual_agents."</font></td></tr>";
	}
	$HTML_text.="<tr class='records_list_x'><td><font size=1>"._QXZ("Total calls: ")."</font></td><td><font size=1>".$erlang_calls."</font></td></tr>";
	$HTML_text.="<tr class='records_list_y'><td><font size=1>"._QXZ("Total drops: ")."</font></td><td><font size=1>".$drops_blocks."</font></td></tr>";
	$HTML_text.="<tr class='records_list_x'><td><font size=1>"._QXZ("Desired drop rate: ")."</font></td><td><font size=1>".sprintf("%5.2f", "$drop_percent")." %</font></td></tr>";
	$HTML_text.="<tr class='records_list_y'><td><font size=1>"._QXZ("Total blocking/drop rate: ")."</font></td><td><font size=1>".sprintf("%-5.2f", (100*$total_blocking))." %</font></td></tr>";
	$HTML_text.="<tr class='records_list_x'><td><font size=1>"._QXZ("Desired sale rate: ")."</font></td><td><font size=1>".sprintf("%5.2f", "$sale_chance")." %</font></td></tr>";
	$HTML_text.="<tr class='records_list_y'><td><font size=1>"._QXZ("Actual sale rate: ")."</font></td><td><font size=1>".sprintf("%-5.2f", (100*$sale_percent))." %</font></td></tr>";
	$HTML_text.="<tr class='records_list_x'><td><font size=1>"._QXZ("Average call duration: ")."</font></td><td><font size=1>".sprintf("%18.2f", "$average_call_length")."</font></td></tr>";
	$HTML_text.="<tr class='records_list_y'><td><font size=1>"._QXZ("Erlangs: ")."</font></td><td><font size=1>".sprintf("%18.4f", $total_erlangs)."</font></td></tr>";
	...
	if ($total_blocking>0) {
		...
		if ($GoS>$total_blocking) {
			...
			while ($GoS>$total_blocking) {
				...
				$ASCII_text.=" $GoS \n";
				# if ($lines%2==0) {echo "1-$lines) adjustedGoS($total_erlangs, $GoS, $retry_rate);<BR>\n";}
				# if ($lines%100==0) {die("Fuck1 $GoS");}
			}
			$ASCII_text.="\n-->";
	...
	if ($erlang_type=="B") {
		...
		$HTML_text.="<tr class='records_list_y'><td><font size=1>"._QXZ("Grade of service: ")."</font></td><td><font size=1>".sprintf("%0.2f", (100*$GoS))."%</font></td></tr>"; # B
	}
	if ($erlang_type=="C") {
	...
	$HTML_text.="<tr class='records_list_x'><td><font size=1>"._QXZ("Estimated agents fielding calls: ")."</font></td><td><font size=1>".$lines."</font></td></tr>";
	#############
	...
	$ASCII_text.=" | "._QXZ("REC AGENTS", 10)." | "._QXZ("EST AGENTS", 10)." | "._QXZ("CALLS/AGNT", 10)." | "._QXZ("REV/CALL", 8)." | "._QXZ("REV/AGENT", 9)." | "._QXZ("TOTAL REV", 10)." | "._QXZ("TOTAL COST", 10)." | "._QXZ("MARGIN", 10)." |\n"; #  EST QUEUE |
	$ASCII_text.=$rpt_header;
	...
	$CSV_text.="\""._QXZ("REC AGENTS")."\",\""._QXZ("EST AGENTS")."\",\""._QXZ("CALLS/AGNT")."\",\""._QXZ("REV/CALL")."\",\""._QXZ("REV/AGENT")."\",\""._QXZ("TOTAL REV")."\",\""._QXZ("TOTAL COST")."\",\""._QXZ("MARGIN")."\"\n";
	ksort($erlang_array);

	$HTML_text2="<table width='960' border='0' cellpadding='2' cellspacing='0'>";
	...
	foreach ($erlang_array as $key => $val) {
		...
		$ASCII_text.=" |\n";
		# $ASCII_text.=sprintf("%-7.2f", (100*$Pqueue))." % |"; #  $val[3] drops ERLANG C
		# $ASCII_text.=" (".pow($erlangs, $lines)."/".(factorial($lines)).")/((".pow($erlangs, $lines)."/".(factorial($lines)).")+((1-($erlangs/$lines))*erlsum(0, ($lines-1), $erlangs)))"; ERLANG C
		...
		# $CSV_text.="\"".sprintf("%.2f", (100*$Pqueue))." %\","; ERLANG C
