...
echo "<META HTTP-EQUIV=\"Content-Type\" CONTENT=\"text/html; charset=utf-8\">\n";
	...
	echo '<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")." $NWB#agent_timeclock_detail$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div></div><div class='col-md-12'> </div>
...
echo "<FORM ACTION=\"$PHP_SELF\" METHOD=GET name=vicidial_report id=vicidial_report>\n";
	...
	echo "<TABLE CELLPADDING=3 CELLSPACING=0 BGCOLOR=\"#e3e3ff\"><TR><TD class='col-md-4' VALIGN=TOP>";
	...
	echo "<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$query_date_D\"><label>"._QXZ("Dates")."</label>";
	echo "</div></div>";
	...
	<?php
	echo "</div>";
echo "<div style='width: 84%;'>";
	echo " <div class='form-group custom-input mb-10'> <INPUT class='form-control' TYPE=TEXT NAME=query_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_T\"></div>";
echo "</div>";
echo "<div class='col-md-12 text-center'><label> "._QXZ("to")."</label> </div>";
echo "<div class='col-md-10'>";
echo "<div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$end_date_D\"></div>";
echo "</div>";
echo "<div class='col-md-2 text-center p-18'>";
	?>
	<script language="JavaScript">
	...
	echo "</div>";
echo "<div style='width: 84%;'>";
echo "<div class='form-group custom-input mb-10'><INPUT TYPE=TEXT class='form-control' NAME=end_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$end_date_T\">";
echo "</div></div>";
	...
	echo "</div></SELECT><label>"._QXZ("User Groups")."</label><BR>\n";
...
<?php
	...
	?>
	<input class='btn btn-success' type=button value="<?php echo _QXZ("SUBMIT"); ?>" name=smt id=smt onClick="submit_form()">
	<?php
