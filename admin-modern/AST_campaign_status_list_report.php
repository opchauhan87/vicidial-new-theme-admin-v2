...
$HTML_text.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name")." $NWB#campaign_status_list_report$NWE</h3><div class='pull-right'><a class=\"btn btn-info\" href=\"./admin.php?ADD=999999\">"._QXZ("BACK")."</a></div> </div>
		<div class='col-md-12'><div class='content'>";
$HTML_text.="<TR><TD class='no-border'>";
...
$HTML_text.="<TABLE CELLPADDING=3 CELLSPACING=0 BGCOLOR=\"#e3e3ff\"><TR><TD VALIGN=TOP class='col-md-4'> ";
...
$HTML_text.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$query_date_D\"><label>"._QXZ("Dates").":</label></div></div>";
...
$HTML_text.="<div class='col-md-10 mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$query_date_T\"></div></div>";

$HTML_text.="<BR><div class='col-md-12' style='text-align:center;'><label> "._QXZ("to")."</label></div> <BR><div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date_D SIZE=11 MAXLENGTH=10 VALUE=\"$end_date_D\"></div></div>";
$HTML_text.="<div class='col-md-2 text-center p-18'>";
$HTML_text.="<script language=\"JavaScript\">\n";
$HTML_text.="var o_cal = new tcal ({\n";
$HTML_text.="	// form name\n";
...
$HTML_text.=" &nbsp; <div class='col-md-10 mb-10'><INPUT class='form-control' TYPE=TEXT NAME=end_date_T SIZE=9 MAXLENGTH=8 VALUE=\"$end_date_T\"></div>";

$HTML_text.="</TD><TD VALIGN=TOP class='col-md-4'> ";
$HTML_text.="<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=5 NAME=group[] multiple>\n";
if  (preg_match("/--ALL--/",$group_string))
...
$HTML_text.="</SELECT><label>"._QXZ("Campaigns").":</label></div>\n";
...
if ($archives_available=="Y") 
	{
	$HTML_text.="<input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label><BR><BR>\n";
	}
...
$HTML_text.="<a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?DB=$DB&query_date=$query_date&end_date=$end_date&query_date_D=$query_date_D&query_date_T=$query_date_T&end_date_D=$end_date_D&end_date_T=$end_date_T$groupQS&file_download=1&SUBMIT=$SUBMIT&search_archived_data=$search_archived_data\">"._QXZ("DOWNLOAD")."</a> ";
$HTML_text.="</div>";
$HTML_text.="</TD>";
$HTML_text.="</TR>";
$HTML_text.="</TABLE>";
