...
$HEADER.="<div id='HelpDisplayDiv' class='help_info' style='display: block; left: 827px; top: 186px; opacity: 1; z-index: 2;'></div>";
...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left"> '._QXZ("$report_name").' '." $NWB#OUTBOUNDsummary_interval$NWE".'</h3><div class= "pull-right"><a class="btn btn-info" href="./admin.php?ADD=999999">'._QXZ("BACK").'</a></div><div class="pull-right"><a class="btn btn-info"  href=\"./admin.php?ADD=34&campaign_id=$group[0]\">'._QXZ("MODIFY").'</a></div> </div>
	...
	$MAIN.="<div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT class='form-control' TYPE=TEXT NAME=query_date SIZE=10 MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date Range").":</label></div></div><div class='col-md-2 text-center p-18'>";
	...
	$MAIN.="	</script></div>\n";
	$MAIN.="<BR><div class='col-md-12' style='text-align:center;'> <label>"._QXZ("to")."</label></div> <div class='col-lg-10 no-padding'><div class='form-group custom-input mb-10'><INPUT  class='form-control'  TYPE=TEXT NAME=end_date SIZE=10 MAXLENGTH=10 VALUE=\"$end_date\"></div></div><div class='col-md-2 text-center p-18'>";
	$MAIN.="	<script language=\"JavaScript\">\n";
	$MAIN.="	var o_cal = new tcal ({\n";
	$MAIN.="		// form name\n";
	$MAIN.="		'formname': 'vicidial_report',\n";
	...
	$MAIN.="</SELECT><label>"._QXZ("Call Time").":</label></div></div>\n";
	...
	$MAIN.="</div></SELECT><label> "._QXZ("Campaigns").":</label><BR><BR>\n";
	
	$MAIN.="<div class='form-group custom-input mb-10'><SELECT class='form-control' SIZE=1 NAME=time_interval>\n";
	...
	$MAIN.="</SELECT><label>"._QXZ("Time Interval").":</label></div>\n";
	$MAIN.="</TD><TD VALIGN=TOP class='col-md-4'>";
	...
	$MAIN.="</SELECT><label>"._QXZ("Include Drop")." "._QXZ("Rollover").":</label></div><BR>\n";
	$MAIN.="<BR>";
	...
	if ($archives_available=="Y") 
		{
		$MAIN.="<input type='checkbox' name='search_archived_data' value='checked' $search_archived_data><label>"._QXZ("&nbsp;Search archived data")."</label>\n";
		}
	...
	$MAIN.="<a class=\"btn btn-bdr-blue\" href=\"$PHP_SELF?DB=$DB&costformat=$costformat&print_calls=$print_calls&query_date=$query_date&end_date=$end_date$groupQS&include_rollover=$include_rollover&time_interval=$time_interval&SUBMIT=$SUBMIT&shift=$shift&file_download=1&search_archived_data=$search_archived_data\">"._QXZ("DOWNLOAD")."</a>  ";
	$MAIN.="</div>";
	$MAIN.="</TD>";
