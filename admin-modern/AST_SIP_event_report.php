...
$MAIN.='<div id="pcont4" class="container-fluid">
		<div class="cl-mcont">
        <div class="row">
		<div class="col-md-12 no-padding"><div class="block-flat"><div class="header"> <h3 class="pull-left">'._QXZ("$report_name").'</h3><div class="pull-right"><a class="btn btn-info" href=\"./admin.php?ADD=999999\">'._QXZ("REPORTS").'</a></div></div><div class="col-md-12"><div class="content">';
...
$MAIN.= "</div><div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\">";
$MAIN.="<INPUT TYPE=TEXT NAME=query_date SIZE=10 class='form-control' MAXLENGTH=10 VALUE=\"$query_date\"><label>"._QXZ("Date")."</label>";
$MAIN.="</div></div><div class='col-lg-1 no-padding'><script language=\"JavaScript\">\n";
...
$MAIN.="</div></div></TD><TD VALIGN=TOP class='no-border size col-lg-4'><BR/>\n";
...
//ishwari
$MAIN.= "<div class=\"col-lg-10 no-padding\"><div class=\"form-group custom-input mb-10\"><select name='group' class='form-control'>";


$MAIN.= "<option value='call_date desc' ".($group=='call_date desc'?'selected="selected"':"")." >"._QXZ("Date-Time UP")."</option>";
$MAIN.= "<option value='call_date asc' ".($group=='call_date asc'?'selected="selected"':"").">"._QXZ("Date-Time DOWN")."</option>";
$MAIN.= "<option value='invite_to_final desc' ".($group=='invite_to_final desc'?'selected="selected"':"").">"._QXZ("Total-Dial UP")."</option>";
$MAIN.= "<option value='invite_to_final asc' ".($group=='invite_to_final asc'?'selected="selected"':"").">"._QXZ("Total-Dial DOWN")."</option>";
$MAIN.= "<option value='invite_to_ring desc' ".($group=='invite_to_ring desc'?'selected="selected"':"").">"._QXZ("Post-Dial UP")."</option>";
$MAIN.= "<option value='invite_to_ring asc' ".($group=='invite_to_ring asc'?'selected="selected"':"").">"._QXZ("Post-Dial DOWN")."</option>";
$MAIN.= "<option value='ring_to_final desc' ".($group=='ring_to_final desc'?'selected="selected"':"").">"._QXZ("Ring-Time UP")."</option>";
$MAIN.= "<option value='ring_to_final asc' ".($group=='ring_to_final asc'?'selected="selected"':"").">"._QXZ("Ring-Time DOWN")."</option>";

$MAIN.= "</select><label>"._QXZ("Sort")."</label></div></div>";

//echo "\n<BR><BR>";
//~ $MAIN.= "</TD><TD VALIGN=TOP lass='no-border size col-lg-4'>\n";

if ($archives_available=="Y") 
	{
	$MAIN.= "<div class=\"col-lg-10 no-padding\"><input type='checkbox' name='search_archived_data' value='checked' $search_archived_data>"._QXZ("Search archived data")."</div>\n";
	}

$MAIN.= "</tr><tr><td colspan=2 class=text-center><INPUT TYPE=SUBMIT NAME=SUBMIT VALUE='"._QXZ("SUBMIT")."' class='btn btn-bdr-sucess'></td>\n";
$MAIN.= "</TD></TR></TABLE>";
...
if (strlen($query_date) < 1)
	{
	$MAIN.= "";
	$MAIN.= _QXZ("PLEASE SELECT A DATE AND TIME RANGE BELOW AND CLICK SUBMIT")."\n";
	}
